...
local frame = CreateFrame("Frame", nil, InterfaceOptionsFramePanelContainer, "BackdropTemplate")
...
closeButton:SetSize(14, 14) -- Adjust the size as needed
...
frame:SetScript("OnShow", function()
    if WoWPro.CreateCurrentGuideTitle then
        ...
        title:SetPoint("TOP", frame, "TOP", 0, -10) -- Adjust the -10 as needed
        title:SetText("WoW-Pro - "..L["Current Guide"])
        subtitle = frame:CreateFontString(nil, "ARTWORK", "GameFontHighlightSmall")
        subtitle:SetHeight(32)
        subtitle:SetPoint("TOP", title, "BOTTOM", 0, -5) -- Adjust the -5 as needed
    ...
    tooltip:SetFrameLevel(frame:GetFrameLevel() + 5)
    tooltip:Hide()
