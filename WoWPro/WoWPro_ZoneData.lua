...
DefineDungeonArea(1018,14,"Lower Sleepers Barrow@Valsharah","Valsharah","Lower Sleepers Barrow")
DefineDungeonArea(1018,15,"Upper Sleepers Barrow@Valsharah","Valsharah","Upper Sleepers Barrow")
DefineDungeonArea(1021, 1,"The Heart of Acherus@BrokenShore","BrokenShore","The Heart of Acherus")
DefineDungeonArea(1021, 2,"Hall of Command@BrokenShore","BrokenShore","Hall of Command")
DefineDungeonArea(1024,20,"Lifespring Lower Cavern@Highmountain","Highmountain","Lifespring Lower Cavern")
DefineDungeonArea(1024,21,"Lifespring Upper Cavern@Highmountain","Highmountain","Lifespring Upper Cavern")
...
DefineDungeonArea(1033,32,"Temple of Fal'adora@Suramar","Suramar","Temple of Fal'adora")
DefineDungeonArea(1033,33,"Falanaar Tunnels@Suramar","Suramar","Falanaar Tunnels")
...
DefineInstance(1007, 0,"BrokenIsles","BrokenIsles")
...
DefineInstance(1014,12,"Dalaran70","Dalaran70")
DefineInstance(1015, 0,"Azsuna","Azsuna")
DefineInstance(1017, 0,"Stormheim","Stormheim")
DefineInstance(1018,15,"Valsharah","Valsharah")
DefineInstance(1020, 0,"TwistingNether70","TwistingNether70")
DefineInstance(1021, 2,"BrokenShore","BrokenShore")
DefineInstance(1022, 0,"Helheim","Helheim")
DefineInstance(1024,21,"Highmountain","Highmountain")
...
DefineInstance(1033,33,"Suramar","Suramar")
...
DefineInstance(1062, 2,"TirisfalGladesInsideScenario","TirisfalGladesInsideScenario")
...
DefineInstance(1096, 0,"AszunaDungeonExterior","AszunaDungeonExterior")
...
DefineTerrain(2,34,  19, 0,"Blasted Lands","BlastedLands")
