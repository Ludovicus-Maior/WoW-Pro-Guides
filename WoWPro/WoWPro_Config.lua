			...
			display = {
				...
				args = {
					...
					fullguide = {
						...
						type = "toggle",
						name = L["Full Guide"],
						desc = L["Shows the full guide in the guide window, rather than just the relevant parts."],
						get = function(info) return WoWProDB.profile.fullguide end,
						set = function(info,val) WoWProDB.profile.fullguide = val  
							WoWPro:UpdateGuide() end
					}, 
					blank2 = {
						order = 5,
