...
WoWPro.RegisterEventHandler("GROUP_ROSTER_UPDATE", function(event, ...)
	if not _G.GetNumSubgroupMembers(LE_PARTY_CATEGORY_HOME) > 0 then
...
WoWPro.RegisterEventHandler("CHAT_MSG_ADDON", function (event,...)
	...
	if successfulRequest and prefix == "WoWPro" and _G.GetNumSubgroupMembers(LE_PARTY_CATEGORY_HOME) > 0 then
