local guide = WoWPro:RegisterGuide("TwiHollEK","WorldEvents","Eastern Kingdom", "Twists", "Alliance", 5)
...
b Stormwind|QID|8311|N|Return to Stormwind.|Z|Teldrassil|
...
C The Collector's Agent|QID|29403|M|51.23,44.63;53.16,42.52;55.26,43.54|CC|N|In the catacombs in the Cathedral of Light.|Z|Stormwind City|
...
A Candy Bucket|QID|12340|M|56.8,47.33;52.90,53.65|CN|N|Depending on where you are at in the quest lines for Westfall, the bucket will be in the Inn or the tower next to the flight point.|Z|Westfall|
...
F Lakeshire|QID|12342|M|29.48,53.77;26.38,41.57|CC|Z|Redridge Mountains|U|37586|
