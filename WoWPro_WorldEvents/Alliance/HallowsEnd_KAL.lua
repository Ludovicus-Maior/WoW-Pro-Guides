...
WoWPro.WorldEvents:RegisterGuide("TwiHollKAL","Hallow's End (Kalimdore)","Hallows End (Kalimdore)","WE", "Twists", "Alliance", function()
return [[
...
F Northwatch Expedition Base Camp|QID||M|70.91,80.50|Z|Stonetalon Mountains|U|68648|
