...
N Wall of Text Part 2 of 2|QID|8677|N|For the Elders that are possible (like Loch Modan) and definite PVP (like Ironforge), I will be putting a target button for them. That way if you have auto-accept/turn-in on, all you have to do is hit the button. It will target the Elder, then run in and right click on them, it will complete the quest, then run like your butt is on fire.|
N This guide starts...|QID|8677|N|In Orgrimmar, so if your in the Eastern Kingdoms.|

A Darkhorn the Elder|N|From Elder Darkhorn.|QID|8677|M|52.25,59.98|Z|Orgrimmar|
...
R Rut'theran Village|N|There is no boat to Rut'theran Village anymore unless you go from Stormwind. You can easily fly across to it though.|QID|8721|M|56.8,90.6|Z|Teldrassil|LVL|60|
...
F Shadowprey Village|N|Fly to Shadowprey Village in Desolace.|QID|8635|M|41.6,47.6|Z|Southern Barrens|RANK|2|
...
A Grimtotem the Elder|N|From Elder Mistwalker.|QID|8679|M|76.70,37.90|Z|Feralas|
...
F Dawnrise Expedition|N|Fly to Dawnrise Expedition in Tanaris.|QID|8671|M|56,64|Z|Un'Goro Crater|
...
A Wildmane the Elder|N|From Elder Wildmane.|QID|8676|M|34.49,39.36|Z|ZulFarrak|RANK|2|
...
A Meadowrun the Elder|N|From Elder Meadowrun, inside the cave.|QID|8722|M|65.21,38.72;63.51,36.11|Z|Western Plaguelands|CS|
A Moonstrike the Elder|N|From Elder Moonstrike. She is on top of Scholomance, not inside of it.|QID|8714|M|69.19,73.45|Z|Western Plaguelands|CS|
...
A Darkcore the Elder|N|From Elder Darkcore. He is near the Thone.|QID|8648|M|66.63,38.23|Z|Undercity|
...
A Ohanzee the Elder|N|From Elder Ohanzee.|QID|13065|M|45.64,61.50|Z|Gundrak|RANK|3|
