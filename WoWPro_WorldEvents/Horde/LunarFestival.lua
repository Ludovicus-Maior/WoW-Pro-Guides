...
F Zidormi|N|If you have finished the BFA opening sequence,  you will need to ask Zidormi to show you what it looked like before|QID|8721|M|48.86,44.45|Z|Felwood|CHAT|LVL|110|;not sure that the lvl 110 is correct
...
R Darnassus|N|Run to Darnassus.|QID|8718|M|39.2,31.8|Z|Darnassus|LVL|60|
A Bladeswift the Elder|N|From Elder Bladeswift.|QID|8718|M|39.21,31.85|Z|Darnassus|T|Elder Bladeswift|
R Rut'theran Village|N|Run through the pink portal if you think you can make it, or go back over the tree.|QID|8725|M|36.16,50.16|Z|Darnassus|LVL|60|
F Zidormi|N|Ask Zidormi to return you to your present time.|QID|8725|M|48.86,44.45|Z|Felwood|CHAT|LVL|110|;not sure that the lvl 110 is correct
...
F Zidormi|CHAT|N|If you have finished the Antarus raid, you will need to talk to Zidormi before you can see the elders.|LVL|110|M|78.8,21.8|Z|Silithus|QID|8654|
...
F Oasis of Vir'sar|QID|29741|M|52.7,34.4|Z|Silithus|FLY|OLD|N|Fly to Oasis of Vir'sar.|LVL|60|
...
F Fizzle's Speedbarge|FLY|OLD|N|Fly to Fizzle's Speedbarge in Thousand Needles.|QID|8724|M|52.0,27.6|Z|Tanaris|
...
A Skychaser the Elder|N|From Elder Skychaser.|QID|8675|M|56.64,47.09|Z|Westfall|T|Elder Skychaser. If agro is a problem, hover beside the tower instead of landing.|LVL|60|
...
R Sandy Beach|QID|8645|M|61.03,28.43|CC|Z|Shimmering Expanse|N|Fly over to Sandy Beach to catch a flight point back to the mainland. This is a REALLY LONG flight, good time for an AFK.|LVL|60|
...
P Vengeance Landing|N|Take the portal (from the where the zeppelin used to stop) to Howling Fjord.|QID|13017|M|58.9,59.0|Z|Tirisfal Glades|LVL|68|

R Utgarde Keep|N|Head inside Utgarde Keep.|QID|13017|M|58.9,48.7|Z|Howling Fjord|RANK|3|LVL|68|
A Jarten the Elder|N|From Elder Jarten inside the instance. Down the stairs in Lower Pinnacle, after Dalronn the Controller. The only thing that has to be killed are the mobs by the fires in the first room, everything else is skippable.|QID|13017|M|47.41,69.55|Z|Njorndir Preparation@UtgardeKeep|RANK|3|LVL|68|
...
A Chogan'gada the Elder|N|From Elder Chogan'gada from inside the instance. You can skip anything you don't agro except Skadi must be killed to open the door and the elder is at the bottom of the stairs after that. Then kill the final boss, King Ymiron, to leave or return the way you came.|QID|13067|M|48.79,23.14|Z|Upper Pinnacle@UtgardePinnacle|RANK|3|LVL|77|

F Camp Oneqwah|FLY|OLD|N|Fly to Camp Oneqwah in Grizzly Hills.|QID|13030|M|79,29.6|Z|Howling Fjord|LVL|68|
...
A Kilias the Elder|N|From Elder Kilias. He is in the area with the large raptor. Everything is skippable, but due to mob density that may be difficult at times.|QID|13023|M|68.92,79.10|Z|The Vestibules of Drak'Tharon@DrakTharonKeep|RANK|3|LVL|71|
...
A Ohanzee the Elder|N|From Elder Ohanzee. He is in the room with the Drakkari Colossus. All the content is skippable to get there and then return back path.|QID|13065|M|45.64,61.50|Z|Gundrak|RANK|3|LVL|73|
...
F Ulduar|QID|13066|FLY|OLD|M|65.4,50.6|N|Fly to Ulduar in The Storm Peaks.|Z|The Storm Peaks|LVL|74|
R Halls of Stone|N|Run into the Halls of Stone.|QID|13066|M|39.57,26.92|Z|The Storm Peaks|RANK|3|LVL|74|
A Yurauk the Elder|N|From Elder Yurauk. Follow the right wall to the elder, just before the first boss. It is not necessary to kill anything if you can avoid it. Return the way you entered.|QID|13066|M|29.39,62.06|Z|Ulduar|RANK|3|LVL|74|
...
F Agmar's Hammer|FLY|OLD|N|Fly to Agmar's Hammer in Dragonblight.|QID|13014|M|40.6,84.6|Z|The Storm Peaks|LVL|68|
...
A Nurgen the Elder|N|From Elder Nurgen. The first boss must be killed to proceed deeper, the 2nd boss can be run past and you drop down the hole where the elder is.  The third boss can also be run past to then exit out the portal at the end.|QID|13022|M|21.80,43.60|Z|The Brood Pit@AzjolNerub|RANK|3|LVL|69|
A Morthie the Elder|N|From Elder Morthie .|QID|13014|M|29.75,55.90|Z|Dragonblight|T|Elder Morthie|LVL|68|
R Moa'ki Harbor|N|Head down to Moa'ki Harbor.|QID|13019|M|48.8,78|Z|Dragonblight|LVL|68|
A Thoim the Elder|N|From Elder Thoim.|QID|13019|M|48.77,78.17|Z|Dragonblight|LVL|68|
F Wintergrasp|FLY|OLD|N|Fly to Wintergrasp in Wintergrasp.|QID|13026|M|48.4,74.4|Z|Dragonblight|LVL|68|
...
F River's Heart|FLY|OLD|N|Fly to River's Heart in Sholazar Basin.|QID|13018|M|21.6,34.8|Z|Wintergrasp|LVL|68|
...
F Transitus Shield|FLY|OLD|N|Fly to the Transitus Shield in Colderra.|QID|13016|M|50,61.4|Z|Sholazar Basin|LVL|68|
A Northal the Elder|N|From Elder Northal. Before the first boss. Nothing needs to die, but due to mob density, you probably will find it easier to kill a few.|QID|13016|M|33.80,34.36|Z|Borean Tundra|LVL|68|
...
P Deepholm|QID|29735|N|Take the portal to Deepholm.|M|50.81,36.43|Z|Orgrimmar@Orgrimmar|LVL|82|
...
P Orgrimmar|QID|29734|M|50.81,53.08|Z|Deepholm|N|Fly back to the Temple of Earth and take the portal back to Orgrimmar.|LVL|82|

P Nordrassil|QID|29740|N|Take the portal to Mount Hyjal.|M|51.13,38.27|Z|Orgrimmar@Orgrimmar|LVL|80|
...
P Orgrimmar|QID|29736|M|62.54,22.82|Z|Mount Hyjal|N|Fly back to Nordassil and take the portal or otherwise travel to Orgrimmar.|LVL|80|

P Dragonmaw Port|QID|29736|N|Take the portal to the Twilight Highlands. If you quested or want to do a few quests in Twilight Highlands there is a return portal also.|M|50.21,39.44|Z|Orgrimmar@Orgrimmar|LVL|84|
