...
K The Abominable Greench|QID|6983|M|45.26,40.32|Z|Hillsbrad Foothills|N|Go to Growless Cave in the Hillsbrad Foothills. Loot the Treats from the bags (fast) and talk to Metzen (fast) to complete if you were not around for the kill.  Yes, if you get there at the right time, you can complete the quest!|
...
A A Smokywood Pastures' Thank You!|QID|6984|PRE|6983|M|52.55,77.04|Z|Orgrimmar|N|From Kaymard Copperpinch.|
T A Smokywood Pastures' Thank You!|QID|6984|M|49.61,77.98|Z|Orgrimmar|N|To Great-father Winter.|
