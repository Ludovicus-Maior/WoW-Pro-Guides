...
C Punting Season|QID|29101|M|21.33,56.37|Z|0198; Mount Hyjal|N|Along the Shores of both lakes (top and bottom half), kill the flame elementals attacking the little tortoises. Pick up a tortoise and punt it into the lake using ablility #1. If you want, you can try to punt it at one of the fire elementals instead. If you aimed right, the elemental will die and you'll get credit for a step in the achievement 'And the Meek Shall Inherit Kalimdor'.|ACH|5868;4|
C Punting Season|QID|29101|M|21.33,56.37|Z|0198; Mount Hyjal|N|Along the Shores of both lakes (top and bottom half), kill the flame elementals attacking the little tortoises. Pick up a tortoise and punt it into the lake using ablility #1.|
...
C Echoes of Nemesis|QID|29122|M|24.01,55.80|Z|0198; Mount Hyjal|N|Talk to Tooga and kill Nemesis when he appears. When he starts to erupt, hide under Toogas shell. If you do this correctly, you will get credit for a step in the achievement 'Infernal Ambassadors'.|ACH|5869;5|
C Echoes of Nemesis|QID|29122|M|24.01,55.80|Z|0198; Mount Hyjal|N|Talk to Tooga and kill Nemesis when he appears. When he starts to erupt, hide under Toogas shell.|
...
C The Protectors of Hyjal|QID|29128|Z|0198; Mount Hyjal|N|When you approach Sethria's Roost, some NPCs will appear and follow you. With their aid, destory the elite mobs.|S|
...
C Achievement step available!|QID|29128|M|31.28, 76.61|Z|0198; Mount Hyjal|N|One of the NPCs that follow you will usually be a questgiver you might recognize from elsewhere. /wave at Linken, Hemet Nesingwary, Nat Pagle, Chromie, Mankrik and Thassarian for the achievement 'Have... Have We Met?'. You can also wave at those if you spot them following another player. Click this step off to continue if you don't see any of the mentioned NPCs.|ACH|5865|
C Achievement step available!|QID|29128|M|31.28, 76.61|Z|0198; Mount Hyjal|N|There are some non-agressive enemies on Sethria's Roost. Kill all of them to get the achievement 'The Fiery Lords of Sethria's Roost'. However, they can be quite hard to solo, even with the NPCs following you. Try to get someone else to help you, or click this step off to continue.|ACH|5861|
C The Protectors of Hyjal|QID|29128|M|31.28, 76.61|Z|0198; Mount Hyjal|N|When you approach Sethria's Roost, some NPCs will appear and follow you. With their aid, destory the elite mobs.|US|
...
C The Harder They Fall|QID|29141|M|49.03,68.79|Z|MoltenFront|N|This quest can be a pain if you're a melee. Kill the big behemoths on the battlefield. They're slow, but they pack a davastating punch.|US|
...
T Strike at the Heart|QID|29243|M|47.57,90.56|Z|MoltenFront|N|At Captain Saynna Stormrunner in the small cave under the Seintinel Tree.|
...
T Additional Armaments|QID|29281|LEAD|29283^29279|M|27.17,62.54|Z|0198; Mount Hyjal|N|Check if you have 125 Marks of the World Tree yet, close this step if you don't. If you do, you can turn in one of your unlocking quests. Additional Armaments and Calling the Ancients each unlock one additional daily quest, while Filling the Moonwell unlocks a one-time-only questline that represents the final battle of the Firelands Invasion, the choice is yours. Close this step to get coordinates for the other two quests, or turn in Additional Armaments at Matoclaw at the Sanctuary of Malorne in Hyjal.|
T Calling the Ancients|QID|29283|LEAD|29281^29279|M|26.00,61.20|Z|0198; Mount Hyjal|N|Check if you have 125 Marks of the World Tree yet, close this step if you don't. If you do, you can turn in one of your unlocking quests. Additional Armaments and Calling the Ancients each unlock one additional daily quest, while Filling the Moonwell unlocks a one-time-only questline that represents the final battle of the Firelands Invasion, the choice is yours. Close this step to get coordinates for Filling the Moonwell, or turn in Calling the Ancients at the Ancient Elderlimb at the Sanctuary of Malorne in Hyjal.|
...
T Additional Armaments|QID|29281|PRE|29283|LEAD|29279|M|27.17,62.54|Z|0198; Mount Hyjal|N|Check if you have 125 Marks of the World Tree yet, close this step if you don't. If you do, you can turn in one of your unlocking quests. Additional Armaments unlocks one additional daily quest, while Filling the Moonwell unlocks a one-time-only questline that represents the final battle of the Firelands Invasion, the choice is yours. Close this step to get coordinates for Filling the Moonwell, or turn in Additional Armaments at Matoclaw at the Sanctuary of Malorne in Hyjal.|
...
T Calling the Ancients|QID|29283|PRE|29281|LEAD|29279|M|26.00,61.20|Z|0198; Mount Hyjal|N|Check if you have 125 Marks of the World Tree yet, close this step if you don't. If you do, you can turn in one of your unlocking quests. Calling the Ancients unlocks one additional daily quest, while Filling the Moonwell unlocks a one-time-only questline that represents the final battle of the Firelands Invasion, the choice is yours. Close this step to get coordinates for Filling the Moonwell, or turn in Calling the Ancients at the Ancient Elderlimb at the Sanctuary of Malorne in Hyjal.|
...
T Filling the Moonwell|QID|29279|PRE|29281&29283|M|27.17,62.54|Z|0198; Mount Hyjal|N|Check if you have 125 Marks of the World Tree yet, close this step if you don't. If you do, you can turn in the final unlocking quest. Filling the Moonwell unlocks a one-time-only questline that represents the final battle of the Firelands Invasion, turn it in at Matoclaw at the Sanctuary of Malorne in Hyjal.|
...
C Into the Depths|QID|29203|M|57.70,49.50|Z|MoltenFront|N|Head into the Igneous Depths and make your way to the center of the cave. Kill Leyara. This quest has been known to bug out occasionally when someone else comletes it the same moment you enter the area. If Leyara is not attackable, abandon the quest and accept it from Malfurion again to reset it.|
T Into the Depths|QID|29203|M|47.00,91.00|Z|MoltenFront|N|Back at Malfurion under the Sentinel Tree.|
A A Smoke-Stained Locket|QID|29298|M|63.48,23.69|Z|0198; Mount Hyjal|N|Check your mail to recieve the Smoke-Stained Locket from Theresa Barkskin, which starts this quest. The nearest mailbox is in front of the Nordrassil Inn under the World Tree (which is also halfway to where you need to go for the quest).|
...
C Unlocking the Secrets Within|QID|29302|M|51.70,45.06|Z|Moonglade|N|Witness the events of Leyaras distant past.|
...
C Tragedy and Family|QID|29303|M|40.52,53.37|Z|Ashenvale|N|Bring the locket to the grave of Valstann Staghelm, which is a little east of Astranaar in Ashenvale. Witness Leyaras mourning.|
...
C The Tipping Point|QID|29310|M|07.59,34.59|Z|0198; Mount Hyjal|N|Bring the locket to the place where Leyara burned Arch Druid Hamuul Runetotem at the beginning of the Firelands Invasion. It's on the western edge of Mount Hyjal. Witness Leyaras fall to the Dark Side.|
