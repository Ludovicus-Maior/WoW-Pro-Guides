...
local guide = WoWPro:RegisterGuide("LudoThunderKing",'Dailies', "Isle of Thunder", "Ludovicus", "Alliance", 5)
...
A Pick up any follow up quests|QID|32586^32588^32576^32577^32578^32579^32580^32581^32583^32584^32585^32607|M|55.74,74.41|N|From Archmage Modera, Lyalia, Sanatation Sorcerer Stephen Litmatch and/or Image of Archmage Vargoth.|PRE|32535^32536^32537^32545^32546^32547^32548^32606|
...
C All In the Family|QID|32558|QO|1|M|59.31,56.56|N|Kill Spiritbinder Tu'chek, and loot the mask.|
C All In the Family|QID|32558|QO|2|M|56.71,46.36|N|Kill Arcanital Ra'kul, loot the mask.|
C Centuries in Sentries|QID|32555|M|59,52|US|U|93806|N|Kill Spirit Bound sentries, then use the crystal on the body.|
...
A Pick up 1-4 quests|QID|32207^32281^32297^32550^32551^32552^32553^32554|M|51.74,47.15|N|From Scout Captain Daelin and Miura Brightweaver.|PRE|32567|
C Saur Loser|QID|32207^32550|M|51,39|S!US|N|Kill Trolls!|
C Compy Stomp|QID|32281^32551|M|51,39|S!US|N|Kill Raptors.|
...
C Direhorn or Devilsaur|QID|32297^32553|M|53.91,43.06|N|Kill the trolls surrounding him to release the Devilsaur.|
...
T Direhorn or Devilsaur|QID|32297^32553|M|51.85,47.16|N|To Miura Brightweave.|
T Compy Stomp|QID|32282^32551|M|51.78,47.15|N|To Scout Captain Daelin.|
T Saur Loser|QID|32207^32550|M|51.78,47.15|N|To Scout Captain Daelin.|
T Dino Might|QID|32554|M|51.78,47.15|N|To Scout Captain Daelin.|
A Quest from Miura|QID|32586^32588|M|61.89,52.08|N|From Miura Brightweave.|PRE|32207^32281^32297^32550^32551^32552^32553^32554|; may be offered other places, other PREs
...
C Agent Reginald|QID|32588|QO|1|U|93761|M|34.60,70.44|Z|505|NC|N|Use the provided crystal wand to free Agent Reginald.|
C Agent Grisel|QID|32588|QO|2|U|93761|M|40.42,53.59|Z|505|NC|N|Take the first right, to find & free Agent Grisel.|
...
A Forge Ahead|QID|32587^52724|PRE|32586^32588|M|PLAYER|N|From your quest log UI.|
K Itolka|ACTIVE|32587^52724|QO|1|M|57.86,34.11|N|When he puts up a shield, go click the 4 points that the lightning originates from.|T|Itolka|
K Fleshcrafter Hoku|ACTIVE|32587^52724|QO|2|M|55.62,38.46|N|Kill and loot for the codex.|T|Fleshcrafter Hoku|
T Forge Ahead|QID|32587^52724|M|58.68,42.68|N|To Scout Captain Daelin.|
A Raiding the Vault|QID|32608^32677|PRE|32587^52724|M|58.68,42.78|N|From Taoshi.|
R The Swollen Vault|ACTIVE|32608^32677|M|62.36,40.45|N|Run down the hill and click on the door to enter The Swollen Vault.|
C Raiding the Vault|QID|32608^32677|M|33.04,28.44|Z|506|N|Kill Shan Bo, to get the key, then Run/jump across the pillers to get to the treasure chest on the other side. Loot for the neeeded item.|
...
K Arcweaver Jor'guva|ACTIVE|32576^32579|M|44.0,69.0|QO|1|N|Interrupt Arcane Blasts. Stay away from Arcane Storms. Get out of Arcane Slams.|
...
K Horgak the Enslaver|ACTIVE|32577^32581|M|45.4,59.4|QO|1|N|When Horgak casts expanding or contracting circles, get 30 yards away before they blow.  Interrupt "Thermal Strike".|
...
T Raiding the Vault|QID|32677^32608|M|63.24,72.24|N|To Lady Jaina Proudmoore. You can use your Kirin Tor Beacon for a quick return.|U|95567|
