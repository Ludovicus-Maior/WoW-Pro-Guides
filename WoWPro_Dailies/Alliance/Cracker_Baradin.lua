WoWPro.Dailies:RegisterGuide("CraToPBar", "Tol Barad Peninsula", "Baradin Wardens Reputation", "Cata", "Crackerhead22", "Alliance", function()
return [[
...
C Teach A Man To Fish.... Or Steal|QID|28137|M|68.2,23.3|N|You can loot the Seabass from the Rustberg Fisherman ot from Strings of Fish.|
...
A A Huge Problem|QID|28122|M|51,49.4|N|From Sergeant Parker.|Z|Tol Barad|
A Swamp Bait|QID|28162|M|51,49.4|N|From Sergeant Parker.|Z|Tol Barad|
A The Leftovers|QID|28163|M|51,49.4|N|From Sergeant Parker.|Z|Tol Barad|

A Accept all quests|M|51.8,49.6|N|From either Commander Stevens, Marshal Fallows or 2nd Lieutenant Wansworth.|QID|28118;28120;28117;28223;28188;28232;28185;28165;28186|Z|Tol Barad|

C A Huge Problem|QID|28122|M|30.9,45.2;38.4,61.7;50.6,58.2;61.7,57.8;62,43.8;57.6,35.3;41,33.9|N|Find and kill Problim. If someone else is attacking him, help out as you will get the completion as well.|T|Problim|Z|Tol Barad|

C Learning From The Past|QID|28120|M|61,49.9|N|Pick up Dusty Prison Journals off the ground.|S|Z|Tol Barad|
C Clearing the Depths|QID|28117|M|61,49.9|N|Kill 9 of any type of Ghost.|S|Z|Tol Barad|
R Cursed Depths|QID|28118|N|Head straight East from the quest giver.|Z|Tol Barad|
C The Imprisoned Archmage|QID|28118|M|56.8,54.8|N|Go down into the Cursed Depths. Find, kill and loot Archmage Galus.|Z|Tol Barad|
C Learning From The Past|QID|28120|M|61,49.9|N|Pick up Dusty Prison Journals off the ground.|US|Z|Tol Barad|
C Clearing the Depths|QID|28117|M|61,49.9|N|Kill 9 of any type of Ghost.|US|Z|Tol Barad|

C Prison Revolt|QID|28188|M|42.8,68.9|N|Kill 10 prisoners of any type.|S|Z|Tol Barad|
C Food From Below|QID|28232|M|42.8,68.9|N|The Cellblock Rations can either be looted from Prisoners or from crates on the ground.|S|Z|Tol Barad|
R The Hole|QID|28223|M|42.8,68.9|N|Head SW from the quest giver.|Z|Tol Barad|
C The Warden|QID|28223|M|37.4,71|N|Head down into The Hole. Kill and loot Warden Silva for his keys.|Z|Tol Barad|
C Food From Below|QID|28232|M|42.8,68.9|N|The Cellblock Rations can either be looted from Prisoners or from crates on the ground.|US|Z|Tol Barad|
C Prison Revolt|QID|28188|M|42.8,68.9|N|Kill 10 prisoners of any type.|US|Z|Tol Barad|

C D-Block|QID|28165|M|42.7,37.6|N|Kill 10 of any type of Demon.|S|Z|Tol Barad|
C Cursed Shackels|QID28186|M|42.7,37.6|N|Loot 8 of the Cursed Shackels that are lying around.|S|Z|Tol Barad|
R D-Block|QID|28185|M|42.7,37.6|N|NW from the quest giver.|Z|Tol Barad|
C Svarnos|QID|28185|M|48.2,30.4|N|Head down into D-Block. Kill then loot Svarnos for his collar.|Z|Tol Barad|
C Cursed Shackels|QID28186|M|42.7,37.6|N|Loot 8 of the Cursed Shackels that are lying around.|US|Z|Tol Barad|
C D-Block|QID|28165|M|42.7,37.6|N|Kill 10 of any type of Demon.|US|Z|Tol Barad|

C The Leftovers|QID|28163|M|50.9,46.4;65.6,65;34.7,68.3|N|Head into either Warden's Vigil, Slagworks or Ironclad Garrison (whichever is closer). Kill 12 Horde Infantry.|Z|Tol Barad|
C Swamp Bait|QID|28162|M|40,48.7|N|Kill and loot Crocolisks until you have 8 hides.|Z|Tol Barad|

T A Huge Problem|QID|28122|M|21,49.4|N|To Sergeant Parker.|Z|Tol Barad|
T Swamp Bait|QID|28162|M|21,49.4|N|To Sergeant Parker.|Z|Tol Barad|
T The Leftovers|QID|28163|M|21,49.4|N|To Sergeant Parker.|Z|Tol Barad|

T Learning From The Past|QID|28120|M|51.8,49.6|N|To Commander Stevens.|Z|Tol Barad|
T Clearing the Depths|QID|28117|M|51.8,49.6|N|To Commander Stevens.|Z|Tol Barad|
T The Imprisoned Archmage|QID|28118|M|51.8,49.6|N|To Commander Stevens.|Z|Tol Barad|

T Prison Revolt|QID|28188|M|51.8,49.6|N|To Marshal Fallows.|Z|Tol Barad|
T Food From Below|QID|28232|M|51.8,49.6|N|To Marshal Fallows.|Z|Tol Barad|
T The Warden|QID|28223|M|51.8,49.6|N|To Marshal Fallows.|Z|Tol Barad|

T D-Block|QID|28165|M|51.8,49.6|N|To 2nd Lieutenant Wansworth.|Z|Tol Barad|
T Cursed Shackels|QID|28186|M|51.8,49.6|N|To 2nd Lieutenant Wansworth.|Z|Tol Barad|
T Svarnos|QID|28185|M|51.8,49.6|N|To 2nd Lieutenant Wansworth.|Z|Tol Barad|

N You can turn these quests into to Captain Jake Sones at the Baradin Base Camp on Tol Barad Peninsula if the quest giving NPC's despawn in preparation for another battle.|
