...
WoWPro.Dailies:RegisterGuide("LudoValExp", "Icecrown", "Valiance Expedition", "Lich", "Ludovicus", "Alliance", function()
return [[
N Valiance Expedition|N|The Valiance Expedition Reputation Dailies.|
...
C Capture More Dispatches|QID|13333|M|48, 54|N|Go near this hill and shoot down the riders flying nearby.  Druids can shoot|
