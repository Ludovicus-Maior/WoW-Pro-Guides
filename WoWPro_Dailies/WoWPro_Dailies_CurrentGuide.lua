...
WoWPro.Dailies.CreateCurrentGuideTitle = true
local title, subtitle

local frame = _G.CreateFrame("Frame", "WoWPro_Dailies_CurrentGuide", _G.InterfaceOptionsFramePanelContainer)
frame.name = L["Current Guide"]
frame.parent = "WoW-Pro Dailies"
frame:Hide()

-- Frame Contents --
frame:SetScript("OnShow", function()

    if WoWPro.Dailies.CreateCurrentGuideTitle then
        title = frame:CreateFontString(nil, "ARTWORK", "GameFontNormalLarge")
        title:SetPoint("TOPLEFT", 16, -16)
        title:SetText("WoW-Pro Dailies - "..L["Current Guide"])
        ...
        WoWPro.Dailies.CreateCurrentGuideTitle = false
    end
    ...
    function WoWPro.Dailies.UpdateCurrentGuidePanel()
