...
R Therazane's Throne|QID|27046|M|49.27,50.33|N|Take the portal from your capital city to Deepholm, then take the portal from the center of Deepholm to Therazane's Throne.|
...
C Fungal Fury|QID|27050|S|M|69.43,33.90|N|Loot mushrooms. There are four types: red, brown, blue, and purple with red spots. Avoid the last kind unless you are going for the achievement, and then make sure to do it last. The achievement requires you to loot one of each type within 2 minutes|
