ocal guide = WoWPro:RegisterGuide("LarePetWQAzs","Dailies","Legion","Larenon","Neutral")
...
;TESTED once
N Dazed and Confused and Adorable|QID|42146|
F Illidari Stand|AVAILABLE|42146|N|Fly to Illidari Stand in Azsuna|
A Dazed and Confused and Adorable|QID|42146|M|50.03, 41.43|Z|Azsuna|N|Click on the Beguiling Orb to start the battle.|
