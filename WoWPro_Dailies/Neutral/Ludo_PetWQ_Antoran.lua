local guide = WoWPro:RegisterGuide("LudoPetWQAntoran","Dailies","Legion","Ludovicus","Neutral")
...
! One-of-Many|NPC|128024|QID|?|
A One-of-Many|QID|?|
C Sure-Fire?|QID|?|PET1|Unborn Val'kyr;71163;2+2+1|PET2|Ikky;86447;1+1+1|PET3|Bunny1;;312+163+119|STRATEGY|wow-petguide-1of∞|
C Val'kyr|QID|?|STRATEGY|wow-petguide-1of∞|N|1) [ability=217/curse-of-doom]\n2) [ability=320/unholy-ascension]|SELECT|1|SWITCH|2|
C Ikky|QID|?|STRATEGY|wow-petguide-1of∞|N|1) [ability=918/black-claw]\n2) Spam [ability=581/flock]\n3) Switch to Bunny|SELECT|2|SWITCH|3|
C Bunny|QID|?|STRATEGY|wow-petguide-1of∞|N|1) [ability=312/dodge]\n2) [ability=163/stampede]\n3) Spam [ability=119/scratch]\n3) Use [ability=312/dodge] to avoid [ability=1968/antaen-cannon]|SELECT|3|DEAD|2,1|
C Critical Critters|QID|?|PET1|Bunny1;;312+163+119;S>281|PET1|Bunny2;;312+163+119;S>281|PET1|Bunny3;;312+163+119;S>281|STRATEGY|LudovicusBunny|
C Bunny1|QID|?|STRATEGY|LudovicusBunny|N|1) [ability=312/dodge]\n2) [ability=163/stampede]\n3) Spam [ability=119/scratch]|SELECT|1|DEAD|1,1|
...
C Bunny3|QID|?|STRATEGY|LudovicusBunny|N|1) [ability=312/dodge]\n2) [ability=163/stampede]\n3) Spam [ability=119/scratch]\n3) Use [ability=312/dodge] to avoid [ability=1968/antaen-cannon]|SELECT|3|DEAD|2,1|
