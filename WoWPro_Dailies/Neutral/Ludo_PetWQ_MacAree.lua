local guide = WoWPro:RegisterGuide("LudoPetWQMacAree","Dailies","Legion","Ludovicus","Neutral")
...
return
[[
N This guide is under construction.
...
C Random|QID|49051|STRATEGY|wow-petguide-Marcuus|0) Select your abilities before battle, if you can.\n1) Whatever\n2) Val'kyr is forced in.|SELECT|1|SWITCH|2|
C Val'kyr|QID|49051|STRATEGY|wow-petguide-Marcuus|1) [ability=217/curse-of-doom]\n2) [ability=210/shadow-slash]\n3) [ability=210/shadow-slash]\n4) Ikky is forced in.|SELECT|2|SWITCH|3|
C Ikky|QID|49051|STRATEGY|wow-petguide-Marcuus|1) [ability=918/black-claw]\n2) [ability=581/flock]|SELECT|3|SWITCH|1|
C Random|QID|49051|STRATEGY|wow-petguide-Marcuus|1) Go for the kill|SELECT|1|DEAD|2,1|
...
; Bucky  - Untested
! Bucky|NPC|128013|QID|?|
A Bucky|QID|?|
C Wow-Petguide.com|QID|49051|PET1|;|PET2|Chrominius;68662;1+1+2|PET3|Ikky;86447;1+1+1|STRATEGY|wow-petguide-Bucky|
C Random|QID|49051|STRATEGY|wow-petguide-Marcuus|0) Select your abilities before battle, if you can.\n1) Whatever\n2) Chrominius is forced in.|SELECT|1|SWITCH|2|
C Chrominius|QID|49051|STRATEGY|wow-petguide-Marcuus|N|1) [ability=362/howl]\n2) [ability=593/surge-of-power]\n3) Switch to Ikky|SELECT|2|SWITCH|3|
C Ikky|QID|49051|STRATEGY|wow-petguide-Marcuus|N|1) [ability=918/black-claw]\n2) [ability=581/flock]\n3) Switch to Random.|SELECT|3|SWITCH|1|
C Random|QID|49051|STRATEGY|wow-petguide-Marcuus|1) Go for the kill|SELECT|1|DEAD|2,1|

; Snozz  - Untested
! Snozz|NPC|128014|QID|?|
A Snozz|QID|49052|PET1|Ikky;86447;1+1+1|PET2|Bloodgazer Hatchling;115787;1+1+1|PET3|Direbeak Hatchling;115785;1+1+1|STRATEGY|wow-petguide-Snozz|
C Ikky|QID|49052|STRATEGY|wow-petguide-Snozz|N|1) [ability=918/black-claw]\n2) Bloodgazer is forced in.|SELECT|1|SWITCH|2|
C Bloodgazer|QID|49052|STRATEGY|wow-petguide-Snozz|N|1) [ability=1773/falcosaur-swarm]\n2) [ability=518/predatory-strike]\n3) Direbeak is forced in.|SELECT|2|SWITCH|3|
C Direbeak|QID|49052|STRATEGY|wow-petguide-Snozz|N|1) [ability=518/predatory-strike]\n 2) [ability=1773/falcosaur-swarm]|SELECT|3|DEAD|2,1|
