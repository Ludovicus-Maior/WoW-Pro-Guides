...
local guide = WoWPro:RegisterGuide("LudoArgDawn",'Dailies', "Eastern Plaguelands", "Ludovicus", "Neutral", 4)
...
N Annals of the Silver Hand|N|This quest can be accepted more than once a day!  So if you do not reset the instance and just go back, you can get another turnin until you get sick of Stratholme.|
