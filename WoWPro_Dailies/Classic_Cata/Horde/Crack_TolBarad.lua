...
local guide = WoWPro:RegisterGuide("CraToBarH",'Dailies', "Tol Barad", "Crackerhead22", "Horde", 4)
...
C A Huge Problem|QID|28657|M|30.9,45.2;38.4,61.7;50.6,58.2;61.7,57.8;62,43.8;57.6,35.3;41,33.9|N|Find and kill Problim. If someone else is attacking him, help out as you will get the completion as well.|T|Problim|
...
C Cursed Shackels|QID28665|M|42.7,37.6|N|Loot 8 of the Cursed Shackels that are lying around.|S|
...
C Cursed Shackels|QID28665|M|42.7,37.6|N|Loot 8 of the Cursed Shackels that are lying around.|US|
C D-Block|QID|28663|M|42.7,37.6|N|Kill 10 of any type of Demon.|US|

C The Leftovers|QID|28659|M|50.9,46.4;65.6,65;34.7,68.3|N|Head into either Warden's Vigil, Slagworks or Ironclad Garrison (whichever is closer). Kill 12 Horde Infantry.|
...
T Cursed Shackels|QID|28665|M|51.8,49.6|N|To Drillmaster Razgoth.|
