...
;  Updated to Retail - Cataclysm splits / new format on 21-Jan-2022 by Blanckaert ( blanckaert@gmail.com or Discord: Maquis#5791 )

N Guide Hub|QID|202000000|JUMP|Engineering: Guide Hub|S!US|N|Jump to the Guide Hub.|NOCACHE|

N This Guide is a Work In Progress Guide.|QID|202000001|N|Currently in Development, This Guide covers Cataclysm content in Retail. \n[color=FF0000]NOTE: [/color]This guide, is just the Make (Create) steps for now, will be fleshed out at a later time.|
