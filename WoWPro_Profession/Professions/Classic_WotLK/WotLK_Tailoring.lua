...
N This Guide|QID|197000001|N|is for Wraith of the Lich King in CLASSIC only. *** Vanilla - TBC - >WotLK<- not done yet, pre release file ***\nAlso ASSUMES you have the appropriate Skill|
N PLEASE Report any issues|QID|197000002|N|In our Discord #WotLK-bug-reports, Please Right Click on the step you have an issue, select the Report Issue, and copy info into Discord.|
...
U Learn Recipe|QID|1970002751|P|Tailoring;197;0+275|RECIPE|18417|N|Learn [spell=18417/Runecloth Gloves] Recipe from Master Tailoring Trainer in Hellfire Peninsula.|
...
= Learn [spell=26790/Master Tailoring]|QID|197026790|M|54.6,63.6|Z|1944|P|Tailoring;197;0+275|SPELL|Master Tailoring;12180|LVL|50|N|Learn from Hama, in Honor Hold, Hellfire Peninsula.|FACTION|Horde|
...
B [spell=26773/Netherweave Robe]|QID|197026773|M|66.2,68.8|Z|1955|RECIPE|26773|T|Eiin|N|Purchase [item=21896/Pattern - Netherweave Robe] from Eiin, in Lower City, Shattrath City. Alternately, you can purchase in The Exodar OR Silvermoon City.|
...
U Learn Recipe|QID|197003401|P|Tailoring;197;0+340|RECIPE|26747|U|21892|N|Learn [spell=26773/Netherweave Robe], using [item=21896/Pattern - Netherweave Robe].|
M [item=21854/Netherweave Boots]|QID|197026773|P|Tailoring;197;0+360;1|ITEM|21854|CRAFT|26773 20|MATS|21840 8;14341 2|N|This turns yellow about 355 points, so you might need to make a few more. Alternately you can make [item=21855/Netherweave Tunic], it costs the same.|
...
B [spell=26778/Imbued Netherweave Tunic]|QID|197026778|M|55.8,58.2|Z|1948|RECIPE|26778|N|Purchase [item=21901/Pattern - Imbued Netherweave Tunic] from Arrond, Sanctum of the Stars, Shadowmoon Valley. REQUIRES being at least Neutral with The Scryers.\n[color=FF0000]NOTE: [/color]You do not have the Rep to buy this, Check the AH OR use another toon, or ask someone to get it for you.|REP|The Scryers;934;Hated-Unfriendly|
