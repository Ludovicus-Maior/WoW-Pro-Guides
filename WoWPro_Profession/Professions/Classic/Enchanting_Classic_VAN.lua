...
R Badlands|QID|333013920|M|65.2,43.1|Z|Badlands|SPELL|Enchanting;13920|N|You'll need to get to Uldaman Instance for the next trainer, make sure to have the about 200 Vision Dust, 5 Lesser Nether Essence and gold before going!|
R Uldaman|QID|333013920|SPELL|Enchanting;13920|IZ|Badlands|N|\n[color=FF0000]NOTE: [/color]NPC is located INSIDE the Uldaman Instance, in Badlands. Walk pass the elite trogg outside, Zone in and open the door.|
