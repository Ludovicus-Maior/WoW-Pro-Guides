...
local guide = WoWPro:RegisterGuide("BlancBSM_Classic_TBC","Profession","Blacksmithing_Classic_TBC", "Blanckaert", "Neutral",2)
WoWPro:GuideIcon(guide,"PRO",164)
WoWPro:GuideLevels(guide)
WoWPro:GuideName(guide, "Blacksmithing_Classic_TBC")
WoWPro:GuideNickname(guide, "BSM_Classic_TBC")
