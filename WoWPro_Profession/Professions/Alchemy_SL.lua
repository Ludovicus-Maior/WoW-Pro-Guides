...
local guide = WoWPro:RegisterGuide("BlancScribe_SL","Profession","Alchemy_SL", "Blanckaert", "Neutral")
...
= Learn Recipe|QID|171000003|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+15|RECIPE|261423|Learn Spiritual Rejuvenation Potion Recipe, from Trainer.|
= Learn Recipe|QID|171000004|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+15|RECIPE|307120|Learn Ground Death Blossom Recipe, from Trainer.|
...
= Learn Recipe|QID|171000005|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+20|RECIPE|307124|Learn Ground Rising Glory Recipe, from Trainer.|
...
= Learn Recipe|QID|171000006|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+30|RECIPE|261424|Learn Potion of the Hidden Spirit Recipe, from Trainer.|
...
= Learn Recipe|QID|171000007|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+45|RECIPE|307123|Learn Ground Marrowroot Recipe, from Trainer.|
N Ground Marrowroot (10)|QID|171307123|P|Alchemy;171;8+55;1|N|2;Marrowroot;20;165|
= Learn Recipe|QID|171000008|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+50|RECIPE|256134|Learn Potion of Soul Purity Recipe, from Trainer.|
...
= Learn Recipe|QID|171000009|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+50|RECIPE|256133|Learn Potion of Specter Swiftness Recipe, from Trainer.|
...
= Learn Recipe|QID|171000010|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+80|RECIPE|307121|Learn Ground Vigil's Torch Recipe, from Trainer.|
N Ground Vigil's Torch (22)|QID|171307121|P|Alchemy;171;8+97;1|N|2;Vigil's Torch;44;144|
= Learn Recipe|QID|171000011|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+90|RECIPE|344316|Learn Potion of Psychopomp's Speed, from Trainer.|
...
= Learn Recipe|QID|171000012|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+100|RECIPE|307094|Learn Potion of Hardened Shadows, from Trainer.|
= Learn Recipe|QID|171000013|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+100|RECIPE|307095|Learn Potion of Spiritual Clarity, from Trainer.|
...
= Learn Recipe|QID|171000014|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+105|RECIPE|307122|Learn Ground Widowbloom, from Trainer.|
= Learn Recipe|QID|171000015|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+110|RECIPE|322301|Learn Potion of Sacrifical Anima, from Trainer.|
...
= Learn Recipe|QID|171000016|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+125|RECIPE|343675|Learn Novice Crafter's Mark, from Trainer.|
= Learn Recipe|QID|171000017|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+125|RECIPE|307383|Learn Potion of Divine Awakening, from Trainer.|
= Learn Recipe|QID|171000018|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+125|RECIPE|307382|Learn Potion of Phantom Fire, from Trainer.|
N Novice Crafter's Mark (5)|QID|171307122|P|Alchemy;171;8+120;1|N|1;Distilled Death Extract5;10:5;Deathblossom;25;50|
...
= Learn Recipe|QID|171000019|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+135|RECIPE|307384|Learn Potion of Deathly Fixation, from Trainer.|
= Learn Recipe|QID|171000020|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+135|RECIPE|307381|Learn Potion of Empowered Exorcisms, from Trainer.|
...
= Learn Recipe|QID|171000021|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+150|RECIPE|343679|Learn Crafter's Mark I, from Trainer.|
= Learn Recipe|QID|171000022|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+150|RECIPE|307093|Learn Potion of Specter Agility, from Trainer.|
= Learn Recipe|QID|171000023|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+150|RECIPE|307098|Learn Potion of Specter Strength, from Trainer.|
= Learn Recipe|QID|171000024|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+150|RECIPE|307097|Learn Potion of Specter Stamina, from Trainer.|
= Learn Recipe|QID|171000025|M|39.6,40.2|Z|Ring of Fates@Oribos|P|Alchemy;171;8+150|RECIPE|307096|Learn Potion of Specter Intellect, from Trainer.|
N Crafter's Mark I (5)|QID|171343679|P|Alchemy;171;8+155;1|N|1;Distilled Death Extract5;5:5;Deathblossom;25;25|
