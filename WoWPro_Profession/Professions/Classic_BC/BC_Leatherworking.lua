...
;  Typed update to Vanilla splits on 29-Jun-2021 by Blanckaert ( blanckaert@gmail.com or Discord: Maquis#5791 )

N This Guide is a Work In Progress Guide.|QID|165000001|N|Currently in Development, starting with Classic - The Burning Crusade Content.\nAlso ASSUMES you have the appropriate Skills.|
N PLEASE Report any issues|QID|165000002|N|In our Discord #tbc-bug-reports, using the Report Issue option menu. (Right click on the step, to bring up Menu).|
...
B [spell=35543/Drums of Battle]|QID|165035543|M|51.2,42.6|Z|1955;Shattrath City|RECIPE|35543|T|Almaador|N|Purchase [item=29717/Pattern - Drums of Battle] from Almaador, Sha'tari Quartermaster. This recipe is Bind on Pick up, also requires Honored with The Sha'tar.|REP|The Sha'tar;935;Honored-Exalted|
B [spell=35538/Drums of Panic]|QID|165035538|M|63.6,57.6|Z|1446;Tanaris|REP|Keepers of Time;989;Honored-Exalted|RECIPE|35538|T|Alurmi|N|Purchase [item=29713/Pattern - Drums of Panic] from Alurmi, Keepers of Time Quartermaster (inside Caverns of Time). This recipe is Bind on Pick up, also requires Honored with Keepers of Time.|
...
= Learn [spell=32549/Leatherworking]|QID|165032549|P|Leatherworking;165;0+275|M|56.2,38.6|Z|1944;Hellfire Peninsula|IZ|3483;Hellfire Peninsula|SPELL|Leatherworking;32549|LVL|50|N|Learn Master Leatherworking from Barim Spilthoof, in Thrallmar, Hellfire Peninsula. Also, BUY all Recipes available.|FACTION|Horde|
= Learn [spell=32549/Leatherworking]|QID|165032549|P|Leatherworking;165;0+275|M|54.0,64.0|Z|1944;Hellfire Peninsula|IZ|3483;Hellfire Peninsula|SPELL|Leatherworking;32549|LVL|50|N|Learn Master Leatherworking from Brumman, in Honor Hold, Hellfire Peninsula. Also, BUY all Recipes available.|FACTION|Alliance|
