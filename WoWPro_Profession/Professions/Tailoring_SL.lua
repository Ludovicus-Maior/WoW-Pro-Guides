...
local guide = WoWPro:RegisterGuide("SpoonyTAI_SLN","Profession","Tailoring_SLN", "Spoony", "Neutral")
WoWPro:GuideIcon(guide,"PRO",197)
WoWPro:GuideLevels(guide)
WoWPro:GuideName(guide, "Tailoring_ShadowLands_NEW")
WoWPro:GuideNickname(guide, "TAI_SLN")
