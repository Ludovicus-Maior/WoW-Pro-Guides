...
WoWPro:GuideNickname(guide, "Bringing the Bass")
WoWPro:GuideName(guide,"Bringing the Bass")
WoWPro.Achievements:GuideMisc(guide, "Bringing the Bass", "Exploration", "Draenor")
