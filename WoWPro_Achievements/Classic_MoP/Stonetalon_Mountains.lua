...
local guide =  WoWPro:RegisterGuide("LudoExpStM","Achievements","Stonetalon Mountains","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Stonetalon Mountains", "Explore Kalimdor", "Cata")
