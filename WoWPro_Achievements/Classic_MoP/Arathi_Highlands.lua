...
local guide =  WoWPro:RegisterGuide("TwiExpAH","Achievements","Arathi Highlands","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Arathi Highlands", "Explore Eastern Kingdoms", "Cata")
