...
local guide =  WoWPro:RegisterGuide("TwiExpSF","Achievements","Silverpine Forest","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Silverpine Forest", "Explore Kalimdor", "Cata")
