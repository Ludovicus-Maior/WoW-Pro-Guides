...
local guide =  WoWPro:RegisterGuide("LudoExpThN","Achievements","Thousand Needles","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Thousand Needles", "Explore Kalimdor", "Cata")
