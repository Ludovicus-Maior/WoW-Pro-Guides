...
local guide =  WoWPro:RegisterGuide("TwiExpGL","Achievements","Ghostlands","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Ghostlands", "Explore Eastern Kingdoms", "Cata")
