...
local guide =  WoWPro:RegisterGuide("TwiExpLM","Achievements","Loch Modan","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Loch Modan", "Explore Eastern Kingdoms", "Cata")
