...
local guide = WoWPro:RegisterGuide('Lorewalkers',"Achievements",'Pandaria', 'WoWPro Team','Neutral', 5)
WoWPro.Achievements:GuideMisc(guide, "Lorewalkers", "Faction", "Pandaria")
