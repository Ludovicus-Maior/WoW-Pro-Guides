...
local guide =  WoWPro:RegisterGuide("LudoExpTiG","Achievements","Tirisfal Glades","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Tirisfal Glades", "Explore Eastern Kingdoms", "Cata")
