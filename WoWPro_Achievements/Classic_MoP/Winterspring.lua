    ...
    local guide =  WoWPro:RegisterGuide("LudoExpWin","Achievements","Winterspring","WoWPro Team", "Neutral", 5)
    WoWPro:GuideLevels(guide,10,50)
    WoWPro.Achievements:GuideMisc(guide, "Explore Winterspring", "Explore Kalimdor", "Cata")
