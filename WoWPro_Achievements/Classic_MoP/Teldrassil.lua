...
local guide =  WoWPro:RegisterGuide("LudoExpTel","Achievements","Teldrassil","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Teldrassil", "Explore Kalimdor", "Cata")
