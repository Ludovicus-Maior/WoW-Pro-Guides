...
local guide = WoWPro:RegisterGuide("TwiHallACat",'Achievements',"Cataclysm", "WoWPro Team", "Alliance", 5)
...
N Out With It|QID|991656|N|You should have enough Tricky Treats to do this one. Just eat one every time the global cooldown is over until you throw up.|ACH|1656;2|U|33226|RANK|3|
N That Sparkling Smile|QID|990981|N|You should have a toothpick by now. If not, you can buy one or try again in the next guide.|ACH|1656;5|U|37604|RANK|3|
