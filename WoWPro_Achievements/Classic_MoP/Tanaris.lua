...
local guide =  WoWPro:RegisterGuide("LudoExpTan","Achievements","Tanaris","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Tanaris", "Explore Kalimdor", "Cata")
