...
local guide = WoWPro:RegisterGuide("LudoHallowCAT",'Achievements',"Cataclysm", "Ludovicus", "Horde", 5)
WoWPro:GuideLevels(guide,10)
WoWPro.Achievements:GuideMisc(guide, "Tricks and Treats of Cataclysm", "Holiday", "Hallows End")
