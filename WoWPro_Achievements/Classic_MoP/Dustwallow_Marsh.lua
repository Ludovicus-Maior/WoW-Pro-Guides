...
local guide =  WoWPro:RegisterGuide("LudoExpDuM","Achievements","Dustwallow Marsh","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Dustwallow Marsh", "Explore Kalimdor", "Cata")
