...
local guide =  WoWPro:RegisterGuide("LudoExpWet","Achievements","Wetlands","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Wetlands", "Explore Eastern Kingdoms", "Cata")
