...
local guide =  WoWPro:RegisterGuide("TwiExpSG","Achievements","Searing Gorge","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Searing Gorge", "Explore Eastern Kingdoms", "Cata")
