...
local guide =  WoWPro:RegisterGuide("TwiExpDM","Achievements","Dun Morogh","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Dun Morogh", "Explore Eastern Kingdoms", "Cata")
