...
local guide = WoWPro:RegisterGuide("TwiExpBT","Achievements","Borean Tundra","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Northrend", "Explore Northrend", "Cata")
