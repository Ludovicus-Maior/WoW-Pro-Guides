...
local guide =  WoWPro:RegisterGuide("LudoExpAzs","Achievements","Azshara","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Azshara", "Explore Kalimdor", "Cata")
