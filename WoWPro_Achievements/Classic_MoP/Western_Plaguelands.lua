...
local guide =  WoWPro:RegisterGuide("LudoExpWeP","Achievements","Western Plaguelands","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Western Plaguelands", "Explore Eastern Kingdoms", "Cata")
