...
local guide =  WoWPro:RegisterGuide("LudoExpNoS","Achievements","Northern Stranglethorn","WoWPro Team", "Neutral", 5)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Northern Stranglethorn", "Explore Eastern Kingdoms", "Cata")
