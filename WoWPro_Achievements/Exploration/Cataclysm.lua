...
local guide = WoWPro:RegisterGuide("KabExpCata","Achievements","Cataclysm","WoWPro Team", "Neutral")
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Cataclysm", "Exploration", "Cataclysm")
