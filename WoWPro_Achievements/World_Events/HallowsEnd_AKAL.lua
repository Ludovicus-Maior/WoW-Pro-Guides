...
local guide = WoWPro:RegisterGuide("TwiHollKAL",'Achievements',"Kalimdor", "Twists", "Alliance")
WoWPro:GuideLevels(guide,10,90)
WoWPro.Achievements:GuideMisc(guide, "Tricks and Treats of Kalimdor", "World Events", "Hallows End")
