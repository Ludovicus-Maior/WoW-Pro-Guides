...
-- Date: 2017-09-18 10:06
-- Who: Emmaleah
-- Log: Play thru tweaks for first 2 weeks of the questline.  I have changes for 3rd week too, but I will take some time to properly merge them with yours (as I foolishly was playing with a version from before 9/12)
...
C The Vindicaar|QID|47224|M|33.65,66.39|Z|Floor3@AzuremystScenario|QO|2|NC|N|Board the Vindicaar, by clicking on the portal thingy.|
...
C Righteous Fury|QID|47589|M|57.92,77.71|QO|1|N|Destroy Southern Devastator.|
C Righteous Fury|QID|47589|M|59.20,74.31|QO|3|N|Destroy Eastern Devastator.|
C Righteous Fury|QID|47589|M|57.17,74.16|QO|2|N|Destroy Western Devastator.|
C Overwhelming Power|QID|46297|M|58.08,77.15|QO|1|N|Finish slaying demons.|US|
C A Stranger's Plea|QID|48483|M|55.77,74.67|QO|1|U|152472|N|Finish healing Felbound Drudges.|US|
...
C Shattered Fields|QID|47431|M|45.55,66.14|QO|3|NC|N|Pause a moment while the rubble is cleared and then reach the Shattered Fields though the tunnel.|
...
A An Offering of Light|QID|48559|M|62.17,87.76|N|From Prophet Velen.|PRE|47743|
A The Vindicaar Matrix Core|QID|47287|M|62.01,86.78|N|From Grand Artificer Romuul.|PRE|47743|
...
A The Wranglers|QID|48460|M|56.55,67.55|N|From Chieftain Hatuun near the Krokul Hovel Beacon.|
...
A Strike Back|QID|48542|M|66.95,67.90|N|The item to start this quest will drop from one of the first few mobs you kill.|
...
A Woah, Nelly!|QID|48544|M|64.44,62.63|N|From Lead Rider Jerek. This puts you on a Wild Cragscaler to speed you on your return to Krokul Hovel.|
...
C Scouting Map|QID|48441|M|69.56,54.30|Z|Lower Deck@ArgusSurface|NC|N|Head back to the Vindicaar and complete the mission, "Darkfall Ridge Supplies".  The Scouting Map is on the lower floor."|
...
C Defenseless and Afraid|QID|46818|M|54.22,73.45|Z|ArgusMacAree|QO|1|U|152408|N|Kill ghosts to collect Pylon Cores, you need 3 pylon cores to activate the Ancient Pylons.|
...
C Consecrating Ground|QID|47066|M|52.80,80.24|Z|ArgusMacAree|NC|N|Argunite Matrix restored, in a undergound bunker.|
...
C Conservation of Magic|QID|47882|M|67.09,51.21|Z|ArgusMacAree|QO|1|U|151624|NC|N|Stabilize Power Conduits.|S|
...
C Conservation of Magic|QID|47882|M|67.09,51.21|Z|ArgusMacAree|NC|U|151624|N|Stabilize Power Conduits.|US|
...
C The Longest Vigil|QID|47883|M|59.92,50.40|Z|ArgusMacAree|QO|1|NC|N|Click on the Inactivated Vigilent to Wake the Gatekeeper.|
...
C Gatekeeper's Challenge: Cunning|QID|47685|M|63.68,44.83|Z|ArgusMacAree|QO|2|NC|N|Fragment of Acuity, blue and yellow.|
C Gatekeeper's Challenge: Cunning|QID|47685|M|61.84,42.82|Z|ArgusMacAree|QO|3|NC|N|Fragment of Wit, red and yellow.|
C Gatekeeper's Challenge: Cunning|QID|47685|M|60.94,44.18|Z|ArgusMacAree|QO|4|NC|N|Fragment of Guile, blue and red.|
...
C The Sigil of Awakening|QID|48107|M|52.18,90.43|Z|ArgusMacAree|QO|2|NC|N|Place the Sigil of Awakening on the matching alcove in front of Velen (upper level).|
