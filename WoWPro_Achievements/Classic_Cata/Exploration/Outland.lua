...
local guide = WoWPro:RegisterGuide("KabExpOutland","Achievements","Hellfire Peninsula","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Outlands", "Explore Outlands", "Cata")
