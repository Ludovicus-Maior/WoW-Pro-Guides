...
local guide =  WoWPro:RegisterGuide("TwiExpBad","Achievements","Badlands","WoWPro Team", "Neutral")
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Badlands", "Exploration", "Cata")
