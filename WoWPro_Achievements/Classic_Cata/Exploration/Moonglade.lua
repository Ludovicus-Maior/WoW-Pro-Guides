...
local guide =  WoWPro:RegisterGuide("LdoExpTG","Achievements","Moonglade","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Moonglade", "Explore Kalimdor", "Cata")
