...
local guide =  WoWPro:RegisterGuide("TwiExpBL","Achievements","Blasted Lands","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Blasted Lands", "Explore Eastern Kingdoms", "Cata")
