...
local guide =  WoWPro:RegisterGuide("LudoExpAsh","Achievements","Ashenvale","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Ashenvale", "Explore Kalimdor", "Cata")
