...
local guide =  WoWPro:RegisterGuide("LudoExpDur","Achievements","Durotar","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Durotar", "Explore Kalimdor", "Cata")
