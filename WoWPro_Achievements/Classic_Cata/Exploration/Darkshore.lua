...
local guide =  WoWPro:RegisterGuide("LudoExpDaS","Achievements","Darkshore","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Darkshore", "Explore Kalimdor", "Cata")
