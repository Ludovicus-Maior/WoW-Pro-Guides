...
local guide =  WoWPro:RegisterGuide("LudoExpDes","Achievements","Desolace","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Desolace", "Explore Kalimdor", "Cata")
