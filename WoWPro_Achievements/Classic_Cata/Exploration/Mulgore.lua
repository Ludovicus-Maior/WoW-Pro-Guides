...
local guide =  WoWPro:RegisterGuide("LudoExpMul","Achievements","Mulgore","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Mulgore", "Explore Kalimdor", "Cata")
