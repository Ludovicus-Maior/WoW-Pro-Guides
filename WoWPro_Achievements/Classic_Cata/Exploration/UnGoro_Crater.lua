...
local guide =  WoWPro:RegisterGuide("LudoExpUnC","Achievements","Un'Goro Crater","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Un'Goro Crater", "Explore Kalimdor", "Cata")
