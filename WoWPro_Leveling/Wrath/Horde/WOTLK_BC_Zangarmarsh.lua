...
K A Job Undone|ACTIVE|9899|QO|1|M|76.61,45.15|N|Kill Sporewing.|
...
R Disturbance at Umbrafen Lake|ACTIVE|9716|QO|1|M|70.9,82.1|N|[Coordinates need updating]Head to the waypoint to get the quest completion.|
...
C Disable the Umbrafen Lake Controls|QID|9720|QO|1|M|70.6,80.3|N|Kill the Steam Pump Overseer (if necessary) and use the seeds.|U|24355|NC|
C Leader of the Darkcrest|QID|9730|M|65.10,68.67|N|Kill Rajah Haghazed. (lv 63 Elite)|
C Disable the Lagoon Controls|QID|9720|QO|4|M|63,65|N|[COORDS]Kill the Steam Pump Overseer (if necessary) and use the seeds.|U|24355|NC|
...
C Disable the Serpent Lake Controls|QID|9720|QO|3|M|62,41|N|[COORDS]Kill the Steam Pump Overseer (if necessary) and use the seeds.|U|24355|NC|
K Leader of the Bloodscale|ACTIVE|9817|QO|1|M|65,41|N|[COORDS]Kill Rajis Fyashe.|
...
T Spirits of the Feralfen|QID|9846|M|32.4,52.0|N|[COORDS]To Seer Janidi.|
A A Spirit Ally?|QID|9847|PRE|9846|M|32.4,52.0|N|[COORDS]From Seer Janidi.|
...
C A Spirit Ally?|ACTIVE|9847|QO|1|M|44.5,66.1|N|At the Boha'mu Ruins, go to the bottom of the stairs and use the totem to spawn the Serpent Spirit.|U|24498|NC|
T A Spirit Ally?|QID|9847|M|32.4,52.0|N|To Seer Janidi.|
K The Biggest of Them All|ACTIVE|9903|QO|1|M|42,42|N|[COORDS]Mragesh is just under the surface of Serpent Lake at the northeastern tip of the isle at .|
...
C Pursuing Terrorclaw|QID|9904|QO|1|M|22.30,45.86|N|Terrorclaw is on the southernmost island in Marshlight Lake.\n[color=FF0000]NOTE: [/color]You may want to clear a spot first, as he fears.|
