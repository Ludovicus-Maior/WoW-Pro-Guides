...
C The Forgotten Pools|QID|870|N|Get into the lake, and look for a crack in the floor with some bubbles flowing out of it. Swim over the bubbles.|M|45.3,22.7|
...
C Call of Fire (Part 3)|QID|1525|C|Shaman|N|Kill Razormane spellcasters of any type until one drops Fire Tar.|
T Call of Fire (Part 3)|QID|1525|C|Shaman|N|Head back into Durotar to turn in your class quest, at the same twisty mountain path as before.|
A Call of Fire (Part 4)|QID|1526|C|Shaman|
C Call of Fire (Part 4)|QID|1526|C|Shaman|U|6636|N|Use your Fire Sapta, go to the end of the trail, and kill the fire elemental there. Loot him, then right click the altar behind him.|
T Call of Fire (Part 4)|QID|1526|C|Shaman|
A Call of Fire (Part 5)|QID|1527|C|Shaman|
T Call of Fire (Part 5)|QID|1527|C|Shaman|N|Back to the Barrens. This will get you your fire totems, congradulations!|
...
T The Missing Shipment (Part 2)|QID|892|M|62.7,36.3|
...
T Samophlange (Part 1)|QID|894|N|You will find a small Goblin hut, and a big piece of machinery. Inside the machinery is a Control Console. You'll have to kill a few Venture Co. Peons to get at it.|M|52.4,11.7|
A Samophlange (Part 2)|QID|900|M|52.4,11.7|
C Samophlange (Part 2)|QID|900|N|Run a circle around the machinery, turning valves off. There are three in all, one at the left side, one at the right side, and one at the back. Clear off the area and use the valves. Some Peons spawn when you turn a valve, but it's nothing you can't handle.|
T Samophlange (Part 2)|QID|900|M|52.4,11.7|
A Samophlange (Part 3)|QID|901|M|52.4,11.7|
C Samophlange (Part 3)|QID|901|N|Retrieve a Console Key from Tinkerer Sniggles, who can be found inside the hut.|M|52.9,10.5|
T Samophlange (Part 3)|QID|901|N|At this point, you can throw away the Control Console Operating Manual in your inventory.|M|52.4,11.7|
A Samophlange (Part 4)|QID|902|M|52.4,11.7|
...
K Razormane|QID|872|QO|Razormane Geomancer slain: 8/8|N|Kill Razormane Geomancers and Razormane Defenders.|M|58,24|
K Razormane|QID|872|QO|Razormane Defenders slain: 8/8|N|Kill Razormane Defenders.|M|58,24|
C Supplies for the Crossroads|QID|5041|N|Check for the crates. If they aren't there, they are probably across the way near Kreenig Snarlsnout.|M|59.5,24|
C The Disruption Ends|QID|872|N|Kreenig Snarlsnout patrolls around. Kill him and loot his tusk.|M|58.6,27|

T Samophlange (Part 4)|QID|902|N|Head south again, towards Ratchet.|M|63.0,37.2|
A Wenikee Boltbucket|QID|3921|M|63.0,37.2|

C Stolen Booty|QID|888|N|You are looking for two boxes among the pirate camps. One is fairly close to the water. The other is in the west, fairly close to the mountains (62.6, 49.7). Keep a look out for Baron Longshore and kill him if you see him.|M|63.6, 49.2|
...
C The Stagnant Oasis|QID|877|N|Now head southwest towards the Stagnant Oasis, killing Kolkar as you go. When you get to the water, start looking for another Bubbling Fissure (55.5,42.4). Beware the turtles, they're aggressive.|U|5068|

C Verog the Dervish|QID|851|N|Look for another centaur gazeebo-like building, up on a hill (53.1,41.7). Near the gazeebo, you will find a couple of tents, and a few kolkar. Kill centaur until one says "I am slain! Summon Verog!" When you see this shout, head back to the gazeebo. Verog should be standing there.|
C Centaur Bracers|QID|855|US|N|Get any last centaur bracers you need.|

T Centaur Bracers|QID|855|N|Now head west, past the crossroads, to Regthar Deathgate's Bunker.|
...
C Ignition|QID|858|N|This quest involves killing Supervisor Lugwizzle (56.3,8.2), who you'll find at the top of the large tower slightly to the south, in the middle of the water. Start climbing the tower, killing as you go. Also, stop to loot any Tool Buckets you see.|
...
R Malaka'jin|QID|6401|N|At (71,95), you'll find a Darkspear Troll settlement called Malaka'Jin.|Z|Stonetalon Mountains|
...
N Fresh Zhevra Carcasse|QID|882|L|10338 1|N|Head north to the dead tree at (60,30). On your way, Kill the first Zhevra you see.|
C Ishamuhale|QID|882|N|When you get to the tree (59,30), Right-Click the Caracas in your inventory. This should summon Ishamuhale. Kill it.|U|10338|
R The Crossroads|QID|899|N|(52,30)|
...
C Cry of the Thunderhawk|QID|913|N|(46.6,61.5)|
