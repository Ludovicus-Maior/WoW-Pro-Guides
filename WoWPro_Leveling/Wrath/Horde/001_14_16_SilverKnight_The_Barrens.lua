local guide = WoWPro:RegisterGuide("SilBar1416", "Leveling", "The Barrens", "SilverKinght", "Horde", 3)
WoWPro:GuideNickname(guide, "The Barrens")
WoWPro:GuideName(guide, "The Barrens")
WoWPro:GuideNextGuide(guide, "SilSil1619")
WoWPro:GuideLevels(guide, 14, 16)
