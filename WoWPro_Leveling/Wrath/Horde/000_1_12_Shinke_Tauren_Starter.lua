...
A Simple Note |QID|3091|C|Warrior,Krieger,Kriegerin|R|Tauren|
A Verdant Note |QID|3094|C|Druid,Druide,Druidin|R|Tauren|

T Etched Note |QID|3092|C|Hunter,Jäger,Jägerin|R|Tauren|
T Rune-Inscribed Note |QID|3093|C|Shaman,Schamane,Schamanin|R|Tauren|
T Simple Note |QID|3091|C|Warrior,Krieger,Kriegerin|R|Tauren|
T Verdant Note |QID|3094|C|Druid,Druide,Druidin|R|Tauren|

A A Humble Task (Part 1)|QID|752|N|Chief Hawkwind. (44,76) |M|44,76|
T A Humble Task (Part 1)|QID|752|N|Greatmother Hawkwind (50,81) |M|50,81|
A A Humble Task (Part 2) |QID|753|
N Water Pitcher |QID|753|L|4755|N|Click the Water Pitcher on the fountain.|
T A Humble Task (Part 2) |QID|753|N|Chief Hawkwind. (44,76)|M|44,76|
A Rites of the Earthmother (Part 1)|QID|755|
A Break Sharptusk! |QID|3376|N|Brave Windfeather|

C The Hunt Continues |QID|750|N|Kill Mountain Cougars until you loot 10 Mountain Cougar Pelts (44,88) |M|44,88|

T Rites of the Earthmother (Part 1)|QID|755|
A Rite of Strength |QID|757|
T The Hunt Continues |QID|750|
A The Battleboars |QID|780|
A Call of Earth (Part 1) |QID|1519|C|Shaman,Schamane,Schamanin|R|Tauren|
...
T Call of Earth (Part 1) |QID|1519|C|Shaman,Schamane,Schamanin|R|Tauren|
A Call of Earth (Part 2) |QID|1520|C|Shaman,Schamane,Schamanin|R|Tauren|
R Kodo Rock |QID|1521|U|6635|C|Shaman,Schamane,Schamanin|R|Tauren|N|Run to Kodo Rock and drink the Earth Sapta. (53.81,80.46) |M|53.81,80.46|
T Call of Earth (Part 2) |QID|1520|C|Shaman,Schamane,Schamanin|R|Tauren|
A Call of Earth (Part 3) |QID|1521|C|Shaman,Schamane,Schamanin|R|Tauren|
T Call of Earth (Part 3) |QID|1521|C|Shaman,Schamane,Schamanin|R|Tauren|
A A Task Unfinished |QID|1656|

T A Task Unfinished |QID|1656|
h Bloodhoof Village |QID|745|N|Innkeeper Kauth. (46.7,61.0) |M|46.7,61.0|
...
N Poison Water |QID|748|N|Start at (46.47,69.70) and kill all Prairie Wolves and Plainstriders you come across. Don't be afraid to go after Plainstriders or especially Swoops. Work your way towards the East until you come across Palemane gnolls. Close this step to continue.|R|Tauren|M|46.47,69.70|
...
C Rite of Vision (Part 2)|QID|771|N|Loot the remaining Ambercorns and get 2 Well Stones near the Well at (53.67,66.28). |M|53.67,66.28|
C Winterhoof Cleansing |QID|754|U|5411|N|Just use the Winterhoof Cleansing Totem near the well. (53.67,66.28)|R|Tauren |M|53.67,66.28|
...
N Thunderhorn Totem|QID|749|N|Go towards (46.6,47.9). From there fight your way towards (49.9,42.5). Finally to the Caravan at (53.5,48.2). Make sure you have one free inventory space at least when trying to accept "The Ravaged Caravan (Part 2)". Close this step to continue.|M|53.5,48.2|
T The Ravaged Caravan (Part 1)|QID|749|
A The Ravaged Caravan (Part 2)|QID|751|
C Thunderhorn Totem |QID|756|N|Again go towards (58.5,61.8). Kill everything you still need for the Tunderhorn Totem on the side of the trail. If you haven't completed the quest when reaching the coordinates work your way towards (60.2,68.2), you can find more mobs for this quest in that direction. Once you finish get back to (58.5,61.8)|R|Tauren |M|58.5,61.8|
...
C Thunderhorn Cleansing |QID|758|U|5415|N|Fight your way to the well (44.7,45.5) and use the Totem in your inventory to complete the quest.|R|Tauren |M|44.7,45.5|
...
A Veteran Uzzek |QID|1505|C|Warrior,Krieger,Kriegerin|
A Call of Fire  |QID|2984|C|Shaman,Schamane,Schamanin|
A Heeding the Call |QID|5926|C|Druid,Druide,Druidin|
T Mazzranache |QID|766|
A Taming the Beast (Part 1)|QID|6061|C|Hunter,Jäger,Jägerin|R|Tauren|
C Taming the Beast (Part 1)|QID|6061|U|15914|N|Just go south outside the Village. (52.0,64.2)|C|Hunter,Jäger,Jägerin|R|Tauren|M|52.0,64.2|
T Taming the Beast (Part 1)|QID|6061|C|Hunter,Jäger,Jägerin|R|Tauren|
A Taming the Beast (Part 2)|QID|6087|C|Hunter,Jäger,Jägerin|R|Tauren|
C Taming the Beast (Part 2)|QID|6087|U|15915|N|Just go north outside the Village. (46.8,47.8)|C|Hunter,Jäger,Jägerin|R|Tauren|M|46.8,47.8|
T Taming the Beast (Part 2)|QID|6087|C|Hunter,Jäger,Jägerin|R|Tauren|
A Taming the Beast (Part 3)|QID|6088|C|Hunter,Jäger,Jägerin|R|Tauren|
C Taming the Beast (Part 3)|QID|6088|U|15916|N|Just go north outside the Village. (46.8,47.8) Look around a bit. You should find one soon.|C|Hunter,Jäger,Jägerin|R|Tauren|M|46.8,47.8|
T Taming the Beast (Part 3)|QID|6088|C|Hunter,Jäger,Jägerin|R|Tauren|
A Training the Beast |QID|6089|C|Hunter,Jäger,Jägerin|R|Tauren|

N Prospector's Picks |QID|746|L|4702 5|N|Kill Dwarves to get 5 Prospector's Picks (31,50)|M|31,50|
T Rite of Vision (Part 3)|QID|772|
A Rite of Wisdom |QID|773|
C The Hunter's Way |QID|861|N|Go towards (59.89,25.60) while killing every Flatland Prowler on your way to complete the quest.|M|59.89,25.60|
A Sacred Burial |QID|833|
C Sacred Burial |QID|833|N|Go towards the Ancestral Spirit (61.39,20.89), while killing every Quilboar in your way.|M|61.39,20.89|
T Rite of Wisdom |QID|773|
A Journey into Thunder Bluff |QID|775|
T Sacred Burial |QID|833|
R Thunder Bluff |QID|776|N|Take the north-side elevator at (41.00,22.19).|M|41.00,22.19|
T Journey into Thunder Bluff |QID|775|
A Rites of the Earthmother |QID|776|
T Heeding the Call |QID|5926|C|Druid,Druide,Druidin|R|Tauren|
...
C Body and Heart |QID|6002|U|15710|N|The stone can be found at (42.0,60.9). Use the dust near the stone. Be careful because of the level 20 mobs around here.|C|Druid,Druide,Druidin|R|Tauren|Z|The Barrens|M|42.0,60.9|
...
C Dwarven Digging |QID|746|U|4702|N|Go to the Forge use the Prospector's Picks five times. (39.1,56.3)|Z|Thunder Bluff|M|39.1,56.3|
C Wildmane Cleansing |QID|760|U|5416|N|Take the north-side elevator, then fight your way to the well and cleanse it. (42.65,14.23)|R|Tauren|M|42.65,14.23|
C Preparation for Ceremony |QID|744|N|First go to the camp at (53,6). When there are no more harpies there, there's another one at (55.5,11). Watch out, I stumbled upon a level 11 Elite Harpy there. If you find the big gray Kodo, Arra'Chea, kill it.|M|53,6|
C Rites of the Earthmother |QID|776|N|Arra'Chea can be hard to find. It patrols clockwise, so we go counter-clockwise. Just follow the waypoints, and you'll run into it eventually. If you don't run into Arra'Chea after a full circle, just uncheck the previous point in the guide menu and then check it again. So the Waypoints should be there again. (52.7,12.7)(50.8,13.0)(49.5,18.2)(51.2,24.5)(52.2,31.7)(52.9,33.5)(55.6,29.9)(55.0,24.4)(54.5,18.9)|M|52.7,12.7|
C Supervisor Fizsprocket |QID|765|N|The entrance to the mine is at (61.4,47.3). Always stick to the right way and you will eventually find Fizsprocket at (64.4,43.7). Kill him and head back out of the mine.|M|61.4,47.3|
...
F Camp Taurajo |QID|886|N|Tal (46.8,50.2)|Z|Thunder Bluff|M|46.8,50.2|
...
f The Crossroads|QID|6362|N|He's at (51.1,28.1)|R|Tauren|Z|The Barrens|M|51.1,28.1|
