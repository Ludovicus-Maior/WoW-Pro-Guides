local guide = WoWPro:RegisterGuide("ScoSho7879", "Leveling", "Sholazar Basin", "Scoot", "Alliance", 3)
WoWPro:GuideNickname(guide, "Sholazar Basin")
WoWPro:GuideName(guide, "Sholazar Basin")
WoWPro:GuideNextGuide(guide, "NLXIce7980")
...
T Rhino Mastery: The Chase |QID|12526|N|Oracle Soo-rahm is in a camp south by the Bones of Nozronn. |M|25.55,66.45|
