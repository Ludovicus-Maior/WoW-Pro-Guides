...
C Rescue the Survivors!|QID|9283|M|77.45,44.80|N|Go west and look for a Draenei Survivor. Cast your Gift of the Naaru on him.|T|Draenei Survivor|R|Draenei,Human,Night Elf|NC|
...
C Help Tavara|QID|9586|M|56.23,48.90|N|Find Tavara and heal her wounds.|R|Draenei,Dwarf,Human|C|Priest|S|
...
C An Alternative Alternative|QID|9473|NC|QO|1|M|48.5,55.1|N|Look for Azure Snapdragon Bulbs (shimmering, glowing plants next to trees).|R|Draenei|
...
C Cookie's Jumbo Gumbo|QID|9512|US|M|58,67|N|Follow the shore back eastwards while killing crawlers for Skittering Crawler Meat.|
...
C Precious and Fragile Things Need Special Handling|QID|9523|M|35,75|S|N|Go to the Wrathscale Point and collect Ancient Relics.|
A Rune Covered Tablet|QID|9514|U|23759|M|36.1,77.0|N|The tablet should have dropped off the naga while you're killing them.|
C Reclaiming the Ruins|QID|9513|M|39.18,78.15|N|Kill any Naga you still need for this quest.|US|
C Precious and Fragile Things Need Special Handling|QID|9523|M|35,75|US|N|Go to the Wrathscale Point and collect Ancient Relics.|
C I've Got a Plant|QID|9530|US|M|45.43,66.20|N|Move towards Odesyus' Landing. There you will find hollow trees. Loot the remaining Piles of Leaves.|
...
C The Great Moongraze Hunt|QID|10324|S|M|50.17,45.30|N|Kill and loot the needed Moongraze Bucks for the Hides.|
...
A Strange Findings|QID|9455|M|48.26,41.43|U|23678|N|Kill Infected Nightstalkers until one of them drops a Faintly Glowing Crystal, then accept the quest from it.|
C The Great Moongraze Hunt|QID|10324|US|M|50.17,45.30|N|Kill and loot the needed Moongraze Bucks for the Hides.|
C Help Tavara|QID|9586|M|56.23,48.90|N|Find Tavara and heal her wounds.|R|Draenei,Dwarf,Human|C|Priest|US|
...
T Totem of Coo|QID|9539|M|55.2,41.6|N|Turn the quest into the Totem of Coo.|
...
C Nightstalker Clean Up, Isle 2...|QID|9456|M|30.94,56.87|S|N|Kill Infected Nightstalkers.|
C The Great Moongraze Hunt|QID|10324|M|30.94,56.87|N|Kill Infected Nightstalkers.|
C Nightstalker Clean Up, Isle 2...|QID|9456|M|30.94,56.87|US|N|Kill Infected Nightstalkers.|
...
C The Prophecy of Akida|QID|9544|M|28.5,66.4|N|Kill Bristlelimb Furbolgs in the camp and get the keys off them. Use them to unlock 8 cages.|
...
C Tree's Company|QID|9531|U|23792|M|18.48,84.33|N|Fight your way out of the cavern then go far southwest to a Naga Flag. Use your Tree Disguise Kit and wait for the complete message.\nOnly one person at a time!|
A A Cry For Help|QID|9528|M|13.61,73.26|N|On the northern side of the island, behind a fallen tree. From Magwin.|
C A Cry For Help|QID|9528|M|16.6,94.5|QO|1|N|Escort Magwin across the island, defending her from the owlkin (she's VERY slow). You'll end up at the next quest NPC we need.|
...
A Taming the Beast|QID|9591|MPRE|9757|M|24.19,54.34|N|From Huntress Kella Nightbow.|C|Hunter|R|Draenei|
C Taming the Beast|QID|9591|M|20.76,65.37|N|Use the Taming Totem to befriend a Barbed Crawler and return to Huntress Kella Nightbow when you have succeeded.|C|Hunter|R|Draenei|U|23896|T|Barbed Crawler|
T Taming the Beast|QID|9591|M|24.19,54.34|N|To Huntress Kella Nightbow.|C|Hunter|R|Draenei|
A Taming the Beast|QID|9592|MPRE|9591|M|24.19,54.34|N|From Huntress Kella Nightbow.|C|Hunter|R|Draenei|
C Taming the Beast|QID|9592|M|40.35,31.57|N|Use the Taming Totem to befriend a Greater Timberstrider and return to Huntress Kella Nightbow when you have succeeded.|C|Hunter|R|Draenei|U|23897|T|Greater Timberstrider|
T Taming the Beast|QID|9592|M|24.19,54.34|N|To Huntress Kella Nightbow.|C|Hunter|R|Draenei|
A Taming the Beast|QID|9593|MPRE|9592|M|24.19,54.34|N|From Huntress Kella Nightbow.|C|Hunter|R|Draenei|
C Taming the Beast|QID|9593|M|36.07,41.44|N|Use the Taming Totem to befriend a Nightstalker and return to Huntress Kella Nightbow.|C|Hunter|R|Draenei|U|23898|T|Nightstalker|
T Taming the Beast|QID|9593|M|24.19,54.34|N|To Huntress Kella Nightbow.|C|Hunter|R|Draenei|
A Beast Training|QID|9675|MPRE|9593|M|24.19,54.34|N|From Huntress Kella Nightbow.|C|Hunter|R|Draenei|
...
C Show Gnomercy|QID|9537|T|Engineer "Spark" Overgrind|M|48.28,72.22|N|Search the beach for Engineer "Spark" Overgrind, talk to him, then kill and loot him.|
...
C Beasts of the Apocalypse!|QID|9560|M|54.24,19.36|S|N|Kill and loot Ravagers at the Menagerie Wreckage.|
;C Strength of One|QID|9582|M|54.06,9.84|N|Click on cage and kill Death Ravager.|C|Warrior|R|Draenei|
C Beasts of the Apocalypse!|QID|9560|M|54.24,19.36|US|N|Kill and loot Ravagers at the Menagerie Wreckage.|
T Beasts of the Apocalypse!|QID|9560|M|44.77,23.90|N|To Moordo.|
C Murlocs... Why Here? Why Now?|QID|9562|M|35,13|S|N|Kill murlocs around until you have 5 Stillpine Grain. You can also collect them from bags around the murloc huts.|
...
C Murlocs... Why Here? Why Now?|QID|9562|M|35,13|US|N|Kill murlocs around until you have 5 Stillpine Grain. You can also collect them from bags around the murloc huts.|
...
C Call of Fire|QID|9465|M|46.94,15.10|N|While you are killing wildkin keep an eye out for the torch.|C|Shaman|R|Draenei|S|
...
C Call of Fire|QID|9465|M|46.94,15.10|N|While you are killing wildkin keep an eye out for the torch.|C|Shaman|R|Draenei|US|
...
T Blood Crystals|QID|9566|M|46.7,20.6|N|Get out of the cave. Turn the quest into High Chief Stillpine.|
...
T Call of Fire|QID|9467|M|59.52,17.95|N|Use the Orb of Returning and turn in to Temper.|C|Shaman|R|Draenei|U|24335|
