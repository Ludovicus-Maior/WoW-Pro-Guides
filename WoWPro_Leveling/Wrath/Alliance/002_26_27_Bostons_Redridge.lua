local guide = WoWPro:RegisterGuide("BosRed2627", "Leveling", "Redridge Mountains", "Boston", "Alliance", 3)
WoWPro:GuideNickname(guide, "Redridge Mountains")
WoWPro:GuideName(guide, "Redridge Mountains")
WoWPro:GuideNextGuide(guide, "BosDus2728")
WoWPro:GuideLevels(guide, 26, 27)
