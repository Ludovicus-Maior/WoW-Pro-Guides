...
A Withered Basidium|QID|9827|M|78.3,45.2|N|Right Click the Withered Basidium.|U|24483|
...
C Too Many Mouths to Feed|QID|9781|M|75.50,71.18|N|Kill the rest of the Hydras needed for this quest in the lake.|US|T|Mire Hydra|
...
l Unidentified Plant Parts|ACTIVE|9802|M|82.00,39.0|L|24401 30|N|Kill mobs until you have at least 30 Unidentified Plant Parts.\n[Blessings of the Ancients] appears when you are Friendly with the Cenarion Expedition.|US|
; Cenarion Refuge
...
C Saving the Sporeloks|M|73.98,94.66|Z|Zangarmarsh|N|Kill mobs until you are finished with this quest.|QID|10096|US|
; Cenarion Refuge
...
C As the Crow Flies|M|PLAYER|N|Use the Stormcrow Amulet to take a ride around the zone.|QID|9718|U|25465|
...
l Bog Lord Tendril|QID|9743|L|24291 6|M|14.5,61.6|N|Kill and loot Fungal Giants|US|
...
C Maktu's Revenge|N|Kill Mragash here.|M|42.00, 42.0|QID|9905|T|Mragesh|
...
C The Terror of Marshlight Lake|N|Kill Terrorclaw here, Terrorclaw can fear.|M|22.20,45.3|QID|9902|T|Terrorclaw|
...
A Fhwoor Smash!|QID|9729|M|19.78,50.841|N|From Fhwoor.  This is an annoying escort quest, but needed to complete the "Mysteries of Zangarmarash".|LVL|63|REP|Sporeggar;970;exalted|
