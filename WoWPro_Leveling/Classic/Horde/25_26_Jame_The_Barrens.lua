...
A Deep Cover|QID|2458|C|Rogue|O|PRE|2460|
...
T Deep Cover|QID|2458|U|8051|O|N|Head north of the Sludge Fen. When the tower is in sight, use the Flare Gun to signal your arrival to Taskmaster Fizzule. Fire off TWO flares, then approach Taskmaster Fizzule and perform the Shattered /Salute.|C|Rogue|
A Mission: Possible But Not Probable|QID|2478|O|PRE|2458|C|Rogue|
N Pickpocket Silixiz|QID|2478|L|8072|C|Rogue|O|N|Pickpocket Foreman Silixiz |M|54.8,6.1|
K Mutated Venture Co. Drones|QID|2478|C|Rogue|O|Q|Mission: Possible But Not Probable|QO|Mutated Venture Co. Drone slain: 2/2|N|Go inside the tower and kill 2 drones on the first floor. They are weak to Ambush.|
K Mutated Venture Co. Patrollers|QID|2478|C|Rogue|O|Q|Mission: Possible But Not Probable|QO|Venture Co. Patroller slain: 2/2|N|Go up the stairs to the second floor and kill 2 patrollers. They are weak to Rupture.|
K Mutated Venture Co. Lookouts|QID|2478|C|Rogue|O|Q|Mission: Possible But Not Probable|QO|Venture Co. Lookout slain: 2/2|N|Go up the stairs to the third floor and kill 2 lookouts. They are weak to Eviscerate.|
C Mission: Possible But Not Probable|QID|2478|C|Rogue|O|N|Stealth up to the fourth floor. Use Ambush on Gallywix, then kill him. Loot his head, and pick the lock on the footlocker. Loot the mixture inside.|
T Mission: Possible But Not Probable|QID|2478|C|Rogue|O|N|Out of the tower and back to Fizzule. Use the whistle to call him.|U|8066|
...
A Mahren Skyseer |QID|874|O|PRE|913|
...
A Isha Awak |QID|873|O|PRE|874|
K Kill Isha Awak for Heart of Isha Awak |QID|873|QO|Heart of Isha Awak: 1/1|O|M|64,50|
T Isha Awak |QID|873|O|
