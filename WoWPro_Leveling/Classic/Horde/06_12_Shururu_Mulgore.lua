...
C Winterhoof Cleansing|QID|754|M|53.67,66.34|U|5411|N|Clear your way to the well and use the provided Winterhoof Cleansing Totem.|
...
C Dwarven Digging|QID|746|M|31.26,49.83|U|4702|N|Kill Dwarves for the Prospector's Picks and use the Picks at the forge to destroy them.|
...
C Thunderhorn Cleansing|QID|758|M|44.33,45.33|U|5415|N|Clear the way to the well and use the totem.|
...
C Taming the Beast|QID|6061|C|Hunter|R|Tauren|M|43.55,51.80|U|15914|N|Use the Taming Rod on an Adult Plainstrider, either north or south of Either north or south of Bloodhoof Village.|
...
C Taming the Beast|QID|6087|C|Hunter|R|Tauren|M|47.07,49.26|U|15915|N|Use the Taming Rod on an Prairie Stalker north of the Bloodhoof Village.|
...
C Taming the Beast|QID|6088|C|Hunter|R|Tauren|M|48.82,46.57|U|15916|N|Use the Taming Rod on a Swoop north of the Bloodhoof Village. You may want to wait for the first Swoop Stun before you start the taming.|
T Taming the Beast|QID|6088|C|Hunter|R|Tauren|M|M|47.82,55.68|N|To Yaw Sharpmane.|
...
A Testing an Enemy's Strength|QID|5723|M|70.51,31.83;70.18,29.50|CN|Z|Thunder Bluff|RANK|3|N|Pick this quest up from Rahauro if you are planning to run the dungeon Ragefire Chasm.|
A Searching for the Lost Satchel|QID|5722|M|70.51,31.83;70.18,29.50|CN|Z|Thunder Bluff|RANK|3|N|Pick this quest up from Rahauro if you are planning to run the dungeon Ragefire Chasm.|
...
C Great Bear Spirit|QID|5930|C|Druid|R|Tauren|M|39.31,27.44|Z|Moonglade|QO|1|N|Talk to the bear spirit until quest is complete.|
...
R Exit Thunder Bluff|QID|759|M|50.85,32.38|CC|Z|Thunder Bluff|N|Use the lifts on the north side to exit Thunder Bluff.|
...
T Supervisor Fitzsprocket|QID|765|PRE|751|M|55.17,60.66|N|To Morin Cloudstalker, who patrols the road.|
...
R Exit Thunder Bluff|QID|760|M|50.85,32.38|CC|Z|Thunder Bluff|N|Use the lifts on the north side to exit Thunder Bluff.|
