...
T Call of Earth|QID|1520|U|6635|M|53.83,80.57|N|Use the Earth Sapta once you are at Kodo Rock.|R|Tauren|C|Shaman|
...
C Winterhoof Cleansing|QID|754|U|5411|M|53.67,66.34|QO|1|N|Clear your way to the well and use the provided Winterhoof Cleansing Totem.|
...
C Dwarven Digging|QID|746|U|4702|M|31.26,49.83|QO|1|N|Kill Dwarves for the Prospector's Picks and use the Picks at the forge to destroy them.|
...
A Thunderhorn Cleansing|QID|758|PRE|756|M|48.53,60.39|N|From Mull Thunderhorn.|R|Tauren|
...
C A Sacred Burial|QID|833|N|Kill Bristleback Interlopers on the way.|S|
...
A Wildmane Totem|QID|759|PRE|758|M|48.53,60.39|N|From Mull Thunderhorn.|R|Tauren|
r Sell Junk and Repair|QID|775|M|45.90,58.73|N|Sell Junk and repair and train your skills before heading out again.|
; --- class quests ------------------------------------------------------------
A Veteran Uzzek|QID|1505|M|49.51,60.58|N|From Krang Stonehoof.|C|Warrior|
A Call of Fire|QID|2984|M|48.39,59.16|N|From Narm Skychaser.|
A Heeding the Call|QID|5926|M|48.48,59.65|N|From Gennia Runetotem.|C|Druid|
A Taming the Beast|QID|6061|M|47.82,55.68|N|From Yaw Sharpmane.|R|Tauren|C|Hunter|
C Taming the Beast|QID|6061|U|15914|M|43.55,51.80|N|Use the Taming Rod on an Adult Plainstrider, either north or south of Either north or south of Bloodhoof Village.|R|Tauren|C|Hunter|
T Taming the Beast|QID|6061|M|47.82,55.68|N|To Yaw Sharpmane.|R|Tauren|C|Hunter|
A Taming the Beast|QID|6087|PRE|6061|M|47.82,55.68|N|From Yaw Sharpmane.|R|Tauren|C|Hunter|
C Taming the Beast|QID|6087|U|15915|M|47.07,49.26|N|Use the Taming Rod on an Prairie Stalker north of the Bloodhoof Village.|R|Tauren|C|Hunter|
T Taming the Beast|QID|6087|M|47.82,55.68|N|To Yaw Sharpmane.|R|Tauren|C|Hunter|
A Taming the Beast|QID|6088|PRE|6087|M|47.82,55.68|N|From Yaw Sharpmane.|R|Tauren|C|Hunter|
C Taming the Beast|QID|6088|U|15916|M|48.82,46.57|N|Use the Taming Rod on a Swoop north of the Bloodhoof Village. You may want to wait for the first Swoop Stun before you start the taming.|R|Tauren|C|Hunter|
T Taming the Beast|QID|6088|M|47.82,55.68|N|To Yaw Sharpmane.|R|Tauren|C|Hunter|
A Training the Beast|QID|6089|PRE|6088|M|47.82,55.68|N|From Yaw Sharpmane.|R|Tauren|C|Hunter|
...
A Moonglade|QID|5922|PRE|5926|M|76.47,27.26|Z|Thunder Bluff|N|From Turak Runetotem.|R|Tauren|C|Druid|
...
A Great Bear Spirit|QID|5930|PRE|5922|M|56.21,30.62|Z|Moonglade|N|From Dendrite Starblaze.|R|Tauren|C|Druid|
R Great Bear Spirit|QID|5930|M|53.39,31.16;45.03,26.67|Z|Moonglade|CS|R|Tauren|C|Druid|
C Great Bear Spirit|QID|5930|M|39.31,27.44|Z|Moonglade|N|Talk to the bear spirit until quest is complete.|R|Tauren|C|Druid|
...
A Back to Thunder Bluff|QID|5932|PRE|5930|M|56.21,30.62|Z|Moonglade|N|From Dendrite Starblaze.|C|Druid|
F Thunder Bluff|QID|5932|M|44.29,45.85|Z|Moonglade|N|Fly back using the Thunder Bluff Flight Master.|R|Tauren|C|Druid|
T Heeding the Call|QID|5932|M|76.47,27.26|Z|Thunder Bluff|N|To Turak Runetotem.|R|Tauren|C|Druid|
A Body and Heart|QID|6002|PRE|5932|M|76.47,27.26|Z|Thunder Bluff|N|From Turak Runetotem.|R|Tauren|C|Druid|
F Camp Taurajo|QID|6002|M|46.98,49.84|Z|Thunder Bluff|R|Tauren|C|Druid|
; --- FIXME: check coordinates
C Body and Heart|QID|6002|C|Druid|U|15710|M|42.00,60.90|Z|The Barrens|N|Use the Cenarion Lunardust near the stone to summon Lunaclaw. Kill him and talk to his ghost to complete the quest. Be careful of the level 20 Thunderheads that roam the area.|R|Tauren|
...
R Exit Thunder Bluff|QID|759|M|67.42,28.69;50.85,32.38|CS|Z|Thunder Bluff|N|Use the lifts on the north side to exit Thunder Bluff.|
C Wildmane Totem|QID|759|N|Kill Prairie Wolf Alphas on the way.|S|
C The Hunter's Way|QID|861|N|Kill Flatland Prowlers on the way.|S|
...
C Wildmane Totem|QID|861|M|56.55,29.44|N|Kill Flatland Prowlers on the way.|US|
C The Hunter's Way|QID|861|M|53.19,34.87|N|Kill Flatland Prowlers.|US|
R Venture Co. Mine|QID|764|M|60.58,49.77|N|Run to the Venture Co. Mine.|
C The Venture Co.|QID|764|N|Kill Venture Co. Workers and Supervisors on the way.|S|
...
C The Venture Co.|QID|764|N|Kill the remaining Venture Co. Workers and Supervisors for this quest.|US|
...
A Wildmane Cleansing|QID|760|PRE|759|M|48.53,60.39|N|From Mull Thunderhorn.|R|Tauren|
...
A Tal the Wind Rider Master|QID|6363|PRE|6362|M|45.73,55.83|Z|Thunder Bluff|N|From Ahanu.|R|Tauren|
T Tal the Wind Rider Master|QID|6363|M|46.98,49.84|Z|Thunder Bluff|N|To Tal at the top of the tower.|R|Tauren|
A Return to Jahan|QID|6364|PRE|6363|M|46.98,49.84|Z|Thunder Bluff|N|From Tal.|R|Tauren|
