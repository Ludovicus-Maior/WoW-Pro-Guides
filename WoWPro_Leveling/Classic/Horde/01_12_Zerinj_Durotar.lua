...
local guide = WoWPro:RegisterGuide('Classic-01-12-Zerinj-Durotar', 'Leveling', 'Durotar', 'Zerinj', 'Horde', 1)
...
A Speak with Un'thuwa|QID|1883|C|Mage|R|Orc,Troll|M|39.15,86.27||Z|Orgrimmar|N|From Uthel'nay, Valley of the Spirits.|
...
C Hidden Enemies|QID|5726|US|N|Kill Burning Blade Apprentices and Fanatics until you have the Lieutenants Insignia.|
