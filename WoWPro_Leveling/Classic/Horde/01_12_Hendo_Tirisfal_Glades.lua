...
A The Mindless Ones|QID|364|M|30.84,66.20|PRE|363|
...
A Encrypted Scroll|QID|3096|M|30.80,66.20|N|From Shadow Priest Sarvis in the chapel.|PRE|364|R|Undead|C|Rogue|
A Glyphic Scroll|QID|3098|M|30.80,66.20|N|From Shadow Priest Sarvis in the chapel.|PRE|364|R|Undead|C|Mage|
A Hallowed Scroll|QID|3097|M|30.80,66.20|N|From Shadow Priest Sarvis in the chapel.|PRE|364|R|Undead|C|Priest|
A Simple Scroll|QID|3095|M|30.80,66.20|N|From Shadow Priest Sarvis in the chapel.|PRE|364|R|Undead|C|Warrior|
A Tainted Scroll|QID|3099|M|30.80,66.20|N|From Shadow Priest Sarvis in the chapel.|PRE|364|R|Undead|C|Warlock|
...
T Glyphic Scroll|QID|3098|M|30.90,66.10|N|Turn in your class quest in the chapel at Isabella.|R|Undead|C|Mage|
T Hallowed Scroll|QID|3097|M|31.10,66.00|N|Turn in your class quest in the chapel at Dark Cleric Duesten.|R|Undead|C|Priest|
T Simple Scroll|QID|3095|M|32.70,65.60|N|Go to the bigger house across the chapel at Dannal Stern.|R|Undead|C|Warrior|
T Tainted Scroll|QID|3099|M|30.90,66.30|N|Turn in your class quest in the chapel at Maximillion.|R|Undead|C|Warlock|
A Piercing the Veil|QID|1470|M|30.98,66.41|N|From Venya Marthand in the chapel.|R|Undead|C|Warlock|
...
L Level 6|QID|365|N|Grind out until you are at least 1 bubble from levelling. Killing Tirisfal Farmers and Farmhands while collecting the pumpkins is probably your best bet. Avoid pulling groups and you should be okay.|LVL|5;2640|
...
L Level 6|QID|407|N|You must be level 6 to continue. Go grind until you are.|LVL|6|
...
N Austil de Mon|ACTIVE|8|M|61.85,52.54|N|Warrior Trainer, on the main floor inside the Tavern.|C|Warrior|
N Cain Firesong|ACTIVE|8|M|61.96,52.46|N|Mage Trainer, at the top of the stairs inside the Tavern.|C|Mage|
N Rupert Boch|ACTIVE|8|M|61.59,52.40|N|Warlock Trainer, upstairs inside the Tavern.|C|Warlock|
N Gina Lang|ACTIVE|8|M|61.55,52.61|N|Demon Trainer, upstairs inside the Tavern.|C|Warlock|
N Dark Cleric Beryl|ACTIVE|8|M|61.58,52.20|N|Priest Trainer, upstairs inside the Tavern.|C|Priest|
N Marion Call|ACTIVE|8|M|61.75,52.00|N|Rogue Trainer, upstairs inside the Tavern.|C|Rogue|
...
C Garments of Darkness|QID|5650|M|59.18,46.49|N|Go north. Heal Deathguard Kel and give Power Word: Fortitude to him.|R|Undead|C|Priest|
; ---
...
T Garments of Darkness|QID|5650|M|61.57,52.19|N|To Dark Cleric Beryl upstairs at the Tavern.|R|Undead|C|Priest|
...
C Proof of Demise|QID|374|M|53.1,65.8|QO|1|N|Kill Scarlet Crusade to collect Scarlet Insignia Rings.|S|
...
K Duskbats|QID|375|M|56.00,60.00|QO|1|N|Kill Duskbats around the area southwest of Brill until you have 5 Duskbat Pelts.|US|
...
C Graverobbers|QID|358|QO|1;2;3|N|By this point, you should only have Graverobbers left to kill. You can finish collecting the Embalming Fluid from them. If you still need them, the Mongrels are back at the farm.|US|
...
K Gregor Agamand|QID|354|M|45.78,29.40|QO|1|N|Continue north-west to where you should find Gregor Agamand. Kill him and loot Gregor's Remains. [color=FF0000]NOTE: [/color]He hits hard but should be soloable if you make sure to pull him alone.|
...
; --- Priest
A Touch of Weakness|QID|5658|M|49.28,18.36|Z|Undercity|N|From Aelthalyste.|LVL|10|R|Undead|C|Priest|
T Touch of Weakness|QID|5658|M|49.28,18.36|Z|Undercity|N|Turn into Aelthalyste.|LVL|10|R|Undead|C|Priest|
; --- Rogue
...
C Balnir Farmstead|QID|1882|M|77.43,61.77|N|Loot the Balnir Snapdragons.|R|Undead|C|Mage|NC|

N Slumber Sand|ACTIVE|371|N|[color=FF0000]NOTE: [/color]Captain Vachon is level 11 and can be difficult for some classes. Especially since he has an add who will heal him. Now is a good time to use your Slumber Sand. Put it on your action bar and use it to crowd control the Friar while you kill Captain Vachon.|
...
C Proof of Demise|QID|374|QO|1|N|Kill Scarlet Crusade to collect Scarlet Insignia Rings.|US|
...
C The Lich's Identity|QID|357|M|68.00,42.10|QO|1|N|Run to the island in Brightwater Lake and grab the Lich's Spellbook from the table.|NC|
