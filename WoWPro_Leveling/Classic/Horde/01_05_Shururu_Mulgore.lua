...
C Water Pitcher|QID|753|M|50.22,81.37|L|4755|N|Click the Water Pitcher on the fountain.|
...
C The Hunt Continues|QID|750|US|M|44.21,89.06|N|Kill Mountain Cougars until you have all 10 Mountain Cougar Pelts.|
...
N Train level 4 skills/spelss|QID|780|N|Before heading out go to your trainer and learn your level 4 spells/skills. Right-click this step off.|
...
C Call of Earth|QID|1519|C|Shaman|R|Tauren|M|64.8,79.2|N|Make sure you have the 2 Ritual Salves.|
H Camp Narache|QID|757|U|6948|
...
R Kodo Rock|QID|1521|C|Shaman|R|Tauren|M|53.95,80.21|CN|
T Call of Earth|QID|1520|C|Shaman|R|Tauren|M|53.83,80.57|U|6635|N|Use the Earth Sapta once you are at Kodo Rock.|
A Call of Earth|QID|1521|M|53.83,80.57|C|Shaman|R|Tauren|
...
h Bloodhoof Village|QID|745|M|46.7,61.0|N|At Innkeeper Kauth.|
]]
end)
