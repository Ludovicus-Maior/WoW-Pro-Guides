...
local guide = WoWPro:RegisterGuide('ClassicEasternKingdom1220', 'Leveling', 'Loch Modan', 'Bidaum+Boston+Emmaleah', 'Alliance', 1)
...
C Filthy Paws|QID|307|M|35.53,18.71|QO|1|N|Enter the mine and collect the crates of Miners' Gear.|
...
C Crocolisk Hunting|QID|385|QO|1;2|M|54.50,39.00|US|N|Kill and loot crocolisks for their skin and meat. You'll find them in the Loch, on the islands and along the shoreline.|
T Bingles' Missing Supplies|QID|2038|M|63.54,47.90|N|To Bingles Blastenheimer.|
R The Farstrider Lodge|ACTIVE|385|M|80.78,59.47|N|Run to the Farstrider Lodge.|
...
K Chok'sul|ACTIVE|256|M|79.49,15.55|QO|1|N|Chok'sul is found all the way to the back of the cave. Kill and take his head as proof.|T|Chok'sul
...
K Ol' Sooty|ACTIVE|271|M|40.21,66.95;36.81,61.23|CS|N|Go up this path to find Ol' Sooty in a cave and take his head.|T|Ol' Sooty
