...
return [[
;Before Dungeon
A Shadowshard Fragments|QID|7070|M|66.42,49.26|Z|Dustwallow Marsh|N|From Archmage Tervosh. This is optional, a bit out of the way in Theramore and is only done outside the instance. It's good if you want to solo some of the outside stuff before hand though since some of the quests require both inside and outside tasks.|
A Corruption of Earth and Seed|QID|7065|M|63.84,10.67|Z|Desolace|N|From Keeper Marandis.|
A Vyletongue Corruption|QID|7041|M|68.50,8.88|Z|Desolace|N|From Talendria.|
A Twisted Evils|QID|7028|M|62.20,39.63|Z|Desolace|N|From Willow.|
A The Pariah's Instructions|QID|7067|M|46.88,86.79|Z|Desolace|N|From Centaur Pariah. He patrols the area, you need to find him.|
...
A Legends of Maraudon|QID|7044|M|38.78,58.12|Z|1414|N|From Cavindra. Before the Orange entrance.|
...
A The Scepter of Celebras|QID|7046|M|39.27,58.20|Z|Desolace|N|From Celebras the Redeemed.|PRE|7044|
...
A Seed of Life|QID|7066|M|39.27,58.20|Z|Desolace|N|From Zaetar's Spirit after you kill the princess.|
...
N Maraudon Complete|N|This completes the Maraudon guide.|
]]
end)
