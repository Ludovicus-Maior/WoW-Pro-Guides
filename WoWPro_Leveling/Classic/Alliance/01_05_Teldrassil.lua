...
WoWPro:GuideName(guide, 'Teldrassil 01-05')
...
N First Aid|QID|928|RECIPE|3275|M|55.29,56.82|N|You can learn first aid from the trainer Byancle. Right-click this step off to skip.|
