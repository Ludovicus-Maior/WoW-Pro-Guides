...
local guide = WoWPro:RegisterGuide('ClassicAlliance2530', "Leveling", 'Westfall', 'Bidaum+Boston+Elidion', 'Alliance', 1)
...
C Uncovering the Past|QID|299|M|34,47|QO|2|S|N|From a Large Jug that spawns around.|
C Uncovering the Past|QID|299|M|37,50|QO|4|S|N|Pile of Dirt. Spawns all around the Excavation.|
...
C Uncovering the Past|QID|299|M|37,50|QO|4|US|N|Pile of Dirt. Spawns all around the Excavation.|
C Uncovering the Past|QID|299|M|34,47|QO|2|S|N|From a Large Jug that spawns around.|
...
K Spiders|QID|101|M|81.8,59.3|QO|2|S|N|From now on kill any type of spider you see along the way.|
...
K Spiders|QID|101|M|28,50|QO|2|US|N|Kill the Black Widow Hatchlings around the eastern edge of this area until you get 5 Vials of Spider Venom.|
...
* Trash the book|ACTIVE|221|L|2154|S|N|Destroy The Story of Morgan Ladimore, it is useless and wastes precious bag space.|PRE|227|
