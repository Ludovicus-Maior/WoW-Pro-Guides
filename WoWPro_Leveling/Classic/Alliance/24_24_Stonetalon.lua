...
A Castpipe's Task|QID|2931|
N If you are not playing on a PvP server you should head to Stonetalon peak: Take the quest to kill the harpies and the Flightmaster, then head to the charred vale and Kill basilisks and harpies until your quests are done.
...
N If you did the harpy quest run to stonetalon peak turn in and fly to Astranaar
