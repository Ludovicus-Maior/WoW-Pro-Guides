local guide = WoWPro:RegisterGuide('ElidionDun_Uld', 'Leveling', 'Badlands', 'Elidion', 'Alliance', 1)
...
A Power in Uldaman|QID|1956|M|46.06,57.09|Z|Dustwallow Marsh|N|From Tabetha. In case you did the prerequisite but didn't pick this up, you might want to grab this before heading to Ironforge.|PRE|1955|C|Mage|
...
A Uldaman Reagent Run|QID|17|M|37.07,49.38|Z|Loch Modan|N|From Ghak Healtouch.|PRE|2500|
T Murdaloc|QID|739|M|65.9,65.6|Z|Loch Modan|N|To Prospecter Ironband.|
A Agmond's Fate|QID|704|M|65.9,65.6|Z|Loch Modan|N|From Prospecter Ironband.|PRE|739|

;Before Dungeon
A Power Stones|QID|2418|M|42.39,52.92|Z|Badlands|N|From Rigglefuzz.|
A Solution to Doom|QID|709|M|51.39,76.87|Z|Badlands|N|From Theldurin the Lost.|
...
A Amulet of Secrets|QID|722|M|54.04,57.66|Z|Eastern Kingdoms|N|From Hammertoe Grez.|PRE|721|
...
A Back to Uldaman|QID|2200|M|36.37,3.60|Z|Ironforge|N|From Talvash del Kissel.|PRE|2199|
...
A An Ambassador of Evil|QID|762|M|77.53,11.81|Z|Ironforge|N|From Historian Karnik.|PRE|726|
...
K Ambassador Infernus|QID|762|M|41.99,28.72|Z|Badlands|N|Bottom floor of Angor Fortress. Kill and loot his bracer.\n\nElite|L|4621|T|Ambassador Infernus|
T An Ambassador of Evil|QID|762|M|77.34,9.68|Z|Ironforge|N|To Advisor Belgrum.|
A The Lost Tablets of Will|QID|1139|M|77.34,9.68|Z|Ironforge|N|From Advisor Belgrum.|PRE|762|
...
A The Hidden Chamber|QID|2240|M|PLAYER|N|From Baelog. Located at dig 2.|PRE|2398|
...
A Find the Gems|QID|2201|M|PLAYER|N|From the Remains of a Paladin.|PRE|2200|
...
A Restoring the Necklace|QID|2204|M|PLAYER|N|Use the Phial of Scrying on the floor if you haven't already done so and then click on it to get this quest.|PRE|2201|U|7667|
...
A The Platinum Discs|QID|2278|M|PLAYER|N|Run into the treasure room and click on The Discs of Norgannon.|
