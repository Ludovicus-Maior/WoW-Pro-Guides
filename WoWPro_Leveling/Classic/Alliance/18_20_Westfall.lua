...
N If you find a treasure map, it is worth doing it as soon as you find it, as the final step is at the north coast and you can clear your way back to the lighthouse, remember to destroy the treasure maps after you're done to save precious bag space.
...
C The Defias Brotherhood (part 5)|N|Go to Moonbrook , looking for the Defias Messenger.  Kill him and loot the message.  He spawns in Moonbrook and then wanders on the road. (45.00, 69.00)|QID|142|M|45,69|
