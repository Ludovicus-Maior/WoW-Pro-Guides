...
R The Stockades|QID|1363|M|40,63|Z|Stormwind City|N|Next quest located inside a building just south of The Stockades entrance.|
...
K Chucky "Ten Thumbs"|ACTIVE|QID|609|QO|3|M|34.3,54.3;40.00,58.20|CS|T|Chucky "Ten Thumbs"|N|Kill Chucky Ten Thumbs and loot the ring.|
...
R The Harborage|QID|1389|M|26,31.4|Z|Swamp of Sorrows|N|Run east along the mountain.|
...
C Driftwood|QID|1398|M|94.7,44.8;84.3,83.8|Z|Swamp of Sorrows|NC|N|Run south along the coast picking up driftwood.|
...
F Stormwind City|ACTIVE|M|65.50,24.40|Z|Blasted Lands|N|Fly to Stormwind.|
...
T Akiris by the Bundle|QID|623|M|67.7,51.7|Z|Duskwallow Marsh|N|To Privateer Gray.|
t Alliance Trauma|QID|6625|M|67.8,49.0|Z|Duskwallow Marsh|N|Breadcrumb quest is optional. Turns in to Doctor Gustaf VanHowzen.|
A Triage|QID|6624|M|67.8,49.0|Z|Duskwallow Marsh|N|From Doctor Gustaf VanHowzen.|P|First Aid;129;0+225|
C Triage|QID|6624|M|67.8,49.0|Z|Duskwallow Marsh|N|Prioritize the Critically Injured, then Badly and lastly Injured.  Position yourself in the middle of the room when all patients are in range, hot key the bandages, If you dont have Friendly Nameplates on, CTRL-V. Save 15 before 6 die.|
T Triage|QID|6624|M|67.8,49.0|Z|Duskwallow Marsh|N|To Doctor Gustaf VanHowzen.|
...
A WANTED: Andre Firebeard|QID|2875|M|66.8,22.4|Z|Tanaris|From Wanted Poster.|
A Screecher Spirits|QID|3520|M|67.0,22.4|Z|Tanaris|N|From Yeh'kinya.|
A Southsea Shakedown|QID|8366|M|67.1,23.9|Z|Tanaris|From Security Chief Bilgewhizzle.|
...
F Thalanaar|QID|2969|M|51.00,29.30|Z|Tanaris|N|Fly to Thalanaar (Feralas).|
R Grimtotem Camp|QID|2969|M|65,47|Z|Feralas|N|Make your way to Grimtotem Camp avoiding Camp Mojache.|
R Kindal Moonweaver|QID|2969|M|65,47|Z|Feralas|CC|Make sure you know where she is and then go back to the Grimtotem Camp.|
...
b Feathermoon Stronghold|QID|4124|M|43.40,42.70|Z|Feralas|N|Take the boat to Feathermoon Stronghold. If the boat isn't in sight, just swim, it will be faster.|
h Feathermoon Stronghold|QID|4124|M|31.00,43.50|Z|Feralas|N|Set your hearthstone to Feathermoon Stronghold.|
A The Mark of Quality|QID|2821|M|30.6,42.7|Z|Feralas|N|From Pratt McGrubben.|
f Feathermoon Stronghold|QID|4124|M|30.25,43.25|Z|Feralas|N|Get the flight path.|
...
T The Ruins of Solarsal|N|QID|2866|M|26.30,52.30|Z|Feralas|N|To Solarsal Gazebo.|
...
N Hippogryph Egg|QID|2741|M|56.70,76.80|Z|Feralas|L|8564|N|Get a Hippogryph Egg from this location.|
...
R Woodpaw Hills|ACTIVE|4131|M|73,56N|Follow the road east, then run south to the Southeastern tip of the small lake.|
...
H Feathermoon Stronghold|QID|2821|N|Hearth to Feathermoon Stronghold.|Z|Feralas|
...
F Thalanaar|QID|ACTIVE|M|30.20,43.20|Z|Feralas|N|Fly to Thalanaar.|
T Thalanaar Delivery|QID|4281|M|89.6,46.6|Z|Feralas|N|To Falfindel Waywarder.|
F Gadgetzan|QID|2941|N|Fly to Gadgetzan.|M|89.50,45.85|Z|Feralas|
...
f Aerie Peak|QID|1450|M|11.10,46.15|Z|The Hinterlands|N|Get the flight path at Guthrum Thunderfist.|
...
h Wildhammer Keep|QID|1449|M|13.60,41.70|Z|The Hinterlands|N|Set your hearthstone to Aerie Peak.|
...
T Rhapsody Shindigger|QID|1451|26,48|Z|The Hinterlands|N|To Rhapsody Shindigger.|
A Rhapsody's Kalimdor Kocktail|QID|1452|26,48|Z|The Hinterlands|N|From Rhapsody Shindigger.|
N Wildkin Feathers|QID|3661|S!US|L|10819 15|N|These are ground spawn, NOT drops from the Owlbeasts. Pick up all you see.|
K Trolls|QID|2880|L|9259 5|S|N|Kill the trolls to collect the Necklaces.|
...
A The Altar of Zul|N|QID|2989|M|48.84,68.44|Z|The Hinterlands|N|From Gryphon Master Talonaxe.|
r Sell junk, repair, restock|N|Sell junk, repair, restock|

R Altar if Zul|QID|2989|M|49,64|N|Run to the Alter of Zul and ask in zone chat if anyone else is interested in doing [The Altar of Zul]. Ideally 2 other people, higher level (50).|
K Qiaga the Keeper|QID|2989|M|49.00,68.00|Z|The Hinterlands|T|Qiaga the Keeper|L|9241 1|N|Loot the Sacred Mallet from Qiaga the Keeper. This is optional, only needed to summon a mob in Zul'Farrak Dungeon. Skip this objective if you can't find anyone to help.|
...
B Make sure you have two Elixirs of Fortitude.|QID|3842|L|3825 2|N|Make sure you have two Elixirs of Fortitude in your inventory, bank or mailbox, you are about to need them.|
...
F Feathermoon Stronghold|QID|992|N|Fly to Gadgetzan|Z|Teldrassil|M|58.30,94.00|
...
K Rage Scar Yetis|QID|7735|M|52,32|Z|Feralas|L|18969|N|Kill Yetis at this location until you get a Pristine Yeti Hide (follow the road there).|
...
N Samha Essence|QID|2879|M|40.55,12.65|Z|Feralas|L|9257|NC|N|Loot the Samha Essence here (From the Flame of Samha).|
N Imbel Essence|QID|2879|M|39.90,9.45|Z|Feralas|L|9256|NC|N|Loot the Imbel Essence here.|
N Lahassa Essence|QID|2879|M|37.75,12.18|Z|Feralas|L|9255|NC|N|Loot the Lahassa Essence here.|
N Byltan Essence|QID|2879|M|38.50,15.80|Z|Feralas|L|9258|NC|N|Loot the Byltan Essence here.|
C The Stave of Equinex|QID|2879|M|38.85,13.30|Z|Feralas|U|9306|N|Right-click Troyas' Stave to charge it.|
...
T The Giant Guardian|QID|2844|M|38.20,10.20|QID|2844|Z|Feralas|To Shay Leafrunner.|
...
H Feathermoon Stronghold|QID|2942|N|Hearth to Feathermoon Stronghold.|
...
F Thallanaar|ACTIVE|3841|M|30.20,43.25|Z|Feralas|Fly to Thalanaar then on to Gadgetzan.|
...
N Sell junk, repair, restock|QID|3445|N|Sell junk, repair, restock|
...
N Sell junk, repair, restock|ACTIVE|3161|N|Sell junk, repair, restock.|
...
A Nekrum's Medallion (Dungeon)|QID|2991|M|66,18|Z|Blasted Lands|N|From Thadius Grimshade.|
...
T Nekrum's Medaillon|ACTIVE|2991|M|66,18|Z|Blasted Lands|N|To Thadius Grimshade
...
R Ride West|QID|2583|M|50,14|Z|Blasted Lands|N|Ride out of Nethergarde Keep, go west / northwest until you find the two Blood Elves.|
...
L Level Check|QID|N|You should be about 4 bubbles from level 50 now, take some time to grind here or in Jintha'Alor if you aren't.|LVL|49;112,960|
H Wildhammer Keep|QID|3843|N|Hearth to Aerie Peak.|
