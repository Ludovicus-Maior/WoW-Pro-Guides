...
b Tirisfal Glades|AVAILABLE|445|M|50.88,13.83|Z|1411; Durotar|N|Take the Zepplin to Tirisfal Glade.|IZ|1411; Durotar^1454; Orgrimmar|
...
; --- UC Entrance and FP ** TAXI won't work here without a connecting flight point and Undead will already have it - Hendo72
...
B Cooking recipes|ACTIVE|447|M|33.00,17.84|Z|1421; Silverpine Forest|N|From Killian Sanatha by the shore in North Tide's Run.\n[color=FF0000]NOTE: [/color]He can help if you need bag space.\n \nManually check this step off to skip.|S!US|IZ|The Skittering Dark^North Tide's Run|
C A Recipe For Death|QID|447|M|35.91,15.07|Z|1421; Silverpine Forest|L|3253 6;3254 6|ITEM|3253;3254|N|Grizzled Bear and spiders.\n[color=FF0000]NOTE: [/color]Don't go in the mine unless you have to.\nKeep an eye out for Krethis Shadowspinner (lv 15 rare) that spawns at the mine entrance.|T|Moss Stalker|US|
...
= Level 14 Demon Training|ACTIVE|438|M|PLAYER|CC|N|Pick up your Grimoires of Blood Pact and Fire Shield for 9s each.\nCome back later if you can't afford it.\n[color=FF0000]NOTE: [/color]Manually check this step off to continue.|LVL|14|C|Warlock|IZ|1458; Undercity|
...
A Michael Garrett|QID|6322|PRE|6323|M|61.51,41.81|Z|1458; Undercity|N|From Gordon Wendham.|R|Undead|
...
L Level 15|ACTIVE|478|Z|1421; Silverpine Forest|N|Grind until you're within 3 bubbles of level 15.\n[color=FF0000]NOTE: [/color]You'll be starting your class quest when you get back to The Sepulcher.|LVL|14;-2215|C|Mage|
L Level 15|ACTIVE|478|Z|1421; Silverpine Forest|N|Grind until you're within 3 bubbles of level 15.|LVL|14;-2215|C|-Mage|
R The Sepulcher|ACTIVE|478|M|46.21,41.59|Z|1421; Silverpine Forest|N|Run back to The Sepulcher.\n[color=FF0000]NOTE: [/color]Save your hearth for Deep Elem Mine.|
T Maps and Runes|QID|478|M|43.97,40.93|Z|1421; Silverpine Forest|N|To Shadow Priest Allister.| ;750 exp
A Dalar's Analysis|QID|481|PRE|478|M|43.97,40.93|Z|1421; Silverpine Forest|N|From Shadow Priest Allister.|
T Arugal's Folly|QID|423|M|44.20,39.78|Z|1421; Silverpine Forest|N|To Dalar Dawnweaver.| ;975 exp
A Arugal's Folly|QID|424|PRE|423|M|44.20,39.78|Z|1421; Silverpine Forest|N|From Dalar Dawnweaver.|
T Dalar's Analysis|QID|481|M|44.20,39.78|Z|1421; Silverpine Forest|N|To Dalar Dawnweaver.| ;100 exp
A Dalaran's Intentions|QID|482|PRE|481|M|44.20,39.78|Z|1421; Silverpine Forest|N|From Dalar Dawnweaver.|
T Dalaran's Intentions|QID|482|M|43.97,40.93|Z|1421; Silverpine Forest|N|To Shadow Priest Allister.| ;100 exp
A Ambermill Investigations|QID|479|PRE|482|M|43.97,40.93|Z|1421; Silverpine Forest|N|From Shadow Priest Allister.|
T Rot Hide Clues|QID|439|M|43.43,40.86|Z|1421; Silverpine Forest|N|To High Executor Hadrec inside the crypt.\n[color=FF0000]NOTE: [/color]Don't get the follow-up yet; it won't be done until you return in "Chapter 1".| ;290 exp
...
N Spellfire Robe|AVAILABLE|1959|Z|1421; Silverpine Forest|N|Unlike the Druid quest, the Mage class quest is done in this area. It's in your best interest to make the trip now to start this class quest chain.\n[color=FF0000]NOTE: [/color]Manually check this step off to continue.|R|Undead,Troll|C|Mage|
F Undercity|AVAILABLE|1959|M|45.62,42.60|Z|1421; Silverpine Forest|N|Fly to Undercity.|R|Undead,Troll|C|Mage|
R Tirisfal Glades|AVAILABLE|1959|M|61.86,64.98|Z|1420; Tirisfal Glades|N|Take the elevator up and leave Undercity through the front gates.|R|Undead,Troll|C|Mage|IZ|1458; Undercity|
...
C Arugal's Folly|QID|424|M|58.43,44.88|Z|1421; Silverpine Forest|L|3634|ITEM|3634|N|Grimson the Pale at the back of the mine.\n[color=FF0000]NOTE: [/color]The faster you do this, the less likely you are to get as many repops should you have to fight your way out.|
H The Sepulcher|ACTIVE|424|M|46.21,41.59|Z|1421; Silverpine Forest|N|Hearth back to The Sepulcher.\n[color=FF0000]NOTE: [/color]If your hearth is on cooldown, be prepared to fight your way out. If you die, you respawn outside.|
...
C Gathering Materials|QID|1961|QO|1;2|Z|1421; Silverpine Forest|N|Collect the Linen and Dalaran Gems you need.|S|
...
C Gathering Materials|QID|1961|QO|1;2|Z|1421; Silverpine Forest|N|Finish collecting the Linen and Dalaran Gems you need.|US|
...
F Undercity|ACTIVE|440|M|45.62,42.60|Z|1421; Silverpine Forest|N|At Karos Razok.|IZ|-1420; Tirisfal Glades|
...
R Brill|ACTIVE|440|M|61.49,53.75|Z|1420; Tirisfal Glades|N|Exit Undercity through the front gates and head north to Brill.|IZ|1458; Undercity^1420; Tirisfal Glades|
...
T Raleigh and the Undercity|QID|441|M|62.00,42.76|Z|1458; Undercity|N|To Raleigh Andrean standing beside the Cooking Supplier in the Trade Quarter of Undercity.\n[color=FF0000]NOTE: [/color]Do not take the follow-up.|
...
R Tirisfal Glades|ACTIVE|1358|M|61.88,64.87|Z|1420; Tirisfal Glades|TZ|Tirisfal Glades|N|Exit Undercity through the front gates.|IZ|1458; Undercity|
