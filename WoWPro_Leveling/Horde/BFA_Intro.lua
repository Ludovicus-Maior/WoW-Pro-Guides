...
R Speaker of the Horde|ACTIVE|46931|M|57.55,44.05|Z|Zuldazar|QO|1|N|Head to Zolani and once she starts moving, take the elevator down to the lower level.\n[color=FF0000]NOTE: [/color]You don't need to wait for Zolani to complete these steps.|
C Speaker of the Horde|QID|46931|M|49.92,39.49|Z|Dazar'alor|QO|2|N|Head outside and click the banner to summon your companions.|H|
R Speaker of the Horde|ACTIVE|46931|M|57.95,44.31|Z|Zuldazar|QO|3|N|Head back inside and walk towards Brillin the Beauty (The Great Seal Innkeeper).|
h The Great Seal|ACTIVE|46931|QO|6|N|Optionally, you can make The Great Seal your new home before moving on.\n[color=FF0000]NOTE: [/color]Manually check this step off to continue.|
R Speaker of the Horde|ACTIVE|46931|M|67.00,71.83|Z|The Great Seal!Dazar'alor|QO|4|N|Head down the stairs to theleft into the Hall of Ancient Paths.\n[color=FF0000]NOTE: [/color]These will be your portals to the Horde Cities once this quest is complete.|
R Speaker of the Horde|ACTIVE|46931|M|32.22,70.00|Z|The Great Seal!Dazar'alor|CS|QO|5|N|Head back up the stairs, across the corridor, then down the stairs to the Vault of the King.|
