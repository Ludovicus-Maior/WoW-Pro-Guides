...
T Neeka Bloodscar |QID|1418|N|He's at the top of the guard tower. |
...
A Badlands Reagent Run |QID|2258|N|Kill all coyotes and buzzards you run across until this quest is done. |M|2.4,46.1|
A Study of the Elements: Rock (Part 2) |QID|710|N|Ride east to Lotwil Beratius to get this quest. |M|25.9,44.6|
...
C Study of the Elements: Rock (Part 2) |QID|710|N|Also get 3 large stone slabs for [39] Badlands Reagent Run.  If the area is too crowded, hunt coyotes, buzzards and/or troggs until it repops.  |M|40.00,78.00|
...
C Barbecued Buzzard Wings |QID|703|N| |M|42.00,52.00|
...
T Study of the Elements: Rock (Part 2) |QID|710|N| |M|25.00,44.00|
A Study of the Elements: Rock (Part 3) |QID|711|M|25.9,44.6|
