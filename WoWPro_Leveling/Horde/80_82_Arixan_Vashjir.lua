...
f Smuggler's Scar|QID|25587|M|56.24,31.23|Z|Kelp'thar Forest|N|Swim toward Smuggler's Hole, a small cave just north of where you are. Grab the flight point|
...
C A Taste For Tail|QID|25389|M|48.77,36.36|Z|Kelp'thar Forest|N|In the area just east, kill Clacksnap Pincers for A Taste For Tail.|
...
l Crumpled Treasure Map|QID|25467|N|In the same area, kill Sabreclaw Skitterers until you get a Crumpled Treasure Map.|M|52,35|L|54345|
...
N Gnash's Head|QID|27687|M|51.25,39.94|Z|Kelp'thar Forest|N|Gnash is an elite that drops a quest item. If your able to kill him, kill him then loot his head. This is optional.|T|Gnash|L|62138|
A An Opened Can of Whoop Gnash|QID|27687|M|51.25,39.94|Z|Kelp'thar Forest|N|Accept the quest from the head. This is optional, if you don't want to do it, skip this quest.|U|62138|
...
C The Horde's Hoard|QID|25377|M|58.95,36.73|Z|Kelp'thar Forest|N|Kill Akasha who patrols around here and loot the Horde Chest Key.|T|Akasha|
...
A A Desperate Plea|QID|25638|M|56.48,29.99|Z|Kelp'thar Forest|N|From Broken Bottle.|
A Oh, the Insanity!|QID|25651|M|55.25,38.87|Z|Kelp'thar Forest|N|From Budd.|
l Oh, the Insanity!|QID|25651|L|55185 50|M|52.75,50.21|S|Z|Kelp'thar Forest|N|Kill Gilblin Hoarder's and collect cannon balls until you have 50 Pilfered Cannonballs.|
...
A Lady La-La's Medallion|QID|25419|M|50.62,48.43|Z|Kelp'thar Forest|N|Accept this quest from Lady La-La's Necklace.|U|55186|
...
A Shark Weak|QID|27699|M|58.34,48.76|Z|Kelp'thar Forest|N|(UI Alert)|
C Shark Weak|QID|27699|M|59.25,46.87|Z|Kelp'thar Forest|N|(UI Alert)|
...
A Wake of Destruction|QID|25887|M|63.92,59.76|Z|Kelp'thar Forest|N|From Erunak Stonespeaker.|
N Wake of Destruction|QID|25887|M|58.1,69.8|Z|Kelp'thar Forest|U|56576|N|Swim out of the grotto and head just a bit west, where you will find the Famished Great Sharks. Target one of the sharks while staying far enough away that it doesn't attack you and use the Orb of Suggestion.|
...
A How Disarming|QID|25883|RANK|1|M|60.3,70.1|Z|Kelp'thar Forest|N|From the Naga Tridents.|
...
C Rundown|QID|25221|U|54466|M|54,26|Z|Shimmering Expanse|N|When you come out of the tunnel, you will see naga swimming off to your left. Use Toshe's Hunting Spears to kill 20 naga.|
...
f Silver Tide Hollow|QID|25222|M|49.49,41.28|Z|Kelp'thar Forest|N|Swim toward Silver Tide Hollow, a small cave just south of where you are. Go inside, until you reach the surface of the water. Get the flightpoint at the Swift Seahorse.|
...
C A Distracting Scent|QID|25215|M|49.2,42;49,44|Z|Shimmering Expanse|N|Swim out of Silver Tide Hollow and mount up. Near the cave entracne, swim close to a naga corpse and right-click it to start dragging the body. Swim south to Glimmerdeep Gorge. You will drop the naga you are dragging, once you are over the gorge . Drag 3 bodies into the gorge to complete Distracting Scent.|
...
C Capture the Crab|QID|25989|L|56182|M|57,52.6|Z|Shimmering Expanse|N|Use the net to capture the Crab, then loot the Crab. Kill the naga when you have the crab.|
...
N Overseer Idra'kess|QID|25995|CC|M|60.17,52.86|Z|Shimmering Expanse|N|Follow the outside wall directly behind Legionnaire Nazgrim, keeping the wall on your right. Keep going, heading generally northwest, until you reach a tunnel leading up. Follow this tunnel until you get to the upper chamber. In the back of this chamber, directly opposite the tunnel, you will find Overseer Idra'kess.|
C Overseer Idra'kess|QID|25995|M|57.6,57.3|Z|Shimmering Expanse|N|Take down the two casters first then focus on Overseer Idra'kess. Once you get the message "Nespirah is waking up!" just pull him over the red slime things. They explode and should kill him. The casters may spawn again at one point to reshield him.|
T Overseer Idra'kess|QID|25995|Z|Shimmering Expanse|N|To Earthmender Duarn.|M|51.7,52.1|
...
T Deep Attraction|QID|25592|Z|Shimmering Expanse|N|To Legionnaire Nazgrim.|M|51.21,63|
...
N Lestharia Vashj statue|QID|25954|QO|Lestharia Vashj statue: 1/1|M|39.6,59|Z|Shimmering Expanse|N|Investigate the Lestharia Vashj statue.|
N Queen Azshara statue|QID|25954|QO|Queen Azshara statue: 1/1|M|38.7,59|Z|Shimmering Expanse|N|Investigate the Lestharia Vashj statue.|
N An Occupation of Time|QID|25954|QO|High Priestess Siralen statue: 1/1|M|38.5,66|Z|Shimmering Expanse|N|Investigate the High Priestess Siralen statue.|
C Ranger Valarian statue|QID|25954|QO|Ranger Valarian statue: 1/1|M|39.7,67.8|Z|Shimmering Expanse|N|Investigate the Lestharia Vashj statue.|
N Northern Quel'Dormir Gardens scouted|QID|25955|QO|Northern Quel'Dormir Gardens scouted: 1/1|Z|Shimmering Expanse|N|Scout the Northern Quel'Dormir Gardens.|
N Tunnel west of Quel'Dormir Gardens scouted|QID|25955|QO|Tunnel west of Quel'Dormir Gardens scouted: 1/1|Z|Shimmering Expanse|N|Scout the Tunnel west of the Quel'Dormir Gardens.|
...
l Ancient Elven Etching|QID|27717|L|62282|N|If you have not gotten this, keep killing Azsh'ir Patrollers and Infantry until it drops.|M|39.7,67.6|Z|Shimmering Expanse|
...
T Looking Forward|QID|25958|Z|Shimmering Expanse|N|To Captian Vilethorn.|M|39.73,53.86|

A Clear Goals|QID|25959|PRE|25958|RANK|1|Z|Shimmering Expanse|N|From Captian Vilethorn.|M|39.73,53.86|
...
C Properly Inspired|QID|25962|S|Z|Shimmering Expanse|N|Find 8 Bloated Kelp Bulbs.|M|32.3,74.4|
...
N Speak to Fiasco Sizzlegrin|QID|25963|QO|Speak to Fiasco Sizzlegrin: 1/1|Z|Shimmering Expanse|M|39.49,54.86|N|Go outside and speak to Fiasco Sizzlegrin.|
...
C Fallen But Not Forgotten|QID|25964|M|34.4,78.3|Z|Shimmering Expanse|N|While doing the next two steps, look for Injured Assault Volunteers. Speak to them to send them back to the rendezvous point.|
C Scout the Northwestern Terrace|QID|25965|QO|Scout the Northwestern Terrace: 1/1|M|32.1,72.4|Z|Shimmering Expanse|N|Scout the Northwestern Terrace.|
...
T Gauging Success|QID|25965|Z|Shimmering Expanse|N|To Captian Vilethorn.|M|49.2,56.9|
T Fallen But Not Forgotten|QID|25964|Z|Shimmering Expanse|N|To Legionnaire Nazgrim.|M|49.2,56.9|
...
N Speak to Fathom-Lord Zin'jatar|QID|25858|M|34.4,78.7|QO|Speak to Fathom-Lord Zin'jatar: 1/1|Z|Shimmering Expanse|N|Swim east through the tunnel. In the middle of the tunnel, you will find Fathom-Lord Zin'jatar. Speak to him to get his troops' assistance.|
N Speak to Overseer Idra'kess|QID|25858|M|36.86,79.75|QO|Speek to Overseer Idra'kess: 1/1|Z|Shimmering Expanse|N|Continue east to Overseer Idra'kess.|
C By Her Lady's Word|QID|25858|M|39.21,78|QO|Speak to Lady Sira'kess: 1/1|Z|Shimmering Expanse|N|You will find Lady Sira'kess just a bit more east, near the end of the terrace.|
...
A The Culmination of Our Efforts|QID|26191|RANK|1|M|46.2,79.5|Z|Shimmering Expanse|N|From Lady Naz'jar. Close this step as it does not auto-complete.|
...
A Desperate Plan|QID|25968|PRE|25892|RANK|1|Z|Shimmering Expanse|N|From Legionnaire Nazgrim.|M|51.14,63|
...
l Honor and Privilege|QID|25972|QO|Swim to the rescue balloon at the surface: 1/1|L|56188|M|50.35,79|Z|Shimmering Expanse|N|Swim straight up to the surface. You should see a rescue balloon and Bloodguard Toldrek. Loot the Rescue Flare from the crate next to Jorlan.|
...
T Welcome News|QID|25973|Z|Shimmering Expanse|N|To Legionnaire Nazgrim.|M|51.59,62.99|
...
N Visions of the Past: Rise From The Deep|QID|26135|U|55171|M|33.1,77.8|Z|Shimmering Expanse|N|In the center of the temple, you will find the Crucible. Swim up to a ledge just above the entrance to find the point where you can enter the vision.|
...
C Devout Assembly|S|QID|25896|QO|Sira'kess Tide Priestesses gathered: 6/6|M|34.5,78.6|Z|Shimmering Expanse|N|All around the temple you will find Sira'kess Tide Priestesses. Talk 6 of them to send them back to the temple.|
N Fathom-Caller Azrajar gathered|QID|25896|QO|Fathom-Caller Azrajar gathered: 1/1|M|33.1,61.2|Z|Shimmering Expanse|N|find Fathom-Caller Azrajar. Speak to him to send him back to the temple as well.|
C Devout Assembly|US|QID|25896|QO|Sira'kess Tide Priestesses gathered: 6/6|M|34.5,78.6|Z|Shimmering Expanse|N|All around the temple you will find Sira'kess Tide Priestesses. Talk 6 of them to send them back to the temple.|
...
N Final Judgement|QID|25951|QO|Hold the eastern end of Quel'Dormir Terrace: 1/1|M|42.9,78.4|Z|Shimmering Expanse|N|Swim out of the temple to the east, where you will find Lady Naz'jar.|
...
f |QID|26006|M|49.48,65.58|U|57412|N|Swim just outside the cave, and use the Boom Boots. Then get the flight point at Swift Seahorse.|Z|Shimmering Expanse|
...
A Secure Seabrush|QID|26124|Z|Abyssal Depths|N|Find and kill an Alliance Sea-scout, the quest will pop-up, accept it.|
C Secure Seabrush|QID|26124|Z|Abyssal Depths|N|Kill a total of 7 Alliance Sea-scouts.|
C Environmental Awareness|QID|26122|U|56821|Z|Abyssal Depths|US|N|Kill Seabrush Terrapins, Scourgut Remoras and Spinescale Hammerheads, then use the pump on their corpses. If your a looter, loot then use it.|
T Secure Seabrush|QID|26124|N|To Bloodguard Toldrek.|M|51.5,60.8|
...
A Orako|QID|26086|N|From Captain "Jewels" Verne.|Z|Abyssal Depths|M|51.47,60.82|
T Orako|QID|26086|N|To Orako.|Z|Abyssal Depths|M|42.91,51.02|
A "Glow-Juice"|QID|26087|N|From Orako.|Z|Abyssal Depths|M|42.91,51.02|
C "Glow-Juice"|QID|26087|N|Kill Pyreshell Crabs and Luxscale Groupers, which can be found anywhere in Coldlight Chasm, until you have 6 Coldlight Phosphora.|Z|Abyssal Depths|
...
C Die Fishman Die|QID|26089|S|N|Kill Coldlight Oracles and Huntersa.|Z|Abyssal Depths|M|44.62,60.43|
C Here Fishie Fishie|QID|26088|U|56813|Z|Abyssal Depths|N| Use the Fish Hat to put a small glowing orb on your head. Swim all through the coral reefs in the Chasm until you collect 30 Coldlight Nibblers.|M|44.62,60.43|
C Die Fishman Die|QID|26089|US|N|Kill Coldlight Oracles and Huntersa.|Z|Abyssal Depths|M|44.62,60.43|
...
T Orako's Report|QID|26092|Z|Abyssal Depths|N|To Captain “Jewels” Verne.|M|51.4,61.5|
...
C Sira'kess Slaying|QID|25974|S|M|51.1,17.3|Z|Abyssal Depths|N|Kill Naga.|
...
C A Standard Day for Azrajar|QID|25980|M|53.3,22.3|Z|Abyssal Depths|U|56255|N|Use the Horde Standard on Azrajar's corpse.|
C Treasure Reclamation|QID|25976|M|40.4,17|L|56235 6|Z|Abyssal Depths|N|Kill Deepfin Scroungers or loot chests on the stone columns.|
...
T Those Aren't Masks|QID|25982|N|To Fiasco Sizzlegrin.|Z|Abyssal Depths|M|51.5,60.8|
...
T Promontory Point|QID|25984|N|To Legionnaire Nazgrim.|Z|Abyssal Depths|M|42.73,37.82|
...
K Ur'Goz|QID|26130|M|36.4,46.8|Z|Abyssal Depths|QO|Ur'Goz slain: 1/1|N|Kill Ur'Goz.|
K Sku'Bu|QID|26130|M|34.4,54.2|Z|Abyssal Depths|QO|Sku'Bu slain: 1/1|N|Kill Sku'Bu.|
...
K Twilight Devotee|S|QID|26154|M|34.4,50.3|Z|Abyssal Depths|QO|Twilight Devotee slain: 50/50|N|Kill Twilight Devotees.|
C Twilight Extermination|QID|26154|M|34.6,50.3|Z|Abyssal Depths|QO|Faceless Overseer slain: 10/10|N|Kill Faceless Overseers.|
K Twilight Devotee|US|QID|26154|M|34.4,50.3|Z|Abyssal Depths|QO|Twilight Devotee slain: 50/50|N|Kill Twilight Devotees.|
...
T Back to Tenebrous Cavern|QID|26182|M|51.55,60.9|Z|Abyssal Depths|N|To Erunak Stonespeaker.|
