...
N Treasure|QID|39864|N|All treasures necessary for the zone treasure hunting achievement are listed if you do the guide on rank 1. If you are using handy notes treasures, there treasure symbol will show over the tomtom green dot, obscuring it, the arrow will still work fine.|
N Rares (Silver Elite)|QID|39864|N|All of the Silver mobs are also included. The item displayed has a high chance to drop but not guarenteed.  Blizzard has marked these mobs on the minimap with a star.|
N Ranks|QID|39864|N|Setting the guide to Rank 1 will get you all of the essential questlines for the zone questing achievement. Rank 2, adds the quests you may as well do while you are there. Rank 3 gets every quest & treasure and rare in the zone.|
...
C Making the Rounds|QID|39698|M|61.48,9.07|Z|Durotar|QO|3|NC|N|Click on Dread-Captain Tattersail (no actual dialog).|
...
C The Windrunner|QID|39801|SO|1;1|M|55.36,64.92|Z|AraukNashalIntroScenario|NC|N|Report to Sylvanas.|
C The Windrunner|QID|39801|SO|2;1|M|53.83,64.92|Z|AraukNashalIntroScenario|NC|N|Ride with Nathanos then hop on the Catapult and shoot down the skyfire gryphons.|
C The Blightcaller|QID|39801|SO|3;1|M|42.05,54.13|Z|AraukNashalIntroScenario|N|If the Ice blast didnt knock you to the next ship, ride with Natanos and then slay all paratroopers on The Blightcaller.|
C The Black Rose|QID|39801|SO|4;1|M|47.01,50.10|Z|AraukNashalIntroScenario|N|Ride with Natanos and then slay all worgen on The Black Rose.|
C Boarding the Skyfire|QID|39801|SO|5;1|M|72.63,71.44|Z|AraukNashalIntroScenario|N|Place volatile flares (at the glowing bottles) on this level and then go up the stairs and do the rest.|
C Queen Takes King||QID|39801|SO|6;1|M|69.53,79.62|Z|AraukNashalIntroScenario|N|Go to the top level and fight more soldiers until Genn shows, then defeat Genn Greymane.|

T The Splintered Fleet|QID|39801|M|36.07,27.56|N|To Dread-Rider Cullen.|
A The Ranger Lord|QID|38332|M|36.07,27.56|N|From Dread-Rider Cullen.|
...
C Wrath of the Blightcaller|QID|38361|M|39.47,19.51|S|N|Kill alliance forces.|
$ Captain Tomas of the Blightcaller|QID|38498|M|35.53,18.67|QO|1|ITEM|129040|N|Talk to Captain Tomas to start the vignette. You will need to check this off manually.|;havent yet found correct QID
...
K Kill Bloodstalker Alpha|QID|38626|M|38.42,42.80|QO|1|ITEM|129101|T|Bloodstalker Alpha|N|He roams this part of the valley. Silver - Kill and loot for a bit of treasure and resources.|
...
A Assault the Drekirjar-Bonus Objective|QID|38374|M|45.86,67.84|N|Auto-accepted when you enter the area.|
C Assault the Drekirjar-Bonus Objective|QID|38374|M|45.86,67.84|S|N|Go about your quests to advance this objective.|
...
A Assault on Skold-Ashil-Bonus Objective|QID|38939|M|56.76,66.30|N|Autoa-accepted when you enter the area.|
C Assault on Skold-Ashil-Bonus Objective|QID|38939|M|56.76,66.30|S|N|Kill vrykal and destroy the weapon racks. There are also some shieldmaiden statues, you can click on the for a 10 minute buff Three differant buffs, so click all you see.|
...
$ Treasure Chest|QID|40089|M|61.83,62.89|
...
C Assault on Skold-Ashil|QID|38939|M|61.93,61.46|US|N|Finish this up or click it off manually.|
t Assault on Skold-Ashil|QID|38939|M|61.93,61.46|N|Auto turned in when completed.|
...
H Return to Dalaran|QID|40072|M|70.52,69.24|U|140192|N|If you are doing this guide on rank 1, you are done now, hearth ot Dalaran or your class hall and continue on your adventuring.|LEAD|39792|
