...
N Megs in Marketing|N|Megs Dreadshredder|M|58.23,76.44|
A Rolling with my Homies|QID|14071|N|From Megs Dreadshredder. Put the keys to the Hot Rod on an easily accessible button.  You'll be using it to get around from now on.  Get in your car now by using the keys.  |M|58.23,76.44|

C Rolling with my Homies|QID|14071|N|Pick up Izzy, next to the pool.|QO|Izzy picked up: 1/1|M|58.3,85.7|
...
R Kajaro Field|N|Drive through the gate on the north side of the courtyard outside KTC Headquarters.  Instead of taking the roads, you can immediately turn left, and drive over the cliffs down to the field.|M|48.8,57.6|
...
A Life of the Party|N|From Candy Cane|
C Life of the Party|N|Entertain 15 guests at the pool.|  
T Life of the Party|N|Candy Cane|
A Pirate Party Crashers|N|Candy Cane|
C Pirate Party Crashers|N|Time to kill some pirate party crashers, outside around the pool.|
T Pirate Party Crashers|N|Sassy Hardwrench|
A The Uninvited Guest|N|Sassy Hardwrench|
T The Uninvited Guest|N|Upstairs, turn in to Trade Prince Gallywix.|
A A Bazillion Macaroons?!|N|Trade Prince Gallywix|

T A Bazillion Macaroons?!|N|Turn in to Sassy, now outside.|M|59.56,77.05|
A The Great Bank Heist|N|From Sassy Hardwrench|M|59.56,77.05|
A Waltz Right In|N|From Slinky Sharpshiv|M|59,76.6|
A Robbing Hoods|N|From Megs Dreadshredder, now by the entrance to the pool courtyard.|M|60,78.29|
A Liberate the Kaja'Mite|N|From Foreman Dampwick|M|62.95,77.78|

C Liberate the Kaja'Mite|N|Use your kablooey bombs to blow up the chunks of ore.  Pick up the ore from the ground once you've blown up a deposit. The bombs can be used to stun the hostile tolls in the area.|

R First Bank of Kezan|N|Run over the Hired Looters with your car to get their stolen loot, on your way to The Bank of Kezan.|M|29.89,67.89|
C Personal Riches|N|Click on one of the little pigs inside and complete a mini game to loot your Personal Riches.  Just watch and you will be told what tool to use at each moment.  Use it and when you have cracked the safe, loot the riches.|M|29.89,67.89|
C Robbing Hoods|N|Time to finish running over looters.  They can be somewhat difficult to find - the best place seems to be on the north side of town, amidst the shops.  Drive in a circuit around town until you have retrieved 12 Stolen Loot.|

R Gallywix's Villa|M|19.55,35.92|N|Once you arrive, be sure to avoid the Keensnout Potbelly pigs who can smell through your disguise.|
C Waltz Right In|QID|.....|QO|The Ultimate Bomb: 1/1|M|19.99,30.74|
C Waltz Right In|QID|.....|QO|The Goblin Lisa: 1/1|M|12.9,35.17|
C Waltz Right In|QID|.....|QO|Maldy's Faction: 1/1|

T Waltz Right In|QID|.....|N|Slinky Sharpshiv|M|59,76.6|
T Robbing Hoods|QID|.....|N|Megs Dreadshredder|M|60,78.29|
T Liberate the Kaja'Mite|QID|.....|N|Foreman Dampwick|M|62.95,77.78|
T The Great Bank Heist|QID|.....|N|Sassy Hardwrench|M|59.56,77.78|
