...
-- Date: 2016-10-04 23:24
-- Who: tubera
-- Log: Rewrite to allow start at lower level (60) and to not assume Hellfire is done already.

-- URL: http://wow-pro.com/node/3274/revisions/26918/view
...
F Funggor Cavern|QID|10096|M|74.71, 91.54|N|Fly/Ride to Funggor Cavern.
...
f Zabra'jin|QID|9775|M|84.76,55.1|N|Get the flight point at Du'ga.|
H Cenarion Refuge|QID|9775|U|9732|N|Hearth to the Cenarion Refuge.|
...
A News from Rakoria.|QID|9796|M|85.3,54.8|N|From Shadow Hunter Denjai. This leads into Terokkar Forest, accept if you want to go there next.|
