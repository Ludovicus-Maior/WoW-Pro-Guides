...
A Return of the Highborne?|QID|14127|RANK|2|M|29.95,74.40|N|From the Scout's Orders you looted.|
C Venison for the Troops|QID|14118|US|M|27.98,68.76|N|Collect 15 Slabs of Venison from Weakened Mosshoof Stags.|
...
C Stone Cold|QID|14165|S|NC|M|29.25,66.59|N|Kill Greystone Basilisks while you search for a stonified Mountainfoot Miner at the Mountainfoot Strip Mine.|
C Stone Cold|QID|14165|NC|US|M|29.25,66.59|
C Basilisk Bashin'|QID|14161|M|25.50,68.50|N|Kill 10 Greystone Basilisks.|
...
C Mortar the Point|QID|14258|M|43.11,77.18|
...
C Bad Science! Bad!|QID|14322|M|45.01,77.76|
...
C Raptor Raptor Rocket|QID|14422|M|42.21,76.09|
...
C To Gut a Fish|QID|14262|M|55.49,76.45|
...
C Azsharite Experiment Number One|QID|14385|PRE|14377|M|43.49,83.00;40.07,84.43|N|The Laxative is upstairs in Bingham's house.|
...
A A Hello to Arms|QID|24458|M|50.53,74.77;51.48,74.32|N|From Hobart Grapplehammer.|N|Speak with Friz Groundspin for a free airlift.|
A Operation Fishgut|QID|14478|M|56.99,50.13|
...
A There Are Many Like It|QID|14479|PRE|24455|M|58.07,52.32|N|From Captain Desoto.|N|Hop on the rocket when you're ready to leave.|
...
T Probing into Ashenvale|QID|24463|M|94.39,46.80|Z|AshenvaleN|Run back through all the hostile mobs and across the bridge to Kulg Gorespatter.|
A To The Ramparts!|QID|13866|PRE|24463|M|94.39,46.80|Z|AshenvaleN|From Kulg Gorespatter.|
