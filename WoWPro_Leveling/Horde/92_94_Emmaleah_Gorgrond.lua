...
N Treasure|QID|35557|N|The guide mentions some but not nearly all the treasure to be found in the zone. At some point while questing you will recieve a treasure map that when you use it shows all the potential treasure on your map. Depending on which building you build at your outpost, you will either have a shredder that can cut thru the tangled vines you run across or Beatface will come remove big rocks to uncover treasure previously hidden. You can loot the treasure someone else's shredder or Beatface uncovers.|
...
N Sparring Arena|QID|35880|ACTIVE|35880|N|What follows next is a running from flight path to flight path and getting a couple of followers.  If that doesnt interest you check these steps off.  There are bonus objectives in these areas but no quests.|
;if lumber yard
...
f Evermorn Springs|QID|35468|M|41.32,87.16|N|At Chucklespine.|
R The Destroyed Expidition|QID|36037|M|44.86,86.72|N|This is to pick up a follower, if followers don't interest you following the road east to Bastian Rise is more direct.|RANK|2|
A A Centurian Without a Cause|QID|36037|M|44.86,86.72|RANK|2|N|Assist Centurian Tormark with the waves of mobs, when they are defeated he will offer to be your folloer. Its safer to run back to Evermorn Rise (where you just got the flight path) and run on to Bastion Rise from there, but you can go from here, just more mobs in the way.|
R Deeproot|QID|34279|RANK|2|M|42.74,90.76|CC|N|Take the trail up here to find another follower.|
...
A I am Blook|QID|34279|RANK|2|CHAT|M|41.27,91.44|N|If he despawns before you accecpt the quest you will have to fight him again when he respawns.|
R Bastion Rise|QID|36488|M|46.49,93.57|
...
R Mistcreep Mire|QID|35667|M|54.45,66.65|PRE|35510|N|You can choose to hearth or fly back to Beastwatch for a shorter trip to Dionar's Demise.(and then run the remainder of the way.) \nThere is really no nice straight path over there, so check your map and go towards the waypoints.|
...
R Mistcreep Mire|QID|33694|M|49.36,49.70|PRE|35139|N|If you chose to return to your outpost to sell, you can take the flightpath back to Breaker's Crown and run from there.|

R Mistcreep Mire|QID|35667|M|54.45,66.65|
