...
A Finding Yi-Mo|QID|30080|M|79.74,1.50|N|From Mei Barrelbottom.|
C Speak with Yun|QID|30079|M|79.35,3.43|QO|3|N|up the stairs, inside.|CHAT|
C Speak with Despondent Warden of Zhu|QID|30079|M|79.93,2.25|QO|1|N|Any one of them will suffice. They're all around Zhu Watch.|CHAT|
C Speak with Sunni|QID|30079|M|81.50,2.51|QO|2|N|up the stairs, inside.|CHAT|
...
C Kill cranes|QID|30352|M|63.94,29.44|S|
C Kill tigers|QID|30353|S|M|71.15,24.65|N|The tigers drop 0-3 blood, they also run around stealthed.|
K Darnassian Outrider|QID|30124|M|61.56,30.64|QO|1|N|She paths up and down this path.|T|Darnassian Outrider|; Darnassian Outrider slain: 1/1
...
A Herbal Remedies|QID|30130|M|59.90,24.48|N|From Sunwalker Dezco.|PRE|30124|
A The Mogu Agenda|QID|30129|M|60.12,24.96|N|From Kang Bramblestaff.|PRE|30123&30124|
K Chasheen|QID|31260|M|61.66,31.78|L|85774|T|Chasheen|
C Herbal Remedies|QID|30130|M|54.59,39.74|N|Keep an eye out for the flowers as you work you way up the terraces.|S|
C Threat from Dojan|QID|30127|M|54.68,38.86|N|Kill these guys as you go up the terraces to where the boss is.|S|
K Dojani Dominator|QID|30129|M|55.51,35.48|L|78917|N|Kill him and loot the Dojani Orders.|T|Dojani Dominator|
T The Mogu Agenda|QID|30129|M|55.51,35.48|N|To Kang Bramblestaff.|
A The Pools of Youth|QID|30128|M|55.51,35.48|N|From Kang Bramblestaff.|PRE|30129|
C Threat from Dojan|QID|30127|M|54.68,38.86|N|Finish these guys before you go to the pools so you don't have to return this way.|US|
...
C The Pools of Youth|QID|30128|M|51.63,33.08|N|When facing the platform where you killed the Dominator, go to your left, over a bridge and down some stairs to a pool area. Free Na Lek, kill the guardians and loot 'the water of youth' (groundspawn).|CHAT|
...
C Life|QID|30131|M|60.37,25.23|N|Watch a cutscene of Leza and Dezco.|CHAT|
...
A Unsafe Passage|QID|30269|M|44.16,43.00|N|From Koro Mistwalker.|PRE|30133^30178|
...
C Tread Lightly|QID|30694|M|45.77,28.17|N|Target the traps and use your stick from a short distance away to set them off safely.|U|80828|NC|S|
C Blinding the Riverblades|QID|30270|M|46.14,30.06|
C Tread Lightly|QID|30694|M|45.77,28.17|U|80828|NC|US|
...
A Sha Can Awe|QID|30271|M|40.67,33.88|N|From Anduin Wrynn.|PRE|30268&30270&30694|
...
C Striking the Rain|QID|30272|M|40,45|N|Kill them near the Hopeless Monks to get credit for Sha Can Awe also.|S| ;something I can't figure out, the sticky shading is staying for the next several steps, reset didn't change anything, reloadUI made the shading "stay where it belonged", but the vertical spacing remained off until I logged off upon arriving at Marista.
C Sha Can Awe|QID|30271|M|40,45|N|Kill Haunts and Incarnations of Despair near the Hopeless Monks to inspire them.|S|
...
C Striking the Rain|QID|30272|M|40,45|N|Kill them near the Hopeless Monks to get credit for Sha Can Awe also.|US|
C Sha Can Awe|QID|30271|M|40,45|N|Kill Haunts and Incarnations of Despair near the Hopeless Monks to inspire them.|US|
...
K Riverbank Flesh-Hunter|QID|30168|M|29.55,45.17|Z|Valley of the Four Winds|L|78958 5|N|If you still have the raft, take a shortcut across the water, unfortunately, you lose the buff when you technically cross into Valley of the Four Winds.|S|
K Raid Leader Slovan|QID|30169|QO|1|M|31.87,29.01|Z|Valley of the Four Winds|T|Slovan| ; Slovan slain: 1/1
K Riverbank Flesh-Hunter|QID|30168|M|29.55,45.17|Z|Valley of the Four Winds|L|78958 5|US|
...
R Dawnchaser Retreat|QID|30169|M|28.92,50.38|FLY|OLD|
f Dawnchaser Retreat|QID|30169|M|28.92,50.38|N|At Munch Windhoof.|TAXI|-Dawnchaser Retreat|
...
K Kill Groundbreaker Brojai|QID|30174|M|23.35,48.80|QO|1|N|Talk to Kor to start a scripted vignette where Kor must act like a typical orc and Dezco makes peace.|T|Groundbreaker Brojai| ; Groundbreaker Brojai slain: 1/1
T For Family|QID|30174|M|28.92,50.75|N|To Sunwalker Dezco.|
A Warn Stoneplow|QID|30241|M|28.92,50.75|N|From Sunwalker Dezco.|PRE|29990&30117&30273&30174|
...
A The Mantidote|QID|30623|M|17.97,56.34|Z|Valley of the Four Winds|N|From Mei Barrelbottom.|PRE|30241^30360^30376|
...
A The Gratitude of Stoneplow|QID|30628|M|17.91,56.25|Z|Valley of the Four Winds|N|From Loon Mei.|PRE|30627|
