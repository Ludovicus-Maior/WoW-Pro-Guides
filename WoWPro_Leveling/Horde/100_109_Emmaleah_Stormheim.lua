...
-- URL: http://wow-pro.com/node/3680/revisions/29078/view
...
-- URL: http://wow-pro.com/node/3680/revisions/28571/view
...
-- URL: http://wow-pro.com/node/3680/revisions/28098/view
...
-- URL: http://wow-pro.com/node/3680/revisions/27830/view
-- Date: 2016-09-22 06:23
-- Who: Emmaleah
-- Log: Add Rank tags, where missing to final steps of Sixtrigger quest.

-- URL: http://wow-pro.com/node/3680/revisions/27801/view
-- Date: 2016-09-16 22:12
-- Who: Emmaleah
-- Log: change registration levels to 100-109

-- URL: http://wow-pro.com/node/3680/revisions/27800/view
-- Date: 2016-09-16 21:16
-- Who: Emmaleah
-- Log: finished play thru on rank 1 and 3. Corrected path for Time to Collect. other tweaks.

-- URL: http://wow-pro.com/node/3680/revisions/27758/view
-- Date: 2016-09-14 02:19
-- Who: Emmaleah
-- Log: Play thru on live Rank 3 - but only thru felskorn warcamp (80%ish). Moved all rank 1 treasures/silvers/bonuse objectives to rank 2. Added LVL|-109 to bonus objectives. Added the final sixtrigger quest and moved the treasure that went with it, various other changes, including those suggested by other users.

-- URL: http://wow-pro.com/node/3680/revisions/27728/view
...
$ Small Treasure Chest|QID|38490|M|33.62,27.28;32.73,27.90|CS|N|Loot for a bit of treasure and resources.|
...
$ Captain Tomas of the Blightcaller|QID|38422|M|35.53,18.67|QO|1|ITEM|129040|N|Talk to Captain Tomas to start the vignette.|
C The Windrunner's Fate|QID|38360|M|39.47,19.51|QO|1|NC|N|Investigate the dagger in the door of the Windrunner.|
$ Small Treasure Chest|QID|38498|M|39.58,19.35|N|Loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|43195|M|50.00,18.10|N|Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|38487|M|35.03,36.60|N|Loot for a bit of treasure and resources.|
C Masters of Disguise|QID|38317|M|34.22,37.43|QO|2|N|Kill Spymaster Shwayder.|T|Spymaster Shwayder|
$ Small Treasure Chest|QID|38495|M|33.13,36.06|N|Loot for a bit of treasure and resources.|
T Masters of Disguise|QID|38317|M|36.46,36.54|N|To Forsaken Bat-Rider.|
$ Small Treasure Chest|QID|43208|M|36.00,39.22;37.21,38.66|CS|N|Loot for a bit of treasure and resources.|
...
K Kill Whitewater Typhoon|QID|38472|M|36.67,51.79|QO|1|RARE|ITEM|138418|N|Silver - Kill and loot for some treasure and resources.|
$ Treasure Chest|QID|38677|M|35.73,54.15|N|On the lowest level of the crashed alliance ship, be careful you don't fall over the waterfall. Loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|38680|M|35.92,47.92|N|Loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|38676|M|32.62,51.76;31.09,56.00|CS|N|On the other half of the alliance ship. Loot for a bit of treasure and resources.|
$ Treasure Chest|QID|38529|M|80.89,48.83;20.03,41.23|Z|1017/9|CS|N|Inside the drake cave that the alliance ship has crashed into. Loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|43196|M|32.93,48.10;32.06,47.20|CS|N|You don't have to wake the sleeping drakes. Loot for a bit of treasure and resources.|
R Stony Highlands|QID|38626|M|34.36,43.06|N|Back from our treasure hunting sidetrip.|RANK|3|

K Kill Bloodstalker Alpha|QID|38626|M|38.42,42.80|QO|1|RARE|ITEM|129101|T|Bloodstalker Alpha|N|He roams this part of the valley. Silver - Kill and loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|43246|M|48.48,41.28;48.89,40.92;49.52,40.96;50.14,40.77|CS|N|Standing at the first coordinate, look up and northeast.  Follow the grapple hook path towards the 2nd coordinate to find the chest. Loot for a bit of treasure and resources.|
...
K Kill Glimar Ironfist|QID|38333|M|41.5,66.7|QO|1|RARE|ITEM|129291|T|Glimar Ironfist|N|Silver - Kill and loot for a bit of treasure and resources.|
...
K Kill Thane Irglov the Merciless|QID|38424|M|40.66,72.40|T|Thane Irglov the Merciless|RARE|ITEM|129113|N|Silver - Kill the others in the Mead Hall, then you can take on Thane. Kill and loot for some treasure and resources.|
...
$ Small Treasure Chest|QID|38476|M|48.09,75.79;49.89,73.72;48.93,72.75;48.13,74.22|CS|N|Beside the waterfall, loot for a bit of treasure and resources.|
K Kill Stormwing Matriarch|QID|38423|M|49.6,71.6|T|Stormwing Matriarch|QO|1|RARE|ITEM|129110|N|Silver - Kill and loot for a bit of treasure and resources. Also drops a pet.|
U Stormwing Whelpling|QID|38423|M|49.6,71.6|U|129208|N|Click to add pet to your collection.|RARE|
...
K Kill Bladesquall|QID|38431|M|45.88,77.37|QO|1|RARE|ITEM|129048|T|Bladesquall|N|Grapple across the defunct bridge for this silver - Kill and loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|38481|M|46.55,79.35;46.77,80.40|CS|N|First point is a hook point, Hook to the chest, loot for treasure and resources.|
C Wings of Liberty|QID|38413|M|49.07,81.07|QO|1|NC|N|Free Aleifir.|
K Kill Fathnyr|QID|38425|M|46.67,83.68|QO|1|RARE|ITEM|129206|T|Fathnyr|N|Silver - In a small cave roughly above Hridmogir, easiert reached from hook points starting at the cave Aleifir was in. Loot for a bit of resources and treasure.|
...
K Kill Tiptog the Lost|QID|38774|M|46.29,50.01|T|Tiptog the Lost|QO|1|RARE|ITEM|129163|N|Silver - Kill and loot for a bit of treasure and resources.|
$ Glimmering Treasure Chest|QID|38763|M|49.70,49.20;49.69,47.28|CS|N|Dodge the energy beams, open the chest, be ready to fight.  Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|43207|M|49.07,60.00|N|Loot for a bit of treasure and resources.|
K Kill Houndmaster Ely|QID|38712|M|47.10,57.20|QO|1|RARE|ITEM|129037|T|Houndmaster Ely|N|Silver - Kill and loot for a bit of loot and Treasure.|
...
$ Small Treasure Chest|QID|43238|M|43.14,39.01;43.17,40.49|CS|N|Hook out to find chest, loot for treasure and resources.|
$ Small Treasure Chest|QID|43240|M|44.06,37.88;44.99,38.24|CS|N|Use grapple points to get to this treasure. Loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|43255|M|45.68,32.90;46.29,33.12;46.49,34.09;47.45,34.10|CS|N|Use grapple points to get to this treasure. Loot for a bit of treasure and resources.|
$ Glimmering Treasure Chest|QID|43189|M|42.12,35.72;42.46,34.08|CS|ITEM|141896|N|Long run up the steps At the top you get achievement and a chest to loot for treasure and resources.|
K Kill Egyl the Enduring|QID|40068|M|41.77,34.11|QO|1|RARE|ITEM|132898|N|Silver - There is a cave under the statue. Go inside to find Egyl. Kill and loot for a bit of treasure and resources.|
...
K Kill Starbuck|QID|42437|M|54.70,29.21|QO|1|RARE|ITEM|130132|T|Starbuck|N|Silver - Kill and loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|38477|M|42.33,61.12|N|If you are careful, you can get without waking the Basilisk. Otherwise kill the basilisk curled around the treasure and then its yours. Kite him around to escape his AOE and interrupt his glare. Loot for treasure and resources.|
...
$ Small Treasure Chest|QID|38681|M|48.18,65.20;46.60,64.96|CS|N|Inside the cave.  Loot for a bit of treasure and resources.|
...
h Set Hearth to Valdisdall|QID|39804|M|60.54,50.26|N|At Riala the Hearthwatcher. If you are doing this on Rank 2 or 3.  It will save you a lot of time.|RANK|2|ACTIVE|39792|
...
K Kill Urgev the Flayer|QID|38847|M|64.88,51.82|QO|1|RARE|ITEM|129219|T|Urgev the Flayer|N|Silver - Kill and loot for a bit of treasure and resources.|
...
K Kill Mordvigbjorn|QID|38837|M|72.60,49.99|QO|1|RARE|ITEM|129035|T|Mordvigbjorn|N|Silver - Kill and loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|43306|M|73.25,42.68;74.41,41.84|CS|N|Get this before you complete the next quest or you will have to run a long ways back to get it.  Use Hook to get up to alcove above. Loot for a bit of treasure and resources.|
...
K Kill Fenri|QID|38461|M|84.94,50.05|Z|Helheim|QO|1|RARE|ITEM|129291|T|Fenri|N|Silver - Loot for a bit of treasure and resorces.|
...
K Kill Soulthirster|QID|39870|M|28.27,64.80|Z|Helheim|QO|1|RARE|ITEM|129188|T|Soulthirster|N|Silver - Kill for a pet and the usual resources.|
...
K Kill Daniel "Boomer" Vorick|QID|39048|M|58.42,75.65|RARE|ITEM|129144|QO|1|T|Daniel "Boomer" Vorick|N|Silver - Kill and loot for a bit of treasure and resources and FOR THE HORDE!|
C A Stack of Racks|QID|39792|M|56.77,78.87|US|N|Finish collectomg Meaty Rack of Musken Ribs.|RANK|2|
K Kill Hannval the Butcher|QID|42591|M|51.69,74.50|QO|1|T|Hannval the Butcher|N|Silver - Kill for treasure and resources.|RARE|
...
K Kill Isel the Hammer|QID|39120|M|62.02,60.48|QO|1|RARE|ITEM|129133|T|Isel the Hammer|N|Silver - Kill and loot for a bit of resources and treasure.|
$ Treasure Chest|QID|40088|M|59.25,58.59|N|Loot for a bit of treasure and resources.|
...
K Kill Ivory Sentinel|QID|39031|M|59.86,68.07|QO|1|RARE|ITEM|132895|T|Ivory Sentinel|N|Silver - Kill and loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|40091|M|61.82,70.38;62.12,71.26;62.15,72.48;62.59,73.64|CS|N|Grapple up this path to the top of the tower. Loot for a bit of treasure and resources.|
K Kill Inquisitor Ernstenbok|QID|37908|M|63.66,74.33|QO|1|RARE|ITEM|140685|T|Inquisitor Ernstenbok|N|Silver - Kill and loot for a bit of treasure and resources. In cave under the tower.|
...
$ Small Treasure Chest|QID|40094|M|60.85,42.73|N|Use grapple to get on roof beam with chest.  Loot for resources and treasure.|
K Kill Tarben|QID|40081|M|60.90,43.91;61.53,43.25|CS|QO|1|RARE|ITEM|129199|T|Tarben|N|Silver - From the roofbeam, Grapple to the loading dock above and then Kill Tarben for a bit of treasure and resources.|
$ Small Treasure Chest|QID|40093|M|61.41,44.41|N|Loot for treasure and resources.|
$ Small Treasure Chest|QID|40082|M|58.04,47.51|N|Run up to the top of the tower to find a chest. Loot for a bit of treasure and resources.|
...
K Kill Captain Brvet|QID|38642|M|57.97,45.28|QO|1|RARE|ITEM|129123|N|Silver - Blow the "Horn of the Helmouth", to summon 3 raiders. Kill and loot for a bit of treasure and resources.|
K Kill Captain Sten|QID|40044|M|55.83,46.82|QO|1|T|Captain Sten|RANK|2|
$ Treasure Chest|QID|40095|M|54.98,47.14|N|Underwater on the deck of sunken ship. Loot for a bit of treasure and resources.|
...
K Kill Roteye|QID|43342|QO|1|M|57.73,34.77;58.37,33.96|CS|RARE|ITEM|139387|T|Roteye|N|Silver-Kill and loot for a bit of treasure and resources.|
$ Treasure Chest|QID|38744|M|61.91,32.25|N|Loot for a bit of treasure and resources.|
...
K Kill Kottr Vondyr|QID|40109|M|73.46,47.68|QO|1|RARE|ITEM|138419|T|Kottr Vondyr|N|Silver - Kill and loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|43194|M|73.10,45.72|N|Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|42632|M|75.37,52.11|N|Hook from the ship to piller.  Chest on top of piller. Loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|42629|M|75.17,49.49|N|Hook to the next ship and then up to the crows nest to find a chest. Loot for treasure and resources.|
...
$ Small Treasure Chest|QID|42632|M|73.9,52.2|N|Loot for a bit of treasure and resources.|
...
A Rout the Bilgefin Invaders-Bonus Objective|QID|40111|M|80.44,53.11|N|Auto-accepted as you enter the area.|RANK|2|LVL|-109|
...
K Kill Grrvrgull the Conquerer|QID|40113|M|78.65,61.17|QO|1|RARE|ITEM|138421|T|Grrvrgull the Conquerer|N|Silver - Kill and loot for a bit of treasure and resources.|
$ Treasure Chest|QID|40099|M|80.58,67.04;81.86,67.49|CS|N|Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|43191|M|82.40,54.51|N|Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|43307|M|76.05,65.05;76.91,66.17;77.25,67.18;77.31,68.16;77.12,69.29;78.57,70.33;78.43,71.38|CS|N|Very time comsuming to get to. About 5 hook points and a couple of jump downs.  Loot for a bit of treasure and resources. (or decide you dont want to.)|
$ Small Treasure Chest|QID|43304|M|75.49,60.10;75.62,60.63|CS|N|Look up from first coord. Use Hook Point. Loot for treasure and resources.|
$ Small Treasure Chest|QID|43237|M|73.98,58.59|N|Loot for treasure and resources.|
