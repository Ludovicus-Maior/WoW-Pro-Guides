...
K Malas the Corrupter |QID|12554|N|Try it solo if you want, just stay out of the AoE. If you can't, just keep questing and do it when you find a group. Turn it in when you're done. Go up the ramp to the right of the entrance, Malas is at the top of the tower.|L|38521|M|60.80,80.32|
...
C Breaking Through Jin'Alai |QID|12627|N|Just South, Click on the Purple cauldron.|M|57.62,61.72|QO|Purple Cauldron disturbed|
C Breaking Through Jin'Alai |QID|12627|N|Click on the Red cauldron.|M|58.78,62.71|QO|Red Cauldron disturbed|
C Breaking Through Jin'Alai |QID|12627|N|Click on the Blue cauldron.|M|57.20,65.34|QO|Blue Cauldron disturbed|
...
T The Blessing of Zim'Rhuk |QID|12655|N|Zim'Rhuk is the big statue at the waypoint. There are some elite golems around, but you should be able to get around them.|M|59.46,44.46|
...
T Wooly Justice |QID|12707|N|To Scalper Ahunae.|M|59.51,57.99|
...
l Unblemished Heart of the Guardian |QID|12729|N|Get the buff from Zim'Torga. Kill the Guardians around Zim'Rhuk  for the Heart. They are 76-77 Elites, so get help if you have problems burning them down.|L|39540|M|59.46,44.46|
...
A Unfinished Business |QID|13097|M|60.13,57.72|N|From Har'koa.|
...
C Malas the Corrupter |QID|12554|N|Last chance in the guide.|M|60.80,80.32|
C Wanted: Ragemane's Flipper |QID|12857|N|Last chance in the guide.|M|38.2,85.6|
