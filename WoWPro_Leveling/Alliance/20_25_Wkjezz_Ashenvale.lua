...
C Destroy the Legion|QID|26444|S|QO|Demons slain: 15/15|M|82.51,78.23|N|Don't forget to loot these Demons (especially if you are doing Loremaster) They drop a quest item.|
...
K Path to Uthil Mooncall|QID|26472||M|77.28,75.15;76.88,74.86;78.34,75.32;77.95,74.06;77.23,74.00;77.99,73.15|QO|Uthil Mooncall slain: 1/1|
...
C Culling the Furbolg Threat|QID|13867|M|35.55,33.17|N|Make sure you loot the Furbolgs you kill as they drop a quest item.|
l Troll Charm|QID|13867|M|33.78,39.46|N|Kill Furbolgs until this drops.|L|46128|
A Corrupting Influence?|QID|13868|U|46128|M|33.78,39.46|U|46128|
...
C A Trip to the Moonwell|QID|13919|NC|M|53.64,46.03|U|46389|
...
C They Took Our Gnomes|QID|13913|M|43.29,63.52|N|Look for the (badly driven) caravan, and kill the driver.|

R Behind the big... thing|QID|13981|CC|M|46.27,61.03|N|You should be behind the big machine. Once at this location ascend the tracks.|
...
H Astranaar|QID|26482|

T True Power of the Rod|QID|26482|M|36.63,49.65|N|To Raene Wolfrunner.|

F Stardust Spire|QID|26838|N|Fly to Stardust Spire. Congratulations on the Zone Achievement by the way.|
...
N The End|QID|99999|N|This is the end of Ashenvale. The next guide is Stonetalon Mountains, which this guide leades directly into. Close this step, and it should load right up. I've been WKjezz, thanks for using our Addon!|
