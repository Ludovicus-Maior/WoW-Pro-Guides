WoWPro.Leveling:RegisterGuide('WkjAsh2025', 'Ashenvale', 'WKJezz', '20', '25', 'WkjSto2530', 'Alliance', function()
...
R Ashenvale|QID|99999|NC|N|This is one zone south of Darkshore.  The nearest flight path will be "Grove of the Ancients" |
...
C Bathran's Hair|QID|26473|S|M|21.65,14.69|

C Don't Forget the Horde|QID|13594|S|M|21.65,17.27|

C Don't Forget the Horde|QID|13594|US|M|31.99,23.55|

R Run here...|QID|13595|CC|M|22.23,16.20|N|Run here and loot the Oil from the table|

C Of Their Own Design|QID|13595|M|32.81,21.38|

C Bathran's Hair|QID|26473|US|M|31.36,22.80|N|Flat red bushes.|
...
C The Ancient Statuettes|QID|26465|S|M|11.69,24.27|

C Naga of the Strand|QID|13602|M|13.58,14.69|

C The Ancient Statuettes|QID|26465|US|M|12.92,26.45|
...
A Ruuzel|QID|26466|M|18.24,20.50|N|From Talen.|

N Blackfathom Deeps|QID|99999|N|There is a quest in this Hub for the Instance Blackfathom Deep, if you wish to run this dungeon, feel free to pick it up (Click to continue)|

C Ruuzel|QID|26466|M|6.62,13.19|

T Ruuzel|QID|26466|M|18.25,20.56|N|To Talen.|
...
C A Squad of Your Own|QID|13624|M|26.34,38.15|N|Execise caution here, the music can make it very easy to get carried away.|
...
C Respect for the Fallen|QID|13626|U|45044|M|26.95,40.82|N|Equip and use the cloak. The Hammer is in the circle of Rocks as you move south (26.30,38.43), loot the dead corpse. At the top of the tower, kill the warlock, loot the dead corpse.|
...
C Rear Guard Duty|QID|13632|S|

R Run here|QID|99999|CC|M|27.49,33.21|N|And click the green moonstone.|

R Run here|QID|99999|CC|M|28.93,31.65|N|And click the red moonstone.|

C The Reason Why|QID|13630|M|30.34,31.36|
...
C The Lost Gem|QID|26464|S|QO|Glowing Gem: 0/1|M|21.94,40.27|N|Kill and loot tenticles as you progress thru these steps.|

C That Which Has Risen|QID|13644|M|20.65,41.90|

C Bathed in Light|QID|13642|M|18.86,41.68|
...
C The Lost Gem|QID|26464|US|M|19.53,43.82|
...
A Elune's Tear|QID|26475|M|37.32,51.81|N|From Pelturas Whitemoon.|
...
f Astranaar|QID|99999|NC|

A A Helping Hand|QID|26453|M|35.00,49.96|N|Here is where things may seem odd in our zone flow.  This will reap the most XP doing the zone this way. Mob levels are lowest on the East and West of the zone, so we need to do those first for Maximum XP gain. Talk to Vindicator Palanaar to ride the Elekk East to Forest Song.|

f Forest Song|QID|99999|N|Get the flight point here.|
...
C The Branch of Cenarius|QID|26468|M|78.47,42.89|

C A Shameful Waste|QID|26454|S|M|80.69,52.34|

C The Lost Chalice|QID|26455|M|81.20,49.19|

C A Shameful Waste|QID|26454|US|M|81.60,51.00|
...
C Satyr Slaying!|QID|26469|S|M|80.17,48.70|

C Stopping the Rituals|QID|13683|M|80.12,49.82|N|Clicky clicky on the Purple Gems.|

C Satyr Slaying!|QID|26469|US|M|81.65,48.18|
...
C Agents of Destruction|QID|26457|S|M|88.73,57.88|

C Recover the Remains|QID|13869|S|M|88.14,61.47|

R Run here|QID|99999|NC|CC|M|89.81,58.05|N|Oveerseer Gorthak is in this building|

C Agents of Destruction|QID|26457|US|M|90.90,58.98|

C Recover the Remains|QID|13869|US|M|87.74,58.96|
...
C Explosives Shredding|QID|13698|M|84.09,62.57|N|Have a hunt for a Shredder with Green Name text. Get in this Vehicle and blow up som Kegs :D Boom!.  When you have killed the kegs follow the arrow back to the camp.|

T Explosives Shredding|QID|13698|M|83.93,62.68|N|To Sentinel Luciel Starwhisper.|

C Destroy the Legion|QID|26444|S|QO|Demons slain: 0/15|M|82.51,78.23|N|Don't forget to loot these Demons (especially  if you are doing Loremaster) They drop a quest item.|

C Reclaiming Felfire Hill|QID|26446|M|82.12,66.78|

C Destroy the Legion|QID|26444|US|M|83.84,70.40|

A Diabolical Plans|QID|26443|U|23780|M|83.98,70.68|N|Make sure you have looted this item and click it to open up a quest.|
...
C Closure is Only Natural|QID|13766|S|U|45545|M|82.53,80.62|N|Use the twigg on the green portals as you encounter them.|

R Path to Gorgannon|QID|99999|NC|CS|M|84.25,71.81;84.09,77.06;87.24,79.33;89.39,77.08|N|Follow the waypoints.|

K Gorgannon|QID|99999|N|Be aware of the mobs close to him, he calls for help. Once you kill him loot his Blade (click the check box to continue)|

R Path to the Seeker.|QID|99999|CS|M|84.16,77.19;82.64,77.86;81.21,79.87;78.44,81.59|N|Follow the waypoints.|

C Closure is Only Natural|QID|13766|US|U|45545|M|81.21,79.87|

C Never Again!|QID|26445|M|78.28,83.79|
...
C Insane Druids|QID|26472|S|M|75.07,74.22|N|Make sure you kill ATLEAST 7 Severed Druids, and loot 7 Untainted Spirits as you go.|

R Taneel Darkwood|QID|99999|M|77.14,74.21|N|Get to the bottom of the Barrow Den, Straight across the first bridge is Taneel Darkwood.|

R Path to Uthil Mooncall|QID|99999|CS|M|77.28,75.15;76.88,74.86;78.34,75.32;77.95,74.06;77.23,74.00;77.99,73.15|

R Path to the heart|QID|99999|CS|M|77.87,73.54;77.04,74.20;75.86,73.56;75.99,74.05|

C The Forest Heart|QID|13796|M|83.76,63.11|N|Right click on your 7 Untainted Spirits, then loot the forrest heart.|

R Path to the last Druid|QID|99999|CS|M|75.25,73.26;74.82,73.55;74.81,74.27|

C Insane Druids|QID|26472|M|74.82,74.27|
...
H Astranaar|QID|99999|NC|

r Repair/Restock/Sell Junk|QID|99999|M|34.45,49.56|N|To Aeolynn|

C Culling the Furbolg Threat|QID|13867|M|35.55,33.17|N|Make sure you loot the Shamans you kill as they drop a quest item.|

A Corrupting Influence?|QID|13868|U|46128|M|33.78,39.46|
...
C A Not-So-Charmed Life|QID|13874|M|41.77,32.92|N|Little browny yellow boxes in the cave.|

C Too Far Gone|QID|13876|M|41.67,35.67|
...
R Run here.|QID|99999|CS|M|43.05,45.83;46.82,46.76|

C Elune's Tear|QID|26475|M|46.82,46.73|
...
C Hot Lava|QID|13880|S|U|46352|M|50.12,51.85|N|Kill Laver Ragers as you go, you should have an elemental helping you out.|

C Put Out The Fire|QID|13884|M|49.78,47.06|

C Hot Lava|QID|13880|US|U|46352|M|49.78,47.06|
...
C Vortex|QID|13886|M|48.85,40.13|N|Press buttons 1 and 2 every time they are up, when you are made to be on fire, hit 3.|
...
C A Trip to the Moonwell|QID|13919|NC|M|53.64,46.03|

T A Trip to the Moonwell|QID|13919|M|53.62,46.03|

A He Who Would Be Forgiven|QID|13921|M|53.62,46.03|
...
C Defend the Tree!|QID|13935|M|61.09,49.94|N|Speak to the quest giver and tell her you are ready.  The Demolishers and Mounted units are elite, so if you pull them use Rake (button 2) otherwise spam Swipe (1). Should you need to regen health, run into the tree house, and sit on the moonwell.|

T Defend the Tree!|QID|13935|M|59.00,58.76|N|To Sentinel Melyria Frostshadow.|

A Report from the Northern Front|QID|26456|M|59.00,58.76|N|From Sentinel Melyria Frostshadow.|

R Waypoint Series|QID|99999|NC|CS|M|62.40,54.79;63.30,43.87;65.73,44.27;66.42,52.57|

C In the Hands of the Perverse|QID|13922|M|66.46,55.86|N|From the Satyr Demons|
...
H Astranaar|QID|99999|N|If your hearthstone is on cool down, or you fancy the excercise,  it's a fairly short run back.|
...
R Run to this location|QID|99999|CC|M|55.80,33.88|N|Kill treants as you go, until one drops a wooden key.|

R Go through this cave|QID|99999|CC|M|54.34,36.40|

C Search the Bole|QID|26477|M|55.02,40.66|

R Optional Step : Read Carefully|QID|99999|M|51.50,80.54|Z|Felwood|N|If you wish to do felwood later follow you arrow to the flight point. It is dangerous, but worth it. Collect the flight path once there. If you dont want to, or have the Flight Path already, skip this step by clicking the check mark.|
...
H Astranaar|QID|99999|N|If your hearthstone is on cooldown, run back|
...
r Repair/Sell|QID|99999|M|34.71,71.31|N|From the Boyer in the tower.|

C Retaking Mystral Lake|QID|26470|M|48.23,70.63|

C Retaking Mystral Lake|QID|26470|M|52.78,71.67|

R Waypoint Trail|QID|99999|CS|M|53.07,71.67;54.00,73.93,51.58,74.94|

U Use this rod...|QID|99999|U|46739|N|Do not Kill Krolg (Click the check box on this step once you have transformed)|

T Dartol's Rod|QID|26480|M|50.89,75.07|N|To Krolg.|

A King of the Foulweald|QID|13989|M|50.89,75.07|N|From Krolg.|

T Report from the Northern Front|QID|26456|M|61.88,83.85|N|To Sentinel Farsong. This step is optional, and has no follow ups.  It has little xp but DOES count toward Loremaster. Feel free to skip this step and abandon the quest if you wish to.|
...
C A New Adornment|QID|26481|M|54.70,79.62|

T A New Adornment|QID|26481|M|50.90,75.08|N|To Krolg.|

A True Power of the Rod|QID|26482|M|50.90,75.08|N|From Krolg.|

R Run here|QID|99999|U|46781|N|Run to near the Furblog Cage, kill the guard by that cage, then use the rod.|

C True Power of the Rod|QID|26482|NC|U|46781|M|50.01,59.73|N|Talk to Ota Wen and then enjoy the carnage.|

C Ze Gnomecorder|QID|25607|S|QO|Filthy Goblin Technology: 0/8|M|47.15,65.01|N|From Goblin Technicians|

C They Took Our Gnomes|QID|13913|NC|M|43.29,63.52|N|Look for the (badly driven) caravan, and kill the driver.|

R Behind the big... thing|QID|99999|CC|M|46.27,61.03|N|You should be behind the big machine. Once at this location ascend the tracks.|

C The Goblin Braintrust|QID|13979|M|46.18,61.58|

A They Set Them Up The Bomb!|QID|13981|M|46.27,61.29|N|This is on the roof of the construct you are currently on top of.|

C Ze Gnomecorder|QID|25607|US|M|46.46,61.31|

H Astranaar|QID|99999|

T True Power of the Rod|QID|26482|M|36.63,49.65|N|To Raene Wolfrunner.|

F Stardust Spire|QID|99999|N|Fly to Stardust Spire. Congratulations on the Zone Achievement by the way.|
...
N The End|QID|99999|N|This is the end of Ashenvale. The next guide is Stonetallon Mountains, which this guide leades directly into. Close this step, and it should load right up. I've been WKjezz, thanks for using our Addon!|
