...
R The Violet Citadel|QID|39735|M|29.10,46.93|Z|Dalaran!Dalaran!Dungeon|N|At Sky Admiral Rogers.|
...
R Stormwind City|QID|38035|M|26.54,45.23|Z|Dalaran!Dalaran!Dungeon|QO|2|N|Click on the portal to get to the Skyfire.|
...
$ Treasure Chest|QID|38677|M|35.71,54.06|N|On the lowest level of the crashed alliance ship, be careful you don't fall over the waterfall. Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|38676|M|31.09,56.00|N|On the other half of the alliance ship, bottom floor. Loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|38529|M|80.89,48.83;20.03,41.23|Z|1017/9|CS|N|Go to the top floor of the Alliance ship and go waay inside the drake cave. Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|43196|M|32.93,48.10;32.06,47.20|CS|N|On top of the Weeping Bluffs is another Drake cave. You don't have to wake the sleeping drakes. Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|38680|M|35.92,47.92|N|On a lake on the Weeping Bluffs, loot for a bit of treasure and resources.|
K Kill Bloodstalker Alpha|QID|38626|M|38.42,42.80|RARE|ITEM|129101|T|Bloodstalker Alpha|N|He roams this part of the valley. Silver - Kill and loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|38486|M|39.47,65.17|N|While you are running to the wall, get the chest under tent. Loot for a bit of treasure and resorces.|
...
$ Treasure Chest|QID|38489|M|44.16,69.98|N|While you are grappling around, get this chest on a rooftop. Loot for a bit of treasure and resources.|
...
K Kill Egyl the Enduring|QID|40068|M|41.77,34.11|QO|1|RARE|ITEM|132898|N|There is a cave under the statue. Go inside to find Egyl. Kill and loot for a bit of treasure and resources.|
K Kill Horde Kill Squad|QID|38630|M|44.50,22.80|RARE|ITEM|129266|T|Apothecary Perez|N|Kill All 4 mobs, if you get there during the 'event', still kill whats there you'll still complete it.|
...
$ Small Treasure Chest|QID|38490|M|33.62,27.28;32.73,27.90|CS|N|Loot for a bit of treasure and resources. Horde Area.|
$ Small Treasure Chest|QID|38487|M|37.00,27.38;39.82,29.75;36.68,32.52;36.31,34.43;35.03,36.60|CS|N|Loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|38495|M|33.44,34.11;34.66,35.96;34.79,37.54;33.13,36.06|CS|N|Loot for a bit of treasure and resources.|
...
K Kill Starbuck|QID|42437|M|54.70,29.21|QO|1|RARE|ITEM|130132|T|Starbuck|N|Kill and loot for a bit of treasure and resources.|
...
F Lorna's Watch|QID|39787|M|51.98,34.81|N|Fly back to Lorna's Watch at Hillevi the Scalekeepter.|RANK|2|SPELL|Flying in Legion;233368|
K Hook & Sinker|QID|38625|M|42.05,57.84|QO|1|RARE|ITEM|129109|T|Hook|N|Silver - Kill and loot for a bit of loot and Treasure.|
...
$ Small Treasure Chest|QID|38681|M|47.25,61.72;47.63,63.29;48.19,64.19;48.18,65.20;46.60,64.96|CS|N|Across the waterfall, inside the cave.  Loot for a bit of treasure and resources.|
...
K The Nameless King|QID|38685|M|67.26,39.93|QO|1|T|The Nameless King|N|Click on his offering shrine to start the vignette.  Kill him and earn treasure and resources.|RARE|
...
K Dread-Rider Cortis|QID|43343|M|74.22,61.44|RARE|ITEM|130134|T|Dread-Rider Cortis|N|Silver - Flies around, above this area.|
...
K Inquistor Ernstenbok|QID|37908|M|63.69,74.31|QO|1|RARE|ITEM|140685|T|Inquisitor Ernstenbok|N|Silver - Kill and loot for a bit of treasure and resources.|
...
F Greywatch|QID|39792|ACTIVE|39792|M|52.53,80.11|N|Fly to Greywatch then run back to Skold-Ashil, OR Click off this step and just run back down.|RANK|3|SPELL|Flying in Legion;233368|
...
K Kill Tarben|QID|40081|M|60.90,43.91;61.53,43.25|CS|QO|1|RARE|ITEM|129199|T|Tarben|N|Silver - Kill Tarben for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|42632|M|73.95,52.22|N|Hook from the ship to pillar.  Chest on top of pillar. Loot for a bit of treasure and resources.|
