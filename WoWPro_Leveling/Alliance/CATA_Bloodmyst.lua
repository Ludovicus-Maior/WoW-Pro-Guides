...
WoWPro:GuideNickname(guide, "Bloodmyst")
WoWPro:GuideName(guide,"Bloodmyst")
WoWPro:GuideNextGuide(guide, 'Cataclysm: Guide Hub')
WoWPro:GuideSteps(guide, function()
return [[
N It's Chromie Time!|AVAILABLE|62567|M|62.25,29.93|Z|84;Stormwind City|JUMP|Chromie Time|LVL|-60|S!US|N|You can now accept Chromie's Call at the Hero's Call board in Stormwind. This will allow you to choose which expansion you want to level in and scale the content to your level.\n\nYou're free to continue your current guide by skipping this and continuing on, but it won't continue to scale. If you want to enable Chromie Time, click the guide button next to this frame to direct you to Chromie in Stormwind!|CT|
R Bloodmyst Isle |ACTIVE|9663|M|65.25,94.00|Z|Bloodmyst Isle|N|There are two quests to lead you to Bloodmyst Isle. 'Elekks Are Serious Business' from Torallius the Pack Handler outside The Exodar if you have done the Coming of Age quest in Azuremyst Isle, or Hero's Call: Bloodmyst Isle! from the Hero's Callboard in The Exodar. Take either of these two quests, then head north to Bloodmyst Isle.|
...
C The Kessel Run|QID|9663|QO|1|CHAT|N|Warn High Chief Stillpine outside Stillpine Hold. Note that you can't resummon the mount it if you get dismounted, so stay out of caves, water and buildings.|Z|Azuremyst Isle|M|46.7,20.8|
C The Kessel Run|QID|9663|QO|2|CHAT|N|Warn Exarch Menelaous in Azure Watch. Note that you can't resummon the mount it if you get dismounted, so stay out of caves, water and buildings.|Z|Azuremyst Isle|M|47.2,50.6|
C The Kessel Run|QID|9663|QO|3|CHAT|N|Warn Admiral Odyseus at Odesyus' Landing. Note that you can't resummon the mount it if you get dismounted, so stay out of caves, water and buildings.|Z|Azuremyst Isle|M|47.0,70.2|
...
r Repair/Restock |ACTIVE|9693|M|53.32,56.67|N|Repair/Sell Junk at Beega.|
...
f Blood Watch |ACTIVE|9634|M|57.69,53.92|N|Get the flight path for Blood Watch.|
...
h Blood Watch |ACTIVE|9624|M|55.84,59.80|N|Set hearthstone to Blood Watch with Caregiver Topher Loaal.|
C Maatparm Mushroom Menagerie|QID|9648|QO|2|NC|N|Obtain a Blood Mushroom, they are small and glow red.|M|59,60|
C Maatparm Mushroom Menagerie|QID|9648|QO|1|NC|N|Obtain an Aquatic Sinkhorn from Stinkhorn Striker in the Blood River.|M|63.75,62.90|
C Maatparm Mushroom Menagerie|QID|9648|QO|3|NC|N|Obtain a Ruinous Polyspore, they are black/grey and tan.|M|67,66|
C Declaration of Power|QID|9666|QO|1|M|68.8,67.3|N|Kill Lord Xiz.|
C Declaration of Power|QID|9666|QO|2|U|24084|M|68.8,67.3|N|Plant the banner at the corpse of Lord Xiz.|
C A Favorite Treat|QID|9624|NC|N|Pick up Sand Pears.|S|
...
C A Favorite Treat|QID|9624|M|59.4,88.39|NC|N|Finish picking up the Sand Pears at the base of the trees.|US|
...
C Maatparm Mushroom Menagerie|QO|4|QID|9648|M|44,78;35,79|NC|N|Obtain a Fel Cone Fungus. They're kind of grey brown in comparison to the rest of the mushrooms they're with.|CN|
H Blood Watch |ACTIVE|9576|N|Hearth or run back to Blood Watch.|M|55.84,59.80|
...
H Blood Watch|ACTIVE|9567|N|Hearth or run back to Blood Watch|M|55.84,59.80|
...
r Repair/Restock |ACTIVE|9584|M|53.32,56.67|N|Repair/Sell Junk at Beega.|
...
F The Exodar |ACTIVE|9698|N|Fly to The Exodar.|M|57.7,53.9|
...
N Training and banking|ACTIVE|9699|N|Train your professions, visit bank etc. while you're here. Close to continue.|R|Draenei|
F Blood Watch |ACTIVE|9699|M|54.43,36.39|N|If your hearth is up, use it to get back to Blood Watch. Otherwise, fly back to Bloodmyst Isle.|Z|The Exodar|
...
r Repair/Restock |ACTIVE|10063|M|53.32,56.67|N|Repair/Sell Junk at Beega.|
...
C Pilfered Equipment|QID|9548|S|NC|N|Watch for Clopper's Equipment.|M|38.4,22.4;40.4,20;44,22.4;46.4,20.4|CN|
...
C Pilfered Equipment|QID|9548|US|NC|N|Look for Clopper's Equipment.|M|38.4,22.4;40.4,20;44,22.4;46.4,20.4|CN|
...
H Blood Watch |ACTIVE|9643|M|55.84,59.80|N|Hearth or run back to Blood Watch.|
...
r Repair/Restock |ACTIVE|9578|M|53.32,56.67|N|Repair/Sell Junk at Beega.|
C Culling the Flutterers|QID|9647|N|Kill every Royal Blue Flutterer you see.|S|
C The Cryo-Core|QID|9703|NC|N|Loot Medical Supplies from the ground and from Blood Elves.|S|
...
A Galaen's Journal - The Fate of Vindicator Saruan|QID|9706|PRE|9779|M|37.51,61.27|N|From the book on the ground next to Galaen's Coprse.|
C Galaen's Fate|QID|9579|N|The amulet drops off of the Blood Elves outside the Cryo Core.|M|39.27,60.42|
C The Cryo-Core|QID|9703|NC|N|Loot Medical Supplies from the ground and from Blood Elves.|US|M|39.27,60.42|
...
r Repair/Restock|ACTIVE|10064|M|53.32,56.67|N|Repair/Sell Junk at Beega.|
C Containing the Threat|QID|9569|QO|2;3|N|Head back to Axxarien. Kill Hellcallers and Shadowstalkers, on the way to kill Zevrax.|M|41.6,29.8|S|
C Corrupted Crystals|QID|9569|QO|4|NC|N|Head back to Axxarien. Collect 5 Corrupted Crystals.|M|41.6,29.8|S|
K Zevrax|ACTIVE|9569|QO|1|N|Head back to Axxarien. Kill Zevrax.|M|41.6,29.8|S|
C The Final Sample|QID|9585|U|23877|N|Use the pick on the Axxarien crystal (it's the big one - you need to stand right next to it)|M|41.36,30.72|
C Containing the Threat|QID|9569|N|Finish collecting Corrupted Crystals while killing Hellcallers and Shadowstalkers, on the way to kill Zevrax.|M|41.6,29.8|US|
C Don't Drink the Water|QID|9748|N|Jump down the waterfall, and use your flask.|U|24318|M|34.37,33.56|
H Blood Watch |ACTIVE|9569|M|55.84,59.80|N|Hearth or run back to Blood Watch.|
...
C What We Don't Know...|QID|9756|M|54.4,54.3|CHAT|N|Talk to the prisoner.|
...
C Fouled Water Spirits|QID|10067|N|Kill 6 Fouled Water Spirits.|M|30,39|S|
...
C Fouled Water Spirits|QID|10067|N|Kill 6 Fouled Water Spirits.|M|30,39|US|
...
H Blood Watch |ACTIVE|9711|M|55.84,59.80|N|Hearth or run back to Blood Watch.|
...
;N Go train your skills |QID|9671|N|Train skills, then restock on food/water, etc.|;Dont need to train skills anymore.
...
N The Captain's Kiss Buff|ACTIVE|9682|N|The swim speed and water breathing buff is really useful for another quest. Go back to Captain Edward Hanes, but don't turn in the quest. Ask him to renew the buff on you.|M|79,22|
C Ysera's Tears|QID|9649|NC|N|Loot the green glowing mushrooms from the ground.|S|M|74.55,13.69|
C Restoring Sanctity|QID|9687|NC|N|Loot the bones. They are around where the small Wildkin camps are.|M|60.05,35.47;58.09,29.47|CN|
...
C Ysera's Tears|QID|9649|NC|N|Loot the green glowing mushrooms from the ground.|US|M|74.55,13.69|
...
H Blood Watch|ACTIVE|9649|M|55.84,59.80|N|Hearth or run back to Blood Watch.|
T Ysera's Tears|QID|9649|N|To Maatparm.|M|56.4,56.8|
r Repair/Restock |ACTIVE|9740|M|53.32,56.67|N|Repair/Sell Junk at Beega.|
N Non-Draenei races|ACTIVE|9740|N|Non-Draenei have only one more available quest on bloodmyst. Decide if you are interested, if not, just follow the next guide.|R|-Draenei|
F The Exodar|ACTIVE|9740|N|Fly to The Exodar to train your riding skill. Skip this step if you already have it.|R|Draenei|M|57.68,53.89|
N Get your Mount|ACTIVE|9740|N|Up the ramp and to the left is the riding trainer. You'll need 4 gold for training and 1 gold for the mount. Skip if you already have it. Click to close and continue.|R|Draenei|
F Blood Watch|ACTIVE|9740|N|Fly back to Blood Watch. Skip if you're already there.|Z|The Exodar|M|54.46,36.4|R|Draenei|
...
H Blood Watch|ACTIVE|9740|M|55.84,59.80|N|Hearth or run back to Blood Watch.|
...
F The Exodar|ACTIVE|9632|N|Fly to The Exodar.|M|57.68,53.89|
