...
N To start...|QID|1|N|This guide starts in Darnassus. The general idea is a player is 40 and just came back to catch up on training. Please close this step when you are ready to continue. This guide assumes you are progressing from Feralas to Thousand Needles (if you didn't don't worry the guide is still Valid once you reach the "Hero's Call" turn in.|
A Hero's Call: Thousand Needles!|QID|28503|M|45.15,50.21|Z|Darnassus|
F Shadebough|QID|28503|M|77.31,56.74|Z|Ferelas|N|Fly to Shadebough in Ferelas. (You may need to manually click this step when you land.)|
T Hero's Call: Thousand Needles!|QID|28503|M|86.07,45.32|Z|Feralas|N|To Caryssia Moonhunter. Travel close to the south of the zone on the way to turning this in.|
A The Grimtotem are Coming|QID|25486|M|86.07,45.32|Z|Feralas|N|From Caryssia Moonhunter.|
C The Grimtotem are Coming|QID|25486|M|86.07,45.32|Z|Feralas|N|Progessing East, Kill Grimtotems.|
...
U Bar Fight!|QID|25517|U|54746|N|Taget a goblin and use the grog you just bought from Daisy.|
C Bar Fight!|QID|25517|M|76.62,74.68|Z|Fizzle & Pozzik's Speedbarge|
...
U Quiet the Cannons|QID|25585|U|55121|M|91.45,74.91|N|Jump into the water and use your riverboat item. (Click to continue)|
R Rollin' on the river...|QID|9999999|M|89.34, 72.85|N|Sail North East (To the pirate boats) until you come to a slope. Once you land, kill every Sailor (15 total) you see as we progress to our next objective(Click to Continue)|
C A Little Payback|QID|25588|M|91.61,78.01|
...
R This can be tricky...|QID|99999|U|55158|M|91.99, 81.57|N|Run here, until you see a cave. You need to bribe the ogres with the treasure to allow you safe passage thru the cave.|
...
R Head to the Captain's Room on the First Boat.|QID|25661|M|90.53,71.45|N|Kill "Evil Dolly" and loot her heart. (Click once complete)|
R Swim to this location|QID|25661|M|88.45,72.86|N|Use the ladder. Kill and Loot Seadog Fajardo. (Click to continue)|
...
T With a Little Help...|QID|25661|M|96.84,72.41|N|To Ajamon Ghostcaller.|
...
U Shimmy down the mountian to the north.|QID|99999|U|55121|N|Once you get in the water, summon your boat. (click to continue)|
R Sail north.|QID|99999|M|90.03,60.18|N|Sail Here (click to continue)|
...
R Get in the water|QID|99999|U|55121|M|44.93,35.25|N|Use your boat and head west. (Click to Continue)|
C Fool's Gold|QID|25774|M|48.05,42.85|N|Very very big gold ore nodes. Collect 8 (under water)|
...
H Fizzle and Pozzik's Speedbarge.|QID|99999|N|Hearth. Do not turn in the quests on the steam barge yet.|
R Get in the water|QID|99999|U|55121|M|88.19,59.79|N|Use your boat and head west. (Click to continue)|
...
R Get in the water|QID|99999|U|55121|M|69.95,84.98|N|Use your boat and head south-west. (Click to continue)|
...
C We All Scream for Ice Cream... and then Die!|QID|28051|M|68.53,86.35|
...
R Freezing the Pipes|QID|99999|U|62912|M|65.95,86.41|N|Go to the bug tunnel under water to the east. First Pipe is here. (click to continue)|
R Freezing the Pipes|QID|99999|U|62912|M|65.95,86.50|N|Second Pipe is here. (click to continue)|
R Freezing the Pipes|QID|99999|U|62912|M|64.94,84.52|N|Thrid Pipe is here. (click to continue)|
...
H Hearth to the Speedbarge.|QID|99999|N|If it is down, just sail back (Click to continue)|
...
R Free Freewind Post|QID|25835|M|46.31,57.56|N|Use your boat and travel west. (Click when complete)|
...
C The Writ of History|QID|27320|M|38.77,41.82|
...
R Get in the water|QID|99999|U|55121|M|12.87,34.05|N|Mount up and take a running leap for open water. Summon your boat and head Northwest|
...
C Release Heartrazor|QID|28088|M|17.65,41.08|N|Kill the 4 subduers|
...
C The Twilight Skymaster|QID|28098|M|19.00,48.02|N|Once complete, go back to Heartrazor and fly back.|
...
R On to the Bulwark|QID|28124|U|55121|M|30.41,48.89|N|Jump back onto Heartrazor. (Click when complete)|
...
C Break Them Out|QID|28127|M|27.19,57.68|
...
R Behind You!|QID|28136|U|63071|M|30.13,54.17|N|Run up the tower at this location. (Click to complete)|
R Behind You!|QID|28136|U|63071|M|28.02,57.11|N|Run over here... (click when complete)|
C Behind You!|QID|28136|U|63071|M|31.22,59.61|
C Codemaster's Code|QID|28139|M|31.14,59.76|
...
R Four Twilight Elements|QID|28157|M|53.09,63.51|N|Earth is Here (Click when you have looted it)|
R Unbound|QID|28158|M|52.90,59.60|N|Fury is here (Click when complete)|
R Four Twilight Elements|QID|28157|M|52.79,58.68|N|Water is Here (Click when you have looted it)|
C Unbound|QID|28158|M|56.84,61.28|
R Four Twilight Elements|QID|28157|M|57.53,60.00|N|Up this tower you will find air. (click when complete)|
...
H Hearth to the Speedbarge|QID|99999|N|Hearth to the barge.|
