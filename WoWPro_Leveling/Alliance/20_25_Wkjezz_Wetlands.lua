...
C Cleaning Hovel|QID|25211|S|M|47.99,75.41|
C The Stolen Keg|QID|25395|M|47.86,74.35|N|This is in the top of the bunker.|
C Cleaning Hovel|QID|25211|US|M|47.99,75.41|
...
R Keg Run|QID|25770|CS|M|48.23,67.29;49.23,70.51;53.93,70.37|N|Follow these waypoints|
...
C Fight the Flood|QID|25721|S|M|64.51,67.95|N|Kill the Flood Elementals as you loot the dirt piles.|
C Thresh Out of Luck|QID|25723|S|M|64.25,70.07|N|Kill and loot Threshers as you loot the dirt piles.|
C Sedimentary, My Dear|QID|25722|M|63.77,74.00|
C Thresh Out of Luck|QID|25723|US|M|64.25,70.07|
C Fight the Flood|QID|25721|US|M|64.51,67.95|
...
C Fenbush Berries|QID|25725|S|M|63.29,76.08|N|As you move to the Dwarf, stick to the edge of the lage and loot berry bushes.|
C Drungeld Glowerglare|QID|25727|M|63.82,78.19|N|In the cave by the lake.|
C Fenbush Berries|QID|25725|US|M|63.29,76.08|
C A Dumpy Job|QID|25726|M|55.71,72.21|N|Kill and Loot oozes until you have a Dumpy level in your bags.|
...
R Get Out Of Here, Stalkers|QID|25733|CC|M|53.35,64.14|N|Run to this cave. Kill Leech Stalkers as you see them|
...
C Get Out Of Here, Stalkers|QID|25733|S|M|53.99,66.00|
C Incendicite Ore|QID|25735|S|U|55240|M|47.82,65.97|N|Follow this path|
R Down in Thelgen Rock|QID|25734|NC|CS|M|49.17,62.80;48.66,60.70;45.92,60.61;47.82,65.97|N|Follow this path. Be sure to loot ore and kill spiders as you go|
C Incendicite Ore|QID|25735|US|U|55240|M|47.82,65.97|N|Follow this path|
C Get Out Of Here, Stalkers|QID|25733|US|M|48.54,60.83|
C Down In Thelgen Rock|QID|25734|NC|M|47.78,65.99|
A The Floodsurge Core|QID|25736|U|55243|N|Kill Torrention who will appear behind you. Loot him for this quest.|
...
T Onwards to Menethil|QID|25777|M|10.53,55.66|N|Click on the Ram you see to get a free ride to Captain Stoutfist.|
A Assault on Menethil Keep|QID|25780|M|10.53,55.66|N|From Captain Stoutfist.|
C Assault on Menethil Keep|QID|25780|M|9.91,57.60|N|Work your way to the upper room of the keep.|
...
C The Third Fleet|QID|25815|M|10.64,61.69|N|In the cellar|
...
C Claws from the Deep|QID|25801|S|QO|Bluegill Murloc slain: 12/12;Gobbler's Head: 1/1|M|8.33,58.56|N|Kill Murlocs as you travel|
...
C Claws from the Deep|QID|25801|QO|Bluegill Murloc slain: 12/12;Gobbler's Head: 1/1|M|15.13,31.76|
...
C The Cursed Crew|QID|25817|M|14.06,24.34|
...
R Lifting the Curse|QID|25818|CC|M|14.21,23.56|N|Swim down to the ocean floor, You should see a hole in the side of the ship.|
C Lifting the Curse|QID|25818|M|15.08,23.79|
T Lifting the Curse|QID|25818|M|14.37,24.02|
A The Eye of Paleth|QID|25819|M|14.37,24.02|
H Deepwater Tavern|QID|25819|M|10.58,60.59|N|Hearth now|
...
C Crocolisk Hides|QID|25856|S|M|27.23,23.21|N|Kill and loot as you go.|
C Dinosaur Crisis|QID|25864|M|39.28,20.68|
C I'll Call Him Bitey|QID|25854|M|35.45,20.20|
C Crocolisk Hides|QID|25856|US|M|27.23,23.21|
...
C Dark Iron Trappers|QID|25866|M|43.62,34.27|N|Kill Dark irons and loot their keys.|
C Gnoll Escape|QID|25867|M|45.38,34.90|
...
C Yorla Darksnare|QID|25868|M|41.25,22.00|
...
C Tooling Around|QID|25853|M|35.37,50.71|N|Kill and loot Dinos and Elementals as you go. The Tools are little sparkling boxes.|
C Strike the Earth!|QID|25850|M|33.59,47.47|
C When Archaeology Attacks|QID|25849|M|34.49,46.65|
...
C The Angerfang Menace|QID|26189|M|53.33,54.44|N|Follow the arrow in to the orc camp; killing as you go|
...
C The Crazed Dragonmaw|QID|26120|M|62.53,42.62|
C Mired in Hatred|QID|25926|M|55.90,35.67|
...
C For Peat's Sake|QID|25939|U|56134|M|63.43,33.10|N|Stand in the fire and use your Floodlilly. Kill all fire elementals you encounter|
C The Threat of Flame|QID|25927|M|56.74,29.50|
...
C The Twilight's Hammer Revealed|QID|26127|M|46.49,15.98|
