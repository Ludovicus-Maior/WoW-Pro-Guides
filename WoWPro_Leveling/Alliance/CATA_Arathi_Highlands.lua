...
f Refuge Pointe|QID|26035|M|39.85,47.34|N|Get the flight point for Refuge Point from Cedrik Prose.|NC|
...
A Worth Its Weight in Gold|QID|26035|M|40.34,49.03|N|From Skuerto.|
C Worth Its Weight in Gold|QID|26035|M|59.90,71.01|N|Kill Witherbark Trolls for the drops you need.|
H Refuge Pointe|QID|26035|M|39.89,48.75|N|Hearth or run back to Refuge Pointe.|NC|
T Worth Its Weight in Gold|QID|26035|M|40.27,49.05|N|To Skuerto.|
A Wand over Fist|QID|26036|PRE|26035|M|40.27,49.05|N|From Skuerto.|
...
A Trelane's Defenses|QID|26037|PRE|26036|M|40.35,48.99|N|From Skuerto.|
A Wanted!  Marez Cowl|QID|26024|M|40.24,49.06|N|From the Wanted Poster.|
A Wanted!  Otto and Falconcrest|QID|26079|M|40.24,49.06|N|From the Wanted Poster.|
A Northfold Manor|QID|26093|M|39.91,48.71|N|From Captain Nials.|
...
A Stromgarde Badges|QID|26095|PRE|26093|M|39.89,48.75|N|From Captain Nials.|
...
C Stromgarde Badges|QID|26095|M|19.99,66.47|N|Kill and loot Syndicate mobs for the Stromgarde Badges.|S|
...
C Stromgarde Badges|QID|26095|M|17.75,63.10|N|Finish killing and looting the Syndicate mobs for the Stromgarde Badges.|US|
...
A Attack on the Tower|QID|26038|PRE|26037|M|12.95,69.32|N|From Apprentice Kryten.|
C Attack on the Tower|QID|26038|QO|1|M|11.34,70.17|CS|N|Head into the tower, then up the first ramp, straight across the wooden ramp, under the second set of ramps is a chest. Loot Trelane's Phylactery from the chest.|NC|
C Attack on the Tower|QID|26038|M|11.17,69.90|QO|3|CS|N|Head up the tower to the middle floor, and loot Trelane's Ember Agate from the chest.|NC|
C Attack on the Tower|QID|26038|M|11.33,71.22|QO|2|CS|N|Head to the top floor of the tower, and loot Trelane's Orb from the chest.|NC|
H Refuge Pointe|QID|26024|M|39.89,48.75|N|Hearth or run back to Refuge Pointe.|
...
A Shakes O'Breen|QID|26336|M|40.34,49.03|N|From Skuerto.|
...
A Goggle Boggle|QID|26050|M|27.50,83.13|N|Escort quest. From Professor Phizzlethorpe.|
...
A Sunken Treasure|QID|26051|PRE|26050|M|27.60,83.13|N|From Doctor Draxlegauge.|
C Drowned Sorrows|QID|26055|M|15.77,87.11|N|Kill Daggerspine Raiders and Sorceress.|S|
C Sunken Treasure|QID|26051|M|19.20,87.75|N|Your head gear should have been changed to the Goggles. Find and loot gems, they will show up on your mini-map as 'Calcified Elven Gems'.|NC|U|4491|
C Drowned Sorrows|QID|26055|M|15.77,87.11|N|Finish killing the Daggerspine Raiders and Sorceress. Re-equip your head gear.|US|
...
A Speak to Shakes|QID|26052|PRE|26051|M|27.55,83.08|N|From Doctor Draxlegauge.|
T Speak to Shakes|QID|26052|M|26.05,83.84|N|To Shakes O'Breen.|
A Death From Below|QID|26628|PRE|26052|M|26.05,83.84|N|From Shakes O'Breen.|
C Death From Below|QID|26628|M|25.75,83.16|N|Go up onto the ship and use the cannon to kill incoming naga.|NC|
...
A Quae and Kinelory|QID|26113|LEAD|26110|M|39.99,48.17|N|From Commander Amaren.|
T Quae and Kinelory|QID|26113|M|54.76,55.33|N|To Quae.|
A Just Like Old Times|QID|26110|M|54.76,55.33|N|From Quae.|
...
A Quae Trusts You|QID|26114|PRE|26110|M|54.74,55.28|N|From Quae.|
T Quae Trusts You|QID|26114|M|54.85,55.34|N|To Kinelory.|
A Kinelory Strikes|QID|26116|PRE|26114|M|54.85,55.34|N|When you're ready to do the escort quest. From Kinelory.|
...
A For Southshore|QID|26117|PRE|26116|M|54.70,55.35|N|From Quae.|
T For Southshore|QID|26117|M|39.94,47.73|N|To Commander Amaren.|
A The Stone Shards|QID|26341|LEAD|26039|M|40.34,49.03|N|From Skuerto.|
T The Stone Shards|QID|26341|M|57.03,34.61|N|To the Shards of Myzrael.|
A The Princess Trapped|QID|26039|M|57.03,34.61|N|From the Shards of Myzrael.|
...
A Stones of Binding|QID|26041|PRE|26039|M|79.83,31.62|N|From the Iridescent Shards.|
...
C Stones of Binding: Cresting Key|QID|26041|QO|2|M|61.73,30.38|N|Click on the Stone of East Binding to receive the Cresting Key.|NC|
C Stones of Binding: Thundering Key|QID|26041|QO|3|M|46.56,52.11|N|Click on the Stone of Outer Binding to receive the Thundering Key.|NC|
C Stones of Binding: Burning Key|QID|26041|QO|1|M|18.93,31.00|N|Click on the Stone of West Binding to recieve the Burning Key.|NC|
T Stones of Binding|QID|26041|M|30.06,59.18|N|To the Stone of Inner Binding.|
A Breaking the Keystone|QID|26042|PRE|26041|M|30.06,59.18|N|From the Stone of Inner Binding.|
...
A Myzrael's Tale|QID|26346|PRE|26042|M|30.01,59.18|N|From the Stone of Inner Binding.|
...
A The Princess Unleashed|QID|26049|PRE|26346|M|40.26,49.07|N|From Skuerto. This quest is suggested for [2] players.|
