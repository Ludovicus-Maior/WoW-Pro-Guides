...
K Ice Sickle|QID|52327|QO|1||M|64.55,81.24|T|Ice Sickle|N|Found at the top of the waterfall - path up to him starts here. Silver Elite to kill for loot and achievement.|ITEM|987654|RANK|2|
C Sometimes Less Is More|QID|52796|M|63.10,75.25|US|N|Finish up with saurolisks.|
H The Golden Flagon|TZ|Brennadam|ACTIVE|52796|M|60.17,70.51|N|Hearth back to Brennadam or ride there.|
...
K Foreman Scripps|QID|49951|QO|1|M|64.43,65.93|T|Foreman Scripps|N|Silver Elite to kill for loot and achievement.|ITEM|160471|RANK|2|
...
K Sister Absinthe|QID|52441|QO|1|M|61.69,56.97|T|Sister Absinthe|N|Silver Elite to kill for loot and achievement.|ITEM|155164|RANK|2|
...
K Corrupted Tideskipper|QID|52121|QO|1|M|66.96,50.19|T|Corrupted Tideskipper|N|Kill rare for loot and resources.|RANK|2|
...
K Galestorm|QID|50075|QO|1|M|71.34,54.23|T|Galestorm|N|Silver Elite to kill for loot and achievement.|ITEM|155568|RANK|2|
K Sandfang|QID|52125|QO|1|M|72.70,60.54|T|Sandfang|N|Silver Elite to kill for loot and achievement.|ITEM|987654|RANK|2|
...
C Wendigo Away|QID|50534|M|65.83,78.70|N|Kill Bonerender.|
...
K Severus the Outcast|QID|52315|QO|1|M|22.15,72.83|T|Severus the Outcast|N|Silver Elite to kill for loot and achievement.|RANK|2|
...
K Ragna|QID|51774|QO|1|M|41.50,74.12|T|Ragna|N|Silver Elite to kill for loot and achievement.|ITEM|160465|RANK|2|
K Haegol the Hammer|QID|52463|QO|1|M|35.16,77.86|T|Haegol the Hammer|N|Silver Elite to kill for loot and achievement.|ITEM|154273|RANK|2|
...
K Kickers|QID|52321|QO|1|M|31.28,61.70|T|Kickers|N|Silver Elite to kill for loot and achievement.|ITEM|154475|RANK|2|
...
H Brennadam|ACTIVE|49908|N|Hearth to Brennadam or run back to the flight point and fly there.|
...
K Pinku'shon|QID|51886|QO|1|M|38.05,51.07|T|Pinku'shon|N|Silver Elite to kill for loot and achievement.|ITEM|163678|RANK|2|
...
K Seabreaker Skoloth|QID|51759|QO|1|M|33.64,37.93|T|Seabreaker Skoloth|N|Silver Elite to kill for loot and achievement.|ITEM|160477|RANK|2|;I think there's a time later in the guide when you're standing right next to this guy, anyway. It would be more efficient to kill him then.
C Swimming Lessons|QID|51343|M|34.35,36.41|QO|2|N|On the island.|
K Sabertron|QID|51978|QO|1|M|34.91,32.58|T|Sabertron|N|Inside the cave. Silver Elite to kill for loot and achievement.|ITEM|154664|RANK|2|

;Need QID for Nestmother Acada
K Nestmother Acada|QID|98765|QO|1|M|41.11,44.58|T|Nestmother Acada|N|Path up to elite. Click on the nest to start the event. Silver Elite to kill for loot and achievement.|ITEM|160458|RANK|2|
...
t The Great Sea Scrolls|AVAILABLE|53476|M|40.4,36.4|N|The maximum item level for the quest reward is 295, so if the quest says you will get a headpiece that is that level, there's no need to wait for 120. If you will get something lower, you may want to wait to turn this in.|
...
K Slickspill|QID|51921|QO|1|M|41.60,28.60|T|Slickspill|N|Silver Elite to kill for loot and achievement.|ITEM|158216|RANK|2|
...
C Deep Sea Venture|QID|51220|M|36.90,25.55|US|N|Finish killing goblins.|
...
C Fun With Magnets|QID|50696|M|44.42,55.51|U|158226|S|N|Areas are marked with a glowing sign (and on your map).  Use the Metal Collector 3 or 4 times in each area.|
C Bomb Beats Rock|QID|50697|M|48.72,56.57|QO|2|N|Click on the pile of bombs.|
K Crushtacean|QID|51901|QO|1|M|51.72,55.32|T|Crushtacean|N|Silver Elite to kill for loot and achievement.|ITEM|154857|RANK|2|
K Deepfang|QID|51778|QO|1|M|53.07,50.63|T|Deepfang|N|Quick side trip for another rare. Silver Elite to kill for loot and achievement.|ITEM|160464|RANK|2|
...
A Walking-Around Money|QID|50956|M|42.98,56.60|N|Right next to Leo.|
T Walking-Around Money|QID|50956|M|42.98,56.60|N|Right next to Leo.|
$ Old Ironbound Chest|QID|99999|M|43.60,48.22;42.85,47.23|CS|N|Go in the Cave. Take right tunnel. Through the end on the left.|RANK|2|
...
;Need QID for Whirlwind
K Whirlwind|QID|98765|QO|1|M|47.14,42.09|T|Whirlwind|N|Silver Elite to kill for loot and achievement.|ITEM|158215|RANK|2|
...
C Grizzled|QID|51752|M|35.99,38.81|Z|SalstoneMine_Stormsong!Dungeon|N|Head for Grizz and his mech.|
...
C Having a Blast|QID|51711|M|46.64, 36.20|US|N|Finish killing warfang miners and technicians.|
...
C Eye for an Eye|QID|51712|M|50.62,32.50|U|158465|N|Hop in the shredder. Kill mobs and burn buildings. You can't burn the same building twice. The tents count as a building (keep running around there until it catches on fire). Use ability 4 to heal. Don’t die; it’s a long run back.|
...
h Tidecross|ACTIVE|52067|M|65.5,48.3|N|Set your hearth at Sister Alison in the tent.|
...
H Tidecross|ACTIVE|49998|N|Hearth back to Tidecross.|
...
;Fix Gathering Storm steps to auto-complete after we change QO behavior.
...
$ Hidden Scholar's Chest|QID|99999|M|59.9, 39.1|CS|N|Run up the stairs and onto the roof of the library to pick up this chest.|;Need QID
...
K Croaker|QID|52306|QO|1|M|62.90,32.84|T|Croaker|N|Pass up turning in quests until after you kill the rare, because the turn-ins will lead to an escort quest.|ITEM|154460|RANK|2|
...
C Eye of the Storm|QID|50784|M|69.91,36.13|N|Tell Tideguard Victoria you're ready, then defend her during the few fights along the way. Click the orb at the end.|
...
A Sealed Fate|QID|51320|M|73.61,37.70|N|From Brother Pike.|
C Lost and Forgotten|QID|51278|M|70.91,32.28|S|N|Kill mobs in the area.|
K Song Mistress Dadalea|QID|52452|QO|1|M|71.06,32.98|N|Silver Elite to kill for loot and achievement.|ITEM|158218|RANK|2|
...
A Storm's End|QID|50824|M|75.61,27.02|N|From Brother Pike.|
C Storm's End|QID|50824|M|75.61,27.02|N|Kill the big baddie.|
