...
A Argussian Reach|QID|48642|M|44.44,55.56|
A Court of Farondis|QID|42420|M|30.34,66.78|
A The Wardens|QID|42422|M|31.86,69.46|RANK|2|
...
K Kill Squall|M|57.00,75.80|N|Kill rare for loot and resources.|
...
C A Risky Ploy|QID|49725|M|59.13,69.06|N|Blow the whistle in the crowd.|RANK|2|
...
K Kill Grimscowl the Harebrained.|M|62.17,73.84|N|Kill rare for loot and resources.|
...
C Circle the Wagons|QID|52793|M|63.29,77.74|N|Darion is here.|RANK|2|
...
K Kill Foreman Scripps|M|64.43,65.93|N|Kill rare for loot and resources.|
...
C Unnecessary Duress|QID|49705|M|61.93,65.11|N|Click on item next to human workers.|RANK|2|
...
C Forced Labor|QID|49887|M|64.71,62.10|QO|1|NC|N|Free him from the "Anchor" right next to you.|RANK|2|
...
K Sister Absinthe|M|61.69,56.97|N|Kill rare for loot and resources.|
...
K Kill Galestorm|QID|123|M|71.34,54.23|N|Kill and loot|
...
C Detective Mildenhall|QID|50070|M|68.52,69.00|QO|1|NC|N|Click on the boots here.  ---JPL - this chain autocomplete doesnt work right yet---|
...
C Don't Go in the Basement|QID|50064|M|70.75,69.15;70.81,69.08|CN|N|Go down in the basement and click on the barrel.  [JPL - need to figure out how to make run steps work]|
...
N The Battle for Brennadam|M|57.55,66.32|N|JPL - INSERT BONUS OBJ. QUEST FOR THIS HERE.|
...
C Grain Drain|QID|51314|M|53.76,68.19|N|Pick up the grain as well.|RANK|2|
T Raiders of the Lost Crop|QID|51310|M|54.95,67.99|N|To Farmer Max|RANK|2|
T Grain Drain|QID|51314|M|57.61,66.41|N|To Farmer Max|
K Strange Mushroom Ring|M|53.69,72.00;53.07,69.10|N|Go for the chest, but watch out - 5 mobs are going to pop out!|
K Jakala the Cruel|M|53.41,64.50;53.44,64.39|N|[JPL - this event didnt work...  dont know why].  In the basement - talk to Doc Marrtens to start event.  |
...
C Stop Vining!|QID|50135|M|49.07,65.48;48.04,65.94|QO|1|N|Head into this cave for Vinemaster Smagh.  [ JPL-dual coords might not work.]|
K Captain Razorspine|M|47.35,65.41|NC|N|Now its Razorspine's turn.  (coords inside the cave area)|RANK|2|
...
T Bonus Objective: Weed Whacking|QID|50133|M|51.59,65.97|N|Will auto complete when finished.  [JPL - auto complete zone obj??]|
...
f The Amber Waves|M|50.75,70.22|N|Pick up the flight path from Karla.|RANK|2|
...
K Vinespeaker Ratha|M|51.49,67.78|N|Found in the bottom of this cave.|
C Sic 'Em!|QID|49960|M|51.55,68.37;51.56,68.13|N|Razorgnarl is at the bottom of this cave.  [JPL-two waypoint doesnt work yet.]|
...
K The Lichen King|M|51.78,79.05|N|Its Bolivar Spore-dragon.  ;-)|
...
A Totems, Totems, Totems!|QID|50111|M|42.46,67.58;44.04,72.44|QO|1|US|N|Head up to the highlands, and accept the quest from the totem.  [JPL-has a double coords - need to fix.]|
C Totems, Totems, Totems!|QID|50111|M|44.04,72.46|QO|4|NC|N|Destroy the same totem.|
C Look Out!|QID|50354|M|42.50,67.69|QO|1|NC|N|Kill the scouts - you can use the dart to put them to sleep.  [JPL - useable item id keeps deleting]|
...
C Boaring Company|QID|50353|M|46.23,72.73;47.25,74.32|QO|3|NC|N|Two more farmers in this cave, bear right.  [JPL - has two coord error]|
C Boaring Company|QID|50353|M|46.83,72.60;47.89,73.35|QO|1|NC|N|Back out, and into the next cave for two more.|RANK|2|
C Boaring Company|QID|50353|M|46.51,71.97|QO|2|N|Back out and next farmer here.|
C Totems, Totems, Totems!|QID|50111|M|44.04,72.46|QO|2|NC|N|Central totem here.|RANK|2|
...
C Run For the Hills|QID|50365|M|45.82,77.07;43.54,78.58|N|Up the hill ans inside the cave - there is also a crate inside.  [JPL-mutilple coords...]|
...
K Osca the Bloodied|M|42.12,63.13|N|On our way to get a flight point - kill bear along the way.|
A Undelivered Package|QID|51218|M|38.43,62.99|N|Pick up from a package on the road.|
K Poacher Jane|M|34.64,67.98|N|Might as well take the Poacher out too.|
...
C The Black Sheep|QID|51200|M|26.55,75.36|N|Save Millie.|RANK|2|
...
K Broodmother|M|29.51,69.57|N|Kill Broodmother in the basement.|
C Basement Dwellers|QID|51251|M|28.64,71.17|N|Kill spiders around the area.|
...
$ Ancient Tidesage Scroll|M|31.95,72.90|N|Examine this here (for some achievement...)  JPL - note sure what this is yet...|
...
T Cookies and Cream|QID|51335|M|30.34,66.80|N|To Marie Davenport.|RANK|2|
...
C Mighty Grokkfist|QID|51209|M|38.77,72.90|N|Kill Grokkfist, use the rats to help you.|RANK|2|
C WANTED: Thundersnout|QID|49730|M|41.06,72.82|N|Head over to this cave to kill Thundersnout.  Solo'able by decently geared toons.|RANK|2|
K Ragna|M|41.50,74.12|N|Kill Ragna for loot.|
K Haegol the Hammer|M|35.16,77.86|N|Kill Haegol for loot.|
...
T Ettin It Done|QID|51207|M|30.33,66.81|N|From Marie Davenport.|RANK|2|
K Kickers|QID|123|M|31.28,61.70|N|Kill Kickers|
...
C Caught in the Net|QID|50621|M|27.20,62.08|S|N|Kil naga for keys and free prisoners from cages.|RANK|2|
...
C Freedom for the Sea|QID|50614|M|27.20,62.08|N|Kill the elementals as you go.|RANK|2|
...
T A Bit of a Bind|QID|50616|M|30.16,59.19|N|Kill the Binder and loot the Songstone from her.|RANK|2|
...
A An Illegible Scroll|QID|49832|M|32.21,40.02|N|Pick up quest from scroll on beach.|RANK|2|
K Seabreasker Skoloth|QID|49832|M|33.64,37.93|QO|1|N|Kill rare for loot.|
...
r Repair/Restock|QID|52130|M|35.51,48.73|N|At Assurance Engineer Cole.|RANK|2|
K Pinku'shon|M|38.05,51.07|N|Kill rare for loot.|
...
C Swimming Lessons|QID|51343|M|38.71,39.34|N|Inside the cave.|RANK|2|
C Swimming Lessons|QID|51343|M|34.35,36.41|N|On the island.|RANK|2|
$ Small Treasure Chest|M|35.11,34.44|N|Loot|
K Sabertron|QID|1|M|34.91,32.58|N|Rare.  in this cave.|
...
K Slickspill|M|40.02,37.32|N|Rare.|
C Flavorable Offering|QID|51371|M|38.39,28.21|N|Completed by killing and looting underwater mobs and collecting plants.|
...
K Crushtacean|M|51.72,55.32|N|Kill rare.|RANK|2|
...
C WANTED: Yarsel'ghun|QID|51217|M|57.84,55.83|N|From Lea Martinel.|
]]
