...
C Burn, Baby, Burn!|QID|25622|US|U|55152|M|73.10,49.77|N|Loot the flame thrower from an Incinerator Mob. Then target Warsong Stockpiles and use your flame thrower near them.|
...
C Commandeer That Balloon!|QID|25652|M|71.50,58.64|N|Kill the battery and any goblins that ambush you.|
...
l Just Ask Alice|QID|25673|L|55221 |QO|Mechanized Fire: 1/1|M|63.09,56.70|N|Mechanised Fire. If at the top of this big machine.|

C Free Our Sisters|QID|25662|S|M|65.92,54.00|N|Kill the orc for their keys and free the trapped Sisters.|

A BEWARE OF CRAGJAW!|QID|25730|M|64.96,49.52|

C Just Ask Alice|QID|25673|L|55222 |M|63.07,45.64|N|At the top of this rig.|

R Run to the path|QID|99999|M|68.31,45.38|N|Then once you get there follow it up and around.|
...
R Run here...|QID|99999|CC|M|60.60,70.84|N|You should see a horse called Blue Steel. When you do, mount him for a free ride.|
...
C They Put the Assass in... Never Mind|QID|25806|S|U|56014|N|Use your goggles to see the mobs.|
...
T They Put the Assass in... Never Mind|QID|25806|M|69.47,72.23|N|From UI Alert|

A Is This Thing On?|QID|25808|M|69.47,72.23|N|From UI Alert|

C Is This Thing On?|QID|25808|U|56014|M|70.04,72.90|N|Back track back out of the mines, based on the path you took down.|
...
C A Proper Peace Offerin'|QID|25837|S|M|60.13,87.08|N|Kill rams and loot nests as you go. Once you have these follow the arrow tot he Kobold Cave for the cheese.|
...
r Repair and Sell time|QID|99999|CC|M|71.38,79.55|N|From the Chief Explorer|
