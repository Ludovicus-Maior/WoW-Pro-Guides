...
C Easy Money|QID|27003|M|59.70,71.82|N|Click on the camel, Lady Humps.|
T Easy Money|QID|27003|M|59.70,71.82|

A Traitors!|QID|27922|M|59.63,72.05|N|From Prince Nadun.|
C Traitors!|QID|27922|M|61.69,71.11|N|Click on the Neferset Frond (plant).|
...
C Smoke in Their Eyes|QID|27923|S|U|63027|M|62.12,73.98|N|Set bales of hay on fire, kill Neferset Denizens and Neferset Sentinels for Armor Pieces or find them on ground.|
C Budd's Plan|QID|27924|M|60.91,74.08|N|Find six pieces of Tol'vir Armor.|
C Smoke in Their Eyes|QID|27923|US|U|63027|M|62.12,73.98|N|Finish setting bales on fire.|
...
C Speak with Sun Priest Asaris|QID|28134|M|52.98,27.78|QO|Speak with Sun Priest Asaris: 1/1|N|Speak to Sun Priest Asaris for Impending Retrubution quest.|

A Relics of the Sun King|QID|28141|M|52.98,27.78|
A Venomblood Antidote|QID|28145|M|52.98,27.78|N|From Sun Priest Asaris.|

C Relics of the Sun King|QID|28141|S|M|46.39,21.60|N|Kill various camel-riding mobs and drain scorpids of their blood.|
C Venomblood Antidote|QID|28145|U|63086|M|46.64,20.64|N|Kill scorpids and fill the vial.|
...
C Speak with Asaq|QID|28134|M|49.66,39.13|QO|Speak with Asaq: 1/1|N|Talk to Asaq for Impending Retribution Quest.|
C Speak with Nomarch Teneth|QID|28134|M|49.66,39.13|QO|Speak with Nomarch Teneth: 1/1|N|Talk to Nomarch for the Impending Retribution Quest.|
...
A Do the World a Favor|QID|27187|M|68.09,31.26|N|Kill Skarf or Mangy Hyenas to be offered this quest.|
...
C The Thrill of Discovery|QID|27511|M|64.48,30.27|N|When you go to the south hyroglyphics, pick up the next quest: "Be Prepared".|
...
C After the Fall|QID|27624|M|62.48,31.91|N|Gather the heads of the 4 statues.|
...
C Colossal Guardians|QID|27623|S|M|41.19,37.73|N|While doing the next set of quests, kill Scions of Al'Akir and rescue survivors.|
C Under the Choking Sands|QID|27519|M|40.63,39.15|
C Minions of Al'Akir|QID|27520|M|41.07,38.47|
C Colossal Guardians|QID|27623|US|M|41.19,37.73|
...
T The High Priest's Vote|QID|27630|M|54.16,41.93|N|To High Priest Amet.|

A Stopping the Spread|QID|27836|M|54.16,41.93|N|From High Priest Amet.|
...
C The Defilers' Ritual|QID|28611|M|52.18,40.18;49.89,40.11|
...
C The Element of Supplies|QID|28200|US|M|54.53,46.47|
...
T The Vortex Pinnacle|QID|28845|M|54.42,16.14|Z|The Vortex Pinnacle|N|To Itesh. Exit the Vortex Pinnacle.|
C The Pit of Scales|QID|27738|M|58.72,82.76|

T The Element of Supplies|QID|28200|M|58.97,46.16|N|Use your Hearthstone, then turn in to Sergeant Mehat.|
...
T Gnomebliteration|QID|27779|M|77.24,63.32|N|To Fusion Core.|T The Curse of the Tombs|QID|27755|M|67.32,42.79|N|To Sun Prophet Tumet.|
...
C Salhet's Gambit|QID|28486|M|54.06,71.17;53.83,75.53|N|At the top, the pack on the right does not engage unless you get too close to them. The NPCs are far enough away to not trigger them.|
...
C Ignition|QID|27903|U|62611|M|45.34,59.06|N|Use meteors thrown at you to hit the Guardian.|
...
T Return to the Lost City|QID|28870|M|31.78,16.78|N|If you did the optional dungeon quest. If not, check this off. To Captain Hadan.|
...
C Dirty Birds|QID|27940|S|M|41,69.6|N|From now on, kill Desert Coyotes and Diseased Vultures. Keep an eye out for the Desert Fox.|
C A Favor for the Furrier|QID|27928|M|41.3,72.3|N|Kill Desert Coyotes.|
C The Desert Fox|QID|27939|M|41.3,72.3|N|Find the Desert Fox (friendly NPC running around this area) and capture it.|
