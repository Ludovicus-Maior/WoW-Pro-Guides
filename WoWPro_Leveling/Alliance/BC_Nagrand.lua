...
R Nagrand|QID|9792|M|20.30,55.60|N|Go to Nagrand.|
...
f Telaar|QID|10251|M|54.20,75.05|N|Get the flight path.|
T The Master's Grand Design?|QID|10251|M|51.77,56.88|N|To Nitrin the Learned.|
A Vision of the Dead|QID|10252|PRE|10251|M|51.77,56.88|N|From Nitrin the Learned.|
T The Nesingwary Safari|QID|10113|M|71.46,40.7|N|To Hemet Nesingwary.|
...
l Howling Wind|QID|9861|M|64.0,45.1|N|Kill mobs until you get the Howling Wind.|L|24504|
...
l I Must Have Them!|ACTIVE|10109|M|65.29,48.29|QO|1|N|Kill Air Elementals and other mobs until you get 3x Air Elemental Gas.|S|L|27807 3|
C The Tortured Earth|QID|9819|M|67.00,36.00|N|Kill the Earth Spirits needed for this quest.|
...
C Clefthoof Mastery|QID|9789|M|64.00,48.00|N|Kill the Clefthoofs needed for this quest.|
C Talbuk Mastery|QID|9857|M|61.00,43.00|N|Kill the Talkbuks needed for this quest, they are around the trees.|US|
l I Must Have Them!|ACTIVE|10109|M|65.29,48.29|QO|1|N|Kill Air Elementals until you get 3x Air Elemental Gas.|US|L|27807 3|
...
A Bring Me The Egg!|QID|10111|PRE|10109|M|61.7,67.1|N|From Wazat.|
...
C Not On My Watch!|QID|9918|M|62.00,72.00|N|Attack Lump until he becomes non-hostile, then talk to him.|
...
C The Ruins of Burning Blade|QID|9921|N|Kill Ogres until you finish this quest.|S|
A HELP!|QID|9923|M|72.6,70.7|N|From Corki.|
l Boulderfist Key|QID|9923|M|72.66,70.40|N|Kill ogres until you get the Boulderfist Key|L|25490|
C HELP!|QID|9923|M|72.50,70.70|N|Free Corki from the cage.|
C The Ruins of Burning Blade|QID|9921|M|72.66,70.40|N|Kill Ogres until you finish this quest.|US|
...
A He Called Himself Altruis...|QID|9982|M|53.54,72|N|From Huntress Kima.  She wanders around Telaar.|
N Sell junk, repair, restock|QID|9800|M|53.25,70|N|Do not sell Ogre Warbeads or Ivory Tusks. Sell junk, repair, restock.|
A The Consortium Needs You!|QID|9913|LEAD|9882|M|51.18,69.83|N|From Consortium Recruiter.|
...
C A Rare Bean|QID|9800|M|50.00,30.00|N|Collect Digested Caracoli off the ground from the dung piles, until you finish this quest.|S|
...
C A Rare Bean|QID|9800|M|50.00,30.00|N|Collect Digested Caracoli off the ground from the dung piles, until you finish this quest.|US|
C Talbuk Mastery|QID|9858|M|50.00,30.00|N|Kill the rest of the mobs for this quest.|US|
C Eating Damnation|QID|9821|M|52,19|N|Kill Enraged Crushers until you get the items for this quest.|
...
C Agitated Spirits of Skysong|QID|9804|M|58.16,28.31|N|Kill Lake Spirits in the lake until you finish this quest.|U|24421|
...
C The Twin Clefts of Nagrand|QID|9922|M|40.00,32.00|N|Kill the Ogres needed for this quest.|S|
l Obsidian Warbeads|QID|10476|M|40.76,31.45|N|Kill ogres until you get the warbeads for this quest.|L|25433 10|S|
l Northwind Cleft Key|ACTIVE|9924|M|40.00,32.00|N|Kill Ogres until you get the Northwind Cleft Key.|L|25509|
C Corki's Gone Missing Again!|QID|9924|M|39.30,27.40|N|Free Corki from the north part of the cave.|
C The Twin Clefts of Nagrand|QID|9922|M|40.00,32.00|N|Kill the rest of the Ogres for this quest.|US|
l Obsidian Warbeads|QID|10476|M|40.76,31.45|N|Kill ogres until you get the warbeads for this quest.|L|25433 10|US|
C Muck Diving|QID|9815|M|41.00,38.00|N|Kill Muck mobs until you get the items for this quest.|
C Stopping the Spread|QID|9874|M|33.2,47.7|N|Use the torch on the corpses for this quest.|U|24560|S|
C The Spirit Polluted|QID|9810|M|33.00,50.00|N|Go here and kill 10 Lake Surgers and Watoosun's Polluted Essence.|U|24421|
C Solving the Problem|QID|9878|M|32,43|N|Kill Murkblood Scavengers and Raiders until you finish this quest.|S|
C Murkblood Corrupters|QID|9862|M|32,43|N|Kill Murkblood Putrifiers until you finish this quest.|S|
A The Totem of Kar'dash|QID|9879|M|33.00,42.00|N|You need to kill the two brutes in the house before the quest can be accepted. Make sure you have full health before accepting this escort quest, as you will be attacked immediately on accepting.|
C The Totem of Kar'dash|QID|9879|N|Kill the mobs that spawn and make sure you are at full health before each fight. The escort npc is weak. Getting a group for this may help.|
...
C Survey the Land|QID|9991|M|27.29,43.1|N|Make sure you are not mounted when you accept this quest (or abandon it and re-accept it).  You should fly around automatically.|
...
K Bach'lor|ACTIVE|9859|M|29.1,33.8;26.2,50.6|QO|1|CN|N|Kill Bach'lor and loot his hoof. He wanders between the waypoints.|T|Bach'lor|L|24523|US|
...
A A Head Full of Ivory|QID|9914|M|31.75,56.80|N|From Shadrek.|REP|The Consortium;933;Neutral|
C A Head Full of Ivory|QID|9914|M|56.61,44.62|N|Kill elephants till quest completes.|REP|The Consortium;933;Neutral|
T A Head Full of Ivory|QID|9914|M|31.75,56.80|N|Turn it right into Shadrek.|REP|The Consortium;933;Neutral|
N Sell junk, repair, restock|QID|9922|M|30.59,56.94|N|Sell junk, repair, restock.|
l Murkblood Invasion Plans|QID|9871|M|28.3,53.4;29.9,58.1;33.3,58.5;38,55.3;40.6,58.3;44.2,59.5|CN|N|Kill a Murkblood Invader (they wander the road) and loot the plans.|L|24559|
A Murkblood Invaders|M|28.3,53.4|QID|9871|N|Right-click the plans to start the quest.|U|24559|
l Stealing from Thieves|QID|9882|M|35.00,63.00|N|Loot the crystal fragments needed for this quest.|S|L|25416 10|REP|The Consortium;933;Neutral|
C Matters of Security|QID|9925|M|33.00,66.00|N|Kill Voidspawns until you finish this quest.|
C Stealing from Thieves|QID|9882|M|35.00,63.00|N|Loot the crystal fragments needed for this quest.|US|L|25416 10|REP|The Consortium;933;Neutral|
C Clefthoof Mastery|QID|9851|M|39.00,59.00|N|Kill Banthar (wandering).|T|Banthar|
K Gava'xi|QID|9900|M|42.05,72.46|QO|1|N|Kill Gava'xi. He wanders from atop the hill down to where the Vir'aani are.|; Gava'xi slain: 1/1
...
A Ortor My Old Friend...|QID|9873|PRE|9871|M|55.44,68.78|N|From Arechron.|
T The Totem of Kar'dash|QID|9879|M|55.44,68.78|N|To Arechron.|
A Corki's Ransom|QID|9954|PRE|9924|M|55.44,68.78|N|From Arechron.|
C Diplomatic Measures|QID|10108|M|73.80,62.60|N|Talk to Lantressor of the Blade.|
...
C Ruthless Cunning|QID|9927|M|71.4,79.4|N|Plant the banners on the mob corpses for this quest.|S|U|25552|
C Armaments for Deception|QID|9928|M|71.4,79.4|N|Loot the boxes for this quest.|S|
K Giselda the Crone|QID|9936|M|71.14,92.31|QO|1|N|Kill Giselda the Crone in center the large building.|; Giselda the Crone slain: 1/1
C WANTED: Giselda the Crone|QID|9936|M|70.52,79.2|N|Kill the rest of the Kil'sorrow agents needed.|
C Ruthless Cunning|QID|9927|M|71.4,79.4|N|Plant the rest of the banners on the mob corpses for this quest.|U|25552|US|
C Armaments for Deception|QID|9928|M|71.4,79.4|N|Loot the rest of the boxes for this quest.|US|
...
A Gurok the Usurper|QID|9853|PRE|9849|M|61.8,24.4|N|From Gordawg.|
...
C Returning the Favor|QID|9931|M|50.00,22.00|N|Plant Kil'sorrow Banners on ogre corpses as you did earlier with the other quest.|U|25555|S|
C WANTED: Zorbo the Advisor|QID|9940|M|46.11,19.00|N|Kill Warmaul Shamans and Reavers in the area.|S|
C Body of Evidence|QID|9932|M|46.45,24.35|N|Use the Damp Woolen Blanket here and defend the NPCs.|U|25658|
K Zorbo the Advisor|QID|9940|M|46.22,18.83|QO|1|N|Kill Zorbo inside the cave.|; Zorbo the Advisor slain: 1/1
C WANTED: Zorbo the Advisor|QID|9940|M|46.00,23.00|N|Kill Warmaul Shamans and Reavers in the area.|US|
C Returning the Favor|QID|9931|M|50.00,22.00|N|Plant Kil'sorrow Banners on ogre corpses as you did earlier with the other quest.|U|25555|US|
...
K Gutripper|ACTIVE|9856|M|36.9,20;34.3,26.5;31.2,31.5;32.2,25;33.4,20|QO|1|CN|N|Kill Gutripper and loot his eye.|T|Gutripper|L|24513|S|
l Flawless Greater Windroc Beak|ACTIVE|10252|QO|2|M|36.00,19.00;32.99,22.62|CN|N|Go between the waypoints until a flawless beak drops.|L|28667|
K Gutripper|ACTIVE|9856|M|36.9,20;34.3,26.5;31.2,31.5;32.2,25;33.4,20|QO|1|CN|N|Kill Gutripper and loot his eye. He wanders around where the waypoints are.|T|Gutripper|L|24513|US|
l Mountain Gronn Eyeball|ACTIVE|10252|QO|1|M|30.00,32.00|N|Kill the Mountain Gronn on this path and loot the eyeball.|L|28665|T|Mountain Gronn|
C The Ravaged Caravan|QID|9956|M|27.00,23.00|N|Get the crates needed for this quest.|S|
...
K Cho'war the Pillager|QID|9955|M|27.17,18.68;27.00,11.00|CS|N|Go through the cave and kill Cho'war.|L|25648|
...
C The Ravaged Caravan|QID|9956|M|27.00,23.00|N|Get the rest of the crates needed.|US|
l Aged Clefthoof Blubber|ACTIVE|10252|QO|3|M|27.00,41.00|N|Kill Aged Clefthoofs until you get the Blubber.|L|28668 1|
C Ortor My Old Friend...|QID|9873|M|31.00,42.00|N|Go here and kill Ortor.|
...
A The Ultimate Bloodsport|QID|9852|PRE|9856&9859&9851|M|71.52,40.79|N|From Hemet Nesingwary.|
T Gurok the Usurper|QID|9853|M|61.8,24.4|N|To Gordawg.|
C The Ultimate Bloodsport|QID|9852|M|44.28,65.6|N|Kill and loot Tusker.|
C WANTED: Durn the Hungerer|QID|9938|M|30,63;30.1,75;39.6,79.2;44,70;37.5,59|CN|N|Kill Durn the Hungerer, he wanders around Oshu'gun.|T|Durn the Hungerer|
T WANTED: Durn the Hungerer|QID|9938|M|54.8,71.0|N|To Waden Moi'bff Jill.|
