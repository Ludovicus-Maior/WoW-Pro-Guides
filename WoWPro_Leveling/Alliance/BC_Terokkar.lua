...
C City of Light|QID|10211|M|54.8,44.3|Z|Shattrath City|N|Follow the npc until you get the quest completion.|
...
N Allegiance to the ...|QID|10553^10554|M|55.00,43.98|Z|Shattrath City|N|Either turn in the quest "Allegiance to the Aldor" if you want to be with Aldor, or "Allegiance to the Scyers" if you want to be with the Scryers. Then close this step.|
A Ishanah |Z|Shattrath City|QID|10554|M|54.8,44.3|N|From Khadgar.|REP|Aldor;932|
T Ishanah |QID|10554|M|24.0,29.7|Z|Shattrath City|N|To Ishanah. You must take the elevator up to this area.|REP|Aldor;932|
A Restoring the Light|QID|10021|M|24.0,29.7|Z|Shattrath City|N|From Ishanah.|REP|Aldor;932|
h Shattrath City|QID|9957|M|28.00,49.00|Z|Shattrath City|N|Make Shattrath City (Aldor Rise) your home location.|REP|Aldor;932|
r Sell junk, Repair, restock, train skills|QID|9957|M|27.92,47.45|Z|Shattrath City|N|Sell junk, Repair, restock, train skills.|REP|Aldor;932|
A Voren'thal the Seer|QID|10553|M|54.8,44.3|Z|Shattrath City|N|From Khadgar.|REP|Scryers;934|
T Voren'thal the Seer|QID|10553|M|43.5,91.8|Z|Shattrath City|N|You must take the elevator up to this area.|REP|Scryers;934|
h Scryers Tier|QID|9957|M|56.35,81.55|Z|Shattrath City|N|Make Shattrath City (Scryers Tier) your home location.|REP|Scryers;934|
...
R Terokkar Forest|QID|9957|M|39.5,9.9|N|Go out of Shattrath City.|
C Rather Be Fishin'|QID|10037|M|38.00,13.00|N|Kill eels until you finish this quest.|
...
l Vicious Teromoth Sample|QID|9968|M|44.00,20.00|QO|2|N|Kill Vicious Teromoths to get 4 Vicious Teromoth Samples.|S|
A It's Watching You!|QID|9951|M|45.0,22.5|N|From Warden Treelos.|
C Clues in the Thicket|QID|9971|M|45.10,21.80|N|Examine the Strange Object here.|
C It's Watching You!|QID|9951|M|43.50,22.00|N|Kill Naphthal'ar at the top of the tower.|
T It's Watching You!|QID|9951|M|45.0,22.5|N|To Warden Treelos.|
l Vicious Teromoth Sample|QID|9968|M|44.00,20.00|QO|2|N|Kill Vicious Teromoths to get 4 Vicious Teromoth Samples.|US|
T Clues in the Thicket|QID|9971|M|44.3,26.3|N|To Earthbinder Tavgren.|
C Strange Energy|QID|9968|M|44.00,28.00|QO|1|N|Kill teromoths until you get the items for this quest.|
...
f Allerian Stronghold|QID|10026|M|59.45,55.40|N|Get the flight path.|
...
C Thin the Flock|QID|10869|N|Kill mobs for this quest.|S|
C The Outcast's Plight|QID|10917|N|Kill Arakkoa to get their feathers.|S|
l Eye of Veil Shienor|QID|10847|M|57.90,23.15|QO|2|N|Loot the Eye of Veil Shienor in the tree here. Enter the tree at 59.75,25.25|
K Ayit|QID|9986|M|59.40,23.40|QO|2|N|Kill Ayit.|
C Eastern Altar|QID|10021|M|49.20,20.30|QO|2|NC|N|Right-click the Eastern Altar here.|REP|Aldor;932|
K Ashkaz|QID|9986|M|49.00,17.00|QO|1|N|Kill Ashkaz in the trees here.|
C The Eyes of Skettis|QID|10847|M|50.15,19.40|QO|1|N|Loot the Eye of Veil Reskk here.|
C Northern Altar|QID|10021|M|50.70,16.60|QO|1|NC|N|Right-click the northern altar here.|REP|Aldor;932|
C Restoring the Light|QID|10021|M|48.10,14.50|NC|N|Right-click the Altar here to complete the quest.|REP|Aldor;932|QO|3|
C Thin the Flock|QID|10869|N|Kill mobs until you finish this quest.|US|
C The Outcast's Plight|QID|10917|N|Kill Arakkoa to get their feathers.|US|
H Shattrath City|QID|10021|M|28.09,48.88|Z|Shattrath City|N|Hearth to Shattrath City.|REP|Aldor;932|
...
T The Outcast's Plight|QID|10917|M|51.1,17.64;45.1,19.9|Z|Shattrath City|CN|N|To Vekax. He tends to wander between the two treehouses.|
...
R Terokkar Forest|QID|10038|M|86.33,44.76|Z|Shattrath City|N|Exit the city to Terokkar.|
...
N Shadowy Laborer|N|Talk to the Shadowy Laborer in the town (wandering). Watch out for the Hunters since they can detect the disguise.|S|
N Shadowy Initiate|QID|10040|M|39.05,39.70|QO|1|N|Talk to the Shadowy Initiate in the town. Watch out for the Hunters since they can detect the disguise.|
C Who Are They?|QID|10040|M|40.30,39.00|QO|3|N|Talk to the Shadowy Advisor in the building. Watch out for the Hunters since they can detect the disguise.|
N Shadowy Laborer|QID|10040|M|40.3,39.1|QO|2|N|Talk to the Shadowy Laborer in the town (wandering). Watch out for the Hunters since they can detect the disguise.|US|
...
C Kill the Shadow Council!|QID|10042|M|40.00,38.00|N|Kill all the mobs needed for this quest. Shadowmaster Grieve is at the arrow.|
...
C Missing Friends|QID|10852|M|32.3,41.7|N|Kill bird mobs and get Prison Keys. Use the keys on the cages until you finish this quest.|S|
C A Personal Favor|QID|10112|M|32.3,41.7|N|Kill bird mobs until you finish this quest.|S|
C Veil Skith: Darkstone of Terokk|QID|10839|M|30.80,42.00|N|Use the Rod of Purification here.|U|31610|
C Stymying the Arakkoa|QID|9986|M|31.00,43.00|N|Kill Urdak in the trees.|
C Missing Friends|QID|10852|M|32.3,41.7|N|Kill bird mobs and get Prison Keys. Use the keys on the cages until you finish this quest.|US|
C A Personal Favor|QID|10112|M|32.3,41.7|N|Kill bird mobs until you finish this quest.|US|
...
C Vengeful Souls|QID|10842|M|47.00,55.00|N|Kill the 5 Vengeful Draenei you need to finish this quest.|
C The Tomb of Lights|QID|10840|N|Kill the rest of the mobs needed for this quest.|US|
C WANTED: Bonelashers Dead!|QID|10033|M|42,51|N|Kill Bonelashers until you finish this quest.|US|
T The Tomb of Lights|QID|10840|M|37.4,51.5|N|To High Priest Orglum.|
T Vengeful Souls|QID|10842|M|37.4,51.5|N|To High Priest Orglum.|
...
A Recover the Bones|QID|10030|PRE|10840&10842|M|37.06,49.62|N|From Soolaveen.|
H Shattrath City|QID|10112|M|28.09,48.88|Z|Shattrath City|N|Hearth to Shattrath City.|REP|Aldor;932|
...
C Magical Disturbances|QID|10026|M|55.00,37.00|N|Kill the Warp Stalkers for this quest.|S|
C Timber Worg Tails|QID|10016|M|66.00,49.00|N|Kill worgs until you get the items for this quest.|S|
C Olemba Seeds|QID|9992|M|34.9,42.8|N|Loot the rest of the seeds for this quest.|S|
C Unruly Neighbors|QID|9998|M|66.00,49.00|N|Go here and kill the Peons needed for this quest.|
C Timber Worg Tails|QID|10016|M|66.00,49.00|N|Kill worgs until you get the items for this quest.|US|
...
C Thinning the Ranks|QID|10007|N|Kiill the mobs needed for this quest.|S|
C The Firewing Liaison|QID|10002|M|67.00,53.00|N|Kill Lisaile Fireweaver.|
A Fel Orc Plans|QID|10012|PRE|9998|M|67.90,53.60|N|Click on the plans on the ground.|
C Thinning the Ranks|QID|10007|M|67.14,54.37|N|Kiill the mobs needed for this quest.|US|
C Magical Disturbances|QID|10026|M|55.00,37.00|N|Kill the rest of the Warp Stalkers for this quest.|US|
C Olemba Seeds|QID|9992|M|34.9,42.8|N|Loot the rest of the seeds for this quest.|US|
...
H Shattrath City|QID|9994|M|28.09,48.88|Z|Shattrath City|N|Hearth to Shattrath City.|REP|Aldor;932|
r Sell junk, Repair, restock|QID|10180|M|28.11,47.65|Z|Shattrath City|REP|Aldor;932|
H Shattrath City|QID|9994|M|56.35,81.55|Z|Shattrath City|N|Hearth to Shattrath City.|REP|Scryers;934|
r Sell junk, Repair, restock, train skills|QID|9994|M|54.6,82.4|Z|Shattrath City|REP|Scryers;934|
A Can't Stay Away|QID|10180|Z|Shattrath City|M|57.85,15.47|N|From Oloraak.|
F Allerian Stronghold|QID|9994|M|63.92,41.56|Z|Shattrath City|N|Fly to Allerian Stronghold.|
...
C Attack on Firewing Point|QID|9996|M|70.00,39.00|N|Kill mobs until you finish this quest.|
C The Elusive Ironjaw|QID|10022|M|69.13,32.82|N|Kill Ironjaw (wandering mob) and loot his pelt.|T|Ironjaw|
C A Cure for Zahlia|QID|10020|T|Stonegazer|M|64.00,31.00|N|Kill and loot Stonegazer.|REP|Aldor;932|
...
l The Final Code|QID|10446|M|74.00,36.00|N|Go to the top of the tower and kill Sharth Voldoun and loot the Final Code. If you are about to die, jump off the tower or else you will not be able to get your corpse.|L|29912|
C The Final Code|QID|10446|M|71.20,37.40|N|Right-click the mana bomb in the center of town.|
A Escape from Firewing Point!|QID|10051|M|73.9,35.2|N|From Isla Starmane, wait a bit for her to respawn if she's not there.|
C Escape from Firewing Point!|QID|10051|M|73.9,35.2|N|Do this escort quest.|
...
C A Cure for Zahlia|QID|10020|M|64.00,31.00|N|This is your last chance to complete this quest, if you already haven't kill Stonegazer here with a partner if you need.|REP|Aldor;932|
...
C Recover the Bones|QID|10030|M|52.00,58.00|N|Loot the bones needed for this quest.|S|
...
l Trachela's Carcass|QID|10035|M|43.00,51.00|N|Kill Trachela and loot the carcass.|L|30618|T|Trachela|
...
C Torgos!|QID|10035|M|27.00,55.60|N|Use Trachela's Carcass here and then kill and loot Torgos.|U|30618|
R Shadow Tomb|QID|10887|M|32.00,53.00|N|Go to the Shadow Tomb.|
l Gavel of K'alen|QID|10881|M|29.70,51.70|QO|2|N|Loot the Gavel from the chest here.|
l Drape of Arunen|QID|10881|M|32.10,51.20|QO|1|N|Loot the Drape from the chest here.|
C The Shadow Tomb|QID|10881|M|31.20,46.70|QO|3|N|Loot the scroll from the chest here, then accept the escort quest.|
...
C Veil Lithic: Preemptive Strike|QID|10861|M|26.00,71.00|N|Loot Cursed Eggs here until you finish this quest.|
A An Improper Burial|QID|10913|M|31.0,76.1|N|From Commander Ra'vaj.|
A The Dread Relic|QID|10877|M|31.08,76.46|N|From Oakun.|
A Taken in the Night|QID|10873|M|31.4,75.6|N|From Scout Navrin.|
A Digging Through Bones|QID|10922|M|31.0,76.1|N|From Chief Archaelogist Letoll.|
C Digging Through Bones|QID|10922|M|31.0,76.1|N|Do this escort quest.|
...
C Recover the Bones|QID|10030|US|M|52.00,58.00|N|Loot the rest of the bones needed for this quest.|
R Auchindoun|QID|10227|M|37.38,65.62|N|Enter Auchindoun from this location on the inside of the ring.|
A I See Dead Draenei|QID|10227|M|35.11,65.09|N|From Ha'lei.|
T I See Dead Draenei|QID|10227|M|35.16,66.18|N|To Ramdor the Mad.|
A Ezekiel |QID|10228|PRE|10227|M|35.16,66.18|N|From Ramdor the Mad.|
T Recover the Bones|QID|10030|M|35.16,66.18|N|To Ramdor the Mad.|
A Helping the Lost Find Their Way|QID|10031|PRE|10030|M|35.16,66.18|N|From Ramdor the Mad.|
T Can't Stay Away|QID|10180|M|44.79,65.6|N|To Isfar just inside Sehekk Halls.|
H Shattrath City|QID|10020|M|28.09,48.88|Z|Shattrath City|N|Hearth to Shattrath City.|REP|Aldor;932|
r Sell junk, Repair, restock|QID|10020|M|28.11,47.65|Z|Shattrath City|REP|Aldor;932|
H Shattrath City|QID|10020|M|56.35,81.55|Z|Shattrath City|N|Hearth to Shattrath City.|REP|Scryers;934|
...
C Fumping|QID|10929|M|35.05,51.5|N|Go here (make sure the map says "The Bone Wastes"), use the fumper to possibly spawn a sifter. Kill and loot sifters this way until you get all the items for this quest. Do not be too close to the caravan as the level 85 guards will kill it too quick.|U|31810|
C Helping the Lost Find Their Way|QID|10031|M|40.00,78.00|N|Kill Lost Spirits and Broken Skeletons for this quest.|S|
T Fumping|QID|10929|M|30.98,76.19|N|To Dwarfowitz.|
A The Big Bone Worm|QID|10930|PRE|10929|M|30.98,76.19|N|From Dwarfowitz.|
C An Improper Burial|QID|10913|M|33.30,76.10|N|Use your Sha'tari Torch to burn Draenei Corpses for this quest.|U|31769|
...
C A Hero Is Needed|QID|10914|M|36.00,74.00|N|Kill the mobs for this quest.|
...
C Helping the Lost Find Their Way|QID|10031|M|40.00,78.00|N|Kill the rest of the mobs for this quest.|US|
N The Big Bone Worm|QID|10930|N|For those used to the old way, Blizz has changed it to where, Hai'shulud will follow you into the tunnels.|
C The Big Bone Worm|QID|10930|M|47.01,74.50|N|Kill a Decrepit Clefthoof and then use the Fumper on it. Keep trying the fumper until Hai'shulud spawns, then kill and loot it.|U|31825|
A For the Fallen |QID|10920|M|49.71,76.18|N|From Vindicator Haylen.|
C Taken in the Night|QID|10873|M|52.00,77.00|N|Free Netherweb Victims until you finish this quest.|S|
...
A Terokkarantula|QID|10921|PRE|10920|M|49.71,76.18|N|From Vindicator Haylen.|
C Terokkarantula|QID|10921|M|54.2,81.69|N|Kill Terokkarantula.|
C Taken in the Night|QID|10873|M|52.00,77.00|N|Free Netherweb Victims until you finish this quest.|US|
T Terokkarantula|QID|10921|M|49.71,76.18|N|To Vindicator Haylen.|
A Return to Sha'tari Base Camp|QID|10926|PRE|10921|M|49.71,76.18|N|From Vindicator Haylen.|
...
C Veil Shalas: Signal Fires|QID|10874|QO|1|M|55.2,67.1|N|After getting all of the signal fires except sapphire, mount and fly to the next treehouse where the Sapphire Signal Fire is, then extinguish it.|
...
T Torgos!|QID|10035|M|58.1,53.42|N|To Taela Everstride.|
T Helping the Lost Find Their Way|QID|10031|M|37.09,49.53|N|To Soolaveen.|
...
T Taken in the Night|QID|10873|M|31.4,75.69|N|To Scout Navrin.|
T Return to Sha'tari Base Camp|QID|10926|M|31.4,75.69|N|To Scout Navrin.|
T A Hero Is Needed|QID|10914|M|30.99,76.09|N|To Commander Ra'vaj.|
A The Fallen Exarch|QID|10915|PRE|10914|M|30.99,76.09|N|From Commander Ra'vaj.|
T The Big Bone Worm|QID|10930|M|30.97,76.18|N|To Dwarfowitz.|
T The Dread Relic|QID|10877|M|31.07,76.5|N|To Oakun.|
...
H Shattrath City|QID|10889|M|28.09,48.88|Z|Shattrath City|N|Hearth to Shattrath City.|REP|Aldor;932|
H Shattrath City|QID|10889|M|56.35,81.55|Z|Shattrath City|N|Hearth to Shattrath City.|REP|Scryers;934|
...
C The Skettis Offensive|QID|10879|M|52.6,21.0|Z|Shattrath City|N|Kill the mobs (Two birds, Two Birds, Three Birds, One bird 10k health) until this quest is finished.|
...
r Sell junk, Repair, restock.|M|54.6,82.4|Z|Shattrath City|N|Visit your trainers, etc. Close this step to continue to the next guide.|REP|Scryers;934|
]]
end)
