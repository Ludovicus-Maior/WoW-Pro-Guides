...
C Heat That Just Don't Quit|US|QID|27981|U|62826|M|31.15,43.81;39.07,41.43;42.88,35.89|N|Wander between these 3 spots to get all your flasks.|
...
C They Build a Better Bullet|QID|28030|US|M|49.17,73.38|N|Pick up the Dark Iron Bullet crates, the bullets can also drop off of Dark Iron Marskmen and Lookouts.|
C The Mysteries of the Fire-Gizzard|QID|28032|M|34.85,67.89|US|N|Kill the Incendosaurs to get the items needed for this quest.|
...
C From Whence He Came|QID|28062|U|62925|M|43.78,27.65|N|Take Archduke Calcinder down in health, once you see the UI Alert, use the Consecrated Tripetricine.|
