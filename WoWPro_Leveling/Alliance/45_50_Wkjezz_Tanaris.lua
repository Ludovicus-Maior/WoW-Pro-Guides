...
h Gadgetzan|QID|12650|M|52.60,27.02|N|At Innkeeper Fizzgrimble.|
r Sell Junk / Repair and Restock|QID|99999|M|52.28,29.72|N|You can also put items in the bank here. I would suggest doing so. (Click to continue)|
...
C Dead Man's Chest|QID|25052|S|M|72.61,46.39|
C To The Ground!|QID|25053|U|51547|QO|Northwest Shack: 1/1|M|71.67,46.75|N|The 1st building to torch is here.|
C Lootin' Plunder|QID|25054|S|M|71.50,46.79|N|Look inside the shacks.|
C To The Ground!|QID|25053|U|51547|QO|Southwest Shack: 1/1|M|72.68,46.15|
C To The Ground!|QID|25053|U|51547|QO|Northeast Shack: 1/1|M|71.86,47.73|N|The last building to torch is here. If you still need booty have a look insinde.|
C Lootin' Plunder|QID|25054|US|M|71.50,46.79|
C Dead Man's Chest|QID|25052|US|M|72.61,46.39|
...
H Gadgetzan|QID|99999|M|52.79,27.00|N|Hearth or run|
...
C I'm With Scorpid|QID|25521|S|M|44.38,26.25|N|Kill all the scorpids you see on the way to the trolls. Don't wory if you don't complete the quest; you can kill more on the way back.|
C Blood to Thrive|QID|25021|M|40.46,29.14|N|Kill and loot the trolls. If this camp has been cleared there is another to the Northwest at location 38.46,26.43. |
C I'm With Scorpid|QID|25521|US|M|44.38,26.25|N|Finish up now.|
...
C Cutting Losses|QID|24932|S|M|56.70,61.92|N|Kill as you go|
...
C Cutting Losses|QID|24932|US|M|56.70,61.92|
...
C Chicken of the Desert|QID|24933|S|M|58.14,59.84|N|To say the drop rate on the Basalisks and Hyenas is low, is an understatement; Do not get discouraged. |
C Gazer Tag|QID|24931|US|M|52.65,53.99|
C Chicken of the Desert|QID|24933|US|M|58.14,59.84|N|Hooray!|
...
C What We Came For|QID|25062|M|50.76,90.75|N|Keep killing goblins as you go.|
...
r Sell Junk|QID|25111|CC|M|49.99,82.77|N|At Rations Officer Flexgear.|
...
f Southmoon Ruins|QID|28881|CS|M|49.10,76.00;40.01,77.50|N|At Thurda.|
...
C Laying Claim|QID|25559|S|M|41.21,69.31|
C Fragments of Language|QID|25565|M|41.03,70.46|
C Laying Claim|QID|25559|US|M|41.21,69.31|
...
T The Secrets of Uldum|QID|25566|M|37.64,78.82|
A What Lies Within|QID|25070|M|37.64,78.82|
C What Lies Within|QID|25070|M|37.65,78.76|
T What Lies Within|QID|25070|M|37.63,78.85|
A The Grand Tablet|QID|25421|M|37.63,78.85|
T The Grand Tablet|QID|25421|M|40.14,76.90|N|To Prospector Gunstan.|
H Gadgetzan|QID|99999|N|Your hearth SHOULD still be set at Gadgetzan, if it is not, use the flight path to go back.|
...
C Thunderdrome: The Ginormus!|QID|25067|M|51.75,28.02|
...
C Thunderdrome: Zumonga!|QID|25094|NC|M|51.69,28.38|
...
C Thunderdrome: Sarinexx!|QID|25095|NC|M|51.67,28.26|
