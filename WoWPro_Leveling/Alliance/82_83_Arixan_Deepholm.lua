...
N The Battle is Won, The War Goes On|QID|27398|N|If you don't have this quest, check it off and continue to the next.|
A Hero's Call: Deepholm!|QID|27727|M|63,71.7|Z|Stormwind|N|If you don't have the first quest.|

T The Battle is Won, The War Goes On|QID|27398|M|74.5,19.3|Z|Stormwind|N|If you have it. To Naraat the Earthspeaker.|
T Hero's Call: Deepholm!|QID|27727|M|74.5,19.3|Z|Stormwind|N|If you have it. To Naraat the Earthspeaker.|

A The Maelstrom|QID|27203|PRE|27727|M|74.5,19.3|N|From Neraat the Earthspeaker.|
T The Maelstrom|QID|27203|M|33.2,50.2|Z|The Maelstrom|N|To Thrall.|

A Deepholm, Realm of Earth|QID|27123|PRE|27203|M|33.2,50.2|N|From Thrall.|
C Deepholm, Realm of Earth|QID|27123|M|33.2,50.2|N|Hop on the Wyvern behind you.|
T Deepholm, Realm of Earth|QID|27123|M|49.6,53|N|To Maruut Stonebinder.
...
A The Stone Throne|QID|26709|PRE|26971|M|49.7,53.3|N|Will open up the Daily Quest hub in Deepholm. So fly back to Therazane’s Throne and turn it in. You can do this now, or at a later time. It is not required to continue.|
