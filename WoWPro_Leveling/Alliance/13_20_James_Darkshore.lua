...
C Rescue Volcor|QID|13518|M|45.03,18.20|QO|Volcor rescued: 1/1|N|Talk to Volcor.|
C Rescue Gershala Nightwhisper|QID|13518|M|44.10,17.81|QO|Gershala Nightwhisper rescued: 1/1|N|Talk to Gershala.|
C Rescue Cerellean Whiteclaw|QID|13518|M|44.53,19.93|QO|Cerellean Whiteclaw rescued: 1/1|N|Talk to Cerellean.
C Rescue Shaldyn|QID|13518|M|42.92,21.48|QO|Shaldyn rescued: 1/1|N|Now rescue Shaldyn.|
...
C A Taste for Grouper |QID|13537|M|52.38,17.7|P|Fishing|N|Catch 4 Grouper from the waters by fishing.|
T A Taste for Grouper |QID|13537|M|52.38,17.7|P|Fishing|N|To Johnathan Staats.|
C The Boon of the Seas|QID|13520|M|49.56,18.48|N|Dive underwater and open Encrusted Clams.|S|
...
T Writings of the Void|QID|28529|M|50.31,19.59|N|To Ranger Glynda Nal'Shea.|
