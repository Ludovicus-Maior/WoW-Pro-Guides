...
C Rescue Volcor|QID|13518|M|45.03,18.20|QO|Volcor rescued: 1/1|
C Rescue Gershala Nightwhisper|QID|13518|M|44.10,17.81|QO|Gershala Nightwhisper rescued: 1/1|
C Rescue Cerellean Whiteclaw|QID|13518|M|44.53,19.93|QO|Cerellean Whiteclaw rescued: 1/1|
C Rescue Shaldyn|QID|13518|M|42.92,21.48|QO|Shaldyn rescued: 1/1|
...
C The Boon of the Seas|QID|13520|M|49.56,18.48|N|Dive underwater and open Encrusted Clams.|
...
A Bearer of Good Fortune|QID|13557|M|57.02,31.46|N|Enter the waterfall, kill Vile Corruptors until one drops the Corruptor's Master Key. Right-click it and accept the quest.|
...
A A Troubling Prescription|QID|13831|M|56.78,33.47;57.37,33.80|
...
N Sell Junk and Repair|QID|13562|M|50.76,19.24|N|Close this step when you're done.|
...
C The Ritual Bond|QID|13569|NC|M|43.74,40.34|N|Right-click the Keeper's Incense, which is right infront of Keeper Karithus. Then go talk to the Great Stag Spirit.|
...
A Reason to Worry|QID|13506|M|60.67,17.74|N|Look for a Shatterspear Overseer, loot the Overseers Orders and start the quest.|
...
C War Supplies|QID|13509|U|44999|M|62.42,8.08|US|
...
A Disturbing Connections|QID|13591|M|72.31,18.90|N|Right-click Hellscream's Missive and accept the quest.|
