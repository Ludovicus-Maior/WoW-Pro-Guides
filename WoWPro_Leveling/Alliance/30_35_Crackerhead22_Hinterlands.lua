...
R The Hinterlands|QID|26542|M|43.36,45.18;36.71,31.15;38.45,22.89;39.32,19.03|Z|Arathi Highlands|N|Follow the waypoints to The Hinterlands.|
R Aerie Peak|QID|26542|M|26.29,69.07;26.21,55.04;20.13,53.66;14.17,48.03|N|Follow the waypoints to Aerie Peak.|
T Hero's Call: The Hinterlands!|QID|26542|M|9.96,44.31|N|To Gryphon Master Talonaxe.|
...
h Wildhammer Keep|QID|26547|M|14.14,44.78|
...
C Skulk Rock Supplies|QID|26492|M|57.80,41.44|N|Look around inside the cave to find the Ooze-Coated Supply Crates.|
C Skulk Rock Clean-Up|QID|26491|M|58.29,40.76|N|Head back outside to finish killing any Jade Oozes you need.|
...
l All That Skitters|QID|26523|S|L|58120 8|N|Grab the spiders as you (you need Cool. They can be a little hard to grab since they are small and move aroud a lot.|
...
C All That Skitters|QID|26523|L|58120 8|M|68.55,70.21|N|Grab any spiders that you don't have.|
...
l Dark Vessels|QID|26524|S|L|19071 5|M|65.33,66.55|N|Grab any small, sparkling cauldron you see, you will need 5.|
...
C Death to the Vilebranch|QID|26498|M|60.44,71.43;64,71.25|N|After you free Ongo'longo go down 2 tiers. And kill any Shadowcaster and Berserker you see.|
C Dark Vessels|QID|26524|L|19071 5|M|65.33,66.55|N|Grab any small, sparkling cauldron you see, you will need 5.|
...
l Summit of Fate|QID|26517|L|58228 8|M|59.20,76.98|N|Talk to Doran and choose to ride Sharpbeak. Loot any Sacrificed Vilebranch you see to get the Spider Idols, you will need 8.|
...
K Hunt the Keeper|QID|26526|L|58241 |M|59.69,77.83;59.05,78.69;57.8,81.55;56.91,83.42;54.59,83.59|N|Head back up on Sharpbeak. Go into the cave, take the middle path at the split. Then take a right and follow the path back to Morta'gya. Kill her and loot the tablet from her.|
...
H Wildhammer Keep|QID|27725|N|Hearth back to Wildhamer Keep or run if your hearth is on cooldown.|
...
l Highvale Notes|QID|27626|M|29.63,48.67|N|Loot the Highvale notes from here.|
...
l The Eye of Shadra|QID|26528|L|58282|M|45.53,38.92|N|Loot The Eye of Shadra.|
...
C Starvation Diet|QID|26643|M|49.77,52.63|N|Hit any spider cacoon you see. Need to slay 6 of them.|
l The Fang of Shadra|QID|26529|M|49.47,52.28|N|Grab the fang from the chest.|
...
K Shadra the Venom Queen|QID|26532|M|34.21,69.46|N|Kill Shadra, the NPCs who come to help with take the brunt of her attacks.|
...
A Rescue OOX-09/HL!|QID|836|M|49.36,37.67|N|If you accept this quest, the turn-in is all the way in Booty Bay. To do the quest, Escort OOX-09/HL to safety, you will be ambushed once by 3 Wildkin.|
