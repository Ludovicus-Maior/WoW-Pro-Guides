...
h Firefly Tavern|QID|9777|M|78.50,63.00|N|Set your hearthstone to Cenarion Refuge.|
...
C Menacing Marshfangs|QID|9791|N|Kill Marshfang Rippers needed for this quest.|S|
...
l Withered Basidium|QID|9901|M|82.19,39.93|N|Kill Withered Giants until you get the Withered Basidium, it has quite a low drop chance so it might take a while.|L|24483|US|
A Withered Basidium|N|(UI Alert).|QID|9827|M|78.3,45.2|U|24483|
...
C An Unnatural Drought|QID|9783|N|Kill Withered Giants until you are finished this quest.|S|
...
; Umbrafen Lake
C Too Many Mouths to Feed|QID|9781|N|Kill the Hydras.|T|Mire Hydra|S|
...
C Too Many Mouths to Feed|QID|9781|M|72.24,63.39|N|Kill the rest of the Hydras needed for this quest in the lake.|US|T|Mire Hydra|
...
C Umbrafen Witchdoctor|QID|9747|QO|4|N|Get the Witchdoctor's first. They spawn in only a few places.|S|T|Umbrafen Witchdoctor|
K Kataru|ACTIVE|9747|QO|1|M|85.18, 90.92|N|Head up to the top of the building and slay Kataru|T|Kataru|
...
C Escape from Umbrafen|QID|9752|M|79.47,70.70|N|Do this Escort Quest. You will get ambushed twice by 2 Umbrafen each time.|
; Cenarion Refuge
...
C Saving the Sporeloks|QID|10096|N|Kill mobs until you are finished with this quest.|S|
C A Damp, Dark Place|QID|9788|M|70.53,97.91|N|After you enter the cave, go right at the first fork, then right again at the second fork and down the slope, Ikeyen's Belongings are down the bottom on top of a flat rock.|
C Safeguarding the Watchers|QID|9894|N|Kill Lord Klaq inside the cave.|M|72.00, 94.0|
C Saving the Sporeloks|QID|10096|N|Kill mobs until you are finished with this quest.|US|
; Cenarion Refuge
...
; Feralfen Village
C A Warm Welcome|QID|9728|N|Kill and loot Nagas for this quest.|S|
C Disturbance at Umbrafen Lake|QID|9716|M|69.40, 79.7|NC|N|Go to this spot to automatically finish this quest. Kill any Naga you come across as well.|
C Leader of the Darkcrest|QID|9730|M|65.00,69.0|N|Kill Rajah Haghazed.|
C The Boha'mu Ruins|QID|9786|M|44.20,68.9|NC|N|Go here to complete the quest.|
C Blacksting's Bane|QID|9896|M|49.84,59.74|N|Kill Blacksting and take his Stinger.|
C Leader of the Bloodscale|QID|9817|M|65.14,40.91|N|Kill Rajis Fyashe here.|
; Back to Telredor
T Umbrafen Eel Filets|QID|9780|M|67.7,48.0|N|To Noraani.|
T Too Many Mouths to Feed|QID|9781|M|67.7,48.0|N|To Haalrun.|
...
N Friends with the Cenarion Expedition|REP|Cenarion Expedition;942;neutral|N|Repeat this quest till you are friendly with the Cenarion Expedition|S|
...
C Blessings of the Ancients|QID|9785|M|78.1,63.8|N|Talk to Keleth and Ashyen, giants walking around, and get the marks from them.|
...
C As the Crow Flies|QID|9718|N|Use the Stormcrow Amulet to take a ride around the zone.|U|25465|
...
r Sell junk, repair, restock|QID|9728|M|79.27,63.78|N|Make sure you do not sell the Bog Lord Tendrils, Fertile spores and plant parts you have.|
U Umbrafen Lake Controls Disabled|QID|9720|QO|1|M|70.5,80.|N|Use the ironvine seeds on the control panel at Ubrafen.|U|24355|
U Lagoon Controls Disabled|QID|9720|M|63.10,64.1|QO|4|N|Go here and disable the pump with the Ironvine Seeds.|U|24355|
l Drain Schematics|AVAILABLE|9731|M|62.00,40.60;63.20,64.20;70.50,80.45;25.50,42.90|CN|N|Kill Steam Pump Overseers and loot the Schematics if he has it (10% chance). Use the Ironvine Seeds on the Control Console to get more Overseers to spawn. Repeat until you get the Drain Schematics.|L|24330|U|24355|
A Drain Schematics|QID|9731|M|62.0,40.8|N|Right click the Drain Schematics to start the quest.|U|24330|O|
C Drain Schematics|QID|9731|M|50.50,41.0|N|Go here and dive underwater a bit until you get the quest complete message.|
U Serpent Lake Controls Disabled|QID|9720|QO|3|M|62.00,41.0|U|24355|N|Use the Ironvine Seeds here.|
C A Warm Welcome|QID|9728|M|70.9,82.1|N|Finish killing and looting Nagas for their claws.|US|
T A Warm Welcome|QID|9728|M|79.1,65.3|N|To Warden Hamoot.|
N Plant Parts|QID|9724|M|80.4,64.2|N|Turn in any plant parts you have to Lauranna Thar'well.|
...
R Hellfire Peninsula|QID|9724|M|83.00, 65.0|N|Go to Hellfire Peninsula.|
...
H Cenarion Refuge|ACTIVE|9732|M|78.50,63.00|N|Hearth to Cenarion Refuge.|U|6948|
...
f Orebor Harborage|QID|9776|M|41.25, 29.0|N|Get the flight-path from Halu.|
...
C Ango'rosh Encroachment|QID|9835|N|Kill the Ogres needed for this quest.|S|
C Daggerfen Deviance|QID|10115|N|Kill the Daggerfen needed for this quest.|S|
l Secrets of the Daggerfen|QID|9848|QO|2|M|23.75,22.79|N|Go in this area and loot the Daggerfen Poison Vial.|L|24500|
C Secrets of the Daggerfen|QID|9848|QO|1|M|24.40,27.0|N|Go up the tower, and loot the manual from the ground.|
C WANTED: Chieftain Mummaki|QID|10116|M|23.8,26.8|N|Kill Mummaki and loot the item from him.|
C Daggerfen Deviance|QID|10115|M|24,27|N|Kill the Daggerfen needed for this quest.|US|
C Ango'rosh Encroachment|QID|9835|M|36.00,28.0|N|Kill the Ogres needed for this quest.|US|
...
C Diaphanous Wings|QID|9790|N|Kill bugs until you get the wings for this quest.|S|
...
l The Sporelings' Plight|QID|9739|N|Loot Mature Spore Sacs off the ground until you finish this quest.|L|24290 10|S|
C Observing the Sporelings|N|Go here to complete this quest.|M|13.00,60.0|QID|9701|
l The Sporelings' Plight|QID|9739|M|14.5,61.6|N|Loot Mature Spore Sacs off the ground until you finish this quest.|L|24290 10|US|
l Bog Lord Tendril|QID|9743|M|15.52,61.05|L|24291 6|N|Kill and loot Fungal Giants|US|
T Natural Enemies|QID|9743|M|19.1,63.9|N|To Fahssn.|
T The Sporelings' Plight|QID|9739|M|19.1,63.9|N|To Fahssn.|
N Neutral with Sporeggar|AVAILABLE|9919|M|19.1,63.9|REP|Sporeggar;970;unfriendly|N|You have to be Neutral with the Sporeggar for the next portion this can be done by handing in Bog Lord Tendrils, more Mature Spore Sacs, or by grinding on mobs in the dead mire.|
...
C Lines of Communication|QID|9833|N|Kill Slicers until you finish this quest.|S|
C A Question of Gluttony|QID|9702|M|27.00,63.0|N|Go here, killing giants on the way. Loot Discarded Nutriments off the ground until you get enough for this quest.|
...
C Lines of Communication|QID|9833|N|Kill Slicers until you finish this quest.|S|
l "Count" Ungula's Mandible|QID|9911|M|33.00,60.0|N|Go here and look for a mob called Count Ungula. Kill it and loot the mandible.|L|25459 1|T|"Count" Ungula|
A The Count of the Marshes|QID|9911|M|32.8,59.1|N|Right-click the Mandible to start the quest.|U|25459|
C Lines of Communication|QID|9833|M|32.8,59.1|N|Kill Slicers until you finish this quest.|US|
l Idols of the Feralfen|QID|9787|QO|1|M|49.60,59.7|N|Kill mobs and loot Idols off the ground until you finish this quest.|
C Natural Armor|QID|9834|M|50.00,40.0|N|Kill Fenclaw Trashers until you get the hides needed for this quest.|U|25539|
H Cenarion Refuge|ACTIVE|9787|M|78.59,62.87|N|Hearth to Cenarion Refuge.|U|6948|
N Sell junk, repair, restock, turn in plant parts|QID|9787|M|79.25, 63.7|N|Sell junk, repair, restock, turn in plant parts.|
...
F Orebor Harborage|QID|9834|M|67.80, 51.5|N|Fly to Orebor Harborage|
...
C Maktu's Revenge|QID|9905|M|42.00,42.00|N|Kill Mragash here.|
C Familiar Fungi|QID|9708|M|35.00,34.0|N|Kill ogres until you get the Mushroom Samples for this quest.|
C Stinger Venom|QID|9830|M|25.50,31.05|N|Kill Marshlight Bleeders and bee mobs until you get the items needed for this quest.|
C Diaphanous Wings|QID|9790|M|20.00,30.0|N|Kill mobs until you get the wings for this quest.|US|
C Balance Must Be Preserved|QID|9720|M|25.40,42.9|N|Go here and use the Ironvine Seeds to disable the pump.|U|24355|
C The Terror of Marshlight Lake|QID|9902|M|22.20,45.3|N|Kill Terrorclaw here, Terrorclaw can fear.|
T Sporeggar|QID|9919|M|19.7,52.1|N|To Msshi'fn.|
A Glowcap Mushrooms|QID|9808|M|19.7,52.1|N|From Msshi'fn. Will disappear if you are friendly with Sporeggar.|
C Glowcap Mushrooms|QID|9808|M|40.00,36.3|N|Get the rest of the glowcaps needed for this quest.|
T Glowcap Mushrooms|QID|9808|M|19.7,52.1|N|To Msshi'fn.|
...
A Fertile Spores|QID|9806|M|19.2,49.4|N|To Gshaff.|
C Gathering the Reagents|QID|9801|N|Kill and loot Marsh Walkers, Fen Striders and Sporebats, until you finish this quest.|S|
...
H Cenarion Refuge|ACTIVE|9720|M|78.56,62.82|N|Hearth to Cenarion Refuge.|U|6948|
T Balance Must Be Preserved|QID|9720|M|78.4,62.0|N|To Ysiel Windsinger.|
r Sell junk, repair, restock|QID|9801|M|79.23,63.7|N|Sell junk, repair, restock|
C Gathering the Reagents|QID|9801|M|63.00,51.0|N|Kill and loot Marsh Walkers, Fen Striders and Sporebats, until you finish this quest.|US|
...
T Diaphanous Wings|QID|9790|M|67.7,48.0|N|To Haalrun.|
F Orebor Harborage|QID|9902|M|67.80,51.4|N|Fly to Orebor Harborage.|
...
h Orebor Harborage|QID|9726|M|41.85,26.2|N|Set your hearthstone to Orebor Harborage.|
C Overlord Gorefist|QID|9839|QO|2|N|Kill the rest of the mobs needed for this quest.|S|
l Stealing Back the Mushrooms|QID|9709|QO|1|M|17.00,10.0|N|Loot mushrooms from the boxes scattered in the area. Can drop off of Ogres as well.|
K Overlord Gorefist|QID|9839|QO|1|M|18.00,8.0|N|Kill Overlord Gorefist, who is in a hut on top of the hill, not in the cave!|
C Overlord Gorefist|QID|9839|QO|2|M|18.00,8.0|N|Finish killing the rest of the mobs needed for this quest.|US|
C Now That We're Friends...|QID|9726|M|26.00,36.0|N|Kill Bloodscale Slavedrivers and Enchantresses needed for this quest.|
C Fertile Spores|QID|9806|M|20.00,16.0|N|Kill mobs until you get the spores for this quest.|
...
A Fhwoor Smash!|QID|9729|M|19.78,50.84|N|From Fhwoor.  This is an annoying escort quest, but needed to complete the "Mysteries of Zangarmarash".|
C Fhwoor Smash!|QID|9729|QO|1|N|Accompany Fhwoor, killing Naga along the way for [Now That We're Still Friends...]. Kill Ssslith when he attacks.|
T Fhwoor Smash!|QID|9729|M|19.54,50.04|N|To Gzhun'tt.|
C Now That We're Friends...|QID|9727|M|26.00,36.0|N|Kill Bloodscale Slavedrivers and Enchantresses needed for this quest.|
...
C Messenger to the Feralfen|QID|9803|M|44.00,66.0|CHAT|N|Go here and use Ahuurn's Elixir, then talk to Elder Kurutiin in the building, and go through the dialogue.|U|24428|
H Orebor Harborage|QID|9839|M|41.89,26.29|N|Hearth to Orebor Harborage.|U|6948|
...
F Telredor|QID|9803|M|41.30,29.0|N|Fly to Telredor.|
T Messenger to the Feralfen|QID|9803|M|68.2,49.4|N|To Anchorite Ahuurn.|
r Sell junk, repair, restock|QID|9803|M|68.5,50.14|N|Sell junk, repair, restock. Close this step to go to the next guide.|
