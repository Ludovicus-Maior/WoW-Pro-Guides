...
F Forrest Song|QID|99999|N|in Ashenvale|
...
T Hero's Call: Felwood!|QID|28543|M|51.20,80.49|N|To Tenell Leafrunner.|
...
C Ruumbo Demands Honey|QID|27989|U|62819|M|48.90,88.62|N|Kill Furblogs as you go.|
C Ruumbo Demands Justice|QID|27994|M|48.80,89.80|
C Culling the Corrupted|QID|28148|M|45.93,80.17|N|Kill Wolves and Bears for their pelts around the entrance of the Jadefire camp.|
...
A The Ruins of Kel'Theril|QID|28479|M|51.24,80.36|N|From Kelek Skykeeper.|
...
C Do the Imp-Possible|QID|28000|U|62899|M|47.63,72.93|
...
R Touch the Untouchable|QID|28044|U|62920|M|40.95,75.74|N|Run Here and use the item.|
C Touch the Untouchable|QID|28044|U|62920|M|42.02,79.30|
T Touch the Untouchable|QID|28044|M|41.95,71.95|
...
R Break the Unbreakable|QID|28113|U|63031|M|33.40,65.73|N|Run here and use the item.|
...
C Crying Violet|QID|28116|M|45.84,68.96|N|Can be hard to see, just keep your eyes open for sparkles.|
...
C Purity From Corruption|QID|28119|M|35.93,59.52|N|Kill the mobs that you need for "Forces of Jaedenar" on the way.|
T Purity From Corruption|QID|28119|M|35.92,59.62|
A Dousing the Flames of Protection|QID|28126|M|35.92,59.62|
C Forces of Jaedenar|QID|28121|M|35.90,59.85|N|IMPORTANT!! Complete this quest before you move onto the next. Players used to the old version of these quests might be tempted to go straight into the cave.|
T Forces of Jaedenar|QID|28121|M|35.87,59.83|
A The Inner Circle|QID|28128|M|35.87,59.83|
R Dousing the Flames of Protection|QID|28126|U|12906|M|36.17,58.23|N|Enter this building.|
...
R Dousing the Flames of Protection|QID|28126|U|12906|M|36.96,55.89|N|First Brazier is here. (click to complere)|
R Dousing the Flames of Protection|QID|28126|U|12906|M|37.28,54.92|N|Second Brazier is here. (click to complere)|
R Dousing the Flames of Protection|QID|28126|U|12906|M|37.38,53.16|N|Third Brazier is here. (click to complere)|
C Dousing the Flames of Protection|QID|28126|U|12906|M|38.21,52.54|N|Keep working your way deeper into the cave after this.|
...
R Shadow Lord Fel'dan|QID|28153|QO|Shadow Lord Fel'dan slain: 0/1|M|40.34,48.22|N|When you get here take the North Tunnel|
...
N If all your quests for here are complete...|QID|99999|N|(Which they should be) You should now click the portal Laughing out loud (Click to continue)|
...
T Whisperwind Grove|QID|28306|M|43.29,30.43|N|To Tender Puregrove.|
...
N You have...|QID|99999|N|A lot of quests now in a very small region of the map. As you progess south kill any Courers and Scrub any Squirrels you encounter. (Click to continue)|
C Squirrely Clean|QID|28361|M|45.54,34.17|
C Running their Course|QID|28360|M|44.04,34.65|
N Now that...|QID|99999|N|Your Squirrels shine and the Deers are dead. Carry on soulth killing all infernals, fire elementals and picking up Debris as you go. (Click to Continue)|
C Fel To Pieces|QID|28342|M|44.35,41.77|
C Collecting Corruption|QID|28341|M|44.32,43.12|
C Hunting the Damned|QID|28358|M|43.78,43.11|
...
U Nature and Nurture|QID|28229|U|63332|N|Use the item in the moonwell near the Quest giver. (Click to continue)|
C Nature and Nurture|QID|28229|M|48.67,25.14|N|Use your bottle of moonwell water here.|
...
R Wanted: The Demon Hunter|QID|28217|M|45.54,20.13|N|Talk to the "friendly" npc here.|
C Wanted: The Demon Hunter|QID|28217|M|45.40,20.30|
...
R Deceivers In Our Midst|QID|28261|U|63419|M|43.61,18.54|N|Climb up the cliff to this point, then put on the mask. (click to continue)|
...
R Navarax's Gambit|QID|28264|M|44.80,29.20|N|Talk to the Druid at the top of the Inn in Whisperwind Grove. (click to continue)|
C Navarax's Gambit|QID|28264|M|44.72,29.03|
...
R Borrowed Bombs|QID|28386|N|Entrance of the cave is here. (Click to Continue)|
...
A Wintersrping!|QID|28768|M|64.07,10.39|N|From Nafien.|
N And you are finished!|QID|99999|N|Great Job, Hope you liked Felwood. You now have three quests to take you into Winterspring. If you do not wish to go to Winterspring, you can abandon them.|
]]
