...
A Force Commander Danath |QID|10254|PRE|10140|LEAD|10141;10160|M|54.5,62.8|N|From Marshal Isildor.|
...
F Shatter Point |ACTIVE|10340|N|Talk to Wing Commander Dabir'ee and have him send you to Shatter Point. |M|71.40,62.50|
f Shatter Point |ACTIVE|10340|N|Get the flight-path.|M|78.4,34.9|
...
K Warbringer Arix'Amal |ACTIVE|10397|L|29795|N|The Warbringer is at the waypoint. Kill him and loot the key.|M|53.08,26.4|
...
A Fel Spirits |QID|10909|PRE|10903|M|54.3,63.6|U|31772|N|From Assistant Klatu.|
A Digging for Prayer Beads |QID|10916|PRE|10903|M|54.3,63.6|N|From Assistant Klatu.|
B Silken Thread|QID|10916|M|54.63,63.71|N|Head into the next room and buy a Silken Thread from Hama.|L|4291|QO|1|
B Fei Fei Doggy Treat|QID|10916|M|56.34,62.85|N|Buy a treat from Warrant Officer Tracy Proudwell.|L|31799|QO|1|
l Draenei Prayer Beads|QID|10916|QO|1|M|54.16,63.32|N|Give the treat to Fei Fei, then follow the dog. Loot Fei Fei's Cache (glittering dirt pile) once she stops at the waypoint.|L|31795|
r Sell junk, repair, restock |N|Sell junk, repair, restock  |M|54.65,63.53|AVAILABLE|10916|
...
l Eroded Leather Case |AVAILABLE|9373|N|Kill worms until you get an Eroded Leather Case.|L|23338|M|46.00,64.00|
...
A The Longbeards |QID|9558|PRE|10143+10483|LEAD|9417|LVL|60|M|54.3,63.4|N|From Sid Limbardi.|
...
K Lieutenant Commander Thalvos|QID|10057|QO|2|M|54.7,83.6|N|Kill Lieutenant Commander Thalvos.|
...
; Level 60 Section
R Temple of Telhamat|ACTIVE|10093|M|46.05,44.13;34.11,45.87;28.72,45.55;23.23,40.64|CC|N|Run to the Temple of Telhamat.|
f Temple of Telhamat|ACTIVE|10093|N|Get the flight path.|M|25.20,37.20|
T The Temple of Telhamat |QID|10093|M|23.4,36.5|N|To Amaan the Wise.|
A The Pools of Aggonar|QID|9426|LVL|60|M|23.4,36.5|N|From Amaan the Wise.|
A Deadly Predators |QID|9398|LVL|60|M|23.4,39.7|N|From Scout Vanura.|
A In Search of Sedai |QID|9390|LVL|60|M|23.1,40.3|N|From Anchorite Obadei.|
A Cruel Taskmasters |QID|9399|LVL|60|M|23.1,40.3|N|From Ikan.|
A The Rock Flayer Matriarch |QID|9490|LVL|60|M|23.1,40.3|N|From Ikan.|

T In Search of Sedai|QID|9390|M|26.89,37.42|N|To Sedai's Corpse.|
A Return to Obadei|QID|9423|PRE|9390|LVL|60|M|26.89,37.42|N|From Sedai's Corpse.|
...
A Avruu's Orb |N|Right-click the Orb to accept this quest.|QID|9418|U|23580|LVL|60|M|25.7,75.1|
...
A Makuru's Vengeance |QID|9424|PRE|9423|LVL|60|M|23.1,40.3|N|From Makuru.|
...
A Atonement |QID|9543|PRE|9424|LVL|60|M|23.1,40.3|N|From Anchorite Obadei.|
...
A Cleansing the Waters |QID|9427|PRE|9426|LVL|60|M|23.4,36.5|N|From Amaan the Wise.|
...
C Cleansing the Waters|N|Go here and use the Cleansing Vial, then kill Aggonis.|QID|9427|M|40.00,31.20|U|23361|
...
N Manni's Cage |N|Free Manni from his cage.|QID|10238|QO|1|M|45.10,41.10|
N Moh's Cage |N|Free Moh from his cage.|QID|10238|QO|2|M|46.41,45.09|
C How to Serve Goblins |N|Free Jakk from his cage.|QID|10238|QO|3|M|47.50,46.70|
...
C Shizz Work |U|30803|N|Use the Felhound Whistle to summon the Fel Guard Hound.  Kill boars to the west and then right-click on the Felhound Poo as it appears.  Do this until you get the key.|QID|10629|M|50.31,28.08|
...
C Sha'naar Relics |N|Grab the 10 relics needed for this quest.|QID|9430|M|15.1,55.7|S|
...
A A Traitor Among Us |QID|10367|LVL|60|M|16.3,65.1|N|From Naladu.|
...
A The Dreghood Elders |QID|10368|LVL|60|PRE|10367|M|16.3,65.1|N|From Naladu.|
C Free Morod |N|Free Morod here.|QID|10368|QO|1|M|13.10,61.00|
C Free Aylaan |N|Free Aylaan here.|QID|10368|QO|3|M|13.00,58.40|
C Free Akoru |N|Free Akoru here.|QID|10368|QO|2|M|15.50,58.75|
T The Dreghood Elders |QID|10368|M|16.3,65.1|N|To Naladu.|
A Arzeth's Demise |QID|10369|LVL|60|PRE|10368|M|16.3,65.1|N|From Naladu.|
...
C Sha'naar Relics |N|Grab the 10 relics needed for this quest.|QID|9430|M|15.1,55.7|US|QO|1|
...
; Level 61 Section
A Helping the Cenarion Post |QID|10443|LEAD|9372|LVL|61|M|23.4,36.5|N|From Amaan the Wise.|
A An Ambitious Plan |QID|9383|LVL|61|M|23.2,36.7|N|From Elsaana.|
...
A Demonic Contamination |QID|9372|LVL|61|M|15.7,52.0|N|From Thiah Redmane.|
A Keep Thornfang Hill Clear! |QID|10159|LVL|61|M|15.7,52.0|N|From Mahuram Stouthoof.|
A Colossal Menace |QID|10132|LVL|61|N|From Tola'thion.|M|15.59,52.13|
A The Cenarion Expedition |QID|9912|LVL|61|N|From Amythiel Mistwalker.|M|16.02,52.26|

C Colossal Menace |N|Kill Raging Colossi until you have all 5 kills. As they get low in health, they get smaller and Shardlings form.|QID|10132|M|15,45|
l Crimson Crystal Shard|QID|10134|N|Make sure you have one of these items from the giants.|L|29476|M|15,45|
A Crimson Crystal Clue|N|Right-click the Shard to start the quest.|QID|10134|LVL|61|M|15,45|U|29476|
T Colossal Menace|QID|10132|N|To Tola'thion.|M|15.62,52.12|
T Crimson Crystal Clue|QID|10134|N|To Tola'thion.|M|15.62,52.12|
A The Earthbinder |QID|10349|LVL|61|PRE|10134|N|From Tola'thion.|M|15.62,52.12|
T The Earthbinder |QID|10349|N|To Earthbinder Galandria Nightbreeze.|M|15.89,51.59|
A Natural Remedies |QID|10351|LVL|61|PRE|10349|N|From Earthbinder Galandria Nightbreeze.|M|15.89,51.59|
...
A Testing the Antidote |QID|10255|LVL|61|PRE|9372|M|15.7,52.0|N|From Thiah Redmane.|
