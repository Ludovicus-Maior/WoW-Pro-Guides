...
T Speak to Salfa |QID|8465|M|27.7,34.5|
T Mystery Goo |QID|5085|M|31.3,45.2|
A Toxic Horrors |QID|5086|M|31.3,45.2|
C Moontouched Wildkin |N|Get the rest of the Moontouched Feathers needed for this quest. | |QID|978|M|64.00,53.00|
R Felwood |N|Run through the tunnel to Felwood. |M|27.90,34.45|
...
C Retribution of the Light |N|Go inside Shadow Hold at 35, 58 (not the arrow) and kill Rakaiah (located at the arrow). (38.00, 50.00)| |QID|5204|
...
F Forest Song |QID|4261| |N|Fly to Forest Song. |M|62.30,36.60|
...
T Moontouched Wildkin |QID|978|M|55.5,92.0|
