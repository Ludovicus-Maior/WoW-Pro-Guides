...
T Secrets of the Tower|QID|26290|M|68.39,70.45|N|Leave the tower, then head back to Agent Kearnen.|
...
C Informational Pamphlet |QID|26295|M|41.59,66.41N|The back of the first building on right on entering Moonbrook from the Flight Master.|QO|Informational Pamphlet: 1/1|NC|
...
C Evidence Collection|QID|26296|RANK|2|US|M|45.53,70.95|N|Finish killing the Thugs.|
...
R Defias Hideout|QID|26320|M|40.86,81.98|N|Enter the Defias Hideout.|
...
H Sentinel Hill |QID|26371|N|Hearthstone back to Sentinel Hill.|
...
F Moonbrook |QID|26371|N|Fly to Moonbrook.|
...
C The Coast Isn't Clear|QID|26348|M|33.63,84.34|US|N|Finish killing Murloc Tidehunters and Oracles.|
...
T Captain Sanders' Hidden Treasure|QID|26355|RANK|2|M|40.65,17.05|N|To the Old Jug.|
...
T The Coastal Menace|QID|26349|M|30.53,85.55|N|To Captain Grayson.|S|
...
T The Coastal Menace|QID|26349|M|30.53,85.55|N|To Captain Grayson.|US|

H Sentinel Hill|QID|26347|NC|M|56.45,47.57|N|Hearth to, or otherwise head back to Sentinel Hill.|
