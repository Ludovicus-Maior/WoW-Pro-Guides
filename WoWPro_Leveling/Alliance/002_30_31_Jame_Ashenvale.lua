...
N A Donation of Wool |QID|10352| |N|Turn in 60 Wool Cloth to the NPC in Craftsmen's Terrace. | |Z|Darnassus|M|64.00,23.10|
...
T Velinde's Effects |QID|1038|M|61.8,39.2|
A The Barrens Port |QID|1039|M|61.8,39.2|
...
R The Barrens |QID|1100| |N|Run to The Barrens by taking the path northwest (look on the map). (29.00, 47.00)| |Z|Dustwallow Marsh|
...
N Henrig Lonebrow's Journal |QID|1100| |N|Get Henrig Lonebrow's Journal from the body.  It is very small (you have to click on the book itself and not the body) so look carefully for it on the body. (30.70, 24.40)| |L|5791 1| |Z|Thousand Needles|
A Lonebrow's Journal |N|Right-click the journal to get this quest. | |QID|1100|M|30.7,24.3|
T Lonebrow's Journal |N|Turn in Lonebrow's Journal in Thalanaar. | |QID|1100|M|8.1,19.0|
...
T The Barrens Port |QID|1039|M|63.4,38.5|
A Passage to Booty Bay |QID|1040|M|63.4,38.5|
b Booty Bay |QID|1040| |N|Take the boat to Booty Bay. | |Z|The Barrens|M|63.65,38.65|
T Passage to Booty Bay |QID|1040|M|27.4,74.1|
A The Caravan Road |QID|1041|
...
T The Caravan Road |QID|1041|
A The Carevin Family |QID|1042|
T The Carevin Family |N|Turn in your quest to Jonathan Carevin. | |QID|1042|
A The Scythe of Elune |QID|1043|
A Worgen in the Woods (part 3) |N|Get [31] Worgen in the Woods from Calor if you do not have it already (Requires killing 8 Nightbane Vile Fang and 8 Nightbane Tainted One).  If you cannot get this quest, skip it. | |QID|222|M|75.7,47.6|
...
C Worgen in the Woods (part 3) |N|Finish Worgen in the Woods if you have it. | |QID|222|
N Experience Check |QID|1043| |N|Make sure you are about 75% or more of the way to level 31.|
T Worgen in the Woods (part 3) |QID|222|M|75.7,47.6|
A Worgen in the Woods (part 4) |QID|223|M|75.7,47.6|
T Worgen in the Woods (part 4) |QID|223|M|75.3,48.7|
T The Scythe of Elune |QID|1043|
A Answered Questions |QID|1044|
