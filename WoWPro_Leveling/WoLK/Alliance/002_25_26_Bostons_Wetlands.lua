local guide = WoWPro:RegisterGuide("BosWet2526", "Leveling", "Wetlands", "Boston", "Alliance", 3)
WoWPro:GuideNickname(guide, "Wetlands")
WoWPro:GuideName(guide, "Wetlands")
WoWPro:GuideNextGuide(guide, "BosRed2627")
...
b Stormwind City |QID|473|N|Take the boat to Stormwind City |Z|Darkshore|M|32.40,43.75|
N Train new skills |QID|473|N|Go train new skills and visit the AH if you wish. Close this step when you're done.|
F Menethil Harbor |QID|473|N|Fly to Menethil Harbor |Z|Stormwind City|M|71.00,72.50|
N Level 25 |QID|473|N|You should be level 25 or close. If you are behind it's not a problem, keep on following the guide but kill more stuff on the way. Close this step.|
...
A Search More Hovels |QID|285|M|13.6,38.2|
T Search More Hovels |QID|285|M|13.9,34.8|
A Return the Statuette |QID|286|M|13.9,34.8|
T War Banners |N|On the 2nd floor of the keep.|QID|464|M|9.9,57.5|
T Apprentice's Duties |QID|471|M|8.5,55.7|
T Return the Statuette |QID|286|M|8.3,58.6|
