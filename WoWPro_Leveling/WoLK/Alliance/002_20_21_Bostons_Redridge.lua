local guide = WoWPro:RegisterGuide("BosRed2021", "Leveling", "Redridge Mountains", "Boston", "Alliance", 3)
...
WoWPro:GuideLevels(guide, 20, 21)
...
R Elwynn Forest |QID|126|N|Go to Elwynn Forest.|Z|Stormwind City|M|66.35, 77.51;74.76,93.41|
...
C Selling Fish |N|Kill Murlocs until you get the items for this quest.|QID|127|M|38.23,51.25; 40.00,45.00|
C Murloc Poachers |N|Kill Murlocs until you get the items for this quest.|QID|150|M|40.00,45.00|


C The Everstill Bridge |N|Kill Gnolls until you get the items for this quest.|QID|89|M|37.41,50.35; 38.00,32.00|

C A Baying of Gnolls |N|Kill Gnolls until you finish this quest.|QID|124|M|38.00,32.00|

C Blackrock Menace |N|Kill Orcs until you get the items for this quest.  Also kill Black Dragon Whelps on sight and loot their scales.|QID|20|M|47.46,29.39; 42.10,12.40|

C Underbelly Scales |N|Kill Whelps until you get the items for this quest.|QID|122|M|43.00,31.60; 44.00,39.00; 34.5,72.5|
