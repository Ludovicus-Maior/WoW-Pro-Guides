local guide = WoWPro:RegisterGuide("JamStr4244", "Leveling", "Stranglethorn Vale", "Jame", "Alliance", 3)
WoWPro:GuideNickname(guide, "Stranglethorn Vale")
WoWPro:GuideName(guide, "Stranglethorn Vale")
WoWPro:GuideNextGuide(guide, "JamSwa4445")
WoWPro:GuideLevels(guide, 42, 44)
