local guide = WoWPro:RegisterGuide("JamAra4041", "Leveling", "Arathi Highlands", "Jame", "Horde", 3)
WoWPro:GuideNickname(guide, "Arathi Highlands")
WoWPro:GuideName(guide, "Arathi Highlands")
WoWPro:GuideNextGuide(guide, "JamBad4141")
WoWPro:GuideLevels(guide, 40, 41)
