WoWPro_Leveling:RegisterGuide("JamEDK5859", "Eastern Plaguelands", "Jame DK", "58", "59", "JamWDK5960", "Horde", function()
return [[
...
A Pamela's Doll |QID|5149|N|Go southeast to Darrowshire |M|32.5,83.8|
...
C Pamela's Doll |QID|5149|U|12886|N|Right click the item |M|35.44,82.86|
T Pamela's Doll |QID|5149|N|Pamela Redpath|M|32.5,83.8|
A Auntie Marlene |QID|5152|M|32.4,83.7|
A Uncle Carlin |QID|5241|M|32.4,83.7|

K Plaguehound Runt |QID|5542|QO|Plaguehound Runt slain: 20/20|N|Go in circles around The Marris Stead killing everything until you got 30 Plaguebat and 20 Plaguehound Runts slain and have looted 15 Slabs of Carrion Worm Meat|M|25.1,63.1|
...
T Uncle Carlin |QID|5241|N|Ride to Light's Hope Chapel|M|75.7,53.8|
A Defenders of Darrowshire |QID|5211|M|75.7,53.8|
A Bonescythe Digs |QID|9126|
A Zaeldarr the Outcast |QID|6021|N|Just a bit south of Light's Hope Chapel find Caretaker Alen|
...
N Quel'Thalas Registry |L|15847|N|Ride north to the Quel'Lithien Lodge and clear yourself a path to the main building. Towards the right-hand wing are two Quel'Lithien Protectors, kill them and then loot the Quel'Thalas Registry |M|47.51,14.12|
