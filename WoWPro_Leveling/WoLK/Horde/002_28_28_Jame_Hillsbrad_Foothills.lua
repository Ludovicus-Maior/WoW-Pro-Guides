local guide = WoWPro:RegisterGuide("JamHil2828", "Leveling", "Hillsbrad Foothills", "Jame", "Horde", 3)
WoWPro:GuideNickname(guide, "Hillsbrad Foothills")
WoWPro:GuideName(guide, "Hillsbrad Foothills")
WoWPro:GuideNextGuide(guide, "JamTho2830")
WoWPro:GuideLevels(guide, 28, 28)
