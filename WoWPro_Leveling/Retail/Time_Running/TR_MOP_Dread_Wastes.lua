local guide = WoWPro:RegisterGuide('TR_Dread Wastes', "Leveling", 'Dread Wastes', 'WoWPro Team', 'Neutral')
...
T By the Sea, Nevermore|QID|31089^31682|M|43.3,63.5|N|To Kaz'tik the Manipulator.|
