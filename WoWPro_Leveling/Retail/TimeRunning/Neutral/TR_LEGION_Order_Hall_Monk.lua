local guide = WoWPro:RegisterGuide('TR_EmmLegionMonk', 'Leveling', 'MonkOrderHallTheWanderingIsle', 'WoWPro Team', 'Neutral')
...
;quest missing The Peak of Serenity - Begin Your Training|QID|31586| somewhere before you leave Peak of serenity I picked it up and did it, but missed turning it in and it is not in the guide (It looks to be the same as Before the Storm)
...
C Before the Storm|QID|12103|M|57.56,45.75|Z|Dalaran@Dalaran70|N|Use Zen Pilgrimage to travel to the Peak of Serenity.|QO|2|NC|LVL|11|
C Before the Storm|QID|12103|M|55.94,22.47|Z|0627; Dalaran!Broken Isles|QO|1|FACTION|HORDE|N|Use Dalaran Portal to travel to Peak of Serenity|LVL|-11|
C Before the Storm|QID|12103||QO|1|M|38.91,64.32|Z|0627; Dalaran!Broken Isles|FACTION|ALLIANCE|N|Use Dalaran Portal to travel to Peak of Serenity|LVL|-11|
C Before the Storm|QID|12103|M|44.88,27.76|Z|0424; Pandaria|N|Talk to Master Hight to start a solo scenario.|QO|3|CHAT|
C The Council of Masters|ACTIVE|12103|SO|1|M|44.88,27.76|Z|0424; Pandaria|N|Assist and Listen to the Dialog.|
C Assist Master Crane|ACTIVE|12103|SO|2|M|43.48,27.60|Z|0424; Pandaria|N|Assist Master Crane in Cave of the Crane.|T|Vizznak|CS|
C Access the west temple grounds|ACTIVE|12103|SO|3|M|43.87,27.35|Z|0424; Pandaria|N|Click on Number Nine Jia to take a chi powered ride.|H|
C Rescue Chen Stormstout|ACTIVE|12103|SO|4|M|45.55,25.77|Z|0424; Pandaria|N|Assist Chen kill more demons.|T|Morvath the Reaver|
C Children Rescued|ACTIVE|12103|SO|5|M|45.29,27.07|Z|0424; Pandaria|N|Lead the children to safety, killing demons as you go.|
C Defeat Portal Master Jorvinax|ACTIVE|12103|SO|6|M|44.69,26.74|Z|0424; Pandaria|N|Fight Portal Master Jorvinax.|T|Portal Master Jorvinax|
C Portal Problems|ACTIVE|12103|SO|7|QO|4|M|44.60,26.46|Z|0424; Pandaria|NC|N|Click on the crystal to destroy the portal and be teleported back to The Wandering Isle.|
R Temple of Five Dawns|ACTIVE|12103|M|51.39,54.39|Z|0709; The Wandering Isle!Instance709|N|Run up the hill to the temple.|
T Before the Storm|QID|12103|M|51.39,54.39|Z|0709; The Wandering Isle!Instance709|N|To Fearsome Jang.|
A The Dawning Light|QID|40236|M|51.39,54.40|Z|0709; The Wandering Isle!Instance709|N|From Fearsome Jang.|PRE|12103|
C The Dawning Light|QID|40236|M|51.52,48.6|Z|0709; The Wandering Isle!Instance709|N|Follow Jang up the stairs and listen.|NC|
T The Dawning Light|QID|40236|M|51.39,48.38|Z|0709; The Wandering Isle!Instance709|N|To Iron-Body Ponshu.|
A Prepare To Strike|QID|40636|M|51.39,48.38|Z|0709; The Wandering Isle!Instance709|N|From Iron-Body Ponshu.|PRE|40236|
C Prepare To Strike|QID|40636|M|51.39,48.38|Z|0709; The Wandering Isle!Instance709|N|Choose which artifact path you want, the next one will be available when you finish the first zone (lvl 101/102).|NC|
T Prepare To Strike|QID|40636|M|51.39,48.38|Z|0709; The Wandering Isle!Instance709|N|To Iron-Body Ponshu.|
A Artifact Specific Quest|QID|42762^41003^40569|M|51.39,48.36|Z|0709; The Wandering Isle!Instance709|N|From Iron-Body Ponshu.|PRE|40636|
A Inner Sanctuary|QID|44249|LVL|15|M|50.33,59.14|N|From Caydori Brightstar. Your class hall has a gift for you.|
...
T Two Paths, Two Weapons|QID|43973|M|51.39,48.38|N|To Iron-Body Ponshu and then accept the artifact quest also from Iron-Body Ponshu.|

;3rd spec artifact
A Three Paths, Three Weapons|QID|44424|CCOUNT|2;42765;41003;40570|M|51.39,48.38|N|From Iron-Body Ponshu.|
C Three Paths, Three Weapons|QID|44424|M|51.40,48.38|NC|N|Choose your third aftifact weapon. |
T Three Paths, Three Weapons|QID|44424|M|51.40,48.38|N|To Iron-Body Ponshu and then accept the artifact quest also from Iron-Body Ponshu.|
...
A Brewnaster Hidden Appearance|QID|43974^43661|PRE|42765|M|55.05,55.96|Z|0709; The Wandering Isle!Instance709|S!US|L|139561|N|Tap the Bubbling Keg daily for a chance to receive your hidden appearance.|
U Brewmaster Hidden Appearance|QID|43661|O|U|139561|N|Click the item, you must be in Brewmaster spec.|
A Mistweaver Hidden Appearance|QID|43662|PRE|41003|S!US|L|139562|N|Drops from the third encounter (Dragons of Nightmare) in Emerald Nigtmare raid on any difficulty.|
U Mistweaver Hidden Appearance|QID|43662|O|U|139562|N|Click the item, you must be in Mistweaver spec.|
A Windwalker Hidden Appearance|QID|43663|PRE|40570|S!US|L|139563|N|Drops from the final chest in the Withered Army Training.|
U Windwalker Hidden Appearance|QID|43663|O|U|139563|N|Click the item, you must be in Windwalker spec.|
...
T The Defense of Tian Monastery|QID|41728|M|39.19,24.73|Z|0371; The Jade Forest|N|To Taran Zhu.|
A Desperate Strike|QID|41730|M|39.19,24.73|Z|0371; The Jade Forest|N|From Taran Zhu.|PRE|41728|
A Storm, Earth, and Fire|QID|41731|M|39.19,24.73|Z|0371; The Jade Forest|N|From Taran Zhu.|PRE|41728|
...
;post class campaign
A The Power Within|QID|43496|PRE|43359|M|51.71,48.58|N|From Image of Kalec. This appears up to 48 hours after you finish class order campaign This quest chain is for an artifact appearance and is covered in the [Color=7eff8a] Balance of Power [/color] guide.|;prereq seems to be finishing class hall campaign. (and maybe something else... much discussion on wowhead)

;fresh lvl 25? quests  (Old 110)
A Khadgar's Discovery|QID|39985|LEAD|39986|LVL|25|M|60.92,44.73|N|From UI Alert the next time enter Dalaran after reaching level 25.|
A Goddess Watch Over You|QID|44337|LVL|45|M|51.50,48.41|N|From a floating pink ball which is apparently Archmage Khadgar and appears when you enter your class hall for the first time after reaching level 45. The full quest chain is covered in a separate guide called [Color=7eff8a] Light's Heart [/color] and awards a variation for your artifact weapons.|
...
K Kill Dravax|ACTIVE|41850|M|65.41,57.59|Z|Stormheim|T|Dravax|L|136406|N|Kill and loot the key from Dravax.|
...
C Zero to Hiro|QID|41853|QO|1|M|67.16,64.03|Z|Stormheim|NC|N|Pickup a keg of Stormbrew. Click on a 2nd one for a nice buff while you are here.|
C Zero to Hiro|QID|41853|QO|2|M|66.68,70.32|Z|Stormheim|NC|N|Free Hiro by clicking on his cage.|
...
;Moratori took care of this. B Stonehide Leather|ACTIVE|41911|N|Beg, Buy or Trade... or skin them yourself. However you choose to aquire the Stonehide leather.|L|124113 20|
...
C Amaranthine Hops|QID|41911|M|55.12,73.08;56.33,73.89|CS|Z|Val'sharah|N|Down the ramp into the inn, to meet Fleuris Asterleaf.|ACTIVE|41911|
;gone in remix A Making A Trade|QID|43151|M|56.33,73.89|Z|Val'sharah|N|To Fleuris Asterleaf.|
...
C Storm Brew|QID|41087|QO|4|M|25.91,68.06|H|N|Click on the ingredients by the cauldren.|
...
N On to Broken Shore|QID|47137|N|For another champion and class mount, come back to this guide at some point after you finish Champions of Legionfall in Broken Shore.|

;BREWMASTER
;A The Wanderer's Companion|QID|42762|M|51.39,48.36|Z|0709; The Wandering Isle!Instance709|N|From Iron-Body Ponshu.|PRE|40636|
C The Wanderer's Companion|QID|42762|M|47.14,47.74|Z|0709; The Wandering Isle!Instance709|N|Go out the side door, and talk to Tak Tak to take the flight to Tien Monestary.|CHAT|
...
C The Trial at the Temple|QID|42765|QO|1|M|55.42,58.37|Z|0371; The Jade Forest|N|Talk to the Monkey King to start the solo scenario. and then go talk to Master Windsong.|CHAT|
C Crisis in the Temple|ACTIVE|42765|M|37.66,44.92|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Listen to Master Windsong.|SO|1|NC|
C Gate to the Scrollkeepers Sanctum|ACTIVE|42765|M|33.18,54.42|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Click on the Gate.|SO|2;1|H|
C Scribes Rescued|ACTIVE|42765|M|47.8,70.17|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Kill the demons to rescue the scribes.|SO|2;2|
C Belphiar Slain|ACTIVE|42765|M|27.92,72.72|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Kill Belphiar.|SO|3|T|Belphiar|
C Priestess Summerpetal revived|ACTIVE|42765|M|31.03,73.75|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Click on the priestess.|SO|4|NC|
C Monkey King followed|ACTIVE|42765|M|54.79,85.32;54.41,74.08;47.44,68.53;49.13,60.38|CS|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Follow the Monkey King outside and around/down to next fight.|SO|5|NC|
C Legion Attackers Defeated|ACTIVE|42765|M|47.0,48.28|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Kill more demons. Waves and Waves of demons.|SO|6;1|
C Yu'lon Must Survive|ACTIVE|42765|M|47.0,48.28|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Keep killing demons.|SO|6;2|
C Lord Korithis Defeated|ACTIVE|42765|M|69.12,59.2|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Kill Kord Korithis.|SO|7|T|Lord Korithis|
C Fu Zan reclaimed|ACTIVE|42765|M|70.79,60.83|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Pick up the weapon. Afterwards talk to Yu;lon for a ride home.|SO|8|NC|;added the sentance about talking to Yu'lon because the next line isnt going active.
C The Wanderer Awakens|ACTIVE|42765|M|70.79,60.83|Z|0791; Temple of the Jade Serpent!Dungeon791|N|Chat with Yulon for a ride.|CHAT|IZ|791|;Still doesnt pop up after removing the SO tag
...
C Heal Taran Zhu|ACTIVE|41003|M|92.05,55.91|Z|TerraceofEndlessSpringScenario|N|Heal Taran Zhu to full health,|SO|1;1|NC|  ; wp where gives Terrace of Endless Spring!Instance728
C Free the Shado Pan|ACTIVE|41003|M|78.96,48.76|Z|TerraceofEndlessSpringScenario|N|If you want, you can free them during the fight, or when the fight ends they will be automatically freed.|SO|2|
C Prepare To Strike|ACTIVE|41003|M|58.97,45.45|Z|TerraceofEndlessSpringScenario|N|Talk to each of them, Taren Zhu last.|SO|3|NC|
C Talk to Taran Zhu|ACTIVE|41003|M|58.97,45.45|Z|TerraceofEndlessSpringScenario|N|After you talk to Taran Zhu the fight starts.|SO|4|
C Acquire Sheilun|QID|41003|M|39.15,48.83|Z|TerraceofEndlessSpringScenario|N|Pick up staff.|QO|2|NC|
...
C Into the Skies|ACTIVE|40570|SO|1||M|30.84,45.08|Z|Skywall!Dungeon|N|Lead Li Li and protect her.|
C Running in the Clouds|ACTIVE|40570|SO|2|M|30.38,46.99;30.61,52.69;30.73,48.80|CS|Z|Skywall!Dungeon|N|The green whirlwinds speed your progress up the ramp.|NC|
C Destroy Stormtouched Orbs|ACTIVE|40570|SO|3;1|M|32.57,52.55;29.25,55.05;25.47,60.24|Z|Skywall!Dungeon|N|Click on the orbs to destroy them.|CS|
C Raging Winds Bypassed|ACTIVE|40570|SO|3;2|M|26.77,59.97;28.81,62.38|CN|Z|Skywall!Dungeon|N|Kill the Scion of Typhinius and then use Flying Serpent Kick to pass over the winds.|
C Defeat the minions of Typhinius|ACTIVE|40570|SO|4|M|32.09,66.64|Z|Skywall!Dungeon|N|Defeat the four waves of minions summoned by Typhinius.|
C Leap upon Zaurac|ACTIVE|40570|SO|5||M|31.09,66.64|Z|Skywall!Dungeon|V|N|Leap upon Zaurac.|
C Defeat Typhinius|ACTIVE|40570|SO|6|M|35.65,82.55|Z|Skywall!Dungeon|T|Typhinius|N|Defeat Typhinius|
C Take the Fists of the Heavens|ACTIVE|40570|SO|7|M|35.75,82.91|Z|Skywall!Dungeon|NC|N|Take the Fists of the Heavens|
...
C Panic at the Brewery|ACTIVE|45404|SO|1|M|31.14,48.28|Z|0873; Floor 1@Stormstout Brewery!Dungeon|H|N|Click on the door.|
C Detoxification|ACTIVE|45404|SO|2;1|M|20.05,54.91|Z|StormstoutBreweryScenario/2|S|NC|N|Use your Detox spell on the brewers.|
C Detoxification|ACTIVE|45404|SO|2;2|M|20.05,54.91|Z|StormstoutBreweryScenario/2|NC|N|Click on the barrels of Storm Brew.|
C Detoxification|ACTIVE|45404|SO|2;1|M|20.05,54.91|Z|StormstoutBreweryScenario/2|US|NC|N|Use your Detox spell on the brewers.|
C Maniacal Laughter...|ACTIVE|45404|SO|3|M|17.37,54.51;23.66,25.41|CS|Z|0874; Floor 2@Stormstout Brewery!Dungeon|N|Break down to front doors to get outside.|
C Chug It!|ACTIVE|45404|SO|4|M|29.88,47.11|Z|0872; Stormstout Brewery!Dungeon|N|Drink the Storm Brew. You won't explode. Unless you are secretly a demon...This will probably finish before you can find the brew.|
C Demon Overload|ACTIVE|45404|SO|5|M|36.52,35.36;45.63,46.92;64.48,30.46|CN|Z|0872; Stormstout Brewery!Dungeon|H|N|Close the legion portals to stop the attack on the brewery!|
C Brewmasters Attack!|ACTIVE|45404|SO|6|M|35.90,36.01|Z|0872; Stormstout Brewery!Dungeon|S|N|Step on the blue circle for a quick jump to the porch Blanche is on. Be ready to fight.|
C Panic at the Brewery|ACTIVE|45404|M|71.65,39.65|Z|0872; Stormstout Brewery!Dungeon|CHAT|N|Talk to Brewer Almai to return.|
...
T Hope For a Cure|QID|46320|M|50.49,57.89|N|To Spirit of Brewmaster Blanche. Zen Pilgrimage or otherwise return to your order hall.|
A Not Felling Well|QID|45442|M|50.49,57.89|N|From Spirit of Brewmaster Blanche.|PRE|46320|
C Not Felling Well|QID|45442|M|50.44,57.91|QO|1|H|N|Click on the still to produce the Curative Brew.|
C Not Felling Well|QID|45442|M|52.87,57.88|QO|2|H|N|Click on the Fel-Poisoned Initiates to cure them.|
...
C A Time for Everything|QID|45771|M|51.38,48.41|H|N|Click on Iron-Body Ponshu to cure him.|
...
; - not in remix A Further Advancement|QID|46785|M|52.78,59.80|N|From Master Hsu.|PRE|45771|
...
;legionfall mount
A Master Who?|QID|46353|PRE|45790|M|44.99,61.92|Z|0646; Broken Shore|N|You can now return to Broken Shore for the mount quest from Yiska. Tak Tak offers a ride.|
P Morning Breeze Village|ACTIVE|45790|M|50.05,47.04;45.15,51.49;30.94,43.41|CS|Z|0709; The Wandering Isle!Instance709|N|Use Zen Pilgrimage to return to your Order Hall, then step into the pale blue beam of light for to access the uppermost floor and the path to Master Bu.|
T Master Who?|QID|46353|M|32.33,43.45|Z|0709; The Wandering Isle!Instance709|N|To Mastedr Bu.|
A The Tale of Ban-Lu|QID|46341|PRE|46353|M|32.33,43.45|Z|0709; The Wandering Isle!Instance709|N|From Mastedr Bu.|
C The Tale of Ban-Lu|QID|46341|M|32.33,43.45|Z|0709; The Wandering Isle!Instance709|N|Wait and listen.|
T The Tale of Ban-Lu|QID|46341|M|32.38,43.05|Z|0709; The Wandering Isle!Instance709|N|To Mastedr Bu.|
C Return to the Broken Peak|QID|46342|M|49.99,54.42|Z|0709; The Wandering Isle!Instance709|N|Return to your order hall then take the portal to the Peak of Serenity.|
A Return to the Broken Peak|QID|46342|PRE|46341|M|32.38,43.05|Z|0709; The Wandering Isle!Instance709|N|From Mastedr Bu.|
T Return to the Broken Peak|QID|46342|M|47.34,41.67|Z|0379; Kun-Lai Summit|N|To Master Bu.|
A The Trail of Ban-Lu|QID|46343|PRE|46342|M|47.34,41.67|Z|0379; Kun-Lai Summit|N|From Master Bu.|
C The Trail of Ban-Lu|QID|46343|QO|1|M|47.01,40.58|Z|0379; Kun-Lai Summit|H|N|Go down and click the first paw print.|
C The Trail of Ban-Lu|QID|46343|QO|2|M|46.03,40.12|Z|0379; Kun-Lai Summit|H|N|Go around the lake and click the one of the next paw prints.|
C The Trail of Ban-Lu|QID|46343|QO|3|M|46.36,42.43|Z|0379; Kun-Lai Summit|H|N|The next set are at the top of the hill.|
C The Trail of Ban-Lu|QID|46343|QO|4|M|46.68,45.09|Z|0379; Kun-Lai Summit|H|N|The final set are just over the ridge line.|
T The Trail of Ban-Lu|QID|46343|PRE|46342|M|47.92,48.87|Z|0379; Kun-Lai Summit|N|To Master Bu.|
A Smelly's Luckydo|QID|46344|PRE|46343|M|47.96,49.10|Z|0379; Kun-Lai Summit|N|From Smelly Mountaintop.|
C Smelly's Luckydo|QID|46344|M|50.63,49.61|Z|0379; Kun-Lai Summit|N|Go kill hozen until you find all the parts of his luckydo.|
T Smelly's Luckydo|QID|46344|M|47.96,49.10|Z|0379; Kun-Lai Summit|N|To Smelly Mountaintop.|
A The Shadow of Ban-Lu|QID|46346|PRE|46344|M|47.92,48.87|Z|0379; Kun-Lai Summit|N|From Master Bu.|
R Shado-Pan Monastery|ACTIVE|46346|M|39.99,46.99|Z|0379; Kun-Lai Summit|N|You can fly there, you don't have to follow the road.|
T The Shadow of Ban-Lu|QID|46346|M|36.53,48.25|Z|0379; Kun-Lai Summit|N|To Master Bu.|
A Clean-up on Aisle Sha|QID|46347|PRE|46346|M|36.53,48.25|Z|0379; Kun-Lai Summit|N|From Master Bu.|
C Clean-up on Aisle Sha|QID|46347|QO|1|M|36.75,47.61|Z|0379; Kun-Lai Summit|CHAT|N|Talk to Commander Shen-li for entrance to the monastery.|
C Clean-up on Aisle Sha|QID|46347|QO|2|M|35.90,42.09|Z|0379; Kun-Lai Summit|N|Run around stomping on all the sha-lings. a few will become bigger and you will need to fight them.|
C Clean-up on Aisle Sha|QID|46347|QO|3|M|36.74,47.57|Z|0379; Kun-Lai Summit|CHAT|N|You can go over the mountain and run along the side of the building to get back to him.|
T Clean-up on Aisle Sha|QID|46347|M|36.53,48.25|Z|0379; Kun-Lai Summit|N|To Master Bu.|
A The River to Ban-Lu|QID|46348|PRE|46347|M|36.53,48.25|Z|0379; Kun-Lai Summit|N|From Master Bu.|
R Inkgill Mere|ACTIVE|46348|M|74.38,88.70|Z|0379; Kun-Lai Summit|N|Good thing we can fly, that would be a long run.|
T The River to Ban-Lu|QID|46348|M|74.38,88.70|Z|0379; Kun-Lai Summit|N|To Water Speaker Ryuli.|
A Lilies for Ryuli|QID|46349|PRE|46348|M|74.38,88.70|Z|0379; Kun-Lai Summit|N|From Water Speaker Ryuli.|
R Temple of the White Tiger|ACTIVE|46349|M|73.26,48.64|Z|0379; Kun-Lai Summit|N|Fly up to the lake behind the Temple of the White Tiger.|
C Lilies for Ryuli|QID|46349|M|74.88,47.61|Z|0379; Kun-Lai Summit|H|N|Gather Lilies.|
T Lilies for Ryuli|QID|46349|M|74.38,88.70|Z|0379; Kun-Lai Summit|N|To Water Speaker Ryuli.|
A The Trial of Ban-Lu|QID|46350|PRE|46349|M|74.38,88.70|Z|0379; Kun-Lai Summit|N|From Water Speaker Ryuli.|
C The Trial of Ban-Lu|QID|46350|M|23.50,35.06|Z|0371; The Jade Forest|N|After some dialog, you prove yourself to Ban-Lu.|
P Temple of Five Dawns|ACTIVE|46350|M|PLAYER|N|Use Zen Pilgrimage to return to your order hall.|
R Shrine of Inner Light|ACTIVE|46350|M|51.47,43.74;46.05,20.91|CS|Z|0709; The Wandering Isle!Instance709|N|Run out the north gate and follow the road to find Ban-Lu.|
T The Trial of Ban-Lu|QID|46350|M|41.58,25.14|Z|0709; The Wandering Isle!Instance709|N|To Ban-Lu.|
N Congrats on the new mount.|N|and this concludes the order hall, all except you may still be hunting for hidden appearences.|
]]
end)
