...
C The Hammer of Khaz'goroth|QID|42454|M|49.36,47.34|Z|0627; Dalaran!Broken Isles|NC|N|Central Dalaran teleport used|
T The Hammer of Khaz'goroth|QID|42454|M|41.17,52.45|Z|0629; Aegwynn's Gallery@Dalaran|N|To the glowing "Hammer of Khaz'goroth" on the wall.|
...
D On to Class Halls|N|This ends Highmountain and the Druid order hall guide will load.|C|Druid|GUIDE|TR_EmmLegionDruid|
D On to Class Halls|N|This ends Highmountain and the Death Knight order hall guide will load.|C|Death Knight|GUIDE|TR_EmmLegionDK|
D On to Class Halls|N|This ends Highmountain and the Demon Hunter order hall guide will load.|C|DemonHunter|GUIDE|TR_LinksDHArtCH100100|
D On to Class Halls|N|This ends Highmountain and the Hunter order hall guide will load.|C|Hunter|GUIDE|TR_EmmLegionHunter|
D On to Class Halls|N|This ends Highmountain and the Mage order hall guide will load.|C|Mage|GUIDE|TR_EmmLegionMage|
D On to Class Halls|N|This ends Highmountain and the Monk order hall guide will load.|C|Monk|GUIDE|TR_EmmLegionMonk|
D On to Class Halls|N|This ends Highmountain and the Paladin order hall guide will load.|C|Paladin|GUIDE|TR_EmmLegionPaladin|
D On to Class Halls|N|This ends Highmountain and the Priest order hall guide will load.|C|Priest|GUIDE|TR_EmmLegionPriest|
D On to Class Halls|N|This ends Highmountain and the Rogue order hall guide will load.|C|Rogue|GUIDE|TR_EmmLegionRogue|
D On to Class Halls|N|This ends Highmountain and the Shaman order hall guide will load.|C|Shaman|GUIDE|TR_EmmLegionShaman|
D On to Class Halls|N|This ends Highmountain and the Warlock order hall guide will load.|C|Warlock|GUIDE|TR_EmmLegionWarlock|
D On to Class Halls|N|This ends Highmountain and the Warrior order hall guide will load.|C|Warrior|GUIDE|TR_EmmLegionWarrior|
