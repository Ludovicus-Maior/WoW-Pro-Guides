...
C Nexus-Point Xenas: Eclipse|QID|86521|QO|3|M|64.12,61.81|Z|2405; Voidstorm|CHAT|N|Talk to Alleria to queue for follower dungeon. You can queue for this as a follower dungeon or grab some friends, but either way, you need to run the dungeon to progress the campaign.|
