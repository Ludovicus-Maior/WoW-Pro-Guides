local guide = WoWPro:RegisterGuide('CataclysmGuideHubA', 'Leveling', "Stormwind City", 'Elidion', 'Alliance')
...
A Cataclysm: Onward to Adventure in the Eastern Kingdoms|QID|60891|M|56.26,17.31|N|From Chromie after activating The Cataclysm timeline.|LVL|-70|CT|
