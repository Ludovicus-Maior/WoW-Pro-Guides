...
C The Road to Kun-Lai|QID|31254|FACTION|Alliance|QO|Speak with the Highroad Grummle: 1/1|NC|M|70.08,23.47|Z|Valley of the Four Winds|
C The Road to Kun-Lai|QID|31255|FACTION|Horde|QO|Speak with the Highroad Grummle: 1/1|NC|M|70.08,23.47|Z|Valley of the Four Winds|
...
C Hit Medicine|QID|30460|S|U|79819|M|68.03,87.57|
C All of the Arrows|QID|30459|S|M|68.79,86.46|
...
C Repossession|QID|30469|M|73.99,77.54|S|
C Enraged Vengeance|QID|30468|M|73.26,77.51|S|
...
C Repossession|QID|30469|M|73.99,77.54|US|
...
C Eastwind Rest|QID|30513|FACTION|Horde|NC|QO|Speak with Farmhand Ko: 1/1|M|63.65,86.68|N|Talk to Farmhand Ko.|
C Eastwind Rest|QID|30513|FACTION|Horde|NC|QO|Speak with Elder Shiao: 1/1|M|61.25,82.25|N|Talk to Elder Shiao.|
...
C Farmhand Freedom|QID|30571|M|61.88,87.04|N|Kill the overseers to free the slaves standing near them.|
C ... and the Pot, Too!|QID|30581|M|60.03,88.43|N|The pot is in the house, the virmin zooming around drops the veggies too.|
...
C Profiting off of the Past|QID|30595|S|M|58.40,74.86|
...
C Deanimate the Reanimated|QID|30594|S|FACTION|Horde|M|59.20,72.21|
...
C Pandaren Prisoners|QID|30650|S|FACTION|Alliance|M|49.67,80.36|
...
C Barrels of Fun|QID|30651|FACTION|Alliance|M|49.42,80.61|N|Pick up a sparkly barrell (unique - one at a time) and place it where the gears are on your minimap|
...
C Pandaren Prisoners|QID|30650|US|FACTION|Alliance|M|49.67,80.36|
...
C Pandaren Prisoners|QID|30655|FACTION|Horde|S|M|49.58,78.89|
...
C Barrels of Fun|QID|30656|FACTION|Horde|M|47.99,81.27|N|Pick up a sparkly barrell (unique - one at a time) and place it where the gears are on your minimap|
T In Tents Channeling|QID|30657|FACTION|Horde|N|To UI Alert,|
A The Ordo Warbringer|QID|30661|FACTION|Horde|N|From UI Alert.|
C Pandaren Prisoners|QID|30655|FACTION|Horde|US|M|49.58,78.89|
...
R Muskpaw Ranch|QID|30488|CC|M|70.13,70.24|
...
R The Grummle Bazaar|QID|30492|CC|M|65.51,61.26|
...
C A Grummle's Luck|QID|30808|S|M|62.24,66.92|
C Oil Stop|QID|30614|U|80312|M|63.44,68.53|
C Traffic Issues|QID|30616|M|63.53,66.80|
C A Grummle's Luck|QID|30808|US|M|62.24,66.92|
...
C Instant Courage|QID|30601|US|M|57.54,47.44|N|It's ok to leave the Guides to die if you want to zerg out.|
...
C Seeker's Folly|QID|30684|M|43.22,51.99|N|Stop (click) at each shrine as you go up the hill.|
...
T Staying Connected|QID|30795|U|81712|M|51.94,47.44|U|81712|N|To Image of Lorewalker Cho.|
...
C An end to Everything|QID|30796|M|57.34,47.17|
C It Was Almost Alive|QID|30797|M|57.08,47.83|
T An end to Everything|QID|30796|M|58.03,49.02|U|81712|N|Use the item to call up/turn in to Image of Lorewalker Cho.|
...
C The Tomb of Shadows|QID|30799|M|56.38,43.45|
...
C Chasing the Storm|QID|30802|M|51.31,48.26|
...
C Fisherman's Tale|QID|30935|QO|Speak to Mishi outside of Lei Shen's Tomb: 1/1|NC|M|54.74,46.84|
C Fisherman's Tale|QID|30935|QO|Speak to Shin Whispercloud to access Zouchin Province: 1/1|NC|M|63.46,40.14|N|Go down the Path deeper into the mountain.|
...
C The Scent of Life|QID|30806|S|M|59.61,22.26|N|Kill all the crabs you see, the shell is somewhat rare. The spices are dropped and are sparkly barrels in the pirate camp.|
C By the Falls, For the Fallen|QID|30807|NC|M|60.17,31.11|
C Justice|QID|30805|M|62.14,23.99|
C The Scent of Life|QID|30806|US|M|59.61,22.26|
...
r Repair/Restock|M|63.38,30.69|
...
C No Pack Left Behind|QID|30599|US|M|53.35,74.45|
C Breaking Broketooth|QID|30599|US|M|55.44,70.84|
...
C Trouble Brewing|QID|30745|S|M|37.83,77.90|
C Shut it Down|QID|30742|S|M|40.67,73.42|
C Kota Blend|QID|30744|U|81054|S|M|36.38,76.94|
T Kota Blend|QID|30744|N|To UI Alert.|
A A Fair Trade|QID|30746|N|From UI Alert.|
C Gourmet Kafa|QID|30743|US|M|36.95,76.16|
C Trouble Brewing|QID|30745|US|M|37.83,77.90|
C Shut it Down|QID|30742|US|M|40.67,73.42|
...
C A Line Unbroken|QID|30715|M|30.20,62.58|N|Blizzard has marked the spts with gears.|
...
A My Husband...|QID|30768|M|31.30,61.61|N|From Suna Silentstrike.|;currently bugged and I only pick it up sometimes. I haven't figured out a pattern.
