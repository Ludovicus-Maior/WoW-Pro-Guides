...
-- URL: http://wow-pro.com/node/3657/revisions/28951/view
...
-- URL: http://wow-pro.com/node/3657/revisions/28096/view
-- Date: 2016-12-05 06:59
-- Who: Emmaleah
-- Log: Added another treasure (bear cave) and rare (Cailyn Paledoom)

-- URL: http://wow-pro.com/node/3657/revisions/28092/view
...
-- URL: http://wow-pro.com/node/3657/revisions/28051/view
...
K Kill Ravyn-Drath|QID|37537|QO|1|M|41.14,41.89|T|Ravyn-Drath|RARE|ITEM|129080|N|Silver - Kill and loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|38316|M|40.57,57.66|N|Loot for a bit of treasure and resources.|
...
$ Cache of Infernals|QID|38037|M|35.38,50.37|N|Silver - Click on the pile of rocks to start spawning infernals, 3rd wave is the silver.|
K Kill Ragemaw|QID|44108|QO|1|M|32.57,48.74|RARE|ITEM|129075|T|Ragemaw|N|Silver - Kill and loot for some treasure and resources.|
...
K Kill Vorthax|QID|42280|QO|1|M|37.14,43.35|RARE|ITEM|141875|T|Vorthax|N|Silver - Kill and loot for some treasure and resources.|
...
K Kill Houndmaster Stroxis|QID|42286|QO|1|M|30.82,47.61|N|Silver - Kill and loot for some treasure and resources. Pull him into Illidari perch to get help from the Illidari|RARE|
$ Treasure Chest|QID|44105|M|26.25,47.14|N|Loot for a bit of treasure and resources.|
K Kill Inquistitor Tivos|QID|42376|QO|1|M|26.83,49.07;28.30,51.94|CS|RARE|ITEM|141874|T|Inquistitor Tivos|N|Silver - Use the portal located at the first coordinate, to port up to the Soulrender above, he is in the lower level. Kill and loot for some treasure and resources.|
K Kill Broodmother Lizax|QID|44670|QO|1|M|33.26,42.21|RARE|ITEM|141869|T|Broodmother Lizax|N|Silver - Kill and loot for some treasure and resources.|
...
K Kill Beacher|QID|38238|QO|1|M|32.43,28.61|RARE|ITEM|129067|T|Beacher|N|Silver - Paths up and down the beach. Kill and loot for a bit of treasure and resources.|;probably need a run step in here
$ Small Treasure Chest|QID|44102|M|34.58,35.55|N|In a alcove under a rocky outcropping. Loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|42292|M|40.85,36.59;42,32;41.39,30.75|CS|N|Loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|42289|M|48.16,27.90;51.53,24.33|CS|N|Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|42295|M|47.85,7.73|N|Loot for a bit of treasure and resources.|
K Kill Vintner Shalrala|QID|38203|QO|1|M|47.16,8.30|T|Vintner Shalrala|N|Kill and loot first recipe.|RANK|3|
K Kill Normantis the Deposed|QID|37928|QO|1|M|50.24,7.63;49.49,8.81|CS|RARE|ITEM|129061|T|Normantis the Deposed|N|Silver - In a cave down on the beach. Kill and loot for a bit of treasure and resources.|
...
$ Glimmering Treasure Chest|QID|38367|M|42.63,8.08|N|Loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|42339|M|51.75,17.36;52.82,20.04;54.03,22.42;52.84,20.58|CS|N|You can walk, avoiding the sleeping bears to get to this treasure. Loot for some resources and treasure.|
K Kill Cailyn Paledoom|QID|38268|M|54.03,22.37;52.43,22.90|CS|RARE|ITEM|129063|T|Cailyn Paledoom|N|Silver-Kill and Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|44104|M|53.61,18.13|N|Loot for a bit of treasure and resources.|
...
$ Treasure chest|QID|40711|M|55.56,18.65|N|Click on this ley portal to be teleported to the top of the building where you will find a treasure chest containing an item and some resources.|
C Leyline Abuse|QID|37960|QO|2|M|56.68,17.60|T|Ishkaneth|
C Leyline Abuse|QID|37960|QO|1|M|57.68,15.94|T|Tyndrissen|
$ Treasure Chest|QID|37980|M|58.28,16.07;58.38,15.24;58.69,14.14|CS|N|Take the stairs here, follow the path up, then take the ley portal to find a treasure chest. Loot for treaure and resources.|

$ Treasure Chest|QID|37832|M|63.23,15.21|N|WAY out of the way, but this is as close as you get to it. Loot for a bit of treasure and resources.|
$ Unbound Rift|QID|37932|M|59.74,12.29|QO|1|N|Silver - This vignette is located down in the cravasse. Kill and loot for a bit of resources and treasure.|
...
$ Treasure chest|QID|37958|M|57.89,12.23|N|Treasure chest containing items and resources.|
...
$ Marius & Tehd vs a Doomlord|QID|38352|M|46.71,28.20;43.15,28.20|CS|ITEM|129056|T|Kazrok|N|Silver - Continue assisting Marius and Tehd in thier adventurers by participating in killing this Doomlord. Kill and loot for treasure and resources.|
...
K Kill Arcanist Shal'iman|QID|42505|QO|1|M|40.92,35.03;35.22,34.54|CS|RARE|ITEM|141868|T|Arcanist Shal'iman|N|Silver - He paths around this circle. Kill and loot for a bit of treasure and resources.|
...
$ Glimmering Treasure Chest|QID|42297|M|43.37, 22.43|N|Guarded by two same level elite slow-running mobs.  Loot for a bit of treasure and resources.|
...
K Kill Daggerbeak|QID|37869|QO|1|M|51.09,31.64|T|Daggerbeak|N|Silver - Kill and loot for a bit of loot and treasure.|RARE|
...
K Kill Valiyaka|QID|37726|QO|1|T|Valiyaka the Stormbringer|M|47.41, 34.37|N|Silver - Kill and loot for a bit of treasure and resources.|RARE|ITEM|129082|
C They Came From the Sea|QID|37256|T|Fathom-Commander Zarrin|QO|1|M|45.00,36.89|N|Kill and loot the commander's head.|
$ Small Treasure Chest|QID|37713|M|44.48,39.47|N|Loot for a bit of treasure and resources.|
...
K Kill Mrrgrl the Tide Reaver|QID|37823|QO|1|M|50.09,34.54|RARE|ITEM|129072|T|Mrrgrl the Tide Reaver|N|Silver - Kill and loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|37831|M|49.65,34.47|N|Loot for a bit of treasure and resources.|
...
$ Treasure Chest|QID|38251|M|56.45,34.87|N|Yes, its in the middle of those sleeping basilisks. Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|42282|M|53.61,44.15|N|Loot for a bit of treasure and resources. Its between the pillar and the wall.|
...
$ Small Treasure Chest|QID|42283|M|53.50,45.47|N|Loot for a bit of treasure and resources.|
K Kill Captain Volo'ren|QID|37821|QO|1|RARE|ITEM|129066|M|53.45,43.95|T|Captain Volo'ren|N|Silver - Kill and loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|42281|M|52.00,42.10|N|Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|42287|M|54.40,36.33|N|Loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|37596|M|53.03,37.27|N|Loot for a bit of treasure and resources.|
C Back from the Dead|QID|42694|QO|3|M|55.92,42.47;56.21,42.24|CS|NC|N|Search the eastern colonnade.|RANK|2|
$ Glimmering Treasure Chest|QID|37830|M|58.36,43.78|ITEM|131795|N|Loot for a bit of treasure and resources.|
C Nar'thalas Still Suffers|QID|37486|QO|1|M|55.58,48.10|T|Athissa|N|Defeat Athissa.|
K Kill Brawlgoth|QID|42450|QO|1|M|55.23,43.95|T|Brawlgoth|N|Silver - Kill and loot for a bit of treasure and resources.|RARE|ITEM|129086|
...
$ Small Treasure Chest|QID|42284|M|62.00,83.74|Z|1015/17|N|Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|42285|M|71.76,21.68|Z|1015/17|N|Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|42294|M|62.81,44.79|N|Loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|42293|M|63.64,39.18|N|Loot for a bit of treasure and resources.|
K Kill Golza the Iron Fin|QID|42372|ACH|11261;2|M|65.17,40.02|N|Silver - Blow the 'Horn of the Siren' to summon Golza. Kill two waves of naga and then Golza for some treasure and resources.|RARE|ITEM|129091|T|Golza the Iron Fin|; There are ACH's for all silvers in this zone.
...
$ Small Treasure Chest|QID|42958|M|65.47,29.56|N|Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|44103|M|69.16,25.93;69.77,29.57;68.87,29.73|CS|N|In an underwater cave. Loot for a bit of treasure and resources.|
...
A Hard Times|QID|38948|M|60.00,34.48|N|From Lyndras.|P|Tailoring;197|LVL|102|PRE|38946|
$ Treasure Chest|QID|38419|M|57.15,31.06|N|Loot for a bit of treasure and resources.|
C Runic Catgut|QID|38947|M|57,31|S|N|Kill cats until you collect the catgut needed.|P|Tailoring;197|LVL|102|
K Kill Pridelord Meowl|QID|38061|QO|1|M|56.05,28.91|T|Pridelord Meowl|RARE|ITEM|138395|N|Silver - Kill and loot for a bit of treasure and resources.|
C Runic Catgut|QID|38947|M|57,31|US|N|Kill cats until you collect the catgut needed.|P|Tailoring;197|LVL|102|
$ Small Treasure Chest|QID|42288|M|55.36,27.74|N|Loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|42338|M|55.70,25.48;57.19,25.23|CS|N|Loot for a bit of treasure and resources.|
R Olivian Veil|QID|40751|M|60.98,34.67;65.84,37.26;66.06,43.44|CS|N|Back to questing.|RANK|3|
$ Small Treasure Chest|QID|40751|M|66.06,43.44|N|Loot for a bit of treasure and resources.|
K Kill Syphonus|QID|37989|QO|1|M|67.19,51.58|T|Syphonus|N|Silver - Kill and loot for a bit of treasure and resources.  Be wary of the lvl 110 mobs nearby.|RARE|ITEM|129064|
...
K Kill Treacherous Stallions|QID|44081|QO|1|M|60.25,46.14|RARE|ITEM|140685|T|Devious Sunrunner|N|Silver - Click on the Ley Portal to be transported to a treasure. Kill the Stallions, then loot the chest for a bit of treasure and resources.|
$ Marius & Tehd vs a Fel Lord|QID|38212|M|60.50,48.56;59.17,46.44|CS|ITEM|129068|T|Brogozog|N|Follow this path to once again save Thed's hide. Chat with him to start the vignette. Kill and loot the demon for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|42278|M|62.99,54.17|N|Loot for a bit of treasure and resources.|
T This IS In My Contract.|QID|38237|M|62.91,51.45|N|To Daglop.|RANK|2|

K Kill The Oracle|QID|37822|QO|1|M|59.76,54.65;59.69,55.17|CS|N|Silver - Go up the stairs starting at the first marked spot.  Kill and loot for a bit of treasure and resources|T|The Oracle|RARE|ITEM|129065|
$ Small Treasure Chest|QID|40752|M|58.64,53.38|N|Loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|44405|M|54.87,52.13|N|Loot for a bit of treasure and resources. Be aware. the NPCs in the alcove with you will take offense at you looting their treasure.|
K Kill Warbringer Mox'na|QID|37909|RARE|ITEM|129069|M|51.34,56.19|T|Warbringer Mox'na|N|Silver - Kill and loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|38370|M|49.41,57.98|N|You always wanted to be a wedding crasher... right? Kill the Bride and Groom as they object to you stealing their gifts. Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|37828|M|49.38,45.35|N|Loot for a bit of resources and treasure.|
...
$ Small Treasure Chest|QID|42290|M|50.20,50.29|N|Get this treasure BEFORE you talk to Ooka. Loot for a bit of treasure and resources.|
...
$ Glimmering Treasure Chest|QID|37649|M|69.22,48.69|Z|1015/18|N|Loot for a bit of treasure and resources.|
$ Small Treasure Chest|QID|42291|M|46.36,67.12|Z|1015/18|N|Loot for a bit of treasure and resources.|
...
K Kill Flog the Captain Eater|QID|37824|QO|1|M|45.2,58.0|RARE|ITEM|129090|T|Flog the Captain-Eater|N|Silver - Kill and loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|37829|M|53.17,64.44|N|Loot for a bit of treasure and resources.|
...
$ Small Treasure Chest|QID|42272|M|59.54,61.99;59.88,63.20|CS|N|Path starts at first coord, treasure is on top of a rocky outcrop. Loot for a bit of treasure and resources.|
K Kill Tide Behemoth|QID|38217|QO|1|T|Tide Behemoth|M|61.35,61.93|RARE|ITEM|129062|N|Silver - Kill and loot for a bit of treasure and resources.|
C Making the World Safe for Profit|QID|37657|QO|2|M|62.21,61.48;63.52,63.55|CS|N|The queen is in an underwater cave.|
$ Small Treasure Chest|QID|42273|M|62.38,58.41|N|Loot for a bit of treasure and resources.|
...
K Kill Chief Bitterbrine|QID|42221|QO|1|RARE|ITEM|129073|T|Chief Bitterbrine|M|65.65,56.81|N|Silver - Kill and loot for a bit of treasure and resources.|
...
$ Disputed Treasure|QID|38365|M|55.87,56.87|N|Kill the npcs argueing over the treasure chest then you can loot it for a bit of treasure and resources.|
