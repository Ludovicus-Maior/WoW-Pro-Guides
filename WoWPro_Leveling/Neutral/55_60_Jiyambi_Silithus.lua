WoWPro.Leveling:RegisterGuide('JiySil5560', 'Silithus', 'Jiyambi', '55', '60', 'JiyBla5560|CraBla5458', 'Neutral', function()
return [[
...
A Call of the Warmatron|QID|28865|M|53.29,33.61|N|From Okril'lon Mage. Accept this if you'd like to do the Blasted Lands next, or if you're ready to move on to Hellfire Peninsula.|FACTION|Horde|
A Nethergarde Needs You!|QID|28867|M|53.4,33.4|N|From Nethergarde Mage. Accept this if you'd like to do the Blasted Lands next, or if you're ready to move on to Hellfire Peninsula.|FACTION|Alliance|
