local guide = WoWPro:RegisterGuide('Maw', 'Leveling', "The Maw", 'Elidion', 'Neutral')
...
C The Search for Baine|QID|61099|M|47.82,49.42|Z|Torghast!Instance1769|QO|1|N|Make your way to level 6 and Kill Warden Arkoban. Be sure to loot The Forgotten Key from his corpse.|
...
C The Search for Baine|QID|61099|M|34.88,56.24|Z|Torghast!Instance1769|QO|2|N|Click on Baine to free him.|
...
P Torghast, Tower of the Damned|ACTIVE|60269|M|50.27,80.90|Z|The Runecarver!Instance|N|Take the portal back out to the entrance.|IZ|1912|
...
A Rule 4: Make A List|QID|60281|PRE|62837|M|46.90,41.69|Z|The Maw|N|From Ve'nari.| ; PRE should be correct
C Reawakening|QID|60269|M|38.52,28.80|Z|The Maw|N|Kill Odalrik and loot the Runecarver's Memory.|
C Rule 4: Make A List|QID|60281|M|44.13,17.70|Z|The Maw|QO|1|N|Inquisitor Devaki slain.|
C Rule 4: Make A List|QID|60281|M|44.87,16.36|Z|The Maw|QO|2|NC|N|Source of broker magic found.|
R Ve'nari's Refuge|ACTIVE|60281|M|46.91,41.70|Z|The Maw|N|Make your way to the Ve'nari's Refuge or use your Cypher of Relocation.|U|180817|
T Rule 4: Make A List|QID|60281|M|46.91,41.68|Z|The Maw|N|To Ve'nari.|
...
P Torghast, Tower of the Damned|ACTIVE|60270|M|50.27,80.90|Z|The Runecarver!Instance|N|Take the portal back out to the entrance.|IZ|1912|
P Ve'nari's Refuge|QID|60269|ACTIVE|60270|M|10.42,46.99|Z|Torghast - Entrance!Instance|N|Click the doors to exit to Ve'nari's Refuge.|IZ|1911|
