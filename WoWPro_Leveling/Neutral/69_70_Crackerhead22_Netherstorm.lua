...
A Report to Spymaster Thalodien|QID|11039|M|44.77,76.29|Z|Shattrath City|N|From Arcanist Savan.|REP|Scryers|
...
T Assist Exarch Orelis|QID|11038|M|32.07,64.22|N|To Exarch Orelis.|REP|Aldor|
A Distraction at Manaforge B'naar|QID|10241|M|32.07,64.22|N|From Exarch Orelis.|REP|Aldor|
T Report to Spymaster Thalodien|QID|11039|M|31.98,64.09|N|To Spymaster Thalodien.|REP|Scryers|
A Manaforge B'naar|QID|10189|M|31.98,64.09|N|From Spymaster Thalodien.|REP|Scryers|
...
C Manaforge B'naar|QID|10189|M|27.57,65.41|N|Kill and loot Captain Arathyn to get the B'naar Personnel Roster.|REP|Scryers|
C Distraction at Manaforge B'naar|QID|10241|M|25.32,66.60|N|Kill the mobs needed. The Magisters tend to be around the floating red crystals.|REP|Aldor|
...
T Distraction at Manaforge B'naar|QID|10241|M|32.08,64.23|N|To Exarch Orelis.|REP|Aldor|
A Measuring Warp Energies|QID|10313|M|32.08,64.23|N|From Exarch Orelis.|REP|Aldor|
A Naaru Technology|QID|10243|M|32.05,64.21|N|From Anchorite Karja.|REP|Aldor|
T Manaforge B'naar|QID|10189|M|31.98,64.09|N|To Spymaster Thalodien.|REP|Scryers|
A High Value Targets|QID|10193|M|31.99,64.17|N|From Spymaster Thalodien.|REP|Scryers|
A Bloodgem Crystals|QID|10204|M|32.04,64.06|N|From Magistrix Larynna.|REP|Scryers|
...
N Northern Pipeline|QID|10313|U|29324|QO|Northern Pipeline Measured: 1/1|M|25.76,59.9|N|Use the Warp-Attuned Orb to measure the Northern Pipeline.|REP|Aldor|
N Western Pipeline|QID|10313|U|29324|QO|Western Pipeline Measured: 1/1|M|20.83,66.85|N|Use the Warp-Attuned Orb to measure the Western Pipeline.|REP|Aldor|
T Naaru Technology|QID|10243|M|23.18,68.13|N|Head inside the Manaforge B'naar and turn the quest in at the B'naar Control Console.|REP|Aldor|
A B'naar Console Transcription|QID|10245|M|23.18,68.13|N|From the B'naar Control Console.|REP|Aldor|
N Southern Pipeline|QID|10313|U|29324|QO|Southern Pipeline Measured: 1/1|M|20.86,71.01|N|Use the Warp-Attuned Orb to measure the Southern Pipeline.|REP|Aldor|
l Bloodgem Shard|QID|10204|NC|M|26.20,68.56|N|Kill Sunfury Magisters until you get a Bloodgem Shard from looting them.|REP|Scryers|
C Bloodgem Crystals|QID|10204|NC|M|26.20,68.56|N|Go near one the smaller floating red crystals and use the Bloodgem Shard.|REP|Scryers|
K Sunfury Warp-Masters|QID|10193|S|QO|Sunfury Warp-Master: 2/2|M|24.28,72.93|N|Kill 2 Sunfury Warp-Masters walking around the Sunfury Geologists.|REP|Scryers|
K Sunfury Geologists|QID|10193|QO|Sunfury Geologist slain: 8/8|M|24.31,72.82|N|Best place to find the Sunfury Geologists.|REP|Scryers|
K Sunfury Warp-Masters|QID|10193|US|QO|Sunfury Warp-Master: 2/2|M|24.28,72.93|N|Kill 2 Sunfury Warp-Masters walking around the Sunfury Geologists.|REP|Scryers|
C High Value Targets|QID|10193|M|22.52,72.37;20.33,70.88|N|Kill Sunfury Warp-Engineers between the two waypoints until you complete the quest.|REP|Scryers|
...
C Measuring Warp Energies|QID|10313|U|29324|M|29.10,72.70|N|Measure the last pipeline for this quest.|REP|Aldor|
...
T Measuring Warp Energies|QID|10313|M|32.06,64.24|N|To Exarch Orelis.|REP|Aldor|
T B'naar Console Transcription|QID|10245|M|32.06,64.24|N|To Anchorite Karja.|REP|Aldor|
A Shutting Down Manaforge B'naar|QID|10299|M|32.06,64.24|N|From Anchorite Karja.|REP|Aldor|
T High Value Targets|QID|10193|M|31.97,64.09|N|To Spymaster Thalodien.|REP|Scryers|
A Shutting Down Manaforge B'naar|QID|10329|M|32.00,64.08|N|From Spymaster Thalodien.|REP|Scryers|
T Bloodgem Crystals|QID|10204|M|32.02,64.03|N|To Magistrix Larynna.|REP|Scryers|
...
T Shutting Down Manaforge B'naar|QID|10299|M|32.05,64.24|N|To Anchorite Karja.|REP|Aldor|
A Shutting Down Manaforge Coruu|QID|10321|M|32.05,64.24|N|From Anchorite Karja.|REP|Aldor|
A Attack on Manaforge Coruu|QID|10246|M|32.05,64.21|N|From Exarch Orelis.|REP|Aldor|
T Shutting Down Manaforge B'naar|QID|10329|M|31.98,64.10|N|To Spymaster Thalodien.|REP|Scryers|
A Stealth Flight|QID|10194|M|31.99,64.11|N|From Spymaster Thalodien.|REP|Scryers|
...
K Sunfury Arcanists|QID|10246|S|QO|Sunfury Arcanist slain: 8/8|M|51.64,81.94|N|Kill 8 Sunfury Arcanists.|REP|Aldor|
...
l Sunfury Guardsman Medallion|QID|10197|L|28637 |M|50.93,83.46|N|Kill and loot Sunfury Guardsmen until the Medallion drops. There is a good amount of Guardsmen at the waypoint.|REP|Scryers|
C A Convincing Disguise|QID|10197|M|48.20,81.60|N|Head inside the Manaforge and kill Sunfury Researchers until the Gloves drop.|REP|Scryers|
T A Convincing Disguise|QID|10197|M|48.20,86.66|N|To Caledis Brightdawn.|REP|Scryers|
A Information Gathering|QID|10198|M|48.20,86.66|N|From Caledis Brightdawn.|REP|Scryers|
...
l Krasus' Compendium - Chapter 1|QID|10192|L|28472 |M|58.62,89.18|N|Enter the house and loot Krasus' Compendium - Chapter 1 off the ground.|
...
T Shutting Down Manaforge Coruu|QID|10321|M|32.06,64.24|N|To Anchorite Karja.|REP|Aldor|
A Shutting Down Manaforge Duro|QID|10322|M|32.06,64.24|N|From Anchorite Karja.|REP|Aldor|
T Attack on Manaforge Coruu|QID|10246|M|32.06,64.24|N|To Exarch Orelis.|REP|Aldor|
A Sunfury Briefings|QID|10328|M|32.06,64.24|N|From Exarch Orelis.|REP|Aldor|
T Return to Thalodien|QID|10200|M|32.02,64.06|N|To Spymaster Thalodien.|REP|Scryers|
A Shutting Down Manaforge Duro|QID|10338|M|32.02,64.06|N|From Spymaster Thalodien.|REP|Scryers|
A Kick Them While They're Down|QID|10341|M|32.03,64.05|N|From Magistrix Larynna.|REP|Scryers|
...
C Sunfury Briefings|QID|10328|S|M|59.76,67.11|N|Kill magic using mobs to get the Sunfury Arcane Briefing, and kill melee-type mobs to get the Sunfury Military Briefing.|REP|Aldor|
...
T Shutting Down Manaforge Duro|QID|10322|M|32.05,64.24|N|To Anchorite Karja.|REP|Aldor|
A Shutting Down Manaforge Ara|QID|10323|M|32.05,64.24|N|From Anchorite Karja.|REP|Aldor|
T Sunfury Briefings|QID|10328|M|32.05,64.24|N|To Exarch Orelis.|REP|Aldor|
A Outside Assistance|QID|10431|M|32.05,64.24|N|From Exarch Orelis.|REP|Aldor|
T Shutting Down Manaforge Duro|QID|10338|M|32.03,64.05|N|To Spymaster Thalodien.|REP|Scryers|
A Shutting Down Manaforge Ara|QID|10365|M|32.03,64.05|N|From Spymaster Thalodien.|REP|Scryers|
T Kick Them While They're Down|QID|10341|M|32.03,64.05|N|To Magistrix Larynna.|REP|Scryers|
A A Defector|QID|10202|M|32.01,64.03|N|From Magistrix Larynna.|REP|Scryers|
...
T Outside Assistance|QID|10431|M|34.81,38.21|N|To Kaylaan.|REP|Aldor|

A A Dark Pact|QID|10380|M|34.81,38.21|N|From Kaylaan.|REP|Aldor|
...
T A Dark Pact|QID|10380|M|34.81,38.17|N|To Kaylaan.|REP|Aldor|
A Aldor No More|QID|10381|M|34.81,38.17|N|From Kaylaan.|REP|Aldor|

H Area 52|QID|10249|M|32.04,64.39|N|Hearth to Area 52.|
T Shutting Down Manaforge Ara|QID|10323|M|32.05,64.21|N|To Anchorite Karja.|REP|Aldor|
T Aldor No More|QID|10381|M|32.05,64.21|N|To Exarch Orelis.|REP|Aldor|
A Socrethar's Shadow|QID|10407|M|32.05,64.21|N|From Anchorite Karja.|REP|Aldor|
T Shutting Down Manaforge Ara|QID|10365|M|32.03,64.06|N|To Spymaster Thalodien.|REP|Scryers|
T Damning Evidence|QID|10432|M|32.03,64.06|N|To Spymaster Thalodien.|REP|Scryers|
A A Gift for Voren'thal|QID|10508|M|32.03,64.06|N|From Spymaster Thalodien.|REP|Scryers|
...
l First Half of Socrethar's Stone|QID|10407|L|29624 |M|36.79,27.7|N|Kill and loot Forgemaster Morug to get the first stone.|REP|Aldor|
C Socrethar's Shadow|QID|10407|M|41.08,19.68|N|Kill and loot Silroth to get the second stone.|REP|Aldor|
l First Half of Socrethar's Stone|QID|10508|L|29624 |M|36.79,27.7|N|Kill and loot Forgemaster Morug to get the first stone.|REP|Scryers|
C A Gift for Voren'thal|QID|10508|M|41.01,19.62|N|Kill and loot Silroth to get the second stone.|REP|Scryers|
...
T Ishanah's Help|QID|10410|M|24.09,29.78|Z|Shattrath City|N|To Ishanah.|REP|Aldor|
A Deathblow to the Legion|QID|10409|M|24.09,29.78|Z|Shattrath City|N|From Ishanah.|REP|Aldor|
T Bound for Glory|QID|10509|M|42.68,91.52|Z|Shattrath City|N|To Voren'thal the Seer.|REP|Scryers|
A Turning Point|QID|10507|M|42.68,91.52|Z|Shattrath City|N|From Voren'thal the Seer.|REP|Scryers|
U Voren'thal's Package|QID|10507|U|30260|QO|Voren'thal's Presence: 1/1|N|Open up Voren'thal's Package.|REP|Scryers|

H Area 52|QID|10409|M|32.01,64.39|N|Hearth to Area 52.|REP|Aldor|
H Area 52|QID|10507|M|32.01,64.39|N|Hearth to Area 52.|REP|Scryers|
R Socrethar's Seat|QID|10409|U|29796|M|36.44,18.35|N|Head to the waypoint, use the Socrthar's Teleportation Stone at the Warp Forge, then click on the portal that appears. You have to do this or the NPCs that you need will not spawn.|REP|Aldor|
...
T Deathblow to the Legion|QID|10409|M|29.48,14.41|N|To Ishanah. She will stay at the spot for a minute, if you miss the turn-in, you can go back to her in Shattrath.|REP|Aldor|
R Socrethar's Seat|QID|10507|U|29796|M|36.44,18.35|N|If you don't have flying, head to the waypoint, use the Socrthar's Teleportation Stone at the Warp Forge, then click on the portal. If you have flying, head to the floating piece of land to the NW of the waypoint.|REP|Scryers|
C Turning Point|QID|10507|U|30259|N|You most likely will need help depending on your level/class. At the start use Voren'thal's Presence on Socrethar, then kill Socrethar.|REP|Scryers|
F Shattrath City|QID|10507|M|45.3,34.9|N|Fly to Shattrath City.|REP|Scryers|
T Turning Point|QID|10507|M|42.68,91.52|Z|Shattrath City|N|To Voren'thal the Seer.|REP|Scryers|
