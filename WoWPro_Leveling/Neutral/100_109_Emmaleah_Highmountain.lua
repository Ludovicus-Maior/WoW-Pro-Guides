...
-- URL: http://wow-pro.com/node/3678/revisions/29463/view
...
-- Date: 2016-09-24 18:43
-- Who: Emmaleah
-- Log: Play thru RANK|1, minor refinements, added a couple of rank|-1| R steps, tweaks to coords in thunder totem interior and nelterian's lair.
...
$ Treasure Chest|QID|39812|M|39.53,57.44|N|Loot for a bit of treasure and resources.|
K Kill Flamescale|QID|39963|QO|1|M|40.97,57.72|T|Flamescale|N|Click on the abandoned fishing pole to summon up Flamescale, a rare mob you can kill for treasure and resources.|RARE|ITEM|131773|
...
$ Small Treasure Chest|QID|40491|M|13.67,55.40|Z|ThunderTotem|N|While escorting Jale, pause briefly to loot for a bit of treasure and resources.|
...
K Kill Sekhan|QID|40681|QO|1|M|45.15,56.30|T|Sekhan|N|Rare to kill for treasure and resources.|RARE|
...
K Kill Hartli the Snatcher|QID|39802|M|51.08,48.25|T|Hartli|N|Silver to kill for treasure and resources.|RARE|
...
$ Beastmaster Pao'lek & Arru|QID|39784|M|48.68,50.08|ITEM|131756|N|Beastmaster Pao'lek wants your help taming Arru. After he accomplishes it, and you curse at ungreatful hunters, go inside the now empty cave and loot the Thunder Totem Stolen Goods.|
$ Floating Treasure|QID|39494|M|42.09,52.68|ITEM|131763|N|You can cross over on this log, or just swim, be on the lookout for a Treasure chest that comes to rest here briefly.|
...
$ Mara Swiftmane vs Sure Shot Arnie|QID|40612|M|43.47,47.31|N|Assist Mara and you can have the hunter's treasure. |
...
K Kill Bristlemaul|QID|40405|QO|1|M|38.11,45.68|T|Bristlemaul|N|Kill for a bit of treasure and resources.|RARE|ITEM|131761|
...
K Kill Crab Rider Grmlrml|QID|39994|QO|1|M|43.72,10.89|N|Kill Crab Rider Grmlml for some treasure and resources. He patrols through this area.|T|Crab Rider Grmlrml|RARE|
$ Captured Survivor|QID|40096|M|46.66,7.52|ITEM|131797|T|Mrrklr|N|Talk to Sloppy Joe to attract his captor.|
...
K Kill Slumber|QID|40175|QO|1|M|41.48,31.79|RARE|ITEM|131921|T|Slumber|N|Kill the sleeping bear for a bit of loot and treasure.  Be aware a 110 elite paths through this area.|
...
K Kill Majestic Elderhorn|QID|39646|QO|1|M|44.41,27.18|RARE|ITEM|131900|N|He paths aong the lake shore and then around the mountain.|
C Pet Rocks|QID|39391|M|45.33,27.58|QO|3|NC|N|Out on the island.|
$ Small Treasure Chest|QID|44279|M|45.72,27.51;45.18,27.45|CS|ITEM|138885|N|Jump in the water and swim down to an underwater cave. Loot for treasure and resources.|
K Kill Shara Felbreath|QID|39762|M|48.33,29.47;51.00,25.75|CS|RARE|ITEM|131791|T|Shara Felbreath|N|Down this path is another Silver to kill for treasure and resources.|
...
$ Glimmering Treasure Chest|QID|40482|M|48.05,27.31;46.67,28.11|CS|N|Up the hill. then walk on top of the building/statue and drop down onto the statue's nose to find a tresure chest.  Loot for a bit of resources and treasure.|
K Kill Mellok, Son of Torok|QID|40242|M|49.20,27.11|RARE|ITEM|131808|QO|1|T|Mellok, Son of Torok|N|Kill this silver for a bit of loot and treasure.|
...
$ Small Treasure Chest|QID|44280|M|44.72,25.00;42.79,23.58;46.36,21.63|CS|N|Run up the mountain trail for a great view and to find this chest which contains a bit of loot and treasure. If you don't have a kite/glider, run back down.|
...
K Kill Luggut the Eggeater|QID|40406|QO|1|M|50.81,34.50|T|Luggut the Eggeater|N|Rare - Kill for a bit of treasure and resources.|RARE|ITEM|131776|
...
U Learn Companion Pet|QID|38913|U|129277|N|Click to add to your pet collection. Manually check this step off.|RANK|2|
...
K Kill Devouring Darkness|QID|40414|QO|1|T|Devouring Darkness|N|Take the kobold candles to start this and release the Devouring Darkness.|RARE|ITEM|131780|
...
K Kill Hartil the Snatcher|QID|39802|QO|1|M|53.25,47.92;51.12,48.05|CS|N|Go up this path to find a silver. Kill for a bit of treasure and Resources.|RARE|
...
K Kill Crawshuk the  Hungry|QID|39806|QO|1|M|49.42,39.74;48.38,40.05|CS|T|Crawshuk the Hungry|RARE|ITEM|131809|
$ Treasure Chest|QID|39503|M|47.63,44.05|N|Kick the runt off the cliff, then loot the chest for a bit of treasure and resources.|
...
K Kill Skullhat|QID|39465|QO|1|M|51.37,31.96|T|Skullhat|N|Kill and loot for a bit of treasure and resources.|RARE|ITEM|131769|
...
K Kill the Exiled Shaman|QID|39782|QO|1|M|41.92,41.61|RARE|ITEM|129175|T|Tenpack Flametotem|N|Silver - Run down this path to find kill this shaman and adopt a new pet.|
U Learn companion pet|QID|39322|M|41.92,41.61|U|129175|N|Click to add Crispin to your pet journal. (manually close this step.)|RARE|
...
$ Seemingly Unguarded Treasure|QID|40423|M|52.42,58.48;52.75,58.15|CS|ITEM|140681|N|What could go wrong? Click on the pile of gold and then fight for it.|
...
$ Totally Safe Treasure Chest|QID|39766|M|53.04,55.56;52.32,51.39|CS|N|The path starts at the first coordinate.  It's a bit of a run, but with a beautiful view. What could go wrong.  Find the chest and be prepared to fight for it.  Loot for a bit of treasure and resources.|ITEM|131802|
...
K Kill Gurbog da Basher|QID|40347|QO|1|M|56.0,61.2|N|Kill for a bit of treasure and resources.|RARE|ITEM|131775|T|Gurbog da Basher|
