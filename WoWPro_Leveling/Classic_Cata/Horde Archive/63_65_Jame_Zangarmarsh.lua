...
local guide = WoWPro.Leveling:RegisterGuide("JamZan6365", "Zangarmarsh", "Jame", "63", "65", "JamTer6567", "Horde", function()
return [[

F Swamprat Post|QID|9775|N|Fly to Swamprat Post.|

N Things to do: Zangarmarsh |QID|9747|N|Being in melee range of sporebats when they die gives you a 5 minute +30 to all stats buff. Keep your Fertile Spores and Unidentified Plant Parts, they'll be part of a hand-in.|
A Report to Shadow Hunter Denjai |QID|9775|M|85.3,54.8|N|From Zurai.|
A Thick Hydra Scales |QID|9774|M|85.3,54.8|N|From Zurai.|
A News from Zangarmarsh |QID|9796|M|85.3,54.8|N|From Zurai.|
...
C Disturbance at Umbrafen Lake |QID|9716|N|Head to the waypoint to get the quest completion.|M|70.9,82.1|
...
A Escape from Umbrafen |QID|9752|N|From Kayra Longmane. This is an escort quest. If she isn't there, that means someone else is doing it, so just wait.|M|83,85|
C Escape from Umbrafen |QID|9752|M|83.4,85.5|N|Follow and protect Kayra. You'll get ambushed twice, by two Umbrafen Slavebinders eachtime.|
T The Umbrafen Tribe |QID|9747|M|80.4,64.2|N|To Ikeyen.|
A A Damp, Dark Place |QID|9788|M|80.4,64.2|N|From Ikeyen.|
...
A Nothin' Says Lovin' Like a Big Stinger |QID|9898|M|85.0,54.0|N|From Reavij.|
T Thick Hydra Scales |QID|9774|M|85.3,54.8|N|To Zurai.|
A Searching for Scout Jyoba |QID|9771|M|85.3,54.8|N|From Zurai.|
F Zabra'jin|QID|9775|M|84.76,55.1|N|Fly to Zabra'jin.|
...
N Things to do |QID|9814|N|Grab Glowcap Mushrooms on sight. You'll need 10 Glowcaps(red glowing mushrooms), plus more Glowcaps if you plan on buying anything from Sporeggar.|
...
A Have You Ever Seen One of These? |QID|9816|M|32.9,48.9|N|From Witch Doctor Tor'gash.|
T WANTED: Boss Grog'ak |QID|9820|M|30.7,50.9|N|To Shadow Hunter Denjai.|

A Impending Attack |QID|9822|M|30.7,50.9|N|From Shadow Hunter Denjai.|
C There's No Explanation for Fashion |QID|9769|S|N|Kill and loot flies for the wings.|M|79.7,70.1|
C Stinging the Stingers |QID|9841|N|Kill Marshlight Bleeders.|S|
...
C There's No Explanation for Fashion |QID|9769|US|N|Kill and loot flies for the wings.|M|79.7,70.1|
C Stinging the Stingers |QID|9841|N|Kill Marshlight Bleeders.|US|
T Stinging the Stingers |QID|9841|M|31.6,49.2|N|To Gambarinka.|
A The Sharpest Blades |QID|9842|M|31.6,49.2|N|From Gambarinka.|
T Impending Attack |QID|9822|M|30.7,50.9|N|To Shadow Hunter Denjai.|

A Us or Them |QID|9823|M|30.7,50.9|N|From Shadow Hunter Denjai.|
A Message to the Daggerfen |QID|10118|M|30.7,50.9|N|From Shadow Hunter Denjai.|
C Angling to Beat the Competition |QID|9845|N|Kill Fenclaw Thrashers.|M|50,41|
C A Warm Welcome |QID|9728| M|70.9,82.1|N|Kill and loot Naga for their claws.|S|
N Disable the Serpent Lake Controls |QID|9720|QO|Serpent Lake Controls Disabled: 1/1|U|24355|N|Head west to the steam pump at the shores of Serpent Lake. Use the ironvine seeds on it.|M|62,41|
...
A Drain Schematics |QID|9731|U|24330|M|62.0,40.8|N|From the Drain Schematics.|
...
N Disable the Umbrafen Lake Controls |QID|9720|QO|Umbrafen Lake Controls Disabled: 1/1|U|24355|N|They'll be guarded by a Steam Pump Overseer, kill him and use the seeds.|M|70.6,80.3|
C Leader of the Darkcrest |QID|9730|N|Kill Rajah Haghazed.|M|65,69|
N Disable the Lagoon Controls |QID|9720|QO|Lagoon Controls Disabled: 1/1|U|24355|N|Head west to the steam pump. Use the Ironvine Seeds on it.|M|63,65|
C Spirits of the Feralfen |QID|9846|S|N|Kill the Feralfen here for the totems.|M|50,62|
C Nothin' Says Lovin' Like a Big Stinger |QID|9898|N|Kill and loot Blacksting.|M|50,60|
C Spirits of the Feralfen |QID|9846|US|N|Kill the Feralfen here for the totems.|M|50,62|
H Cenarion Refuge|QID|9730|U|6948|N|Hearth to the Cenarion Refuge.|
...
F Zabra'jin|QID|9846|M|84.8,55.1|N|Fly to Zabra'jin.|
T Spirits of the Feralfen |QID|9846|M|32.4,52.0|N|To Seer Janidi.|
A A Spirit Ally? |QID|9847|M|32.4,52.0|N|From Seer Janidi.|
T Angling to Beat the Competition |QID|9845|M|32.2,49.6|N|To Zurjaya.|
A The Biggest of Them All |QID|9903|M|32.2,49.6|N|From Zurjaya.|
A Pursuing Terrorclaw |QID|9904|M|32.2,49.6|N|From Zurjaya.|
h Zabra'jin |QID|9697|M|30.7,50.9|N|At Merajit.|
...
A Familiar Fungi |QID|9708|M|23.3,66.2|N|From Watcher Leesa'oh.|
C The Sharpest Blades |QID|9842|M|35.9,58.6|N|Kill and loot Marshfang Slicers.|S|
K "Count" Ungula|QID|9911|L|25459|N|Kill and loot "Count" Ungula. He drops a quest item.|M|33,60|
A The Count of the Marshes |QID|9911|U|25459|M|32.8,59.1|N|From "Count" Ungula's Mandible.|
C The Sharpest Blades |QID|9842|M|35.9,58.6|N|Kill and loot Marshfang Slicers.|US|
...
l Get 10 Glowcap Mushrooms |QID|9808|L|24245 10|N|If you haven't already.|S|
C Familiar Fungi |QID|9708|N|Kill and loot ogres in the Hewn Bog.|M|32,38|
l Get 10 Glowcap Mushrooms |QID|9808|L|24245 10|N|If you haven't already.|US|
...
A Glowcap Mushrooms |QID|9808|N|From Msshi'fn. If you've accidently hit friendly with Sporeggar, this will not be there.|
T Glowcap Mushrooms |QID|9808|N|To Msshi'fn.|O|
...
C Balance Must Be Preserved |QID|9720|N|Use the seeds at the last control console.|U|24355|M|25.4,42.9|
C Now That We're Friends... |QID|9726|US|N|Kill Bloodscale Slavedrivers and Enchantresses.|M|25.4,42.9|
C Message to the Daggerfen |QID|10118|N|Kill Daggerfen Assassins and Muckdwellers.|S|
...
C Message to the Daggerfen |QID|10118|N|Kill Daggerfen Assassins and Muckdwellers.|US|
...
K Overlord Gorefist |QID|9823|QO|Overlord Gorefist slain: 1/1|N|Kill Overlord Gorefist.|M|18.3,7.8|
...
F Swamprat Post|QID|9720|N|Fly to Swamprat Post.|M|33.0,51.1|
