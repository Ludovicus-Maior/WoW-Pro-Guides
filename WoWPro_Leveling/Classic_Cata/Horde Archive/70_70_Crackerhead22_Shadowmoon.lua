local guide = WoWPro.Leveling:RegisterGuide('CraSha7070H', 'Shadowmoon Valley', 'Crackerhead22', '69', '70', 'JamBor7173', 'Horde', function()
return [[
...
A Capture the Weapons|QID|10627|M|29.8,31.2|N|From Grokom Deatheye.|
...
A The Art of Fel Reaver Maintenance|QID|10611|M|27.46,21.21|N|From Nakansi.|
...
A The Fel and the Furious|QID|10613|M|27.46,21.22|N|From Nakansi.|
...
A News of Victory|QID|10745|M|27.47,21.23|N|From Nakansi.|
...
A When Worlds Collide...|QID|10765|U|31108|M|52.50,62.91|N|From Kor'kron Wind Rider. Use the flaregun to summon him.|
...
A Tabards of the Illidari|QID|10768|M|52.84,69.67|N|From Kor'kron Wind Rider.|
...
A Dissension Amongst the Ranks...|QID|10769|M|52.64,70.96|N|From Kor'kron Wind Rider.|
