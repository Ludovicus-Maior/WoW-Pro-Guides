...
local guide = WoWPro.Leveling:RegisterGuide('LiaBad4548', 'Badlands', 'Liavan', '45', '48', 'CraSea4850', 'Horde', function()
return [[
...
A It's Goat Time, Baby|QID|27776|M|64.34,38.14|N|From Garyanne Fleezlebop.|
T Easily Swayed|QID|27774|M|65.00,38.31|N|To Dolph Blastus.|
A A Strange Request|QID|27764|M|65.00,38.31|N|From Dolph Blastus.|
...
A First Sample: Wild Eggs|QID|27765|M|66.44,55.48|N|From Rhea.|
A Second Sample: Whelps|QID|27766|M|66.44,55.48|N|From Rhea.|
...
A Lifting the Veil|QID|27770|M|66.39,55.29|N|From Rhea.|
...
A Third Sample: Implanted Eggs|QID|27771|M|66.43,55.33|N|From Rhea.|
...
A Rhea Revealed|QID|27769|M|66.45,55.49|N|From Rhea.|
...
A The Venerable Doctor Blam|QID|27772|M|66.45,55.49|N|From Rheastrasza.|
T The Venerable Doctor Blam|QID|27772|M|46.88,56.44|N|To Dr. Hieronymus Blam.|
A Troggish Troubles|QID|27789|M|46.88,56.44|N|From Dr. Hieronymus Blam.|
...
A The Warden's Game|QID|27885|M|50.38,54.46|N|From the Stone Slab.|
...
A Ancient Protectors|QID|27887|M|48.64,51.55|N|(UI Alert)|
...
A The Titans' Trove|QID|27913|M|50.18,51.69|N|(UI Alert)|
T The Titans' Trove|QID|27913|M|50.25,53.21|N|At the Trove of the Watchers.|
A Return to Blam|QID|27888|M|50.25,53.21|N|From the Trove of the Watchers.|
...
A The Bad Dogs|QID|27890|M|18.06,42.39|N|From Rhea.|
...
A The Sorrow and the Fury|QID|27896|M|17.04,48.28|N|(UI Alert)|
...
A The Hidden Clutch|QID|27897|M|9.12,39.13|N|(UI Alert)|
T The Hidden Clutch|QID|27897|M|16.03,33.36|N|To Rhea.|
A Rheastrasza's Gift|QID|27898|M|16.10,33.20|N|From Rhea.|
C Rheastrasza's Gift|QID|27898|M|15.88,32.97|N|Cutscene.|
T Rheastrasza's Gift|QID|27898|M|15.84,33.24|N|(UI Alert)|

A Devastation|QID|27930|M|15.84,33.24|N|(UI Alert)|
T Devastation|QID|27930|M|18.89,30.18|N|Inside the cave at Rhea's Final Note.|
A The Egg Lives On|QID|27859|M|18.03,30.5|N|This does not auto-complete as it is a complete only quest. So close this step when done.|
