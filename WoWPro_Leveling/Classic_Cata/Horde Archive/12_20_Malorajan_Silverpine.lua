...
local guide = WoWPro.Leveling:RegisterGuide('MalSil1220', 'Silverpine Forest', 'Malorajan', '12', '20', 'AyaHil2025', 'Horde', function()
return [[
...
r Sell junk, repair/restock.|QID|27082|M|44.52,22.43|
...
C Rise, Forsaken|QID|27097|M|65.12,25.64|N|Swim out to the island, then kill any human you come across.|
...
C Nowhere to Run|QID|27195|NC|M|57.72,44.64|N|Just follow Forteski.|

C Reinforcements from Fenris|QID|27231|M|55.95,33.73|N|Kill any Hillsbrad Worgen you see.|
C Hair of the Dog|QID|27226|U|60870|M|55.76,33.60|N|Target an Orc Sea Dog then use the Barrel of Explosive Ale.|
C Reinforcements from Fenris|QID|27231|M|55.95,33.73|N|Kill any Hillsbrad Worgen you see.|
T Reinforcements from Fenris|QID|27231|M|59.21,34.24|N|To Horde Communication Console.|
A The Waters Run Red...|QID|27232|M|59.21,34.24|N|From Horde Communication Console.|
...
A To Forsaken Forward Command|QID|27290|M|44.69,41.52|N|From Lady Sylvanas Windrunner.|
...
C The F.C.D.|QID|27345|M|45.81,21.95|Z|Ruins of Gilneas|N|Watch out for Korok. Head to the waypoint and pick up the F.C.D.|
...
C On Whose Orders?|QID|27364|M|57.83,44.57|Z|Ruins of Gilneas|N|Head to the waypoint and kill Master Sergeant Pietro Zaren.|
...
C Breaking the Barrier|QID|27474|M|63.48,64.20|N|Head inside the Town Hall and clock on the Ambermill Codex.|
...
H The Sepulcher|QID|27180|M|46.40,42.68|N|Hearth back to The Sepulcher, or fly there if your hearth is not up.|
...
T Transdimensional Warfare: Chapter I|QID|27512|M|60.49,72.42|N|Head inside to the back of the cave then, turn the quest into the Ambermill Dimensional Portal.|
...
A Taking the Battlefront|QID|27452|M|51.89,65.14|N|From Lady Sylvanas Windrunner. Close this step as this quests completes when you accept it.|
...
C 7th Legion Battle Plans|QID|27577|M|44.67,81.01|N|Kill Infantry until the 7th Legion Battle Plans.|S|
