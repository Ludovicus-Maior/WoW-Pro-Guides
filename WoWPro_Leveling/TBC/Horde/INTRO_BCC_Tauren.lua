...
; lv 6
A Kyle's Gone Missing!|QID|11129|M|48.24,53.28|Z|1412; Mulgore|N|From Ahab Wheathoof beside the bridge.|
C Kyle's Gone Missing!|QID|11129|QO|1|M|59.28,62.16|Z|1412; Mulgore|L|33009|ITEM|33009|N|a Plainstrider.|S|
...
C Kyle's Gone Missing!|QID|11129|QO|1|M|59.28,62.16|Z|1412; Mulgore|L|33009|ITEM|33009|N|a Plainstrider.|US|
C Kyle's Gone Missing!|QID|11129|M|49.61,60.17|Z|1412; Mulgore|N|Use the Tender Strider Meat to feed Kyle when you find him.|T|Kyle|U|33009|NC|
...
t Kyle's Gone Missing!|QID|11129|M|48.24,53.28|Z|1412; Mulgore|N|To Ahab Wheathoof beside the bridge.|
...
r Repair/Sell|ACTIVE|772|M|46.19,58.55|Z|1412; Mulgore|N|There are vendors inside the large building to whom you can sell and repair with.\n[color=FF0000]NOTE: [/color]Manually check this step off to continue.|IZ|Bloodhoof Village|
= Level 8 Training|ACTIVE|772|M|PLAYER|CC|N|Do your level 8 training.\n[color=FF0000]NOTE: [/color]Manually check this step off to continue.|LVL|8|IZ|Bloodhoof Village|
C Thunderhorn Totem|QID|756|M|42.12,47.80|Z|1412; Mulgore|L|4801 6;4802 6|ITEM|4801;4802|N|Prairie Stalkers and Flatland Cougars.|S|
C Dwarven Digging|QID|746|QO|1|M|31.26,49.83|Z|1412; Mulgore|L|4702 5|ITEM|4702|N|Bael'dun Dwarves at Bael'dun Digsite.|
R Thunder Bluff|ACTIVE|746|QO|1|M|37.81,78.86|Z|1456; Thunder Bluff|L|4702 5|N|Instead of using the Forge in Bael'dun, go use the one in Thunder Bluff.\n[color=FF0000]NOTE: [/color]This is because the Bael'dun Dwarves respawn very quickly and can make it difficult to get the quest done.\n \nSkip this step if you want to use to it anyway.|O|
C Dwarven Digging|QID|746|M|31.26,49.83|Z|1412; Mulgore|L|4703 5|ITEM|4703|N|Use the Picks by the forge to destroy them.\n[color=FF0000]NOTE: [/color]Clear the entire area first and be quick about getting this done because they respawn rather quickly.\n \nMake sure you have AT LEAST 1 OPEN BAG SLOT to put the broken tool before you start destroying them.\n \nIf you're having trouble, you can use the Forge in Thunder Bluff instead.|U|4702|IZ|Bael'dun Digsite|NC|
C Dwarven Digging|QID|746|M|39.37,56.51|Z|1456; Thunder Bluff|L|4703 5|ITEM|4703|N|Go up the elevator and use the Picks by the forge to destroy them.\n[color=FF0000]NOTE: [/color]Make sure you have AT LEAST 1 OPEN BAG SLOT to put the broken tool before you start destroying them.\n \nIf you're having trouble, you can use the Forge in Thunder Bluff instead.|U|4702|IZ|1456; Thunder Bluff|NC|
* Prospector's Pick|PRE|746|N|Once you've gotten yourself to a safer location, trash the Prospector's Picks you have left over.|U|4702|O|
r Housekeeping|ACTIVE|772|N|Before leaving Thunder Bluff, take a minute to visit the bank to pick up or drop off items, the Auction House, or any of the profession trainers.\n[color=FF0000]NOTE: [/color]Manually check this step off when you are done.|IZ|1456; Thunder Bluff|
...
C Thunderhorn Totem|QID|756|M|42.12,47.80|Z|1412; Mulgore|L|4801 6;4802 6|ITEM|4801;4802|N|Prairie Stalkers and Flatland Cougars.|US|
...
C Thunderhorn Cleansing|QID|758|M|44.48,45.47|Z|1412; Mulgore|N|Clear a spot beside the well and use the totem.|U|5415|NC|
...
H Bloodhoof Village|AVAILABLE|861|M|46.62,61.09|Z|1412; Mulgore|N|Hearth back to Bloodhoof Village if your hearthstone is available.|
...
; --- Druid
A Heeding the Call|QID|5926^5927^5928|M|48.48,59.65|Z|1412; Mulgore|N|From Gennia Runetotem.|C|Druid|
...
; ---
R Thunder Bluff|ACTIVE|775|M|36.11,28.92|Z|1412; Mulgore|N|Run to Thunder Bluff and go up the lift.|
