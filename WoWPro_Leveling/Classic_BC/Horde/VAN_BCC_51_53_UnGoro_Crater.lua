...
C Super Sticky Tar|QID|4504|M|49.70,21.86|L|11834 12|ITEM|11834|N|Tar mobs around the Tar Pits|S|
...
f Marshal's Refuge|AVAILABLE|3881|M|45.23,5.84|N|From Gryfe, atop the hill in the northeast corner.\n[color=FF0000]NOTE: [/color]Make sure you open the flight map to update the FP list.|
...
C Super Sticky Tar|QID|4504|M|49.70,21.86|L|11834 12|ITEM|11834|N|Tar mobs around the Tar Pits|US|
