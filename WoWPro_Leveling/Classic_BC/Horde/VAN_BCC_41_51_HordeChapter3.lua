...
R Booty Bay|QID|604|M|29.34,72.83|
...
T A Strange Request|QID|3121|N|Find Neeru Fireblade in the Cleft of Shadows and This quest.|M|77.0,37.2|Z|Orgrimmar|
...
T Rin'ji is Trapped!|QID|2742|N|Swim south back to the main land, after a little walk you should see another isle off shore, with a stone arch on top of it . Right click on the big tablet on the peak of the island to This quest.|M|86,59|Z|The Hinterlands|
...
t Find OOX-17/TN!|QID|351|N|Find the chicken at , The quest and accept the follow-up.|M|60.2,64.7|Z|Tanaris|
