...
local guide = WoWPro:RegisterGuide("KabExpCata","Achievements","Cataclysm","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Cataclysm", "Explore Cataclysm", "Cata")
