...
local guide =  WoWPro:RegisterGuide("TwiExpBS","Achievements","Burning Steppes","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Burning Steppes", "Explore Eastern Kingdoms", "Cata")
