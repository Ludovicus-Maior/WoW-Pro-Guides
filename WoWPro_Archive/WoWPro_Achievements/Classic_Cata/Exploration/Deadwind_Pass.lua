...
local guide =  WoWPro:RegisterGuide("TwiExpDP","Achievements","Deadwind Pass","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Deadwind Pass", "Explore Eastern Kingdoms", "Cata")
