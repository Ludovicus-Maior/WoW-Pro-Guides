...
local guide =  WoWPro:RegisterGuide("LudoExpFel","Achievements","Felwood","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Felwood", "Explore Kalimdor", "Cata")
