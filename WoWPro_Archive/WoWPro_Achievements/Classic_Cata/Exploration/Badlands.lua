...
local guide =  WoWPro:RegisterGuide("TwiExpBad","Achievements","Badlands","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Badlands", "Explore Eastern Kingdoms", "Cata")
