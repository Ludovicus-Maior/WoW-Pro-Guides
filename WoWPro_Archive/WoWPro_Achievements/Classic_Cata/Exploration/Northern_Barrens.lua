...
local guide =  WoWPro:RegisterGuide("LudoExpNoB","Achievements","Northern Barrens","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Northern Barrens", "Explore Kalimdor", "Cata")
