...
local guide =  WoWPro:RegisterGuide("TwiExpSOF","Achievements","Swamp of Sorrows","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Swamp of Sorrows", "Explore Eastern Kingdoms", "Cata")
