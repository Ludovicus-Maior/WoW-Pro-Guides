...
local guide =  WoWPro:RegisterGuide("LdoExpAzI","Achievements","Azuremyst Isle","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Azuremyst Isle", "Explore Kalimdor", "Cata")
