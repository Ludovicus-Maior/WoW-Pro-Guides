...
local guide =  WoWPro:RegisterGuide("LudoExpFer","Achievements","Feralas","WoWPro Team", "Neutral",4)
WoWPro:GuideLevels(guide,10,50)
WoWPro.Achievements:GuideMisc(guide, "Explore Feralas", "Explore Kalimdor", "Cata")
