local guide = WoWPro:RegisterGuide("JamBor7173", "Leveling", "Borean Tundra", "WoWPro Team", "Horde", 4)
...
f Taunka'le Village|ACTIVE|11695|M|77.76,37.76|N|At Omu Spritbreeze.|
...
K Kaganishu|QID|11637|QO|2|N|He's in an alcove just outside and to the left. Loot the fetish off him.|M|56.2,12.8|T|Kaganishu|
...
T The Fall of Taunka'le Village|QID|11929|N|To Mother Tauranook.|M|78.37,38.05|
A Across Transborea|QID|11930|PRE|11929|N|From Mother Tauranook.|M|78.37,38.05|
