...
local guide = WoWPro:RegisterGuide("LudoHodir",'Dailies', "The Storm Peaks", "Ludovicus", "Neutral", 3)
...
A Feeding Arngrim|QID|13046|M|67.57,59.94|N|From Arngrim the Insatiable, at the upper level|REP|The Sons of Hodir;1119;Revered-Exalted|
...
C Feeding Arngrim|QID|13046|M|57,64|N|Use the tooth on the worms and knock them down to 25% and hold. (not the ones in the cave)|S|U|42774|
